...
namespace DataAccess.Validators409
{
    ...
    public class Consumer14
    {
        ...
        private readonly Security_Core_Handler3 _security_Core_Handler3;
        private readonly ISecurity_Core_Repository4 _iSecurity_Core_Repository4;
        private readonly Security_Core_Manager2 _security_Core_Manager2;

        public Consumer14(Auth_Processors_Repository9 auth_Processors_Repository9, Admin_Processors_Builder4 admin_Processors_Builder4, Admin_Processors_Service2 admin_Processors_Service2, Admin_Processors_Controller3 admin_Processors_Controller3, Admin_Api255_Range8 admin_Api255_Range8, Security_Core_Handler3 security_Core_Handler3, ISecurity_Core_Repository4 iSecurity_Core_Repository4, Security_Core_Manager2 security_Core_Manager2)
        {
            ...
            _security_Core_Handler3 = security_Core_Handler3 ?? throw new ArgumentNullException(nameof(security_Core_Handler3));
            _iSecurity_Core_Repository4 = iSecurity_Core_Repository4 ?? throw new ArgumentNullException(nameof(iSecurity_Core_Repository4));
            _security_Core_Manager2 = security_Core_Manager2 ?? throw new ArgumentNullException(nameof(security_Core_Manager2));
        }
        ...
        public Security_Core_Handler3 GetSecurity_Core_Handler3() => _security_Core_Handler3;
        public ISecurity_Core_Repository4 GetISecurity_Core_Repository4() => _iSecurity_Core_Repository4;
        public Security_Core_Manager2 GetSecurity_Core_Manager2() => _security_Core_Manager2;
