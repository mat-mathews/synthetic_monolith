...
namespace DataAccess.Validators409
{
    ...
    {
        private readonly IAuth_Processors_Factory _iAuth_Processors_Factory;
        private readonly Auth_Processors_ViewModel1 _auth_Processors_ViewModel1;
        ...
        public Consumer17(IAuth_Processors_Factory iAuth_Processors_Factory, Auth_Processors_ViewModel1 auth_Processors_ViewModel1, Auth_Processors_Repository9 auth_Processors_Repository9, Admin_Processors_Builder4 admin_Processors_Builder4, IAdmin_Processors_Provider1 iAdmin_Processors_Provider1, Admin_Api255_Handler4 admin_Api255_Handler4, Admin_Api255_Manager10 admin_Api255_Manager10, Admin_Api255_Processor admin_Api255_Processor)
        {
            _iAuth_Processors_Factory = iAuth_Processors_Factory ?? throw new ArgumentNullException(nameof(iAuth_Processors_Factory));
            _auth_Processors_ViewModel1 = auth_Processors_ViewModel1 ?? throw new ArgumentNullException(nameof(auth_Processors_ViewModel1));
        ...
        public IAuth_Processors_Factory GetIAuth_Processors_Factory() => _iAuth_Processors_Factory;
        public Auth_Processors_ViewModel1 GetAuth_Processors_ViewModel1() => _auth_Processors_ViewModel1;
