...
{
    public interface IExport_Data344_Provider6
    {
        /// <summary>Processes the Export_Data344_Provider6 operation.</summary>
        void ProcessExport_Data344_Provider6();

        /// <summary>Validates the Export_Data344_Provider6 state.</summary>
        bool ValidateExport_Data344_Provider6();
    }
