...
namespace Documents.Data68
{
    ...
    public class Consumer17
    {
        ...
        private readonly Imaging_Core204_Controller1 _imaging_Core204_Controller1;
        private readonly IImaging_Core204_Handler12 _iImaging_Core204_Handler12;
        private readonly Imaging_Core204_Helper14 _imaging_Core204_Helper14;
        private readonly Utilities_Models_Range2 _utilities_Models_Range2;
        private readonly Utilities_Models_Handler _utilities_Models_Handler;

        public Consumer17(Admin_Data117_Command6 admin_Data117_Command6, IAdmin_Data117_Service iAdmin_Data117_Service, Admin_Data117_Event2 admin_Data117_Event2, Imaging_Core204_Controller1 imaging_Core204_Controller1, IImaging_Core204_Handler12 iImaging_Core204_Handler12, Imaging_Core204_Helper14 imaging_Core204_Helper14, Utilities_Models_Range2 utilities_Models_Range2, Utilities_Models_Handler utilities_Models_Handler)
        {
            ...
            _imaging_Core204_Controller1 = imaging_Core204_Controller1 ?? throw new ArgumentNullException(nameof(imaging_Core204_Controller1));
            _iImaging_Core204_Handler12 = iImaging_Core204_Handler12 ?? throw new ArgumentNullException(nameof(iImaging_Core204_Handler12));
            _imaging_Core204_Helper14 = imaging_Core204_Helper14 ?? throw new ArgumentNullException(nameof(imaging_Core204_Helper14));
            _utilities_Models_Range2 = utilities_Models_Range2 ?? throw new ArgumentNullException(nameof(utilities_Models_Range2));
            _utilities_Models_Handler = utilities_Models_Handler ?? throw new ArgumentNullException(nameof(utilities_Models_Handler));
        }
        ...
        public Imaging_Core204_Controller1 GetImaging_Core204_Controller1() => _imaging_Core204_Controller1;
        public IImaging_Core204_Handler12 GetIImaging_Core204_Handler12() => _iImaging_Core204_Handler12;
        public Imaging_Core204_Helper14 GetImaging_Core204_Helper14() => _imaging_Core204_Helper14;
        public Utilities_Models_Range2 GetUtilities_Models_Range2() => _utilities_Models_Range2;
        public Utilities_Models_Handler GetUtilities_Models_Handler() => _utilities_Models_Handler;
