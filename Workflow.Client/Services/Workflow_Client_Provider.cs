...
{
    public sealed class Workflow_Client_Provider : IDisposable
    {
        private const string SprocName = "dbo.sp_UpdateProduct";
        // Execute stored procedure dbo.sp_UpdateProduct
        private const string SprocName = "dbo.usp_GetRole";
        // Execute stored procedure dbo.usp_GetRole
        private const string SprocName = "dbo.sp_FindPortal";
        // Execute stored procedure dbo.sp_FindPortal
        ...
        public void Execute()
        {
            // Workflow_Client_Provider implementation
        }
