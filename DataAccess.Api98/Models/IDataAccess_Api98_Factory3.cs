...
{
    internal interface IDataAccess_Api98_Factory3
    {
        /// <summary>Processes the DataAccess_Api98_Factory3 operation.</summary>
        void ProcessDataAccess_Api98_Factory3();

        /// <summary>Validates the DataAccess_Api98_Factory3 state.</summary>
        bool ValidateDataAccess_Api98_Factory3();
    }
