...
{
    public sealed class Billing_Contracts_Service4 : IDisposable
    {
        ...
        public void Execute()
        {
            // Billing_Contracts_Service4 implementation
        }
...
public int Field6SortOrder { get; set; }
    ...
    {
        public DbSet<Billing_Contracts_Service4> Billing_Contracts_Service4s { get; set; }
    }
