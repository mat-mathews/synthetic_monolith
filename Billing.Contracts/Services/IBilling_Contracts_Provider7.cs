...
{
    public interface IBilling_Contracts_Provider7
    {
        /// <summary>Processes the Billing_Contracts_Provider7 operation.</summary>
        void ProcessBilling_Contracts_Provider7();

        /// <summary>Validates the Billing_Contracts_Provider7 state.</summary>
        bool ValidateBilling_Contracts_Provider7();
    }
