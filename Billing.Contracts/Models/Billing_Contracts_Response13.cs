...
{
    /// <summary>Immutable data transfer record for Billing_Contracts_Response13.</summary>
    public record Billing_Contracts_Response13(string Value, int Count, DateTime Timestamp);
