...
{
    /// <summary>Immutable data transfer record for DataAccess_Contracts_ViewModel5.</summary>
    internal record DataAccess_Contracts_ViewModel5(string Value, int Count, DateTime Timestamp);
