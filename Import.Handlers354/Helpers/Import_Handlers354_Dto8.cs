...
{
    /// <summary>Immutable data transfer record for Import_Handlers354_Dto8.</summary>
    public record Import_Handlers354_Dto8(string Value, int Count, DateTime Timestamp);
