...
{
    /// <summary>Immutable data transfer record for Import_Handlers354_Event11.</summary>
    internal record Import_Handlers354_Event11(string Value, int Count, DateTime Timestamp);
