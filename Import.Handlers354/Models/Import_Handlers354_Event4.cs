...
{
    /// <summary>Immutable data transfer record for Import_Handlers354_Event4.</summary>
    internal record Import_Handlers354_Event4(string Value, int Count, DateTime Timestamp);
