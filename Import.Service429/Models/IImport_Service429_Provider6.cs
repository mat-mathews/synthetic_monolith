...
{
    internal interface IImport_Service429_Provider6
    {
        /// <summary>Processes the Import_Service429_Provider6 operation.</summary>
        void ProcessImport_Service429_Provider6();

        /// <summary>Validates the Import_Service429_Provider6 state.</summary>
        bool ValidateImport_Service429_Provider6();
    }
