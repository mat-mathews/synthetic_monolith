...
namespace Export.Processors361
{
    ...
    public class Consumer11
    {
        ...
        private readonly Documents_Events_Event5 _documents_Events_Event5;
        private readonly Documents_Events_Repository11 _documents_Events_Repository11;
        private readonly Scheduling_Data_Provider _scheduling_Data_Provider;
        private readonly Common_Shared95_Controller1 _common_Shared95_Controller1;

        public Consumer11(Admin_Shared_Factory1 admin_Shared_Factory1, Auth_Events78_Response2 auth_Events78_Response2, Admin_Handlers450_Handler7 admin_Handlers450_Handler7, Documents_Data492_Repository3 documents_Data492_Repository3, Documents_Events_Event5 documents_Events_Event5, Documents_Events_Repository11 documents_Events_Repository11, Scheduling_Data_Provider scheduling_Data_Provider, Common_Shared95_Controller1 common_Shared95_Controller1)
        {
            ...
            _documents_Events_Event5 = documents_Events_Event5 ?? throw new ArgumentNullException(nameof(documents_Events_Event5));
            ...
            _scheduling_Data_Provider = scheduling_Data_Provider ?? throw new ArgumentNullException(nameof(scheduling_Data_Provider));
        ...
        public Documents_Events_Event5 GetDocuments_Events_Event5() => _documents_Events_Event5;
        public Documents_Events_Repository11 GetDocuments_Events_Repository11() => _documents_Events_Repository11;
        public Scheduling_Data_Provider GetScheduling_Data_Provider() => _scheduling_Data_Provider;
