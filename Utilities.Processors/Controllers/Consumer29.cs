...
namespace Utilities.Processors
{
    ...
    public class Consumer29
    {
        ...
        private readonly Scheduling_Contracts_Manager3 _scheduling_Contracts_Manager3;
        private readonly Scheduling_Contracts_Controller2 _scheduling_Contracts_Controller2;
        private readonly Scheduling_Mappers48_Provider8 _scheduling_Mappers48_Provider8;
        private readonly Scheduling_Mappers48_Controller2 _scheduling_Mappers48_Controller2;
        private readonly Scheduling_Mappers48_Manager7 _scheduling_Mappers48_Manager7;

        public Consumer29(Admin_Contracts_Point4 admin_Contracts_Point4, Admin_Contracts_Manager7 admin_Contracts_Manager7, IScheduling_Contracts_Repository iScheduling_Contracts_Repository, Scheduling_Contracts_Manager3 scheduling_Contracts_Manager3, Scheduling_Contracts_Controller2 scheduling_Contracts_Controller2, Scheduling_Mappers48_Provider8 scheduling_Mappers48_Provider8, Scheduling_Mappers48_Controller2 scheduling_Mappers48_Controller2, Scheduling_Mappers48_Manager7 scheduling_Mappers48_Manager7)
        {
            ...
            _scheduling_Contracts_Manager3 = scheduling_Contracts_Manager3 ?? throw new ArgumentNullException(nameof(scheduling_Contracts_Manager3));
            _scheduling_Contracts_Controller2 = scheduling_Contracts_Controller2 ?? throw new ArgumentNullException(nameof(scheduling_Contracts_Controller2));
            _scheduling_Mappers48_Provider8 = scheduling_Mappers48_Provider8 ?? throw new ArgumentNullException(nameof(scheduling_Mappers48_Provider8));
            _scheduling_Mappers48_Controller2 = scheduling_Mappers48_Controller2 ?? throw new ArgumentNullException(nameof(scheduling_Mappers48_Controller2));
        ...
        public Scheduling_Contracts_Manager3 GetScheduling_Contracts_Manager3() => _scheduling_Contracts_Manager3;
        public Scheduling_Contracts_Controller2 GetScheduling_Contracts_Controller2() => _scheduling_Contracts_Controller2;
        public Scheduling_Mappers48_Provider8 GetScheduling_Mappers48_Provider8() => _scheduling_Mappers48_Provider8;
        public Scheduling_Mappers48_Controller2 GetScheduling_Mappers48_Controller2() => _scheduling_Mappers48_Controller2;
