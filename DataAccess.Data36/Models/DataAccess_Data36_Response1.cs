...
{
    /// <summary>Immutable data transfer record for DataAccess_Data36_Response1.</summary>
    public record DataAccess_Data36_Response1(string Value, int Count, DateTime Timestamp);
