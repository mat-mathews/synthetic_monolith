...
namespace Documents.Data419
{
    ...
    public class Consumer26
    {
        ...
        private readonly Common_Processors245_Repository3 _common_Processors245_Repository3;
        private readonly Common_Processors245_Command7 _common_Processors245_Command7;
        private readonly Workflow_Mappers_Request _workflow_Mappers_Request;
        private readonly Workflow_Mappers_Processor1 _workflow_Mappers_Processor1;
        private readonly IImport_Client64_Validator _iImport_Client64_Validator;

        public Consumer26(IAdmin_Web_Provider iAdmin_Web_Provider, Admin_Web_Handler1 admin_Web_Handler1, Admin_Web_Processor5 admin_Web_Processor5, Common_Processors245_Repository3 common_Processors245_Repository3, Common_Processors245_Command7 common_Processors245_Command7, Workflow_Mappers_Request workflow_Mappers_Request, Workflow_Mappers_Processor1 workflow_Mappers_Processor1, IImport_Client64_Validator iImport_Client64_Validator)
        {
            ...
            _common_Processors245_Repository3 = common_Processors245_Repository3 ?? throw new ArgumentNullException(nameof(common_Processors245_Repository3));
            _common_Processors245_Command7 = common_Processors245_Command7 ?? throw new ArgumentNullException(nameof(common_Processors245_Command7));
            _workflow_Mappers_Request = workflow_Mappers_Request ?? throw new ArgumentNullException(nameof(workflow_Mappers_Request));
            ...
            _iImport_Client64_Validator = iImport_Client64_Validator ?? throw new ArgumentNullException(nameof(iImport_Client64_Validator));
        }
        ...
        public Common_Processors245_Repository3 GetCommon_Processors245_Repository3() => _common_Processors245_Repository3;
        public Common_Processors245_Command7 GetCommon_Processors245_Command7() => _common_Processors245_Command7;
        public Workflow_Mappers_Request GetWorkflow_Mappers_Request() => _workflow_Mappers_Request;
        public Workflow_Mappers_Processor1 GetWorkflow_Mappers_Processor1() => _workflow_Mappers_Processor1;
        public IImport_Client64_Validator GetIImport_Client64_Validator() => _iImport_Client64_Validator;
