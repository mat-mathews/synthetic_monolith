...
namespace Utilities.Core
{
    ...
    public class Consumer31
    {
        ...
        private readonly ISecurity_Contracts_Repository7 _iSecurity_Contracts_Repository7;
        ...
        private readonly Import_Models457_Handler10 _import_Models457_Handler10;

        public Consumer31(Admin_Handlers450_Processor5 admin_Handlers450_Processor5, ISecurity_Contracts_Repository7 iSecurity_Contracts_Repository7, Security_Contracts_Command11 security_Contracts_Command11, Security_Contracts_Handler12 security_Contracts_Handler12, Auth_Contracts402_Event2 auth_Contracts402_Event2, Auth_Contracts402_Provider9 auth_Contracts402_Provider9, Import_Models457_Processor2 import_Models457_Processor2, Import_Models457_Handler10 import_Models457_Handler10)
        {
            ...
            _iSecurity_Contracts_Repository7 = iSecurity_Contracts_Repository7 ?? throw new ArgumentNullException(nameof(iSecurity_Contracts_Repository7));
            ...
            _import_Models457_Handler10 = import_Models457_Handler10 ?? throw new ArgumentNullException(nameof(import_Models457_Handler10));
        }

        public Admin_Handlers450_Processor5 GetAdmin_Handlers450_Processor5() => _admin_Handlers450_Processor5;
        public ISecurity_Contracts_Repository7 GetISecurity_Contracts_Repository7() => _iSecurity_Contracts_Repository7;
        ...
        public Import_Models457_Handler10 GetImport_Models457_Handler10() => _import_Models457_Handler10;
