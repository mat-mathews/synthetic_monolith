...
{
    /// <summary>Immutable data transfer record for BatchJobs_Core_ViewModel5.</summary>
    internal record BatchJobs_Core_ViewModel5(string Value, int Count, DateTime Timestamp);
