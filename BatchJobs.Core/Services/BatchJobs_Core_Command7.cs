...
{
    /// <summary>Immutable data transfer record for BatchJobs_Core_Command7.</summary>
    public record BatchJobs_Core_Command7(string Value, int Count, DateTime Timestamp);
