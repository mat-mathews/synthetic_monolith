...
{
    /// <summary>Immutable data transfer record for Import_Mappers56_Event1.</summary>
    public record Import_Mappers56_Event1(string Value, int Count, DateTime Timestamp);
