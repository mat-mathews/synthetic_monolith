...
{
    /// <summary>Immutable data transfer record for Import_Processors_Request12.</summary>
    public record Import_Processors_Request12(string Value, int Count, DateTime Timestamp);
