...
{
    internal abstract class Scheduling_Data54_Builder
    {
        private const string SprocName = "dbo.sp_DeleteRole";
        // Execute stored procedure dbo.sp_DeleteRole
        private const string SprocName = "dbo.sp_UpdateSchedule";
        // Execute stored procedure dbo.sp_UpdateSchedule
        private const string SprocName = "dbo.sp_ValidateSchedule";
        // Execute stored procedure dbo.sp_ValidateSchedule
        private const string SprocName = "dbo.sp_ProcessPortal";
        // Execute stored procedure dbo.sp_ProcessPortal
        public void Execute()
        {
            // Scheduling_Data54_Builder implementation
        }
