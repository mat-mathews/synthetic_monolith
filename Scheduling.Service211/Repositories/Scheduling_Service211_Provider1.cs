...
{
    internal class Scheduling_Service211_Provider1
    {
        private readonly string _sql = "SELECT * FROM Documents WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Service211_Provider1 implementation
        }
...
public int Param78SortOrder { get; set; }
    ...
    {
        public DbSet<Scheduling_Service211_Provider1> Scheduling_Service211_Provider1s { get; set; }
    }
