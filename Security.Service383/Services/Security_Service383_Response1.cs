...
{
    /// <summary>Immutable data transfer record for Security_Service383_Response1.</summary>
    public record Security_Service383_Response1(string Value, int Count, DateTime Timestamp);
