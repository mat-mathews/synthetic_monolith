...
{
    internal class Security_Service383_Provider2
    {
        private readonly string _sql = "SELECT * FROM Accounts WHERE Id = @Id";
        public void Execute()
        {
            // Security_Service383_Provider2 implementation
        }
...
public int Detail84SortOrder { get; set; }
    ...
    public class Service383Context : DbContext
    {
        public DbSet<Security_Service383_Provider2> Security_Service383_Provider2s { get; set; }
    }
