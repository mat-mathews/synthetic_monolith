...
{
    /// <summary>Immutable data transfer record for Scheduling_Core273_ViewModel4.</summary>
    public record Scheduling_Core273_ViewModel4(string Value, int Count, DateTime Timestamp);
