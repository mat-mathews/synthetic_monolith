...
{
    public class Documents_Api129_Provider3
    {
        private readonly string _sql = "SELECT * FROM Customers WHERE Id = @Id";
        public void Execute()
        {
            // Documents_Api129_Provider3 implementation
        }
...
public int Config90SortOrder { get; set; }
    ...
    public class Api129Context : DbContext
    {
        public DbSet<Documents_Api129_Provider3> Documents_Api129_Provider3s { get; set; }
    }
