...
{
    internal class Common_Events280_Provider : IDisposable
    {
        private const string SprocName = "dbo.usp_GetReport";
        // Execute stored procedure dbo.usp_GetReport
        private const string SprocName = "dbo.sp_GetAccount";
        // Execute stored procedure dbo.sp_GetAccount
        public void Execute()
        {
            // Common_Events280_Provider implementation
        }
