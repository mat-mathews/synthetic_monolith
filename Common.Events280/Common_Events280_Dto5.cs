...
{
    /// <summary>Immutable data transfer record for Common_Events280_Dto5.</summary>
    internal record Common_Events280_Dto5(string Value, int Count, DateTime Timestamp);
