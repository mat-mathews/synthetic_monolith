...
namespace Common.Events280
{
    ...
    {
        private readonly Reporting_Mappers239_Manager5 _reporting_Mappers239_Manager5;
        private readonly Reporting_Mappers239_Helper3 _reporting_Mappers239_Helper3;
        private readonly Reporting_Mappers239_Builder8 _reporting_Mappers239_Builder8;
        private readonly Scheduling_Api185_Handler2 _scheduling_Api185_Handler2;
        private readonly IScheduling_Api185_Repository6 _iScheduling_Api185_Repository6;
        private readonly IDataAccess_Mappers_Service2 _iDataAccess_Mappers_Service2;
        private readonly IDataAccess_Mappers_Handler4 _iDataAccess_Mappers_Handler4;
        private readonly IDataAccess_Mappers_Service3 _iDataAccess_Mappers_Service3;

        public Consumer2(Reporting_Mappers239_Manager5 reporting_Mappers239_Manager5, Reporting_Mappers239_Helper3 reporting_Mappers239_Helper3, Reporting_Mappers239_Builder8 reporting_Mappers239_Builder8, Scheduling_Api185_Handler2 scheduling_Api185_Handler2, IScheduling_Api185_Repository6 iScheduling_Api185_Repository6, IDataAccess_Mappers_Service2 iDataAccess_Mappers_Service2, IDataAccess_Mappers_Handler4 iDataAccess_Mappers_Handler4, IDataAccess_Mappers_Service3 iDataAccess_Mappers_Service3)
        {
            _reporting_Mappers239_Manager5 = reporting_Mappers239_Manager5 ?? throw new ArgumentNullException(nameof(reporting_Mappers239_Manager5));
            _reporting_Mappers239_Helper3 = reporting_Mappers239_Helper3 ?? throw new ArgumentNullException(nameof(reporting_Mappers239_Helper3));
            _reporting_Mappers239_Builder8 = reporting_Mappers239_Builder8 ?? throw new ArgumentNullException(nameof(reporting_Mappers239_Builder8));
            _scheduling_Api185_Handler2 = scheduling_Api185_Handler2 ?? throw new ArgumentNullException(nameof(scheduling_Api185_Handler2));
            _iScheduling_Api185_Repository6 = iScheduling_Api185_Repository6 ?? throw new ArgumentNullException(nameof(iScheduling_Api185_Repository6));
            _iDataAccess_Mappers_Service2 = iDataAccess_Mappers_Service2 ?? throw new ArgumentNullException(nameof(iDataAccess_Mappers_Service2));
            _iDataAccess_Mappers_Handler4 = iDataAccess_Mappers_Handler4 ?? throw new ArgumentNullException(nameof(iDataAccess_Mappers_Handler4));
            _iDataAccess_Mappers_Service3 = iDataAccess_Mappers_Service3 ?? throw new ArgumentNullException(nameof(iDataAccess_Mappers_Service3));
        }

        public Reporting_Mappers239_Manager5 GetReporting_Mappers239_Manager5() => _reporting_Mappers239_Manager5;
        public Reporting_Mappers239_Helper3 GetReporting_Mappers239_Helper3() => _reporting_Mappers239_Helper3;
        public Reporting_Mappers239_Builder8 GetReporting_Mappers239_Builder8() => _reporting_Mappers239_Builder8;
        public Scheduling_Api185_Handler2 GetScheduling_Api185_Handler2() => _scheduling_Api185_Handler2;
        public IScheduling_Api185_Repository6 GetIScheduling_Api185_Repository6() => _iScheduling_Api185_Repository6;
        public IDataAccess_Mappers_Service2 GetIDataAccess_Mappers_Service2() => _iDataAccess_Mappers_Service2;
        public IDataAccess_Mappers_Handler4 GetIDataAccess_Mappers_Handler4() => _iDataAccess_Mappers_Handler4;
        public IDataAccess_Mappers_Service3 GetIDataAccess_Mappers_Service3() => _iDataAccess_Mappers_Service3;
