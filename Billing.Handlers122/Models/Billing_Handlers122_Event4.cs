...
{
    /// <summary>Immutable data transfer record for Billing_Handlers122_Event4.</summary>
    internal record Billing_Handlers122_Event4(string Value, int Count, DateTime Timestamp);
