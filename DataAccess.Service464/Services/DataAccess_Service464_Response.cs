...
{
    /// <summary>Immutable data transfer record for DataAccess_Service464_Response.</summary>
    internal record DataAccess_Service464_Response(string Value, int Count, DateTime Timestamp);
