...
{
    /// <summary>Immutable data transfer record for Notifications_Mappers110_Response7.</summary>
    internal record Notifications_Mappers110_Response7(string Value, int Count, DateTime Timestamp);
