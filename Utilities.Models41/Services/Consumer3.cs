...
namespace Utilities.Models41
{
    ...
    {
        private readonly Admin_Service_Manager3 _admin_Service_Manager3;
        private readonly Admin_Validators431_Key8 _admin_Validators431_Key8;
        private readonly Admin_Validators431_Builder5 _admin_Validators431_Builder5;
        private readonly Admin_Models476_Event9 _admin_Models476_Event9;
        private readonly IAdmin_Models476_Provider2 _iAdmin_Models476_Provider2;
        private readonly Admin_Models476_Manager8 _admin_Models476_Manager8;
        private readonly Notifications_Mappers55_Controller5 _notifications_Mappers55_Controller5;
        private readonly Notifications_Mappers55_Builder4 _notifications_Mappers55_Builder4;

        public Consumer3(Admin_Service_Manager3 admin_Service_Manager3, Admin_Validators431_Key8 admin_Validators431_Key8, Admin_Validators431_Builder5 admin_Validators431_Builder5, Admin_Models476_Event9 admin_Models476_Event9, IAdmin_Models476_Provider2 iAdmin_Models476_Provider2, Admin_Models476_Manager8 admin_Models476_Manager8, Notifications_Mappers55_Controller5 notifications_Mappers55_Controller5, Notifications_Mappers55_Builder4 notifications_Mappers55_Builder4)
        {
            _admin_Service_Manager3 = admin_Service_Manager3 ?? throw new ArgumentNullException(nameof(admin_Service_Manager3));
            _admin_Validators431_Key8 = admin_Validators431_Key8 ?? throw new ArgumentNullException(nameof(admin_Validators431_Key8));
            _admin_Validators431_Builder5 = admin_Validators431_Builder5 ?? throw new ArgumentNullException(nameof(admin_Validators431_Builder5));
            _admin_Models476_Event9 = admin_Models476_Event9 ?? throw new ArgumentNullException(nameof(admin_Models476_Event9));
            _iAdmin_Models476_Provider2 = iAdmin_Models476_Provider2 ?? throw new ArgumentNullException(nameof(iAdmin_Models476_Provider2));
            _admin_Models476_Manager8 = admin_Models476_Manager8 ?? throw new ArgumentNullException(nameof(admin_Models476_Manager8));
            _notifications_Mappers55_Controller5 = notifications_Mappers55_Controller5 ?? throw new ArgumentNullException(nameof(notifications_Mappers55_Controller5));
            _notifications_Mappers55_Builder4 = notifications_Mappers55_Builder4 ?? throw new ArgumentNullException(nameof(notifications_Mappers55_Builder4));
        }

        public Admin_Service_Manager3 GetAdmin_Service_Manager3() => _admin_Service_Manager3;
        public Admin_Validators431_Key8 GetAdmin_Validators431_Key8() => _admin_Validators431_Key8;
        public Admin_Validators431_Builder5 GetAdmin_Validators431_Builder5() => _admin_Validators431_Builder5;
        public Admin_Models476_Event9 GetAdmin_Models476_Event9() => _admin_Models476_Event9;
        public IAdmin_Models476_Provider2 GetIAdmin_Models476_Provider2() => _iAdmin_Models476_Provider2;
        public Admin_Models476_Manager8 GetAdmin_Models476_Manager8() => _admin_Models476_Manager8;
        public Notifications_Mappers55_Controller5 GetNotifications_Mappers55_Controller5() => _notifications_Mappers55_Controller5;
        public Notifications_Mappers55_Builder4 GetNotifications_Mappers55_Builder4() => _notifications_Mappers55_Builder4;
