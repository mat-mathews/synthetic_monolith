...
{
    public abstract class Workflow_Api433_Controller1
    {
        ...
        public void Execute()
        {
            // Workflow_Api433_Controller1 implementation
        }
...
public int Record70SortOrder { get; set; }
    ...
    public class Api433Context : DbContext
    {
        public DbSet<Workflow_Api433_Controller1> Workflow_Api433_Controller1s { get; set; }
    }
