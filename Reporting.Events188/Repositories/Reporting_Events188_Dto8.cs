...
{
    /// <summary>Immutable data transfer record for Reporting_Events188_Dto8.</summary>
    public record Reporting_Events188_Dto8(string Value, int Count, DateTime Timestamp);
