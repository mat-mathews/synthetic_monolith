...
namespace Reporting.Events188
{
    ...
    public class Consumer22
    {
        ...
        private readonly Documents_Tests171_Builder1 _documents_Tests171_Builder1;
        private readonly Documents_Tests171_Controller4 _documents_Tests171_Controller4;
        private readonly ISecurity_Client137_Handler1 _iSecurity_Client137_Handler1;
        private readonly Security_Client137_Provider6 _security_Client137_Provider6;
        private readonly ISecurity_Client137_Repository _iSecurity_Client137_Repository;
        private readonly Portal_Validators_Point _portal_Validators_Point;
        private readonly IPortal_Validators_Repository3 _iPortal_Validators_Repository3;

        public Consumer22(Admin_Service_Service6 admin_Service_Service6, Documents_Tests171_Builder1 documents_Tests171_Builder1, Documents_Tests171_Controller4 documents_Tests171_Controller4, ISecurity_Client137_Handler1 iSecurity_Client137_Handler1, Security_Client137_Provider6 security_Client137_Provider6, ISecurity_Client137_Repository iSecurity_Client137_Repository, Portal_Validators_Point portal_Validators_Point, IPortal_Validators_Repository3 iPortal_Validators_Repository3)
        {
            _admin_Service_Service6 = admin_Service_Service6 ?? throw new ArgumentNullException(nameof(admin_Service_Service6));
            _documents_Tests171_Builder1 = documents_Tests171_Builder1 ?? throw new ArgumentNullException(nameof(documents_Tests171_Builder1));
            _documents_Tests171_Controller4 = documents_Tests171_Controller4 ?? throw new ArgumentNullException(nameof(documents_Tests171_Controller4));
            _iSecurity_Client137_Handler1 = iSecurity_Client137_Handler1 ?? throw new ArgumentNullException(nameof(iSecurity_Client137_Handler1));
            _security_Client137_Provider6 = security_Client137_Provider6 ?? throw new ArgumentNullException(nameof(security_Client137_Provider6));
            ...
            _portal_Validators_Point = portal_Validators_Point ?? throw new ArgumentNullException(nameof(portal_Validators_Point));
            _iPortal_Validators_Repository3 = iPortal_Validators_Repository3 ?? throw new ArgumentNullException(nameof(iPortal_Validators_Repository3));
        }

        public Admin_Service_Service6 GetAdmin_Service_Service6() => _admin_Service_Service6;
        public Documents_Tests171_Builder1 GetDocuments_Tests171_Builder1() => _documents_Tests171_Builder1;
        public Documents_Tests171_Controller4 GetDocuments_Tests171_Controller4() => _documents_Tests171_Controller4;
        public ISecurity_Client137_Handler1 GetISecurity_Client137_Handler1() => _iSecurity_Client137_Handler1;
        public Security_Client137_Provider6 GetSecurity_Client137_Provider6() => _security_Client137_Provider6;
        public ISecurity_Client137_Repository GetISecurity_Client137_Repository() => _iSecurity_Client137_Repository;
        public Portal_Validators_Point GetPortal_Validators_Point() => _portal_Validators_Point;
        public IPortal_Validators_Repository3 GetIPortal_Validators_Repository3() => _iPortal_Validators_Repository3;
