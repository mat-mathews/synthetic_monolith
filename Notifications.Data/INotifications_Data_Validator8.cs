...
{
    internal interface INotifications_Data_Validator8
    {
        /// <summary>Processes the Notifications_Data_Validator8 operation.</summary>
        void ProcessNotifications_Data_Validator8();

        /// <summary>Validates the Notifications_Data_Validator8 state.</summary>
        bool ValidateNotifications_Data_Validator8();
    }
