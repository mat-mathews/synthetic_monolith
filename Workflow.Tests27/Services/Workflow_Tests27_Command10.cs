...
{
    /// <summary>Immutable data transfer record for Workflow_Tests27_Command10.</summary>
    public record Workflow_Tests27_Command10(string Value, int Count, DateTime Timestamp);
