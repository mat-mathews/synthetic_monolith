...
{
    public interface IReporting_Service_Handler1
    {
        /// <summary>Processes the Reporting_Service_Handler1 operation.</summary>
        void ProcessReporting_Service_Handler1();

        /// <summary>Validates the Reporting_Service_Handler1 state.</summary>
        bool ValidateReporting_Service_Handler1();
    }
