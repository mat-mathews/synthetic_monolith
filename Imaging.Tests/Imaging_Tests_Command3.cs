...
{
    /// <summary>Immutable data transfer record for Imaging_Tests_Command3.</summary>
    internal record Imaging_Tests_Command3(string Value, int Count, DateTime Timestamp);
