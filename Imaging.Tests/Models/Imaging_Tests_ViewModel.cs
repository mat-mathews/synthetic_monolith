...
{
    /// <summary>Immutable data transfer record for Imaging_Tests_ViewModel.</summary>
    public record Imaging_Tests_ViewModel(string Value, int Count, DateTime Timestamp);
