...
namespace Imaging.Tests
{
    ...
    public class Consumer17
    {
        ...
        private readonly Import_Handlers167_Provider4 _import_Handlers167_Provider4;
        private readonly IUtilities_Data415_Provider9 _iUtilities_Data415_Provider9;
        private readonly Utilities_Data415_Manager7 _utilities_Data415_Manager7;
        private readonly IBilling_Handlers122_Validator2 _iBilling_Handlers122_Validator2;
        private readonly Auth_Mappers208_Request6 _auth_Mappers208_Request6;
        private readonly Portal_Service378_Key1 _portal_Service378_Key1;
        private readonly Imaging_Api_Dto3 _imaging_Api_Dto3;

        public Consumer17(Auth_Client_Range3 auth_Client_Range3, Import_Handlers167_Provider4 import_Handlers167_Provider4, IUtilities_Data415_Provider9 iUtilities_Data415_Provider9, Utilities_Data415_Manager7 utilities_Data415_Manager7, IBilling_Handlers122_Validator2 iBilling_Handlers122_Validator2, Auth_Mappers208_Request6 auth_Mappers208_Request6, Portal_Service378_Key1 portal_Service378_Key1, Imaging_Api_Dto3 imaging_Api_Dto3)
        {
            _auth_Client_Range3 = auth_Client_Range3 ?? throw new ArgumentNullException(nameof(auth_Client_Range3));
            _import_Handlers167_Provider4 = import_Handlers167_Provider4 ?? throw new ArgumentNullException(nameof(import_Handlers167_Provider4));
            _iUtilities_Data415_Provider9 = iUtilities_Data415_Provider9 ?? throw new ArgumentNullException(nameof(iUtilities_Data415_Provider9));
            _utilities_Data415_Manager7 = utilities_Data415_Manager7 ?? throw new ArgumentNullException(nameof(utilities_Data415_Manager7));
            _iBilling_Handlers122_Validator2 = iBilling_Handlers122_Validator2 ?? throw new ArgumentNullException(nameof(iBilling_Handlers122_Validator2));
            _auth_Mappers208_Request6 = auth_Mappers208_Request6 ?? throw new ArgumentNullException(nameof(auth_Mappers208_Request6));
            _portal_Service378_Key1 = portal_Service378_Key1 ?? throw new ArgumentNullException(nameof(portal_Service378_Key1));
            _imaging_Api_Dto3 = imaging_Api_Dto3 ?? throw new ArgumentNullException(nameof(imaging_Api_Dto3));
        }

        public Auth_Client_Range3 GetAuth_Client_Range3() => _auth_Client_Range3;
        public Import_Handlers167_Provider4 GetImport_Handlers167_Provider4() => _import_Handlers167_Provider4;
        public IUtilities_Data415_Provider9 GetIUtilities_Data415_Provider9() => _iUtilities_Data415_Provider9;
        public Utilities_Data415_Manager7 GetUtilities_Data415_Manager7() => _utilities_Data415_Manager7;
        public IBilling_Handlers122_Validator2 GetIBilling_Handlers122_Validator2() => _iBilling_Handlers122_Validator2;
        public Auth_Mappers208_Request6 GetAuth_Mappers208_Request6() => _auth_Mappers208_Request6;
        public Portal_Service378_Key1 GetPortal_Service378_Key1() => _portal_Service378_Key1;
        public Imaging_Api_Dto3 GetImaging_Api_Dto3() => _imaging_Api_Dto3;
