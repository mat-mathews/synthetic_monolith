...
{
    public interface IDocuments_Service471_Provider3
    {
        /// <summary>Processes the Documents_Service471_Provider3 operation.</summary>
        void ProcessDocuments_Service471_Provider3();

        /// <summary>Validates the Documents_Service471_Provider3 state.</summary>
        bool ValidateDocuments_Service471_Provider3();
    }
