...
{
    /// <summary>Immutable data transfer record for Documents_Service471_Response11.</summary>
    public record Documents_Service471_Response11(string Value, int Count, DateTime Timestamp);
