...
namespace Import.Tests119
{
    ...
    public class Consumer32
    {
        ...
        private readonly Auth_Data_Provider7 _auth_Data_Provider7;
        private readonly Auth_Data_Helper1 _auth_Data_Helper1;
        private readonly Admin_Handlers61_Range2 _admin_Handlers61_Range2;
        private readonly Admin_Handlers_Provider2 _admin_Handlers_Provider2;
        private readonly DataAccess_Client_Options7 _dataAccess_Client_Options7;
        private readonly DataAccess_Client_Builder6 _dataAccess_Client_Builder6;
        private readonly DataAccess_Client_Point3 _dataAccess_Client_Point3;

        public Consumer32(Auth_Data_Repository6 auth_Data_Repository6, Auth_Data_Provider7 auth_Data_Provider7, Auth_Data_Helper1 auth_Data_Helper1, Admin_Handlers61_Range2 admin_Handlers61_Range2, Admin_Handlers_Provider2 admin_Handlers_Provider2, DataAccess_Client_Options7 dataAccess_Client_Options7, DataAccess_Client_Builder6 dataAccess_Client_Builder6, DataAccess_Client_Point3 dataAccess_Client_Point3)
        {
            _auth_Data_Repository6 = auth_Data_Repository6 ?? throw new ArgumentNullException(nameof(auth_Data_Repository6));
            _auth_Data_Provider7 = auth_Data_Provider7 ?? throw new ArgumentNullException(nameof(auth_Data_Provider7));
            _auth_Data_Helper1 = auth_Data_Helper1 ?? throw new ArgumentNullException(nameof(auth_Data_Helper1));
            _admin_Handlers61_Range2 = admin_Handlers61_Range2 ?? throw new ArgumentNullException(nameof(admin_Handlers61_Range2));
            _admin_Handlers_Provider2 = admin_Handlers_Provider2 ?? throw new ArgumentNullException(nameof(admin_Handlers_Provider2));
            _dataAccess_Client_Options7 = dataAccess_Client_Options7 ?? throw new ArgumentNullException(nameof(dataAccess_Client_Options7));
            _dataAccess_Client_Builder6 = dataAccess_Client_Builder6 ?? throw new ArgumentNullException(nameof(dataAccess_Client_Builder6));
            _dataAccess_Client_Point3 = dataAccess_Client_Point3 ?? throw new ArgumentNullException(nameof(dataAccess_Client_Point3));
        }

        public Auth_Data_Repository6 GetAuth_Data_Repository6() => _auth_Data_Repository6;
        public Auth_Data_Provider7 GetAuth_Data_Provider7() => _auth_Data_Provider7;
        public Auth_Data_Helper1 GetAuth_Data_Helper1() => _auth_Data_Helper1;
        public Admin_Handlers61_Range2 GetAdmin_Handlers61_Range2() => _admin_Handlers61_Range2;
        public Admin_Handlers_Provider2 GetAdmin_Handlers_Provider2() => _admin_Handlers_Provider2;
        public DataAccess_Client_Options7 GetDataAccess_Client_Options7() => _dataAccess_Client_Options7;
        public DataAccess_Client_Builder6 GetDataAccess_Client_Builder6() => _dataAccess_Client_Builder6;
        public DataAccess_Client_Point3 GetDataAccess_Client_Point3() => _dataAccess_Client_Point3;
