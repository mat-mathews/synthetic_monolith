...
{
    /// <summary>Immutable data transfer record for Import_Api272_ViewModel.</summary>
    internal record Import_Api272_ViewModel(string Value, int Count, DateTime Timestamp);
