...
{
    internal interface IImport_Api272_Factory10
    {
        /// <summary>Processes the Import_Api272_Factory10 operation.</summary>
        void ProcessImport_Api272_Factory10();

        /// <summary>Validates the Import_Api272_Factory10 state.</summary>
        bool ValidateImport_Api272_Factory10();
    }
