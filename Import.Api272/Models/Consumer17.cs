...
namespace Import.Api272
{
    ...
    {
        private readonly Admin_Client346_Repository9 _admin_Client346_Repository9;
        private readonly Admin_Client346_Manager2 _admin_Client346_Manager2;
        private readonly IAdmin_Handlers_Handler11 _iAdmin_Handlers_Handler11;
        private readonly BatchJobs_Models304_Provider1 _batchJobs_Models304_Provider1;
        private readonly Portal_Tests323_Service2 _portal_Tests323_Service2;
        ...
        private readonly BatchJobs_Service_Request3 _batchJobs_Service_Request3;

        public Consumer17(Admin_Client346_Repository9 admin_Client346_Repository9, Admin_Client346_Manager2 admin_Client346_Manager2, IAdmin_Handlers_Handler11 iAdmin_Handlers_Handler11, BatchJobs_Models304_Provider1 batchJobs_Models304_Provider1, Portal_Tests323_Service2 portal_Tests323_Service2, ISecurity_Client137_Repository iSecurity_Client137_Repository, Security_Client137_Provider6 security_Client137_Provider6, BatchJobs_Service_Request3 batchJobs_Service_Request3)
        {
            _admin_Client346_Repository9 = admin_Client346_Repository9 ?? throw new ArgumentNullException(nameof(admin_Client346_Repository9));
            _admin_Client346_Manager2 = admin_Client346_Manager2 ?? throw new ArgumentNullException(nameof(admin_Client346_Manager2));
            _iAdmin_Handlers_Handler11 = iAdmin_Handlers_Handler11 ?? throw new ArgumentNullException(nameof(iAdmin_Handlers_Handler11));
            _batchJobs_Models304_Provider1 = batchJobs_Models304_Provider1 ?? throw new ArgumentNullException(nameof(batchJobs_Models304_Provider1));
            _portal_Tests323_Service2 = portal_Tests323_Service2 ?? throw new ArgumentNullException(nameof(portal_Tests323_Service2));
            ...
            _batchJobs_Service_Request3 = batchJobs_Service_Request3 ?? throw new ArgumentNullException(nameof(batchJobs_Service_Request3));
        }

        public Admin_Client346_Repository9 GetAdmin_Client346_Repository9() => _admin_Client346_Repository9;
        public Admin_Client346_Manager2 GetAdmin_Client346_Manager2() => _admin_Client346_Manager2;
        public IAdmin_Handlers_Handler11 GetIAdmin_Handlers_Handler11() => _iAdmin_Handlers_Handler11;
        public BatchJobs_Models304_Provider1 GetBatchJobs_Models304_Provider1() => _batchJobs_Models304_Provider1;
        public Portal_Tests323_Service2 GetPortal_Tests323_Service2() => _portal_Tests323_Service2;
        ...
        public BatchJobs_Service_Request3 GetBatchJobs_Service_Request3() => _batchJobs_Service_Request3;
