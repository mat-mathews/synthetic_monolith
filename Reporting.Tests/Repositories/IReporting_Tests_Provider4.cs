...
{
    internal interface IReporting_Tests_Provider4
    {
        /// <summary>Processes the Reporting_Tests_Provider4 operation.</summary>
        void ProcessReporting_Tests_Provider4();

        /// <summary>Validates the Reporting_Tests_Provider4 state.</summary>
        bool ValidateReporting_Tests_Provider4();
    }
