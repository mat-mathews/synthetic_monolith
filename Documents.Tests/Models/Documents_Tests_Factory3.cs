...
{
    internal abstract class Documents_Tests_Factory3
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // Documents_Tests_Factory3 implementation
        }
...
public int Detail80SortOrder { get; set; }
    ...
    {
        public DbSet<Documents_Tests_Factory3> Documents_Tests_Factory3s { get; set; }
    }
