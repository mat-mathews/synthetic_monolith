...
{
    internal interface IDocuments_Tests_Validator4
    {
        /// <summary>Processes the Documents_Tests_Validator4 operation.</summary>
        void ProcessDocuments_Tests_Validator4();

        /// <summary>Validates the Documents_Tests_Validator4 state.</summary>
        bool ValidateDocuments_Tests_Validator4();
    }
