...
{
    public interface IDocuments_Tests_Handler12
    {
        /// <summary>Processes the Documents_Tests_Handler12 operation.</summary>
        void ProcessDocuments_Tests_Handler12();

        /// <summary>Validates the Documents_Tests_Handler12 state.</summary>
        bool ValidateDocuments_Tests_Handler12();
    }
