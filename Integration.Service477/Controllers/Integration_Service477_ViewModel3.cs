...
{
    /// <summary>Immutable data transfer record for Integration_Service477_ViewModel3.</summary>
    internal record Integration_Service477_ViewModel3(string Value, int Count, DateTime Timestamp);
