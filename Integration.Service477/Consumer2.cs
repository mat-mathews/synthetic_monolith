...
namespace Integration.Service477
{
    ...
    {
        private readonly Portal_Shared_Dto4 _portal_Shared_Dto4;
        private readonly Portal_Shared_Repository5 _portal_Shared_Repository5;
        private readonly BatchJobs_Web_Controller4 _batchJobs_Web_Controller4;
        private readonly BatchJobs_Web_Handler3 _batchJobs_Web_Handler3;
        ...
        public Consumer2(Portal_Shared_Dto4 portal_Shared_Dto4, Portal_Shared_Repository5 portal_Shared_Repository5, BatchJobs_Web_Controller4 batchJobs_Web_Controller4, BatchJobs_Web_Handler3 batchJobs_Web_Handler3, IBatchJobs_Web_Provider iBatchJobs_Web_Provider, Imaging_Shared338_Range6 imaging_Shared338_Range6, Imaging_Shared338_Factory4 imaging_Shared338_Factory4, DataAccess_Service464_Builder3 dataAccess_Service464_Builder3)
        {
            _portal_Shared_Dto4 = portal_Shared_Dto4 ?? throw new ArgumentNullException(nameof(portal_Shared_Dto4));
            _portal_Shared_Repository5 = portal_Shared_Repository5 ?? throw new ArgumentNullException(nameof(portal_Shared_Repository5));
            _batchJobs_Web_Controller4 = batchJobs_Web_Controller4 ?? throw new ArgumentNullException(nameof(batchJobs_Web_Controller4));
            _batchJobs_Web_Handler3 = batchJobs_Web_Handler3 ?? throw new ArgumentNullException(nameof(batchJobs_Web_Handler3));
        ...
        public Portal_Shared_Dto4 GetPortal_Shared_Dto4() => _portal_Shared_Dto4;
        public Portal_Shared_Repository5 GetPortal_Shared_Repository5() => _portal_Shared_Repository5;
        public BatchJobs_Web_Controller4 GetBatchJobs_Web_Controller4() => _batchJobs_Web_Controller4;
        public BatchJobs_Web_Handler3 GetBatchJobs_Web_Handler3() => _batchJobs_Web_Handler3;
