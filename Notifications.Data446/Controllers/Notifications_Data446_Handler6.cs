...
{
    public class Notifications_Data446_Handler6
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // Notifications_Data446_Handler6 implementation
        }
...
public int Param3SortOrder { get; set; }
    ...
    public class Data446Context : DbContext
    {
        public DbSet<Notifications_Data446_Handler6> Notifications_Data446_Handler6s { get; set; }
    }
