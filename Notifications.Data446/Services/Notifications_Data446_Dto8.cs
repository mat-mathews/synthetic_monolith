...
{
    /// <summary>Immutable data transfer record for Notifications_Data446_Dto8.</summary>
    public record Notifications_Data446_Dto8(string Value, int Count, DateTime Timestamp);
