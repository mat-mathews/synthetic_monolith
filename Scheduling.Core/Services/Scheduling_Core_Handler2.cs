...
{
    public sealed class Scheduling_Core_Handler2
    {
        ...
        public void Execute()
        {
            // Scheduling_Core_Handler2 implementation
        }
...
public int Detail61SortOrder { get; set; }
    ...
    {
        public DbSet<Scheduling_Core_Handler2> Scheduling_Core_Handler2s { get; set; }
    }
