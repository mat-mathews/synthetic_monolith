...
{
    public interface IScheduling_Core_Factory4
    {
        /// <summary>Processes the Scheduling_Core_Factory4 operation.</summary>
        void ProcessScheduling_Core_Factory4();

        /// <summary>Validates the Scheduling_Core_Factory4 state.</summary>
        bool ValidateScheduling_Core_Factory4();
    }
