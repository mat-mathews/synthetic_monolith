...
{
    /// <summary>Immutable data transfer record for Security_Api134_ViewModel3.</summary>
    internal record Security_Api134_ViewModel3(string Value, int Count, DateTime Timestamp);
