...
{
    /// <summary>Immutable data transfer record for Security_Api134_ViewModel4.</summary>
    public record Security_Api134_ViewModel4(string Value, int Count, DateTime Timestamp);
