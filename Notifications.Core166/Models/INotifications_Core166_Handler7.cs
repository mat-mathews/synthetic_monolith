...
{
    public interface INotifications_Core166_Handler7
    {
        /// <summary>Processes the Notifications_Core166_Handler7 operation.</summary>
        void ProcessNotifications_Core166_Handler7();

        /// <summary>Validates the Notifications_Core166_Handler7 state.</summary>
        bool ValidateNotifications_Core166_Handler7();
    }
