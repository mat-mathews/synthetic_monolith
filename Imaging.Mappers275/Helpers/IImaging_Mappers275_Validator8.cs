...
{
    internal interface IImaging_Mappers275_Validator8
    {
        /// <summary>Processes the Imaging_Mappers275_Validator8 operation.</summary>
        void ProcessImaging_Mappers275_Validator8();

        /// <summary>Validates the Imaging_Mappers275_Validator8 state.</summary>
        bool ValidateImaging_Mappers275_Validator8();
    }
