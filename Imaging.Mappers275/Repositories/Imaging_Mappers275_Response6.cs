...
{
    /// <summary>Immutable data transfer record for Imaging_Mappers275_Response6.</summary>
    public record Imaging_Mappers275_Response6(string Value, int Count, DateTime Timestamp);
