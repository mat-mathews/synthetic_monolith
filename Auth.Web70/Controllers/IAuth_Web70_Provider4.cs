...
{
    internal interface IAuth_Web70_Provider4
    {
        /// <summary>Processes the Auth_Web70_Provider4 operation.</summary>
        void ProcessAuth_Web70_Provider4();

        /// <summary>Validates the Auth_Web70_Provider4 state.</summary>
        bool ValidateAuth_Web70_Provider4();
    }
