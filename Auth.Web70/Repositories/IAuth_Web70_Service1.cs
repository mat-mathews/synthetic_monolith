...
{
    public interface IAuth_Web70_Service1
    {
        /// <summary>Processes the Auth_Web70_Service1 operation.</summary>
        void ProcessAuth_Web70_Service1();

        /// <summary>Validates the Auth_Web70_Service1 state.</summary>
        bool ValidateAuth_Web70_Service1();
    }
