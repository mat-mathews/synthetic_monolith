...
{
    /// <summary>Immutable data transfer record for Portal_Core_Request10.</summary>
    internal record Portal_Core_Request10(string Value, int Count, DateTime Timestamp);
