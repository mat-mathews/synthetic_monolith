...
{
    public interface IPortal_Core_Repository6
    {
        /// <summary>Processes the Portal_Core_Repository6 operation.</summary>
        void ProcessPortal_Core_Repository6();

        /// <summary>Validates the Portal_Core_Repository6 state.</summary>
        bool ValidatePortal_Core_Repository6();
    }
