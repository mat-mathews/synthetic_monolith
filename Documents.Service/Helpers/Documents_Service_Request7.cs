...
{
    /// <summary>Immutable data transfer record for Documents_Service_Request7.</summary>
    public record Documents_Service_Request7(string Value, int Count, DateTime Timestamp);
