...
{
    public sealed class Documents_Service_Provider10
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // Documents_Service_Provider10 implementation
        }
...
public int Detail71SortOrder { get; set; }
    ...
    {
        public DbSet<Documents_Service_Provider10> Documents_Service_Provider10s { get; set; }
    }
