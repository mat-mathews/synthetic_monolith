...
namespace Auth.Processors411
{
    ...
    public class Consumer2
    {
        ...
        private readonly Import_Contracts_Handler3 _import_Contracts_Handler3;
        private readonly Import_Contracts_Builder6 _import_Contracts_Builder6;
        private readonly Import_Contracts_Controller1 _import_Contracts_Controller1;
        private readonly Integration_Handlers333_ViewModel _integration_Handlers333_ViewModel;
        private readonly Integration_Handlers333_Service8 _integration_Handlers333_Service8;
        private readonly Imaging_Validators108_Response4 _imaging_Validators108_Response4;

        public Consumer2(Auth_Mappers_Controller auth_Mappers_Controller, Auth_Mappers_Manager8 auth_Mappers_Manager8, Import_Contracts_Handler3 import_Contracts_Handler3, Import_Contracts_Builder6 import_Contracts_Builder6, Import_Contracts_Controller1 import_Contracts_Controller1, Integration_Handlers333_ViewModel integration_Handlers333_ViewModel, Integration_Handlers333_Service8 integration_Handlers333_Service8, Imaging_Validators108_Response4 imaging_Validators108_Response4)
        {
            ...
            _import_Contracts_Handler3 = import_Contracts_Handler3 ?? throw new ArgumentNullException(nameof(import_Contracts_Handler3));
            _import_Contracts_Builder6 = import_Contracts_Builder6 ?? throw new ArgumentNullException(nameof(import_Contracts_Builder6));
            _import_Contracts_Controller1 = import_Contracts_Controller1 ?? throw new ArgumentNullException(nameof(import_Contracts_Controller1));
            _integration_Handlers333_ViewModel = integration_Handlers333_ViewModel ?? throw new ArgumentNullException(nameof(integration_Handlers333_ViewModel));
            _integration_Handlers333_Service8 = integration_Handlers333_Service8 ?? throw new ArgumentNullException(nameof(integration_Handlers333_Service8));
        ...
        public Import_Contracts_Handler3 GetImport_Contracts_Handler3() => _import_Contracts_Handler3;
        public Import_Contracts_Builder6 GetImport_Contracts_Builder6() => _import_Contracts_Builder6;
        public Import_Contracts_Controller1 GetImport_Contracts_Controller1() => _import_Contracts_Controller1;
        public Integration_Handlers333_ViewModel GetIntegration_Handlers333_ViewModel() => _integration_Handlers333_ViewModel;
        public Integration_Handlers333_Service8 GetIntegration_Handlers333_Service8() => _integration_Handlers333_Service8;
