...
{
    internal interface INotifications_Data406_Validator1
    {
        /// <summary>Processes the Notifications_Data406_Validator1 operation.</summary>
        void ProcessNotifications_Data406_Validator1();

        /// <summary>Validates the Notifications_Data406_Validator1 state.</summary>
        bool ValidateNotifications_Data406_Validator1();
    }
