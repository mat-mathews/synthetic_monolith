...
{
    /// <summary>Immutable data transfer record for Common_Processors_Dto10.</summary>
    internal record Common_Processors_Dto10(string Value, int Count, DateTime Timestamp);
