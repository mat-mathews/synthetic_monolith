...
{
    /// <summary>Immutable data transfer record for Scheduling_Api3_ViewModel3.</summary>
    public record Scheduling_Api3_ViewModel3(string Value, int Count, DateTime Timestamp);
