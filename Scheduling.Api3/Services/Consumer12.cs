...
namespace Scheduling.Api3
{
    ...
    public class Consumer12
    {
        ...
        private readonly Portal_Validators69_Processor _portal_Validators69_Processor;
        private readonly Scheduling_Models_Info12 _scheduling_Models_Info12;
        private readonly Integration_Client_Service3 _integration_Client_Service3;
        private readonly IIntegration_Client_Service1 _iIntegration_Client_Service1;
        private readonly Integration_Mappers_ViewModel6 _integration_Mappers_ViewModel6;
        private readonly Integration_Mappers_Service _integration_Mappers_Service;

        public Consumer12(Admin_Client346_Service admin_Client346_Service, Admin_Client346_Response14 admin_Client346_Response14, Portal_Validators69_Processor portal_Validators69_Processor, Scheduling_Models_Info12 scheduling_Models_Info12, Integration_Client_Service3 integration_Client_Service3, IIntegration_Client_Service1 iIntegration_Client_Service1, Integration_Mappers_ViewModel6 integration_Mappers_ViewModel6, Integration_Mappers_Service integration_Mappers_Service)
        {
            ...
            _portal_Validators69_Processor = portal_Validators69_Processor ?? throw new ArgumentNullException(nameof(portal_Validators69_Processor));
            _scheduling_Models_Info12 = scheduling_Models_Info12 ?? throw new ArgumentNullException(nameof(scheduling_Models_Info12));
            _integration_Client_Service3 = integration_Client_Service3 ?? throw new ArgumentNullException(nameof(integration_Client_Service3));
            _iIntegration_Client_Service1 = iIntegration_Client_Service1 ?? throw new ArgumentNullException(nameof(iIntegration_Client_Service1));
            ...
            _integration_Mappers_Service = integration_Mappers_Service ?? throw new ArgumentNullException(nameof(integration_Mappers_Service));
        }
        ...
        public Portal_Validators69_Processor GetPortal_Validators69_Processor() => _portal_Validators69_Processor;
        public Scheduling_Models_Info12 GetScheduling_Models_Info12() => _scheduling_Models_Info12;
        public Integration_Client_Service3 GetIntegration_Client_Service3() => _integration_Client_Service3;
        public IIntegration_Client_Service1 GetIIntegration_Client_Service1() => _iIntegration_Client_Service1;
        public Integration_Mappers_ViewModel6 GetIntegration_Mappers_ViewModel6() => _integration_Mappers_ViewModel6;
        public Integration_Mappers_Service GetIntegration_Mappers_Service() => _integration_Mappers_Service;
