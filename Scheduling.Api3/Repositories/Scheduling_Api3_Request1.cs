...
{
    /// <summary>Immutable data transfer record for Scheduling_Api3_Request1.</summary>
    internal record Scheduling_Api3_Request1(string Value, int Count, DateTime Timestamp);
