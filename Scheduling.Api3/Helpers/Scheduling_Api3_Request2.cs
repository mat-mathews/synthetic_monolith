...
{
    /// <summary>Immutable data transfer record for Scheduling_Api3_Request2.</summary>
    internal record Scheduling_Api3_Request2(string Value, int Count, DateTime Timestamp);
