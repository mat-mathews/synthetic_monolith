...
namespace Scheduling.Api3
{
    ...
    public class Consumer32
    {
        ...
        private readonly Admin_Client346_Repository8 _admin_Client346_Repository8;
        private readonly Portal_Validators69_Processor _portal_Validators69_Processor;
        private readonly Portal_Validators69_Dto3 _portal_Validators69_Dto3;
        private readonly Portal_Validators69_ViewModel4 _portal_Validators69_ViewModel4;
        private readonly IScheduling_Models_Service4 _iScheduling_Models_Service4;
        private readonly IScheduling_Models_Provider10 _iScheduling_Models_Provider10;
        private readonly Integration_Client_Manager4 _integration_Client_Manager4;

        public Consumer32(Admin_Client346_Manager11 admin_Client346_Manager11, Admin_Client346_Repository8 admin_Client346_Repository8, Portal_Validators69_Processor portal_Validators69_Processor, Portal_Validators69_Dto3 portal_Validators69_Dto3, Portal_Validators69_ViewModel4 portal_Validators69_ViewModel4, IScheduling_Models_Service4 iScheduling_Models_Service4, IScheduling_Models_Provider10 iScheduling_Models_Provider10, Integration_Client_Manager4 integration_Client_Manager4)
        {
            _admin_Client346_Manager11 = admin_Client346_Manager11 ?? throw new ArgumentNullException(nameof(admin_Client346_Manager11));
            _admin_Client346_Repository8 = admin_Client346_Repository8 ?? throw new ArgumentNullException(nameof(admin_Client346_Repository8));
            ...
            _portal_Validators69_Dto3 = portal_Validators69_Dto3 ?? throw new ArgumentNullException(nameof(portal_Validators69_Dto3));
            _portal_Validators69_ViewModel4 = portal_Validators69_ViewModel4 ?? throw new ArgumentNullException(nameof(portal_Validators69_ViewModel4));
            _iScheduling_Models_Service4 = iScheduling_Models_Service4 ?? throw new ArgumentNullException(nameof(iScheduling_Models_Service4));
            _iScheduling_Models_Provider10 = iScheduling_Models_Provider10 ?? throw new ArgumentNullException(nameof(iScheduling_Models_Provider10));
            _integration_Client_Manager4 = integration_Client_Manager4 ?? throw new ArgumentNullException(nameof(integration_Client_Manager4));
        }

        public Admin_Client346_Manager11 GetAdmin_Client346_Manager11() => _admin_Client346_Manager11;
        public Admin_Client346_Repository8 GetAdmin_Client346_Repository8() => _admin_Client346_Repository8;
        public Portal_Validators69_Processor GetPortal_Validators69_Processor() => _portal_Validators69_Processor;
        public Portal_Validators69_Dto3 GetPortal_Validators69_Dto3() => _portal_Validators69_Dto3;
        public Portal_Validators69_ViewModel4 GetPortal_Validators69_ViewModel4() => _portal_Validators69_ViewModel4;
        public IScheduling_Models_Service4 GetIScheduling_Models_Service4() => _iScheduling_Models_Service4;
        public IScheduling_Models_Provider10 GetIScheduling_Models_Provider10() => _iScheduling_Models_Provider10;
        public Integration_Client_Manager4 GetIntegration_Client_Manager4() => _integration_Client_Manager4;
