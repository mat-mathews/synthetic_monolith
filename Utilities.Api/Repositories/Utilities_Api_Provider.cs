...
{
    public partial class Utilities_Api_Provider : IDisposable
    {
        private const string SprocName = "dbo.sp_FindTransaction";
        // Execute stored procedure dbo.sp_FindTransaction
        private const string SprocName = "dbo.usp_ValidateNotification";
        // Execute stored procedure dbo.usp_ValidateNotification
        private const string SprocName = "dbo.sp_DeleteConfiguration";
        // Execute stored procedure dbo.sp_DeleteConfiguration
        public void Execute()
        {
            // Utilities_Api_Provider implementation
        }
