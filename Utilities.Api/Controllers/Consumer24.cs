...
namespace Utilities.Api
{
    ...
    public class Consumer24
    {
        ...
        private readonly Security_Events_Factory6 _security_Events_Factory6;
        private readonly ISecurity_Events_Handler3 _iSecurity_Events_Handler3;
        private readonly Integration_Data175_Service _integration_Data175_Service;
        private readonly Integration_Data175_ViewModel1 _integration_Data175_ViewModel1;
        private readonly Admin_Models476_ViewModel6 _admin_Models476_ViewModel6;

        public Consumer24(Auth_Data135_Factory auth_Data135_Factory, Auth_Mappers178_Controller6 auth_Mappers178_Controller6, IAuth_Mappers178_Factory3 iAuth_Mappers178_Factory3, Security_Events_Factory6 security_Events_Factory6, ISecurity_Events_Handler3 iSecurity_Events_Handler3, Integration_Data175_Service integration_Data175_Service, Integration_Data175_ViewModel1 integration_Data175_ViewModel1, Admin_Models476_ViewModel6 admin_Models476_ViewModel6)
        {
            ...
            _security_Events_Factory6 = security_Events_Factory6 ?? throw new ArgumentNullException(nameof(security_Events_Factory6));
            _iSecurity_Events_Handler3 = iSecurity_Events_Handler3 ?? throw new ArgumentNullException(nameof(iSecurity_Events_Handler3));
            ...
            _integration_Data175_ViewModel1 = integration_Data175_ViewModel1 ?? throw new ArgumentNullException(nameof(integration_Data175_ViewModel1));
        ...
        public Security_Events_Factory6 GetSecurity_Events_Factory6() => _security_Events_Factory6;
        public ISecurity_Events_Handler3 GetISecurity_Events_Handler3() => _iSecurity_Events_Handler3;
        public Integration_Data175_Service GetIntegration_Data175_Service() => _integration_Data175_Service;
        public Integration_Data175_ViewModel1 GetIntegration_Data175_ViewModel1() => _integration_Data175_ViewModel1;
