...
{
    internal interface IScheduling_Tests214_Repository6
    {
        /// <summary>Processes the Scheduling_Tests214_Repository6 operation.</summary>
        void ProcessScheduling_Tests214_Repository6();

        /// <summary>Validates the Scheduling_Tests214_Repository6 state.</summary>
        bool ValidateScheduling_Tests214_Repository6();
    }
