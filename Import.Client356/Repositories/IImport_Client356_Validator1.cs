...
{
    internal interface IImport_Client356_Validator1
    {
        /// <summary>Processes the Import_Client356_Validator1 operation.</summary>
        void ProcessImport_Client356_Validator1();

        /// <summary>Validates the Import_Client356_Validator1 state.</summary>
        bool ValidateImport_Client356_Validator1();
    }
