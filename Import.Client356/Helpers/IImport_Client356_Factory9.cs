...
{
    public interface IImport_Client356_Factory9
    {
        /// <summary>Processes the Import_Client356_Factory9 operation.</summary>
        void ProcessImport_Client356_Factory9();

        /// <summary>Validates the Import_Client356_Factory9 state.</summary>
        bool ValidateImport_Client356_Factory9();
    }
