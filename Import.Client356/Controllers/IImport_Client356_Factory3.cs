...
{
    public interface IImport_Client356_Factory3
    {
        /// <summary>Processes the Import_Client356_Factory3 operation.</summary>
        void ProcessImport_Client356_Factory3();

        /// <summary>Validates the Import_Client356_Factory3 state.</summary>
        bool ValidateImport_Client356_Factory3();
    }
