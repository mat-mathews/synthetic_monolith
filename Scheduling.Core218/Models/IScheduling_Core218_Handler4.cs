...
{
    internal interface IScheduling_Core218_Handler4
    {
        /// <summary>Processes the Scheduling_Core218_Handler4 operation.</summary>
        void ProcessScheduling_Core218_Handler4();

        /// <summary>Validates the Scheduling_Core218_Handler4 state.</summary>
        bool ValidateScheduling_Core218_Handler4();
    }
