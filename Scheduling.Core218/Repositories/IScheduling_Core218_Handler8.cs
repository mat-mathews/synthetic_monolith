...
{
    internal interface IScheduling_Core218_Handler8
    {
        /// <summary>Processes the Scheduling_Core218_Handler8 operation.</summary>
        void ProcessScheduling_Core218_Handler8();

        /// <summary>Validates the Scheduling_Core218_Handler8 state.</summary>
        bool ValidateScheduling_Core218_Handler8();
    }
