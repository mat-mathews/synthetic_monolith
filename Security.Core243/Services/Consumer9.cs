...
namespace Security.Core243
{
    ...
    public class Consumer9
    {
        ...
        private readonly IScheduling_Web60_Provider8 _iScheduling_Web60_Provider8;
        private readonly Import_Validators_Repository _import_Validators_Repository;
        private readonly IImport_Validators_Repository4 _iImport_Validators_Repository4;

        public Consumer9(IAdmin_Contracts120_Factory iAdmin_Contracts120_Factory, IAuth_Client271_Repository4 iAuth_Client271_Repository4, IReporting_Events220_Handler6 iReporting_Events220_Handler6, Scheduling_Web60_Helper4 scheduling_Web60_Helper4, Scheduling_Web60_Manager10 scheduling_Web60_Manager10, IScheduling_Web60_Provider8 iScheduling_Web60_Provider8, Import_Validators_Repository import_Validators_Repository, IImport_Validators_Repository4 iImport_Validators_Repository4)
        {
            ...
            _iScheduling_Web60_Provider8 = iScheduling_Web60_Provider8 ?? throw new ArgumentNullException(nameof(iScheduling_Web60_Provider8));
            _import_Validators_Repository = import_Validators_Repository ?? throw new ArgumentNullException(nameof(import_Validators_Repository));
        ...
        public IScheduling_Web60_Provider8 GetIScheduling_Web60_Provider8() => _iScheduling_Web60_Provider8;
        public Import_Validators_Repository GetImport_Validators_Repository() => _import_Validators_Repository;
