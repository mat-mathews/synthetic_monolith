...
{
    internal interface ILogging_Mappers_Provider3
    {
        /// <summary>Processes the Logging_Mappers_Provider3 operation.</summary>
        void ProcessLogging_Mappers_Provider3();

        /// <summary>Validates the Logging_Mappers_Provider3 state.</summary>
        bool ValidateLogging_Mappers_Provider3();
    }
