...
{
    /// <summary>Immutable data transfer record for Logging_Mappers_Event7.</summary>
    internal record Logging_Mappers_Event7(string Value, int Count, DateTime Timestamp);
