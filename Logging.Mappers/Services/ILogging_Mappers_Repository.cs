...
{
    public interface ILogging_Mappers_Repository
    {
        /// <summary>Processes the Logging_Mappers_Repository operation.</summary>
        void ProcessLogging_Mappers_Repository();

        /// <summary>Validates the Logging_Mappers_Repository state.</summary>
        bool ValidateLogging_Mappers_Repository();
    }
