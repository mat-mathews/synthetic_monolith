...
{
    public interface ISecurity_Validators217_Repository6
    {
        /// <summary>Processes the Security_Validators217_Repository6 operation.</summary>
        void ProcessSecurity_Validators217_Repository6();

        /// <summary>Validates the Security_Validators217_Repository6 state.</summary>
        bool ValidateSecurity_Validators217_Repository6();
    }
