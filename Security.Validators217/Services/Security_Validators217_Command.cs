...
{
    /// <summary>Immutable data transfer record for Security_Validators217_Command.</summary>
    public record Security_Validators217_Command(string Value, int Count, DateTime Timestamp);
