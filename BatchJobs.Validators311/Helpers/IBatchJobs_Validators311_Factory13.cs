...
{
    internal interface IBatchJobs_Validators311_Factory13
    {
        /// <summary>Processes the BatchJobs_Validators311_Factory13 operation.</summary>
        void ProcessBatchJobs_Validators311_Factory13();

        /// <summary>Validates the BatchJobs_Validators311_Factory13 state.</summary>
        bool ValidateBatchJobs_Validators311_Factory13();
    }
