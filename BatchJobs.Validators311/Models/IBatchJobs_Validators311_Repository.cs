...
{
    public interface IBatchJobs_Validators311_Repository
    {
        /// <summary>Processes the BatchJobs_Validators311_Repository operation.</summary>
        void ProcessBatchJobs_Validators311_Repository();

        /// <summary>Validates the BatchJobs_Validators311_Repository state.</summary>
        bool ValidateBatchJobs_Validators311_Repository();
    }
