...
{
    public partial class Security_Web376_Factory6
    {
        private readonly string _sql = "SELECT * FROM Sessions WHERE Id = @Id";
        public void Execute()
        {
            // Security_Web376_Factory6 implementation
        }
...
public int Config15SortOrder { get; set; }
    ...
    public class Web376Context : DbContext
    {
        public DbSet<Security_Web376_Factory6> Security_Web376_Factory6s { get; set; }
    }
