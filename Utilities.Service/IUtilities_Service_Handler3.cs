...
{
    public interface IUtilities_Service_Handler3
    {
        /// <summary>Processes the Utilities_Service_Handler3 operation.</summary>
        void ProcessUtilities_Service_Handler3();

        /// <summary>Validates the Utilities_Service_Handler3 state.</summary>
        bool ValidateUtilities_Service_Handler3();
    }
