...
namespace Portal.Tests323
{
    ...
    public class Consumer31
    {
        ...
        private readonly DataAccess_Service_Factory _dataAccess_Service_Factory;
        private readonly DataAccess_Service_Point4 _dataAccess_Service_Point4;
        private readonly DataAccess_Service_Service7 _dataAccess_Service_Service7;
        private readonly Billing_Client491_Controller1 _billing_Client491_Controller1;
        private readonly Admin_Service364_Helper1 _admin_Service364_Helper1;
        private readonly Utilities_Contracts228_Handler5 _utilities_Contracts228_Handler5;
        private readonly Utilities_Contracts228_Response _utilities_Contracts228_Response;

        public Consumer31(Auth_Mappers178_Manager5 auth_Mappers178_Manager5, DataAccess_Service_Factory dataAccess_Service_Factory, DataAccess_Service_Point4 dataAccess_Service_Point4, DataAccess_Service_Service7 dataAccess_Service_Service7, Billing_Client491_Controller1 billing_Client491_Controller1, Admin_Service364_Helper1 admin_Service364_Helper1, Utilities_Contracts228_Handler5 utilities_Contracts228_Handler5, Utilities_Contracts228_Response utilities_Contracts228_Response)
        {
            _auth_Mappers178_Manager5 = auth_Mappers178_Manager5 ?? throw new ArgumentNullException(nameof(auth_Mappers178_Manager5));
            _dataAccess_Service_Factory = dataAccess_Service_Factory ?? throw new ArgumentNullException(nameof(dataAccess_Service_Factory));
            _dataAccess_Service_Point4 = dataAccess_Service_Point4 ?? throw new ArgumentNullException(nameof(dataAccess_Service_Point4));
            _dataAccess_Service_Service7 = dataAccess_Service_Service7 ?? throw new ArgumentNullException(nameof(dataAccess_Service_Service7));
            _billing_Client491_Controller1 = billing_Client491_Controller1 ?? throw new ArgumentNullException(nameof(billing_Client491_Controller1));
            _admin_Service364_Helper1 = admin_Service364_Helper1 ?? throw new ArgumentNullException(nameof(admin_Service364_Helper1));
            _utilities_Contracts228_Handler5 = utilities_Contracts228_Handler5 ?? throw new ArgumentNullException(nameof(utilities_Contracts228_Handler5));
            _utilities_Contracts228_Response = utilities_Contracts228_Response ?? throw new ArgumentNullException(nameof(utilities_Contracts228_Response));
        }

        public Auth_Mappers178_Manager5 GetAuth_Mappers178_Manager5() => _auth_Mappers178_Manager5;
        public DataAccess_Service_Factory GetDataAccess_Service_Factory() => _dataAccess_Service_Factory;
        public DataAccess_Service_Point4 GetDataAccess_Service_Point4() => _dataAccess_Service_Point4;
        public DataAccess_Service_Service7 GetDataAccess_Service_Service7() => _dataAccess_Service_Service7;
        public Billing_Client491_Controller1 GetBilling_Client491_Controller1() => _billing_Client491_Controller1;
        public Admin_Service364_Helper1 GetAdmin_Service364_Helper1() => _admin_Service364_Helper1;
        public Utilities_Contracts228_Handler5 GetUtilities_Contracts228_Handler5() => _utilities_Contracts228_Handler5;
        public Utilities_Contracts228_Response GetUtilities_Contracts228_Response() => _utilities_Contracts228_Response;
