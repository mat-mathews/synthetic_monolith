...
{
    /// <summary>Immutable data transfer record for Workflow_Events327_Dto4.</summary>
    public record Workflow_Events327_Dto4(string Value, int Count, DateTime Timestamp);
