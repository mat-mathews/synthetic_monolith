...
{
    internal interface IDocuments_Api251_Factory4
    {
        /// <summary>Processes the Documents_Api251_Factory4 operation.</summary>
        void ProcessDocuments_Api251_Factory4();

        /// <summary>Validates the Documents_Api251_Factory4 state.</summary>
        bool ValidateDocuments_Api251_Factory4();
    }
