...
namespace Imaging.Events424
{
    ...
    {
        private readonly Billing_Client491_Repository8 _billing_Client491_Repository8;
        ...
        private readonly Common_Shared297_Manager3 _common_Shared297_Manager3;
        private readonly Common_Shared297_Helper10 _common_Shared297_Helper10;
        private readonly ISecurity_Client349_Repository10 _iSecurity_Client349_Repository10;
        private readonly Portal_Handlers_Key _portal_Handlers_Key;
        private readonly Portal_Api51_Handler11 _portal_Api51_Handler11;

        public Consumer8(Billing_Client491_Repository8 billing_Client491_Repository8, Admin_Validators_Repository13 admin_Validators_Repository13, ICommon_Shared297_Handler7 iCommon_Shared297_Handler7, Common_Shared297_Manager3 common_Shared297_Manager3, Common_Shared297_Helper10 common_Shared297_Helper10, ISecurity_Client349_Repository10 iSecurity_Client349_Repository10, Portal_Handlers_Key portal_Handlers_Key, Portal_Api51_Handler11 portal_Api51_Handler11)
        {
            _billing_Client491_Repository8 = billing_Client491_Repository8 ?? throw new ArgumentNullException(nameof(billing_Client491_Repository8));
            ...
            _common_Shared297_Manager3 = common_Shared297_Manager3 ?? throw new ArgumentNullException(nameof(common_Shared297_Manager3));
            _common_Shared297_Helper10 = common_Shared297_Helper10 ?? throw new ArgumentNullException(nameof(common_Shared297_Helper10));
            _iSecurity_Client349_Repository10 = iSecurity_Client349_Repository10 ?? throw new ArgumentNullException(nameof(iSecurity_Client349_Repository10));
            _portal_Handlers_Key = portal_Handlers_Key ?? throw new ArgumentNullException(nameof(portal_Handlers_Key));
            _portal_Api51_Handler11 = portal_Api51_Handler11 ?? throw new ArgumentNullException(nameof(portal_Api51_Handler11));
        }

        public Billing_Client491_Repository8 GetBilling_Client491_Repository8() => _billing_Client491_Repository8;
        ...
        public Common_Shared297_Manager3 GetCommon_Shared297_Manager3() => _common_Shared297_Manager3;
        public Common_Shared297_Helper10 GetCommon_Shared297_Helper10() => _common_Shared297_Helper10;
        public ISecurity_Client349_Repository10 GetISecurity_Client349_Repository10() => _iSecurity_Client349_Repository10;
        public Portal_Handlers_Key GetPortal_Handlers_Key() => _portal_Handlers_Key;
        public Portal_Api51_Handler11 GetPortal_Api51_Handler11() => _portal_Api51_Handler11;
