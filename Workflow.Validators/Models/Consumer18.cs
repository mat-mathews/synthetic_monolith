...
namespace Workflow.Validators
{
    ...
    public class Consumer18
    {
        ...
        private readonly IImaging_Core_Repository13 _iImaging_Core_Repository13;
        private readonly Import_Data_Factory _import_Data_Factory;
        private readonly Security_Data_Provider13 _security_Data_Provider13;
        private readonly Security_Data_Result8 _security_Data_Result8;
        private readonly Workflow_Web377_Info9 _workflow_Web377_Info9;

        public Consumer18(IAuth_Client_Handler4 iAuth_Client_Handler4, Auth_Models236_Processor1 auth_Models236_Processor1, Auth_Models236_Handler2 auth_Models236_Handler2, IImaging_Core_Repository13 iImaging_Core_Repository13, Import_Data_Factory import_Data_Factory, Security_Data_Provider13 security_Data_Provider13, Security_Data_Result8 security_Data_Result8, Workflow_Web377_Info9 workflow_Web377_Info9)
        {
            ...
            _iImaging_Core_Repository13 = iImaging_Core_Repository13 ?? throw new ArgumentNullException(nameof(iImaging_Core_Repository13));
            _import_Data_Factory = import_Data_Factory ?? throw new ArgumentNullException(nameof(import_Data_Factory));
            _security_Data_Provider13 = security_Data_Provider13 ?? throw new ArgumentNullException(nameof(security_Data_Provider13));
            _security_Data_Result8 = security_Data_Result8 ?? throw new ArgumentNullException(nameof(security_Data_Result8));
        ...
        public IImaging_Core_Repository13 GetIImaging_Core_Repository13() => _iImaging_Core_Repository13;
        public Import_Data_Factory GetImport_Data_Factory() => _import_Data_Factory;
        public Security_Data_Provider13 GetSecurity_Data_Provider13() => _security_Data_Provider13;
        public Security_Data_Result8 GetSecurity_Data_Result8() => _security_Data_Result8;
