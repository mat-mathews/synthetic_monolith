...
{
    /// <summary>Immutable data transfer record for Workflow_Validators_Request2.</summary>
    public record Workflow_Validators_Request2(string Value, int Count, DateTime Timestamp);
