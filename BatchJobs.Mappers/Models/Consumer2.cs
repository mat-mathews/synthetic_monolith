...
namespace BatchJobs.Mappers
{
    ...
    {
        private readonly Auth_Client271_Controller1 _auth_Client271_Controller1;
        private readonly Auth_Client271_Factory6 _auth_Client271_Factory6;
        private readonly IAuth_Client271_Handler7 _iAuth_Client271_Handler7;
        private readonly ICommon_Data21_Provider _iCommon_Data21_Provider;
        private readonly Common_Data21_Builder4 _common_Data21_Builder4;
        private readonly Common_Data21_Helper3 _common_Data21_Helper3;
        private readonly BatchJobs_Handlers_Processor5 _batchJobs_Handlers_Processor5;
        private readonly BatchJobs_Handlers_Handler _batchJobs_Handlers_Handler;

        public Consumer2(Auth_Client271_Controller1 auth_Client271_Controller1, Auth_Client271_Factory6 auth_Client271_Factory6, IAuth_Client271_Handler7 iAuth_Client271_Handler7, ICommon_Data21_Provider iCommon_Data21_Provider, Common_Data21_Builder4 common_Data21_Builder4, Common_Data21_Helper3 common_Data21_Helper3, BatchJobs_Handlers_Processor5 batchJobs_Handlers_Processor5, BatchJobs_Handlers_Handler batchJobs_Handlers_Handler)
        {
            _auth_Client271_Controller1 = auth_Client271_Controller1 ?? throw new ArgumentNullException(nameof(auth_Client271_Controller1));
            _auth_Client271_Factory6 = auth_Client271_Factory6 ?? throw new ArgumentNullException(nameof(auth_Client271_Factory6));
            _iAuth_Client271_Handler7 = iAuth_Client271_Handler7 ?? throw new ArgumentNullException(nameof(iAuth_Client271_Handler7));
            _iCommon_Data21_Provider = iCommon_Data21_Provider ?? throw new ArgumentNullException(nameof(iCommon_Data21_Provider));
            _common_Data21_Builder4 = common_Data21_Builder4 ?? throw new ArgumentNullException(nameof(common_Data21_Builder4));
            _common_Data21_Helper3 = common_Data21_Helper3 ?? throw new ArgumentNullException(nameof(common_Data21_Helper3));
            _batchJobs_Handlers_Processor5 = batchJobs_Handlers_Processor5 ?? throw new ArgumentNullException(nameof(batchJobs_Handlers_Processor5));
            _batchJobs_Handlers_Handler = batchJobs_Handlers_Handler ?? throw new ArgumentNullException(nameof(batchJobs_Handlers_Handler));
        }

        public Auth_Client271_Controller1 GetAuth_Client271_Controller1() => _auth_Client271_Controller1;
        public Auth_Client271_Factory6 GetAuth_Client271_Factory6() => _auth_Client271_Factory6;
        public IAuth_Client271_Handler7 GetIAuth_Client271_Handler7() => _iAuth_Client271_Handler7;
        public ICommon_Data21_Provider GetICommon_Data21_Provider() => _iCommon_Data21_Provider;
        public Common_Data21_Builder4 GetCommon_Data21_Builder4() => _common_Data21_Builder4;
        public Common_Data21_Helper3 GetCommon_Data21_Helper3() => _common_Data21_Helper3;
        public BatchJobs_Handlers_Processor5 GetBatchJobs_Handlers_Processor5() => _batchJobs_Handlers_Processor5;
        public BatchJobs_Handlers_Handler GetBatchJobs_Handlers_Handler() => _batchJobs_Handlers_Handler;
