...
namespace Portal.Validators
{
    ...
    {
        private readonly Auth_Contracts402_Provider9 _auth_Contracts402_Provider9;
        private readonly Auth_Contracts402_Options8 _auth_Contracts402_Options8;
        private readonly IAuth_Contracts402_Validator11 _iAuth_Contracts402_Validator11;
        private readonly Admin_Client177_Builder1 _admin_Client177_Builder1;
        private readonly DataAccess_Contracts_Helper8 _dataAccess_Contracts_Helper8;
        private readonly DataAccess_Contracts_Factory6 _dataAccess_Contracts_Factory6;
        private readonly Portal_Events_Point9 _portal_Events_Point9;
        private readonly Portal_Events_Processor8 _portal_Events_Processor8;

        public Consumer1(Auth_Contracts402_Provider9 auth_Contracts402_Provider9, Auth_Contracts402_Options8 auth_Contracts402_Options8, IAuth_Contracts402_Validator11 iAuth_Contracts402_Validator11, Admin_Client177_Builder1 admin_Client177_Builder1, DataAccess_Contracts_Helper8 dataAccess_Contracts_Helper8, DataAccess_Contracts_Factory6 dataAccess_Contracts_Factory6, Portal_Events_Point9 portal_Events_Point9, Portal_Events_Processor8 portal_Events_Processor8)
        {
            _auth_Contracts402_Provider9 = auth_Contracts402_Provider9 ?? throw new ArgumentNullException(nameof(auth_Contracts402_Provider9));
            _auth_Contracts402_Options8 = auth_Contracts402_Options8 ?? throw new ArgumentNullException(nameof(auth_Contracts402_Options8));
            _iAuth_Contracts402_Validator11 = iAuth_Contracts402_Validator11 ?? throw new ArgumentNullException(nameof(iAuth_Contracts402_Validator11));
            _admin_Client177_Builder1 = admin_Client177_Builder1 ?? throw new ArgumentNullException(nameof(admin_Client177_Builder1));
            _dataAccess_Contracts_Helper8 = dataAccess_Contracts_Helper8 ?? throw new ArgumentNullException(nameof(dataAccess_Contracts_Helper8));
            _dataAccess_Contracts_Factory6 = dataAccess_Contracts_Factory6 ?? throw new ArgumentNullException(nameof(dataAccess_Contracts_Factory6));
            _portal_Events_Point9 = portal_Events_Point9 ?? throw new ArgumentNullException(nameof(portal_Events_Point9));
            _portal_Events_Processor8 = portal_Events_Processor8 ?? throw new ArgumentNullException(nameof(portal_Events_Processor8));
        }

        public Auth_Contracts402_Provider9 GetAuth_Contracts402_Provider9() => _auth_Contracts402_Provider9;
        public Auth_Contracts402_Options8 GetAuth_Contracts402_Options8() => _auth_Contracts402_Options8;
        public IAuth_Contracts402_Validator11 GetIAuth_Contracts402_Validator11() => _iAuth_Contracts402_Validator11;
        public Admin_Client177_Builder1 GetAdmin_Client177_Builder1() => _admin_Client177_Builder1;
        public DataAccess_Contracts_Helper8 GetDataAccess_Contracts_Helper8() => _dataAccess_Contracts_Helper8;
        public DataAccess_Contracts_Factory6 GetDataAccess_Contracts_Factory6() => _dataAccess_Contracts_Factory6;
        public Portal_Events_Point9 GetPortal_Events_Point9() => _portal_Events_Point9;
        public Portal_Events_Processor8 GetPortal_Events_Processor8() => _portal_Events_Processor8;
