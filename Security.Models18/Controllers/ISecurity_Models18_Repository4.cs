...
{
    public interface ISecurity_Models18_Repository4
    {
        /// <summary>Processes the Security_Models18_Repository4 operation.</summary>
        void ProcessSecurity_Models18_Repository4();

        /// <summary>Validates the Security_Models18_Repository4 state.</summary>
        bool ValidateSecurity_Models18_Repository4();
    }
