...
{
    /// <summary>Immutable data transfer record for Security_Models18_ViewModel2.</summary>
    public record Security_Models18_ViewModel2(string Value, int Count, DateTime Timestamp);
