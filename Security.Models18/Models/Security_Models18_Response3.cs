...
{
    /// <summary>Immutable data transfer record for Security_Models18_Response3.</summary>
    public record Security_Models18_Response3(string Value, int Count, DateTime Timestamp);
