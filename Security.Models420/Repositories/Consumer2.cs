...
namespace Security.Models420
{
    ...
    {
        private readonly Utilities_Handlers462_Controller5 _utilities_Handlers462_Controller5;
        private readonly Utilities_Contracts32_Range2 _utilities_Contracts32_Range2;
        private readonly Integration_Events301_Info7 _integration_Events301_Info7;
        private readonly Integration_Events301_Provider8 _integration_Events301_Provider8;
        private readonly IIntegration_Events301_Factory2 _iIntegration_Events301_Factory2;
        private readonly IDocuments_Data68_Handler5 _iDocuments_Data68_Handler5;
        private readonly Documents_Data68_Manager3 _documents_Data68_Manager3;
        private readonly Documents_Api439_Dto5 _documents_Api439_Dto5;

        public Consumer2(Utilities_Handlers462_Controller5 utilities_Handlers462_Controller5, Utilities_Contracts32_Range2 utilities_Contracts32_Range2, Integration_Events301_Info7 integration_Events301_Info7, Integration_Events301_Provider8 integration_Events301_Provider8, IIntegration_Events301_Factory2 iIntegration_Events301_Factory2, IDocuments_Data68_Handler5 iDocuments_Data68_Handler5, Documents_Data68_Manager3 documents_Data68_Manager3, Documents_Api439_Dto5 documents_Api439_Dto5)
        {
            _utilities_Handlers462_Controller5 = utilities_Handlers462_Controller5 ?? throw new ArgumentNullException(nameof(utilities_Handlers462_Controller5));
            _utilities_Contracts32_Range2 = utilities_Contracts32_Range2 ?? throw new ArgumentNullException(nameof(utilities_Contracts32_Range2));
            _integration_Events301_Info7 = integration_Events301_Info7 ?? throw new ArgumentNullException(nameof(integration_Events301_Info7));
            _integration_Events301_Provider8 = integration_Events301_Provider8 ?? throw new ArgumentNullException(nameof(integration_Events301_Provider8));
            _iIntegration_Events301_Factory2 = iIntegration_Events301_Factory2 ?? throw new ArgumentNullException(nameof(iIntegration_Events301_Factory2));
            _iDocuments_Data68_Handler5 = iDocuments_Data68_Handler5 ?? throw new ArgumentNullException(nameof(iDocuments_Data68_Handler5));
            _documents_Data68_Manager3 = documents_Data68_Manager3 ?? throw new ArgumentNullException(nameof(documents_Data68_Manager3));
            _documents_Api439_Dto5 = documents_Api439_Dto5 ?? throw new ArgumentNullException(nameof(documents_Api439_Dto5));
        }

        public Utilities_Handlers462_Controller5 GetUtilities_Handlers462_Controller5() => _utilities_Handlers462_Controller5;
        public Utilities_Contracts32_Range2 GetUtilities_Contracts32_Range2() => _utilities_Contracts32_Range2;
        public Integration_Events301_Info7 GetIntegration_Events301_Info7() => _integration_Events301_Info7;
        public Integration_Events301_Provider8 GetIntegration_Events301_Provider8() => _integration_Events301_Provider8;
        public IIntegration_Events301_Factory2 GetIIntegration_Events301_Factory2() => _iIntegration_Events301_Factory2;
        public IDocuments_Data68_Handler5 GetIDocuments_Data68_Handler5() => _iDocuments_Data68_Handler5;
        public Documents_Data68_Manager3 GetDocuments_Data68_Manager3() => _documents_Data68_Manager3;
        public Documents_Api439_Dto5 GetDocuments_Api439_Dto5() => _documents_Api439_Dto5;
