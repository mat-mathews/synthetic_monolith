...
namespace Security.Models420
{
    ...
    public class Consumer32
    {
        ...
        private readonly Auth_Processors400_Service1 _auth_Processors400_Service1;
        private readonly Utilities_Handlers462_Info2 _utilities_Handlers462_Info2;
        private readonly Utilities_Contracts32_Processor _utilities_Contracts32_Processor;
        private readonly Utilities_Contracts32_Handler5 _utilities_Contracts32_Handler5;
        private readonly Integration_Events301_Helper3 _integration_Events301_Helper3;
        private readonly Integration_Events301_Command9 _integration_Events301_Command9;
        private readonly Documents_Data68_Repository4 _documents_Data68_Repository4;

        public Consumer32(Auth_Processors400_Controller auth_Processors400_Controller, Auth_Processors400_Service1 auth_Processors400_Service1, Utilities_Handlers462_Info2 utilities_Handlers462_Info2, Utilities_Contracts32_Processor utilities_Contracts32_Processor, Utilities_Contracts32_Handler5 utilities_Contracts32_Handler5, Integration_Events301_Helper3 integration_Events301_Helper3, Integration_Events301_Command9 integration_Events301_Command9, Documents_Data68_Repository4 documents_Data68_Repository4)
        {
            ...
            _auth_Processors400_Service1 = auth_Processors400_Service1 ?? throw new ArgumentNullException(nameof(auth_Processors400_Service1));
            _utilities_Handlers462_Info2 = utilities_Handlers462_Info2 ?? throw new ArgumentNullException(nameof(utilities_Handlers462_Info2));
            _utilities_Contracts32_Processor = utilities_Contracts32_Processor ?? throw new ArgumentNullException(nameof(utilities_Contracts32_Processor));
            _utilities_Contracts32_Handler5 = utilities_Contracts32_Handler5 ?? throw new ArgumentNullException(nameof(utilities_Contracts32_Handler5));
            _integration_Events301_Helper3 = integration_Events301_Helper3 ?? throw new ArgumentNullException(nameof(integration_Events301_Helper3));
            _integration_Events301_Command9 = integration_Events301_Command9 ?? throw new ArgumentNullException(nameof(integration_Events301_Command9));
            _documents_Data68_Repository4 = documents_Data68_Repository4 ?? throw new ArgumentNullException(nameof(documents_Data68_Repository4));
        }

        public Auth_Processors400_Controller GetAuth_Processors400_Controller() => _auth_Processors400_Controller;
        public Auth_Processors400_Service1 GetAuth_Processors400_Service1() => _auth_Processors400_Service1;
        public Utilities_Handlers462_Info2 GetUtilities_Handlers462_Info2() => _utilities_Handlers462_Info2;
        public Utilities_Contracts32_Processor GetUtilities_Contracts32_Processor() => _utilities_Contracts32_Processor;
        public Utilities_Contracts32_Handler5 GetUtilities_Contracts32_Handler5() => _utilities_Contracts32_Handler5;
        public Integration_Events301_Helper3 GetIntegration_Events301_Helper3() => _integration_Events301_Helper3;
        public Integration_Events301_Command9 GetIntegration_Events301_Command9() => _integration_Events301_Command9;
        public Documents_Data68_Repository4 GetDocuments_Data68_Repository4() => _documents_Data68_Repository4;
