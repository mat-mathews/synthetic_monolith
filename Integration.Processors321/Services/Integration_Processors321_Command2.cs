...
{
    /// <summary>Immutable data transfer record for Integration_Processors321_Command2.</summary>
    public record Integration_Processors321_Command2(string Value, int Count, DateTime Timestamp);
