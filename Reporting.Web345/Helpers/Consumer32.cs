...
namespace Reporting.Web345
{
    ...
    public class Consumer32
    {
        ...
        private readonly Admin_Client346_Helper4 _admin_Client346_Helper4;
        ...
        private readonly Billing_Core_Helper8 _billing_Core_Helper8;
        private readonly Scheduling_Processors335_Range4 _scheduling_Processors335_Range4;

        public Consumer32(Admin_Client346_Manager11 admin_Client346_Manager11, Admin_Client346_Response14 admin_Client346_Response14, Admin_Client346_Helper4 admin_Client346_Helper4, Admin_Web4_Controller5 admin_Web4_Controller5, Admin_Web4_Provider1 admin_Web4_Provider1, Billing_Core_Controller1 billing_Core_Controller1, Billing_Core_Helper8 billing_Core_Helper8, Scheduling_Processors335_Range4 scheduling_Processors335_Range4)
        {
            ...
            _admin_Client346_Helper4 = admin_Client346_Helper4 ?? throw new ArgumentNullException(nameof(admin_Client346_Helper4));
            ...
            _billing_Core_Helper8 = billing_Core_Helper8 ?? throw new ArgumentNullException(nameof(billing_Core_Helper8));
            _scheduling_Processors335_Range4 = scheduling_Processors335_Range4 ?? throw new ArgumentNullException(nameof(scheduling_Processors335_Range4));
        }
        ...
        public Admin_Client346_Helper4 GetAdmin_Client346_Helper4() => _admin_Client346_Helper4;
        ...
        public Billing_Core_Helper8 GetBilling_Core_Helper8() => _billing_Core_Helper8;
        public Scheduling_Processors335_Range4 GetScheduling_Processors335_Range4() => _scheduling_Processors335_Range4;
