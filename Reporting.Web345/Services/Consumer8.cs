...
namespace Reporting.Web345
{
    ...
    public class Consumer8
    {
        ...
        private readonly IBilling_Core_Repository9 _iBilling_Core_Repository9;
        private readonly Billing_Core_Service4 _billing_Core_Service4;
        private readonly Billing_Core_Controller1 _billing_Core_Controller1;
        private readonly Scheduling_Processors335_Handler _scheduling_Processors335_Handler;
        private readonly BatchJobs_Contracts399_Helper7 _batchJobs_Contracts399_Helper7;

        public Consumer8(Admin_Client346_Options5 admin_Client346_Options5, Admin_Web4_Repository admin_Web4_Repository, Admin_Web4_Manager6 admin_Web4_Manager6, IBilling_Core_Repository9 iBilling_Core_Repository9, Billing_Core_Service4 billing_Core_Service4, Billing_Core_Controller1 billing_Core_Controller1, Scheduling_Processors335_Handler scheduling_Processors335_Handler, BatchJobs_Contracts399_Helper7 batchJobs_Contracts399_Helper7)
        {
            ...
            _iBilling_Core_Repository9 = iBilling_Core_Repository9 ?? throw new ArgumentNullException(nameof(iBilling_Core_Repository9));
            _billing_Core_Service4 = billing_Core_Service4 ?? throw new ArgumentNullException(nameof(billing_Core_Service4));
            _billing_Core_Controller1 = billing_Core_Controller1 ?? throw new ArgumentNullException(nameof(billing_Core_Controller1));
            _scheduling_Processors335_Handler = scheduling_Processors335_Handler ?? throw new ArgumentNullException(nameof(scheduling_Processors335_Handler));
        ...
        public IBilling_Core_Repository9 GetIBilling_Core_Repository9() => _iBilling_Core_Repository9;
        public Billing_Core_Service4 GetBilling_Core_Service4() => _billing_Core_Service4;
        public Billing_Core_Controller1 GetBilling_Core_Controller1() => _billing_Core_Controller1;
        public Scheduling_Processors335_Handler GetScheduling_Processors335_Handler() => _scheduling_Processors335_Handler;
