...
namespace Reporting.Web345
{
    ...
    public class Consumer3
    {
        ...
        private readonly Scheduling_Processors335_Repository2 _scheduling_Processors335_Repository2;
        private readonly Scheduling_Processors335_Manager8 _scheduling_Processors335_Manager8;
        private readonly IScheduling_Processors335_Validator10 _iScheduling_Processors335_Validator10;
        private readonly IBatchJobs_Contracts399_Validator8 _iBatchJobs_Contracts399_Validator8;
        private readonly BatchJobs_Contracts399_Result11 _batchJobs_Contracts399_Result11;
        private readonly Notifications_Models277_Repository7 _notifications_Models277_Repository7;

        public Consumer3(Admin_Client346_Helper4 admin_Client346_Helper4, Admin_Web4_Event3 admin_Web4_Event3, Scheduling_Processors335_Repository2 scheduling_Processors335_Repository2, Scheduling_Processors335_Manager8 scheduling_Processors335_Manager8, IScheduling_Processors335_Validator10 iScheduling_Processors335_Validator10, IBatchJobs_Contracts399_Validator8 iBatchJobs_Contracts399_Validator8, BatchJobs_Contracts399_Result11 batchJobs_Contracts399_Result11, Notifications_Models277_Repository7 notifications_Models277_Repository7)
        {
            ...
            _scheduling_Processors335_Repository2 = scheduling_Processors335_Repository2 ?? throw new ArgumentNullException(nameof(scheduling_Processors335_Repository2));
            _scheduling_Processors335_Manager8 = scheduling_Processors335_Manager8 ?? throw new ArgumentNullException(nameof(scheduling_Processors335_Manager8));
            ...
            _iBatchJobs_Contracts399_Validator8 = iBatchJobs_Contracts399_Validator8 ?? throw new ArgumentNullException(nameof(iBatchJobs_Contracts399_Validator8));
            _batchJobs_Contracts399_Result11 = batchJobs_Contracts399_Result11 ?? throw new ArgumentNullException(nameof(batchJobs_Contracts399_Result11));
            _notifications_Models277_Repository7 = notifications_Models277_Repository7 ?? throw new ArgumentNullException(nameof(notifications_Models277_Repository7));
        }
        ...
        public Scheduling_Processors335_Repository2 GetScheduling_Processors335_Repository2() => _scheduling_Processors335_Repository2;
        public Scheduling_Processors335_Manager8 GetScheduling_Processors335_Manager8() => _scheduling_Processors335_Manager8;
        ...
        public IBatchJobs_Contracts399_Validator8 GetIBatchJobs_Contracts399_Validator8() => _iBatchJobs_Contracts399_Validator8;
        public BatchJobs_Contracts399_Result11 GetBatchJobs_Contracts399_Result11() => _batchJobs_Contracts399_Result11;
        public Notifications_Models277_Repository7 GetNotifications_Models277_Repository7() => _notifications_Models277_Repository7;
