...
namespace Auth.Shared
{
    ...
    public class Consumer25
    {
        ...
        private readonly Workflow_Contracts330_Repository6 _workflow_Contracts330_Repository6;
        private readonly IWorkflow_Contracts330_Validator _iWorkflow_Contracts330_Validator;

        public Consumer25(IAuth_Mappers28_Handler2 iAuth_Mappers28_Handler2, Auth_Mappers28_Controller3 auth_Mappers28_Controller3, Auth_Mappers28_Provider7 auth_Mappers28_Provider7, Admin_Processors_Service2 admin_Processors_Service2, Auth_Events5_Processor5 auth_Events5_Processor5, Auth_Events5_Dto10 auth_Events5_Dto10, Workflow_Contracts330_Repository6 workflow_Contracts330_Repository6, IWorkflow_Contracts330_Validator iWorkflow_Contracts330_Validator)
        {
            ...
            _workflow_Contracts330_Repository6 = workflow_Contracts330_Repository6 ?? throw new ArgumentNullException(nameof(workflow_Contracts330_Repository6));
            _iWorkflow_Contracts330_Validator = iWorkflow_Contracts330_Validator ?? throw new ArgumentNullException(nameof(iWorkflow_Contracts330_Validator));
        }
        ...
        public Workflow_Contracts330_Repository6 GetWorkflow_Contracts330_Repository6() => _workflow_Contracts330_Repository6;
        public IWorkflow_Contracts330_Validator GetIWorkflow_Contracts330_Validator() => _iWorkflow_Contracts330_Validator;
