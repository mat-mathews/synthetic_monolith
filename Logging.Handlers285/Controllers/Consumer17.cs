...
namespace Logging.Handlers285
{
    ...
    public class Consumer17
    {
        ...
        private readonly Export_Models461_Point3 _export_Models461_Point3;
        private readonly Export_Models461_Manager6 _export_Models461_Manager6;
        private readonly IIntegration_Shared_Validator3 _iIntegration_Shared_Validator3;
        private readonly BatchJobs_Contracts_Point8 _batchJobs_Contracts_Point8;
        private readonly IBatchJobs_Contracts_Handler5 _iBatchJobs_Contracts_Handler5;

        public Consumer17(Admin_Mappers_Handler1 admin_Mappers_Handler1, Admin_Mappers_Helper5 admin_Mappers_Helper5, Admin_Mappers_Manager2 admin_Mappers_Manager2, Export_Models461_Point3 export_Models461_Point3, Export_Models461_Manager6 export_Models461_Manager6, IIntegration_Shared_Validator3 iIntegration_Shared_Validator3, BatchJobs_Contracts_Point8 batchJobs_Contracts_Point8, IBatchJobs_Contracts_Handler5 iBatchJobs_Contracts_Handler5)
        {
            ...
            _export_Models461_Point3 = export_Models461_Point3 ?? throw new ArgumentNullException(nameof(export_Models461_Point3));
            _export_Models461_Manager6 = export_Models461_Manager6 ?? throw new ArgumentNullException(nameof(export_Models461_Manager6));
            _iIntegration_Shared_Validator3 = iIntegration_Shared_Validator3 ?? throw new ArgumentNullException(nameof(iIntegration_Shared_Validator3));
            _batchJobs_Contracts_Point8 = batchJobs_Contracts_Point8 ?? throw new ArgumentNullException(nameof(batchJobs_Contracts_Point8));
            _iBatchJobs_Contracts_Handler5 = iBatchJobs_Contracts_Handler5 ?? throw new ArgumentNullException(nameof(iBatchJobs_Contracts_Handler5));
        }
        ...
        public Export_Models461_Point3 GetExport_Models461_Point3() => _export_Models461_Point3;
        public Export_Models461_Manager6 GetExport_Models461_Manager6() => _export_Models461_Manager6;
        public IIntegration_Shared_Validator3 GetIIntegration_Shared_Validator3() => _iIntegration_Shared_Validator3;
        public BatchJobs_Contracts_Point8 GetBatchJobs_Contracts_Point8() => _batchJobs_Contracts_Point8;
        public IBatchJobs_Contracts_Handler5 GetIBatchJobs_Contracts_Handler5() => _iBatchJobs_Contracts_Handler5;
