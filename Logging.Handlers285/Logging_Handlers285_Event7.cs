...
{
    /// <summary>Immutable data transfer record for Logging_Handlers285_Event7.</summary>
    internal record Logging_Handlers285_Event7(string Value, int Count, DateTime Timestamp);
