...
namespace Imaging.Validators108
{
    ...
    public class Consumer1
    {
        ...
        private readonly Admin_Processors35_Builder6 _admin_Processors35_Builder6;
        private readonly Documents_Handlers_Controller2 _documents_Handlers_Controller2;
        private readonly Documents_Handlers_Repository5 _documents_Handlers_Repository5;
        private readonly Documents_Handlers_Manager4 _documents_Handlers_Manager4;
        private readonly Export_Validators152_Handler2 _export_Validators152_Handler2;
        private readonly Security_Web376_Factory6 _security_Web376_Factory6;
        private readonly Security_Web376_Controller1 _security_Web376_Controller1;

        public Consumer1(Admin_Events306_Event4 admin_Events306_Event4, Admin_Processors35_Builder6 admin_Processors35_Builder6, Documents_Handlers_Controller2 documents_Handlers_Controller2, Documents_Handlers_Repository5 documents_Handlers_Repository5, Documents_Handlers_Manager4 documents_Handlers_Manager4, Export_Validators152_Handler2 export_Validators152_Handler2, Security_Web376_Factory6 security_Web376_Factory6, Security_Web376_Controller1 security_Web376_Controller1)
        {
            _admin_Events306_Event4 = admin_Events306_Event4 ?? throw new ArgumentNullException(nameof(admin_Events306_Event4));
            _admin_Processors35_Builder6 = admin_Processors35_Builder6 ?? throw new ArgumentNullException(nameof(admin_Processors35_Builder6));
            ...
            _documents_Handlers_Repository5 = documents_Handlers_Repository5 ?? throw new ArgumentNullException(nameof(documents_Handlers_Repository5));
            _documents_Handlers_Manager4 = documents_Handlers_Manager4 ?? throw new ArgumentNullException(nameof(documents_Handlers_Manager4));
            _export_Validators152_Handler2 = export_Validators152_Handler2 ?? throw new ArgumentNullException(nameof(export_Validators152_Handler2));
            _security_Web376_Factory6 = security_Web376_Factory6 ?? throw new ArgumentNullException(nameof(security_Web376_Factory6));
            _security_Web376_Controller1 = security_Web376_Controller1 ?? throw new ArgumentNullException(nameof(security_Web376_Controller1));
        }

        public Admin_Events306_Event4 GetAdmin_Events306_Event4() => _admin_Events306_Event4;
        public Admin_Processors35_Builder6 GetAdmin_Processors35_Builder6() => _admin_Processors35_Builder6;
        public Documents_Handlers_Controller2 GetDocuments_Handlers_Controller2() => _documents_Handlers_Controller2;
        public Documents_Handlers_Repository5 GetDocuments_Handlers_Repository5() => _documents_Handlers_Repository5;
        public Documents_Handlers_Manager4 GetDocuments_Handlers_Manager4() => _documents_Handlers_Manager4;
        public Export_Validators152_Handler2 GetExport_Validators152_Handler2() => _export_Validators152_Handler2;
        public Security_Web376_Factory6 GetSecurity_Web376_Factory6() => _security_Web376_Factory6;
        public Security_Web376_Controller1 GetSecurity_Web376_Controller1() => _security_Web376_Controller1;
