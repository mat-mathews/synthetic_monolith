...
{
    /// <summary>Immutable data transfer record for Imaging_Validators108_Response4.</summary>
    internal record Imaging_Validators108_Response4(string Value, int Count, DateTime Timestamp);
