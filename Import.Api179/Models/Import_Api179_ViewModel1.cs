...
{
    /// <summary>Immutable data transfer record for Import_Api179_ViewModel1.</summary>
    public record Import_Api179_ViewModel1(string Value, int Count, DateTime Timestamp);
