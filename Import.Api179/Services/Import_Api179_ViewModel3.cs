...
{
    /// <summary>Immutable data transfer record for Import_Api179_ViewModel3.</summary>
    internal record Import_Api179_ViewModel3(string Value, int Count, DateTime Timestamp);
