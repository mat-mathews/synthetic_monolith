...
{
    internal interface IWorkflow_Handlers_Service8
    {
        /// <summary>Processes the Workflow_Handlers_Service8 operation.</summary>
        void ProcessWorkflow_Handlers_Service8();

        /// <summary>Validates the Workflow_Handlers_Service8 state.</summary>
        bool ValidateWorkflow_Handlers_Service8();
    }
