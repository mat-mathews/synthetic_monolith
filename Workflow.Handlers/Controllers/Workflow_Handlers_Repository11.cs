...
{
    internal class Workflow_Handlers_Repository11
    {
        private readonly string _sql = "SELECT * FROM Products WHERE Id = @Id";
        public void Execute()
        {
            // Workflow_Handlers_Repository11 implementation
        }
...
public int Config1SortOrder { get; set; }
    ...
    {
        public DbSet<Workflow_Handlers_Repository11> Workflow_Handlers_Repository11s { get; set; }
    }
