...
{
    public sealed class Common_Data21_Builder4
    {
        private readonly string _sql = "SELECT * FROM Configurations WHERE Id = @Id";
        public void Execute()
        {
            // Common_Data21_Builder4 implementation
        }
...
public int Field42SortOrder { get; set; }
    ...
    public class Data21Context : DbContext
    {
        public DbSet<Common_Data21_Builder4> Common_Data21_Builder4s { get; set; }
    }
