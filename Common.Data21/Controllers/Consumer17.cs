...
namespace Common.Data21
{
    ...
    {
        private readonly Admin_Service456_Controller1 _admin_Service456_Controller1;
        private readonly Admin_Contracts_Factory11 _admin_Contracts_Factory11;
        private readonly Admin_Contracts_Point4 _admin_Contracts_Point4;
        private readonly IAdmin_Contracts_Provider _iAdmin_Contracts_Provider;
        private readonly IDocuments_Processors133_Provider3 _iDocuments_Processors133_Provider3;
        private readonly GalaxyWorks_Core309_Result8 _galaxyWorks_Core309_Result8;
        private readonly Utilities_Contracts_Processor _utilities_Contracts_Processor;
        private readonly IUtilities_Contracts_Provider6 _iUtilities_Contracts_Provider6;

        public Consumer17(Admin_Service456_Controller1 admin_Service456_Controller1, Admin_Contracts_Factory11 admin_Contracts_Factory11, Admin_Contracts_Point4 admin_Contracts_Point4, IAdmin_Contracts_Provider iAdmin_Contracts_Provider, IDocuments_Processors133_Provider3 iDocuments_Processors133_Provider3, GalaxyWorks_Core309_Result8 galaxyWorks_Core309_Result8, Utilities_Contracts_Processor utilities_Contracts_Processor, IUtilities_Contracts_Provider6 iUtilities_Contracts_Provider6)
        {
            _admin_Service456_Controller1 = admin_Service456_Controller1 ?? throw new ArgumentNullException(nameof(admin_Service456_Controller1));
            _admin_Contracts_Factory11 = admin_Contracts_Factory11 ?? throw new ArgumentNullException(nameof(admin_Contracts_Factory11));
            _admin_Contracts_Point4 = admin_Contracts_Point4 ?? throw new ArgumentNullException(nameof(admin_Contracts_Point4));
            _iAdmin_Contracts_Provider = iAdmin_Contracts_Provider ?? throw new ArgumentNullException(nameof(iAdmin_Contracts_Provider));
            _iDocuments_Processors133_Provider3 = iDocuments_Processors133_Provider3 ?? throw new ArgumentNullException(nameof(iDocuments_Processors133_Provider3));
            _galaxyWorks_Core309_Result8 = galaxyWorks_Core309_Result8 ?? throw new ArgumentNullException(nameof(galaxyWorks_Core309_Result8));
            _utilities_Contracts_Processor = utilities_Contracts_Processor ?? throw new ArgumentNullException(nameof(utilities_Contracts_Processor));
            _iUtilities_Contracts_Provider6 = iUtilities_Contracts_Provider6 ?? throw new ArgumentNullException(nameof(iUtilities_Contracts_Provider6));
        }

        public Admin_Service456_Controller1 GetAdmin_Service456_Controller1() => _admin_Service456_Controller1;
        public Admin_Contracts_Factory11 GetAdmin_Contracts_Factory11() => _admin_Contracts_Factory11;
        public Admin_Contracts_Point4 GetAdmin_Contracts_Point4() => _admin_Contracts_Point4;
        public IAdmin_Contracts_Provider GetIAdmin_Contracts_Provider() => _iAdmin_Contracts_Provider;
        public IDocuments_Processors133_Provider3 GetIDocuments_Processors133_Provider3() => _iDocuments_Processors133_Provider3;
        public GalaxyWorks_Core309_Result8 GetGalaxyWorks_Core309_Result8() => _galaxyWorks_Core309_Result8;
        public Utilities_Contracts_Processor GetUtilities_Contracts_Processor() => _utilities_Contracts_Processor;
        public IUtilities_Contracts_Provider6 GetIUtilities_Contracts_Provider6() => _iUtilities_Contracts_Provider6;
