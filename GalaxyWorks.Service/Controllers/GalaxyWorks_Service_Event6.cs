...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Service_Event6.</summary>
    public record GalaxyWorks_Service_Event6(string Value, int Count, DateTime Timestamp);
