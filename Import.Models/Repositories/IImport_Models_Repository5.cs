...
{
    internal interface IImport_Models_Repository5
    {
        /// <summary>Processes the Import_Models_Repository5 operation.</summary>
        void ProcessImport_Models_Repository5();

        /// <summary>Validates the Import_Models_Repository5 state.</summary>
        bool ValidateImport_Models_Repository5();
    }
