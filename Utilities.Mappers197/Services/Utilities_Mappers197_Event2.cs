...
{
    /// <summary>Immutable data transfer record for Utilities_Mappers197_Event2.</summary>
    public record Utilities_Mappers197_Event2(string Value, int Count, DateTime Timestamp);
