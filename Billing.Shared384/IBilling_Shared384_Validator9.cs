...
{
    public interface IBilling_Shared384_Validator9
    {
        /// <summary>Processes the Billing_Shared384_Validator9 operation.</summary>
        void ProcessBilling_Shared384_Validator9();

        /// <summary>Validates the Billing_Shared384_Validator9 state.</summary>
        bool ValidateBilling_Shared384_Validator9();
    }
