...
{
    public interface IBilling_Shared384_Validator10
    {
        /// <summary>Processes the Billing_Shared384_Validator10 operation.</summary>
        void ProcessBilling_Shared384_Validator10();

        /// <summary>Validates the Billing_Shared384_Validator10 state.</summary>
        bool ValidateBilling_Shared384_Validator10();
    }
