...
{
    internal class Billing_Shared384_Controller
    {
        private readonly string _sql = "SELECT * FROM AuditLogs WHERE Id = @Id";
        public void Execute()
        {
            // Billing_Shared384_Controller implementation
        }
...
public int Record67SortOrder { get; set; }
    ...
    public class Shared384Context : DbContext
    {
        public DbSet<Billing_Shared384_Controller> Billing_Shared384_Controllers { get; set; }
    }
