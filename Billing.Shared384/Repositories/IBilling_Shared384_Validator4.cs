...
{
    public interface IBilling_Shared384_Validator4
    {
        /// <summary>Processes the Billing_Shared384_Validator4 operation.</summary>
        void ProcessBilling_Shared384_Validator4();

        /// <summary>Validates the Billing_Shared384_Validator4 state.</summary>
        bool ValidateBilling_Shared384_Validator4();
    }
