...
{
    public interface IBilling_Shared384_Factory3
    {
        /// <summary>Processes the Billing_Shared384_Factory3 operation.</summary>
        void ProcessBilling_Shared384_Factory3();

        /// <summary>Validates the Billing_Shared384_Factory3 state.</summary>
        bool ValidateBilling_Shared384_Factory3();
    }
