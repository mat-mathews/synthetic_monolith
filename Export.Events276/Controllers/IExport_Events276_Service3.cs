...
{
    public interface IExport_Events276_Service3
    {
        /// <summary>Processes the Export_Events276_Service3 operation.</summary>
        void ProcessExport_Events276_Service3();

        /// <summary>Validates the Export_Events276_Service3 state.</summary>
        bool ValidateExport_Events276_Service3();
    }
