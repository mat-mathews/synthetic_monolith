...
{
    internal interface IExport_Events276_Validator
    {
        /// <summary>Processes the Export_Events276_Validator operation.</summary>
        void ProcessExport_Events276_Validator();

        /// <summary>Validates the Export_Events276_Validator state.</summary>
        bool ValidateExport_Events276_Validator();
    }
