...
{
    /// <summary>Immutable data transfer record for Export_Events276_Dto6.</summary>
    internal record Export_Events276_Dto6(string Value, int Count, DateTime Timestamp);
