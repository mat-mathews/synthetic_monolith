...
{
    public interface IExport_Events276_Provider2
    {
        /// <summary>Processes the Export_Events276_Provider2 operation.</summary>
        void ProcessExport_Events276_Provider2();

        /// <summary>Validates the Export_Events276_Provider2 state.</summary>
        bool ValidateExport_Events276_Provider2();
    }
