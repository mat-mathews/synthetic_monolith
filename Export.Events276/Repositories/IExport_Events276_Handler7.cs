...
{
    internal interface IExport_Events276_Handler7
    {
        /// <summary>Processes the Export_Events276_Handler7 operation.</summary>
        void ProcessExport_Events276_Handler7();

        /// <summary>Validates the Export_Events276_Handler7 state.</summary>
        bool ValidateExport_Events276_Handler7();
    }
