...
{
    internal interface IGalaxyWorks_Api_Service4
    {
        /// <summary>Processes the GalaxyWorks_Api_Service4 operation.</summary>
        void ProcessGalaxyWorks_Api_Service4();

        /// <summary>Validates the GalaxyWorks_Api_Service4 state.</summary>
        bool ValidateGalaxyWorks_Api_Service4();
    }
