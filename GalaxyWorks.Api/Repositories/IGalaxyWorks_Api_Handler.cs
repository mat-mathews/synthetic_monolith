...
{
    internal interface IGalaxyWorks_Api_Handler
    {
        /// <summary>Processes the GalaxyWorks_Api_Handler operation.</summary>
        void ProcessGalaxyWorks_Api_Handler();

        /// <summary>Validates the GalaxyWorks_Api_Handler state.</summary>
        bool ValidateGalaxyWorks_Api_Handler();
    }
