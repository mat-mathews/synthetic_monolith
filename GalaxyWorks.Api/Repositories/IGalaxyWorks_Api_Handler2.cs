...
{
    public interface IGalaxyWorks_Api_Handler2
    {
        /// <summary>Processes the GalaxyWorks_Api_Handler2 operation.</summary>
        void ProcessGalaxyWorks_Api_Handler2();

        /// <summary>Validates the GalaxyWorks_Api_Handler2 state.</summary>
        bool ValidateGalaxyWorks_Api_Handler2();
    }
