...
{
    internal interface IReporting_Client_Factory1
    {
        /// <summary>Processes the Reporting_Client_Factory1 operation.</summary>
        void ProcessReporting_Client_Factory1();

        /// <summary>Validates the Reporting_Client_Factory1 state.</summary>
        bool ValidateReporting_Client_Factory1();
    }
