...
{
    internal interface ICommon_Core417_Factory8
    {
        /// <summary>Processes the Common_Core417_Factory8 operation.</summary>
        void ProcessCommon_Core417_Factory8();

        /// <summary>Validates the Common_Core417_Factory8 state.</summary>
        bool ValidateCommon_Core417_Factory8();
    }
