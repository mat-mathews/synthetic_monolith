...
{
    /// <summary>Immutable data transfer record for Scheduling_Contracts_ViewModel4.</summary>
    internal record Scheduling_Contracts_ViewModel4(string Value, int Count, DateTime Timestamp);
