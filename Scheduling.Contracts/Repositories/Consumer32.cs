...
namespace Scheduling.Contracts
{
    ...
    public class Consumer32
    {
        ...
        private readonly Security_Validators_Request3 _security_Validators_Request3;
        private readonly Security_Client349_Info6 _security_Client349_Info6;
        private readonly ISecurity_Client349_Handler2 _iSecurity_Client349_Handler2;
        private readonly Billing_Service432_Event2 _billing_Service432_Event2;
        private readonly Billing_Service432_Options9 _billing_Service432_Options9;
        private readonly Scheduling_Web264_Options5 _scheduling_Web264_Options5;
        private readonly Integration_Contracts_Provider3 _integration_Contracts_Provider3;

        public Consumer32(Auth_Models236_Processor1 auth_Models236_Processor1, Security_Validators_Request3 security_Validators_Request3, Security_Client349_Info6 security_Client349_Info6, ISecurity_Client349_Handler2 iSecurity_Client349_Handler2, Billing_Service432_Event2 billing_Service432_Event2, Billing_Service432_Options9 billing_Service432_Options9, Scheduling_Web264_Options5 scheduling_Web264_Options5, Integration_Contracts_Provider3 integration_Contracts_Provider3)
        {
            _auth_Models236_Processor1 = auth_Models236_Processor1 ?? throw new ArgumentNullException(nameof(auth_Models236_Processor1));
            _security_Validators_Request3 = security_Validators_Request3 ?? throw new ArgumentNullException(nameof(security_Validators_Request3));
            _security_Client349_Info6 = security_Client349_Info6 ?? throw new ArgumentNullException(nameof(security_Client349_Info6));
            ...
            _billing_Service432_Event2 = billing_Service432_Event2 ?? throw new ArgumentNullException(nameof(billing_Service432_Event2));
            _billing_Service432_Options9 = billing_Service432_Options9 ?? throw new ArgumentNullException(nameof(billing_Service432_Options9));
            _scheduling_Web264_Options5 = scheduling_Web264_Options5 ?? throw new ArgumentNullException(nameof(scheduling_Web264_Options5));
            _integration_Contracts_Provider3 = integration_Contracts_Provider3 ?? throw new ArgumentNullException(nameof(integration_Contracts_Provider3));
        }

        public Auth_Models236_Processor1 GetAuth_Models236_Processor1() => _auth_Models236_Processor1;
        public Security_Validators_Request3 GetSecurity_Validators_Request3() => _security_Validators_Request3;
        public Security_Client349_Info6 GetSecurity_Client349_Info6() => _security_Client349_Info6;
        public ISecurity_Client349_Handler2 GetISecurity_Client349_Handler2() => _iSecurity_Client349_Handler2;
        public Billing_Service432_Event2 GetBilling_Service432_Event2() => _billing_Service432_Event2;
        public Billing_Service432_Options9 GetBilling_Service432_Options9() => _billing_Service432_Options9;
        public Scheduling_Web264_Options5 GetScheduling_Web264_Options5() => _scheduling_Web264_Options5;
        public Integration_Contracts_Provider3 GetIntegration_Contracts_Provider3() => _integration_Contracts_Provider3;
