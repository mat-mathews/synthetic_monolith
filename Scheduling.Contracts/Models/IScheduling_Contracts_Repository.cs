...
{
    public interface IScheduling_Contracts_Repository
    {
        /// <summary>Processes the Scheduling_Contracts_Repository operation.</summary>
        void ProcessScheduling_Contracts_Repository();

        /// <summary>Validates the Scheduling_Contracts_Repository state.</summary>
        bool ValidateScheduling_Contracts_Repository();
    }
