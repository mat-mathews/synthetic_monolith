...
{
    internal interface IExport_Processors79_Validator5
    {
        /// <summary>Processes the Export_Processors79_Validator5 operation.</summary>
        void ProcessExport_Processors79_Validator5();

        /// <summary>Validates the Export_Processors79_Validator5 state.</summary>
        bool ValidateExport_Processors79_Validator5();
    }
