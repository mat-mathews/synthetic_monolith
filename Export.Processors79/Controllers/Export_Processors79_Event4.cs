...
{
    /// <summary>Immutable data transfer record for Export_Processors79_Event4.</summary>
    internal record Export_Processors79_Event4(string Value, int Count, DateTime Timestamp);
