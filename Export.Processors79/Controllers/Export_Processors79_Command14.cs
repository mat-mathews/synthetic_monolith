...
{
    /// <summary>Immutable data transfer record for Export_Processors79_Command14.</summary>
    public record Export_Processors79_Command14(string Value, int Count, DateTime Timestamp);
