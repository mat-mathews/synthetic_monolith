...
{
    internal interface IDataAccess_Validators_Handler6
    {
        /// <summary>Processes the DataAccess_Validators_Handler6 operation.</summary>
        void ProcessDataAccess_Validators_Handler6();

        /// <summary>Validates the DataAccess_Validators_Handler6 state.</summary>
        bool ValidateDataAccess_Validators_Handler6();
    }
