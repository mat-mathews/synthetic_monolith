...
{
    internal abstract class DataAccess_Validators_Processor4
    {
        private readonly string _sql = "SELECT * FROM Schedules WHERE Id = @Id";
        public void Execute()
        {
            // DataAccess_Validators_Processor4 implementation
        }
...
public int Config15SortOrder { get; set; }
    ...
    {
        public DbSet<DataAccess_Validators_Processor4> DataAccess_Validators_Processor4s { get; set; }
    }
