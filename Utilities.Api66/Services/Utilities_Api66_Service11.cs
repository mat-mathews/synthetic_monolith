...
{
    internal class Utilities_Api66_Service11
    {
        private readonly string _sql = "SELECT * FROM AuditLogs WHERE Id = @Id";
        public void Execute()
        {
            // Utilities_Api66_Service11 implementation
        }
...
public int Record36SortOrder { get; set; }
    ...
    public class Api66Context : DbContext
    {
        public DbSet<Utilities_Api66_Service11> Utilities_Api66_Service11s { get; set; }
    }
