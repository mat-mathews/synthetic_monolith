...
{
    internal partial class Admin_Core121_Repository3
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // Admin_Core121_Repository3 implementation
        }
...
public int Config57SortOrder { get; set; }
    ...
    {
        public DbSet<Admin_Core121_Repository3> Admin_Core121_Repository3s { get; set; }
    }
