...
namespace Export.Events163
{
    ...
    public class Consumer18
    {
        ...
        private readonly Integration_Service_Helper _integration_Service_Helper;
        private readonly Export_Handlers202_Repository2 _export_Handlers202_Repository2;
        private readonly Common_Processors_Manager11 _common_Processors_Manager11;

        public Consumer18(Admin_Client346_Repository9 admin_Client346_Repository9, Admin_Client346_Provider3 admin_Client346_Provider3, Documents_Data490_Service1 documents_Data490_Service1, Common_Validators50_Provider common_Validators50_Provider, Export_Shared145_Helper3 export_Shared145_Helper3, Integration_Service_Helper integration_Service_Helper, Export_Handlers202_Repository2 export_Handlers202_Repository2, Common_Processors_Manager11 common_Processors_Manager11)
        {
            ...
            _integration_Service_Helper = integration_Service_Helper ?? throw new ArgumentNullException(nameof(integration_Service_Helper));
            _export_Handlers202_Repository2 = export_Handlers202_Repository2 ?? throw new ArgumentNullException(nameof(export_Handlers202_Repository2));
        ...
        public Integration_Service_Helper GetIntegration_Service_Helper() => _integration_Service_Helper;
        public Export_Handlers202_Repository2 GetExport_Handlers202_Repository2() => _export_Handlers202_Repository2;
