...
{
    /// <summary>Immutable data transfer record for Export_Events163_Request6.</summary>
    internal record Export_Events163_Request6(string Value, int Count, DateTime Timestamp);
