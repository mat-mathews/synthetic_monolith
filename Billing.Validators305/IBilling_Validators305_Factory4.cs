...
{
    public interface IBilling_Validators305_Factory4
    {
        /// <summary>Processes the Billing_Validators305_Factory4 operation.</summary>
        void ProcessBilling_Validators305_Factory4();

        /// <summary>Validates the Billing_Validators305_Factory4 state.</summary>
        bool ValidateBilling_Validators305_Factory4();
    }
