...
{
    /// <summary>Immutable data transfer record for Billing_Validators305_Response1.</summary>
    public record Billing_Validators305_Response1(string Value, int Count, DateTime Timestamp);
