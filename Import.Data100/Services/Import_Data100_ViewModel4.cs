...
{
    /// <summary>Immutable data transfer record for Import_Data100_ViewModel4.</summary>
    public record Import_Data100_ViewModel4(string Value, int Count, DateTime Timestamp);
