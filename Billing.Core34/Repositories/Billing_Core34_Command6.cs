...
{
    /// <summary>Immutable data transfer record for Billing_Core34_Command6.</summary>
    public record Billing_Core34_Command6(string Value, int Count, DateTime Timestamp);
