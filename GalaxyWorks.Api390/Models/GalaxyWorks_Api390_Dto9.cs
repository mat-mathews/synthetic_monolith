...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Api390_Dto9.</summary>
    public record GalaxyWorks_Api390_Dto9(string Value, int Count, DateTime Timestamp);
