...
{
    internal interface IExport_Validators152_Factory
    {
        /// <summary>Processes the Export_Validators152_Factory operation.</summary>
        void ProcessExport_Validators152_Factory();

        /// <summary>Validates the Export_Validators152_Factory state.</summary>
        bool ValidateExport_Validators152_Factory();
    }
