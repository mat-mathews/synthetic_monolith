...
{
    /// <summary>Immutable data transfer record for Imaging_Mappers93_ViewModel7.</summary>
    public record Imaging_Mappers93_ViewModel7(string Value, int Count, DateTime Timestamp);
