...
{
    public interface IImaging_Mappers93_Handler12
    {
        /// <summary>Processes the Imaging_Mappers93_Handler12 operation.</summary>
        void ProcessImaging_Mappers93_Handler12();

        /// <summary>Validates the Imaging_Mappers93_Handler12 state.</summary>
        bool ValidateImaging_Mappers93_Handler12();
    }
