...
{
    /// <summary>Immutable data transfer record for Utilities_Data415_ViewModel.</summary>
    public record Utilities_Data415_ViewModel(string Value, int Count, DateTime Timestamp);
