...
{
    /// <summary>Immutable data transfer record for Utilities_Data415_Dto12.</summary>
    internal record Utilities_Data415_Dto12(string Value, int Count, DateTime Timestamp);
