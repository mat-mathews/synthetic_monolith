...
namespace Utilities.Data415
{
    ...
    {
        private readonly Admin_Handlers450_Range8 _admin_Handlers450_Range8;
        private readonly Admin_Handlers450_Handler9 _admin_Handlers450_Handler9;
        private readonly ICommon_Web_Handler5 _iCommon_Web_Handler5;
        private readonly Export_Handlers_Provider9 _export_Handlers_Provider9;
        private readonly Logging_Models436_Manager8 _logging_Models436_Manager8;
        private readonly Logging_Models436_Builder _logging_Models436_Builder;
        private readonly Integration_Service401_Service7 _integration_Service401_Service7;
        private readonly Integration_Service401_Factory1 _integration_Service401_Factory1;

        public Consumer18(Admin_Handlers450_Range8 admin_Handlers450_Range8, Admin_Handlers450_Handler9 admin_Handlers450_Handler9, ICommon_Web_Handler5 iCommon_Web_Handler5, Export_Handlers_Provider9 export_Handlers_Provider9, Logging_Models436_Manager8 logging_Models436_Manager8, Logging_Models436_Builder logging_Models436_Builder, Integration_Service401_Service7 integration_Service401_Service7, Integration_Service401_Factory1 integration_Service401_Factory1)
        {
            _admin_Handlers450_Range8 = admin_Handlers450_Range8 ?? throw new ArgumentNullException(nameof(admin_Handlers450_Range8));
            _admin_Handlers450_Handler9 = admin_Handlers450_Handler9 ?? throw new ArgumentNullException(nameof(admin_Handlers450_Handler9));
            _iCommon_Web_Handler5 = iCommon_Web_Handler5 ?? throw new ArgumentNullException(nameof(iCommon_Web_Handler5));
            _export_Handlers_Provider9 = export_Handlers_Provider9 ?? throw new ArgumentNullException(nameof(export_Handlers_Provider9));
            _logging_Models436_Manager8 = logging_Models436_Manager8 ?? throw new ArgumentNullException(nameof(logging_Models436_Manager8));
            _logging_Models436_Builder = logging_Models436_Builder ?? throw new ArgumentNullException(nameof(logging_Models436_Builder));
            _integration_Service401_Service7 = integration_Service401_Service7 ?? throw new ArgumentNullException(nameof(integration_Service401_Service7));
            _integration_Service401_Factory1 = integration_Service401_Factory1 ?? throw new ArgumentNullException(nameof(integration_Service401_Factory1));
        }

        public Admin_Handlers450_Range8 GetAdmin_Handlers450_Range8() => _admin_Handlers450_Range8;
        public Admin_Handlers450_Handler9 GetAdmin_Handlers450_Handler9() => _admin_Handlers450_Handler9;
        public ICommon_Web_Handler5 GetICommon_Web_Handler5() => _iCommon_Web_Handler5;
        public Export_Handlers_Provider9 GetExport_Handlers_Provider9() => _export_Handlers_Provider9;
        public Logging_Models436_Manager8 GetLogging_Models436_Manager8() => _logging_Models436_Manager8;
        public Logging_Models436_Builder GetLogging_Models436_Builder() => _logging_Models436_Builder;
        public Integration_Service401_Service7 GetIntegration_Service401_Service7() => _integration_Service401_Service7;
        public Integration_Service401_Factory1 GetIntegration_Service401_Factory1() => _integration_Service401_Factory1;
