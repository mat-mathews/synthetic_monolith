...
{
    /// <summary>Immutable data transfer record for Notifications_Api144_Command5.</summary>
    internal record Notifications_Api144_Command5(string Value, int Count, DateTime Timestamp);
