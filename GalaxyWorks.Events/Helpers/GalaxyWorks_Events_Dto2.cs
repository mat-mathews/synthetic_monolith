...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Events_Dto2.</summary>
    public record GalaxyWorks_Events_Dto2(string Value, int Count, DateTime Timestamp);
