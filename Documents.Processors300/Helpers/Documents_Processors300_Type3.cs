...
{
    /// <summary>Defines the possible states for Documents_Processors300_Type3.</summary>
    internal enum Documents_Processors300_Type3
    {
        None = 0,
        Active = 1,
        Inactive = 2,
    ...
    public class Processors300Context : DbContext
    {
    }
