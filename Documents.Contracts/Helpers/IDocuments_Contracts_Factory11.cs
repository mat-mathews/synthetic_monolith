...
{
    public interface IDocuments_Contracts_Factory11
    {
        /// <summary>Processes the Documents_Contracts_Factory11 operation.</summary>
        void ProcessDocuments_Contracts_Factory11();

        /// <summary>Validates the Documents_Contracts_Factory11 state.</summary>
        bool ValidateDocuments_Contracts_Factory11();
    }
