...
{
    /// <summary>Immutable data transfer record for Documents_Contracts_Request10.</summary>
    internal record Documents_Contracts_Request10(string Value, int Count, DateTime Timestamp);
