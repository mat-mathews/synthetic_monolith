...
{
    public interface IDocuments_Contracts_Validator9
    {
        /// <summary>Processes the Documents_Contracts_Validator9 operation.</summary>
        void ProcessDocuments_Contracts_Validator9();

        /// <summary>Validates the Documents_Contracts_Validator9 state.</summary>
        bool ValidateDocuments_Contracts_Validator9();
    }
