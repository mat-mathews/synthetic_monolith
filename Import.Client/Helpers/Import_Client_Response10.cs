...
{
    /// <summary>Immutable data transfer record for Import_Client_Response10.</summary>
    public record Import_Client_Response10(string Value, int Count, DateTime Timestamp);
