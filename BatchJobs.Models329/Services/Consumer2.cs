...
namespace BatchJobs.Models329
{
    ...
    public class Consumer2
    {
        ...
        private readonly Imaging_Contracts_Command3 _imaging_Contracts_Command3;
        private readonly Import_Client_Controller6 _import_Client_Controller6;
        private readonly Import_Client_Service12 _import_Client_Service12;
        private readonly IImport_Client_Validator5 _iImport_Client_Validator5;
        private readonly Utilities_Mappers_Result3 _utilities_Mappers_Result3;

        public Consumer2(Admin_Handlers447_Factory1 admin_Handlers447_Factory1, Admin_Handlers447_Manager2 admin_Handlers447_Manager2, Admin_Handlers447_Event admin_Handlers447_Event, Imaging_Contracts_Command3 imaging_Contracts_Command3, Import_Client_Controller6 import_Client_Controller6, Import_Client_Service12 import_Client_Service12, IImport_Client_Validator5 iImport_Client_Validator5, Utilities_Mappers_Result3 utilities_Mappers_Result3)
        {
            ...
            _imaging_Contracts_Command3 = imaging_Contracts_Command3 ?? throw new ArgumentNullException(nameof(imaging_Contracts_Command3));
            _import_Client_Controller6 = import_Client_Controller6 ?? throw new ArgumentNullException(nameof(import_Client_Controller6));
            _import_Client_Service12 = import_Client_Service12 ?? throw new ArgumentNullException(nameof(import_Client_Service12));
            _iImport_Client_Validator5 = iImport_Client_Validator5 ?? throw new ArgumentNullException(nameof(iImport_Client_Validator5));
            _utilities_Mappers_Result3 = utilities_Mappers_Result3 ?? throw new ArgumentNullException(nameof(utilities_Mappers_Result3));
        }
        ...
        public Imaging_Contracts_Command3 GetImaging_Contracts_Command3() => _imaging_Contracts_Command3;
        public Import_Client_Controller6 GetImport_Client_Controller6() => _import_Client_Controller6;
        public Import_Client_Service12 GetImport_Client_Service12() => _import_Client_Service12;
        public IImport_Client_Validator5 GetIImport_Client_Validator5() => _iImport_Client_Validator5;
        public Utilities_Mappers_Result3 GetUtilities_Mappers_Result3() => _utilities_Mappers_Result3;
