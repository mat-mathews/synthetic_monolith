...
namespace BatchJobs.Models329
{
    ...
    public class Consumer13
    {
        ...
        private readonly Imaging_Contracts_Repository6 _imaging_Contracts_Repository6;
        private readonly IImaging_Contracts_Validator2 _iImaging_Contracts_Validator2;
        private readonly Imaging_Contracts_Repository1 _imaging_Contracts_Repository1;
        private readonly Import_Client_Factory9 _import_Client_Factory9;
        private readonly Utilities_Mappers97_Provider3 _utilities_Mappers97_Provider3;
        private readonly Utilities_Mappers97_Command6 _utilities_Mappers97_Command6;
        private readonly Utilities_Mappers97_Manager12 _utilities_Mappers97_Manager12;

        public Consumer13(Admin_Handlers447_Factory1 admin_Handlers447_Factory1, Imaging_Contracts_Repository6 imaging_Contracts_Repository6, IImaging_Contracts_Validator2 iImaging_Contracts_Validator2, Imaging_Contracts_Repository1 imaging_Contracts_Repository1, Import_Client_Factory9 import_Client_Factory9, Utilities_Mappers97_Provider3 utilities_Mappers97_Provider3, Utilities_Mappers97_Command6 utilities_Mappers97_Command6, Utilities_Mappers97_Manager12 utilities_Mappers97_Manager12)
        {
            _admin_Handlers447_Factory1 = admin_Handlers447_Factory1 ?? throw new ArgumentNullException(nameof(admin_Handlers447_Factory1));
            _imaging_Contracts_Repository6 = imaging_Contracts_Repository6 ?? throw new ArgumentNullException(nameof(imaging_Contracts_Repository6));
            _iImaging_Contracts_Validator2 = iImaging_Contracts_Validator2 ?? throw new ArgumentNullException(nameof(iImaging_Contracts_Validator2));
            _imaging_Contracts_Repository1 = imaging_Contracts_Repository1 ?? throw new ArgumentNullException(nameof(imaging_Contracts_Repository1));
            _import_Client_Factory9 = import_Client_Factory9 ?? throw new ArgumentNullException(nameof(import_Client_Factory9));
            _utilities_Mappers97_Provider3 = utilities_Mappers97_Provider3 ?? throw new ArgumentNullException(nameof(utilities_Mappers97_Provider3));
            _utilities_Mappers97_Command6 = utilities_Mappers97_Command6 ?? throw new ArgumentNullException(nameof(utilities_Mappers97_Command6));
            _utilities_Mappers97_Manager12 = utilities_Mappers97_Manager12 ?? throw new ArgumentNullException(nameof(utilities_Mappers97_Manager12));
        }

        public Admin_Handlers447_Factory1 GetAdmin_Handlers447_Factory1() => _admin_Handlers447_Factory1;
        public Imaging_Contracts_Repository6 GetImaging_Contracts_Repository6() => _imaging_Contracts_Repository6;
        public IImaging_Contracts_Validator2 GetIImaging_Contracts_Validator2() => _iImaging_Contracts_Validator2;
        public Imaging_Contracts_Repository1 GetImaging_Contracts_Repository1() => _imaging_Contracts_Repository1;
        public Import_Client_Factory9 GetImport_Client_Factory9() => _import_Client_Factory9;
        public Utilities_Mappers97_Provider3 GetUtilities_Mappers97_Provider3() => _utilities_Mappers97_Provider3;
        public Utilities_Mappers97_Command6 GetUtilities_Mappers97_Command6() => _utilities_Mappers97_Command6;
        public Utilities_Mappers97_Manager12 GetUtilities_Mappers97_Manager12() => _utilities_Mappers97_Manager12;
