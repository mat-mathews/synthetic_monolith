...
{
    /// <summary>Immutable data transfer record for Common_Tests350_Command6.</summary>
    public record Common_Tests350_Command6(string Value, int Count, DateTime Timestamp);
