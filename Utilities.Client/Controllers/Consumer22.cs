...
namespace Utilities.Client
{
    ...
    public class Consumer22
    {
        ...
        private readonly Workflow_Data340_Repository _workflow_Data340_Repository;
        private readonly Workflow_Data340_Factory3 _workflow_Data340_Factory3;
        private readonly Workflow_Data340_Handler2 _workflow_Data340_Handler2;
        private readonly Notifications_Tests_Repository3 _notifications_Tests_Repository3;
        private readonly Utilities_Api387_Helper12 _utilities_Api387_Helper12;
        private readonly IUtilities_Api387_Repository13 _iUtilities_Api387_Repository13;
        private readonly Utilities_Api387_Controller1 _utilities_Api387_Controller1;

        public Consumer22(IAuth_Data135_Service2 iAuth_Data135_Service2, Workflow_Data340_Repository workflow_Data340_Repository, Workflow_Data340_Factory3 workflow_Data340_Factory3, Workflow_Data340_Handler2 workflow_Data340_Handler2, Notifications_Tests_Repository3 notifications_Tests_Repository3, Utilities_Api387_Helper12 utilities_Api387_Helper12, IUtilities_Api387_Repository13 iUtilities_Api387_Repository13, Utilities_Api387_Controller1 utilities_Api387_Controller1)
        {
            _iAuth_Data135_Service2 = iAuth_Data135_Service2 ?? throw new ArgumentNullException(nameof(iAuth_Data135_Service2));
            _workflow_Data340_Repository = workflow_Data340_Repository ?? throw new ArgumentNullException(nameof(workflow_Data340_Repository));
            _workflow_Data340_Factory3 = workflow_Data340_Factory3 ?? throw new ArgumentNullException(nameof(workflow_Data340_Factory3));
            _workflow_Data340_Handler2 = workflow_Data340_Handler2 ?? throw new ArgumentNullException(nameof(workflow_Data340_Handler2));
            _notifications_Tests_Repository3 = notifications_Tests_Repository3 ?? throw new ArgumentNullException(nameof(notifications_Tests_Repository3));
            _utilities_Api387_Helper12 = utilities_Api387_Helper12 ?? throw new ArgumentNullException(nameof(utilities_Api387_Helper12));
            _iUtilities_Api387_Repository13 = iUtilities_Api387_Repository13 ?? throw new ArgumentNullException(nameof(iUtilities_Api387_Repository13));
            _utilities_Api387_Controller1 = utilities_Api387_Controller1 ?? throw new ArgumentNullException(nameof(utilities_Api387_Controller1));
        }

        public IAuth_Data135_Service2 GetIAuth_Data135_Service2() => _iAuth_Data135_Service2;
        public Workflow_Data340_Repository GetWorkflow_Data340_Repository() => _workflow_Data340_Repository;
        public Workflow_Data340_Factory3 GetWorkflow_Data340_Factory3() => _workflow_Data340_Factory3;
        public Workflow_Data340_Handler2 GetWorkflow_Data340_Handler2() => _workflow_Data340_Handler2;
        public Notifications_Tests_Repository3 GetNotifications_Tests_Repository3() => _notifications_Tests_Repository3;
        public Utilities_Api387_Helper12 GetUtilities_Api387_Helper12() => _utilities_Api387_Helper12;
        public IUtilities_Api387_Repository13 GetIUtilities_Api387_Repository13() => _iUtilities_Api387_Repository13;
        public Utilities_Api387_Controller1 GetUtilities_Api387_Controller1() => _utilities_Api387_Controller1;
