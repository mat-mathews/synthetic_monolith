...
{
    /// <summary>Immutable data transfer record for Notifications_Processors_Request7.</summary>
    internal record Notifications_Processors_Request7(string Value, int Count, DateTime Timestamp);
