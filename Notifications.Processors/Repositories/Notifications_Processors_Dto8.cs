...
{
    /// <summary>Immutable data transfer record for Notifications_Processors_Dto8.</summary>
    public record Notifications_Processors_Dto8(string Value, int Count, DateTime Timestamp);
