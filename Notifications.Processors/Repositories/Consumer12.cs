...
namespace Notifications.Processors
{
    ...
    public class Consumer12
    {
        ...
        private readonly Imaging_Shared_Key4 _imaging_Shared_Key4;
        private readonly Imaging_Shared_Helper3 _imaging_Shared_Helper3;
        private readonly Imaging_Shared_Provider1 _imaging_Shared_Provider1;
        private readonly Import_Handlers354_Event11 _import_Handlers354_Event11;
        private readonly Import_Client_Handler4 _import_Client_Handler4;
        private readonly Import_Client_Controller2 _import_Client_Controller2;

        public Consumer12(IAdmin_Api255_Service2 iAdmin_Api255_Service2, IAdmin_Api255_Handler11 iAdmin_Api255_Handler11, Imaging_Shared_Key4 imaging_Shared_Key4, Imaging_Shared_Helper3 imaging_Shared_Helper3, Imaging_Shared_Provider1 imaging_Shared_Provider1, Import_Handlers354_Event11 import_Handlers354_Event11, Import_Client_Handler4 import_Client_Handler4, Import_Client_Controller2 import_Client_Controller2)
        {
            ...
            _imaging_Shared_Key4 = imaging_Shared_Key4 ?? throw new ArgumentNullException(nameof(imaging_Shared_Key4));
            _imaging_Shared_Helper3 = imaging_Shared_Helper3 ?? throw new ArgumentNullException(nameof(imaging_Shared_Helper3));
            _imaging_Shared_Provider1 = imaging_Shared_Provider1 ?? throw new ArgumentNullException(nameof(imaging_Shared_Provider1));
            _import_Handlers354_Event11 = import_Handlers354_Event11 ?? throw new ArgumentNullException(nameof(import_Handlers354_Event11));
            _import_Client_Handler4 = import_Client_Handler4 ?? throw new ArgumentNullException(nameof(import_Client_Handler4));
            _import_Client_Controller2 = import_Client_Controller2 ?? throw new ArgumentNullException(nameof(import_Client_Controller2));
        }
        ...
        public Imaging_Shared_Key4 GetImaging_Shared_Key4() => _imaging_Shared_Key4;
        public Imaging_Shared_Helper3 GetImaging_Shared_Helper3() => _imaging_Shared_Helper3;
        public Imaging_Shared_Provider1 GetImaging_Shared_Provider1() => _imaging_Shared_Provider1;
        public Import_Handlers354_Event11 GetImport_Handlers354_Event11() => _import_Handlers354_Event11;
        public Import_Client_Handler4 GetImport_Client_Handler4() => _import_Client_Handler4;
        public Import_Client_Controller2 GetImport_Client_Controller2() => _import_Client_Controller2;
