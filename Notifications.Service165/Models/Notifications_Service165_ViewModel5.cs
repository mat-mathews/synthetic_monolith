...
{
    /// <summary>Immutable data transfer record for Notifications_Service165_ViewModel5.</summary>
    internal record Notifications_Service165_ViewModel5(string Value, int Count, DateTime Timestamp);
