...
namespace Notifications.Service165
{
    ...
    public class Consumer31
    {
        ...
        private readonly Notifications_Processors_Provider12 _notifications_Processors_Provider12;
        private readonly Notifications_Processors_Provider13 _notifications_Processors_Provider13;
        private readonly Notifications_Processors_Processor6 _notifications_Processors_Processor6;
        private readonly IWorkflow_Api433_Repository7 _iWorkflow_Api433_Repository7;
        private readonly Common_Shared95_Provider2 _common_Shared95_Provider2;
        private readonly ICommon_Shared95_Provider4 _iCommon_Shared95_Provider4;
        private readonly IReporting_Events483_Validator _iReporting_Events483_Validator;

        public Consumer31(Auth_Processors_Factory12 auth_Processors_Factory12, Notifications_Processors_Provider12 notifications_Processors_Provider12, Notifications_Processors_Provider13 notifications_Processors_Provider13, Notifications_Processors_Processor6 notifications_Processors_Processor6, IWorkflow_Api433_Repository7 iWorkflow_Api433_Repository7, Common_Shared95_Provider2 common_Shared95_Provider2, ICommon_Shared95_Provider4 iCommon_Shared95_Provider4, IReporting_Events483_Validator iReporting_Events483_Validator)
        {
            _auth_Processors_Factory12 = auth_Processors_Factory12 ?? throw new ArgumentNullException(nameof(auth_Processors_Factory12));
            _notifications_Processors_Provider12 = notifications_Processors_Provider12 ?? throw new ArgumentNullException(nameof(notifications_Processors_Provider12));
            _notifications_Processors_Provider13 = notifications_Processors_Provider13 ?? throw new ArgumentNullException(nameof(notifications_Processors_Provider13));
            ...
            _iWorkflow_Api433_Repository7 = iWorkflow_Api433_Repository7 ?? throw new ArgumentNullException(nameof(iWorkflow_Api433_Repository7));
            _common_Shared95_Provider2 = common_Shared95_Provider2 ?? throw new ArgumentNullException(nameof(common_Shared95_Provider2));
            _iCommon_Shared95_Provider4 = iCommon_Shared95_Provider4 ?? throw new ArgumentNullException(nameof(iCommon_Shared95_Provider4));
            _iReporting_Events483_Validator = iReporting_Events483_Validator ?? throw new ArgumentNullException(nameof(iReporting_Events483_Validator));
        }

        public Auth_Processors_Factory12 GetAuth_Processors_Factory12() => _auth_Processors_Factory12;
        public Notifications_Processors_Provider12 GetNotifications_Processors_Provider12() => _notifications_Processors_Provider12;
        public Notifications_Processors_Provider13 GetNotifications_Processors_Provider13() => _notifications_Processors_Provider13;
        public Notifications_Processors_Processor6 GetNotifications_Processors_Processor6() => _notifications_Processors_Processor6;
        public IWorkflow_Api433_Repository7 GetIWorkflow_Api433_Repository7() => _iWorkflow_Api433_Repository7;
        public Common_Shared95_Provider2 GetCommon_Shared95_Provider2() => _common_Shared95_Provider2;
        public ICommon_Shared95_Provider4 GetICommon_Shared95_Provider4() => _iCommon_Shared95_Provider4;
        public IReporting_Events483_Validator GetIReporting_Events483_Validator() => _iReporting_Events483_Validator;
