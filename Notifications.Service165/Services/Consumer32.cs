...
namespace Notifications.Service165
{
    ...
    public class Consumer32
    {
        ...
        private readonly Notifications_Processors_Processor6 _notifications_Processors_Processor6;
        private readonly Workflow_Api433_Processor6 _workflow_Api433_Processor6;
        private readonly ICommon_Shared95_Provider4 _iCommon_Shared95_Provider4;
        private readonly ICommon_Shared95_Service5 _iCommon_Shared95_Service5;
        private readonly Workflow_Processors_Options3 _workflow_Processors_Options3;
        private readonly Workflow_Processors_Controller5 _workflow_Processors_Controller5;
        private readonly Workflow_Processors_Controller6 _workflow_Processors_Controller6;

        public Consumer32(Auth_Processors_Controller4 auth_Processors_Controller4, Notifications_Processors_Processor6 notifications_Processors_Processor6, Workflow_Api433_Processor6 workflow_Api433_Processor6, ICommon_Shared95_Provider4 iCommon_Shared95_Provider4, ICommon_Shared95_Service5 iCommon_Shared95_Service5, Workflow_Processors_Options3 workflow_Processors_Options3, Workflow_Processors_Controller5 workflow_Processors_Controller5, Workflow_Processors_Controller6 workflow_Processors_Controller6)
        {
            ...
            _notifications_Processors_Processor6 = notifications_Processors_Processor6 ?? throw new ArgumentNullException(nameof(notifications_Processors_Processor6));
            _workflow_Api433_Processor6 = workflow_Api433_Processor6 ?? throw new ArgumentNullException(nameof(workflow_Api433_Processor6));
            _iCommon_Shared95_Provider4 = iCommon_Shared95_Provider4 ?? throw new ArgumentNullException(nameof(iCommon_Shared95_Provider4));
            _iCommon_Shared95_Service5 = iCommon_Shared95_Service5 ?? throw new ArgumentNullException(nameof(iCommon_Shared95_Service5));
            ...
            _workflow_Processors_Controller5 = workflow_Processors_Controller5 ?? throw new ArgumentNullException(nameof(workflow_Processors_Controller5));
            _workflow_Processors_Controller6 = workflow_Processors_Controller6 ?? throw new ArgumentNullException(nameof(workflow_Processors_Controller6));
        }

        public Auth_Processors_Controller4 GetAuth_Processors_Controller4() => _auth_Processors_Controller4;
        public Notifications_Processors_Processor6 GetNotifications_Processors_Processor6() => _notifications_Processors_Processor6;
        public Workflow_Api433_Processor6 GetWorkflow_Api433_Processor6() => _workflow_Api433_Processor6;
        public ICommon_Shared95_Provider4 GetICommon_Shared95_Provider4() => _iCommon_Shared95_Provider4;
        public ICommon_Shared95_Service5 GetICommon_Shared95_Service5() => _iCommon_Shared95_Service5;
        public Workflow_Processors_Options3 GetWorkflow_Processors_Options3() => _workflow_Processors_Options3;
        public Workflow_Processors_Controller5 GetWorkflow_Processors_Controller5() => _workflow_Processors_Controller5;
        public Workflow_Processors_Controller6 GetWorkflow_Processors_Controller6() => _workflow_Processors_Controller6;
