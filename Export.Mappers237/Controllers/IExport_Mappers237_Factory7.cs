...
{
    public interface IExport_Mappers237_Factory7
    {
        /// <summary>Processes the Export_Mappers237_Factory7 operation.</summary>
        void ProcessExport_Mappers237_Factory7();

        /// <summary>Validates the Export_Mappers237_Factory7 state.</summary>
        bool ValidateExport_Mappers237_Factory7();
    }
