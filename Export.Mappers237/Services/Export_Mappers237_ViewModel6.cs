...
{
    /// <summary>Immutable data transfer record for Export_Mappers237_ViewModel6.</summary>
    public record Export_Mappers237_ViewModel6(string Value, int Count, DateTime Timestamp);
