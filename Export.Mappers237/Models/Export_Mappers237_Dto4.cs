...
{
    /// <summary>Immutable data transfer record for Export_Mappers237_Dto4.</summary>
    internal record Export_Mappers237_Dto4(string Value, int Count, DateTime Timestamp);
