...
{
    public interface IExport_Mappers237_Provider13
    {
        /// <summary>Processes the Export_Mappers237_Provider13 operation.</summary>
        void ProcessExport_Mappers237_Provider13();

        /// <summary>Validates the Export_Mappers237_Provider13 state.</summary>
        bool ValidateExport_Mappers237_Provider13();
    }
