...
{
    public interface IExport_Mappers237_Service1
    {
        /// <summary>Processes the Export_Mappers237_Service1 operation.</summary>
        void ProcessExport_Mappers237_Service1();

        /// <summary>Validates the Export_Mappers237_Service1 state.</summary>
        bool ValidateExport_Mappers237_Service1();
    }
