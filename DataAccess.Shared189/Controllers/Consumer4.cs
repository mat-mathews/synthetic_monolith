...
namespace DataAccess.Shared189
{
    ...
    public class Consumer4
    {
        ...
        private readonly Billing_Contracts44_Builder3 _billing_Contracts44_Builder3;
        private readonly Billing_Contracts44_Command _billing_Contracts44_Command;
        private readonly Billing_Contracts44_Response2 _billing_Contracts44_Response2;
        private readonly Admin_Api255_Handler4 _admin_Api255_Handler4;
        private readonly Integration_Handlers17_Helper11 _integration_Handlers17_Helper11;
        private readonly Integration_Handlers17_Builder12 _integration_Handlers17_Builder12;

        public Consumer4(Auth_Models236_Service4 auth_Models236_Service4, Auth_Models236_Handler2 auth_Models236_Handler2, Billing_Contracts44_Builder3 billing_Contracts44_Builder3, Billing_Contracts44_Command billing_Contracts44_Command, Billing_Contracts44_Response2 billing_Contracts44_Response2, Admin_Api255_Handler4 admin_Api255_Handler4, Integration_Handlers17_Helper11 integration_Handlers17_Helper11, Integration_Handlers17_Builder12 integration_Handlers17_Builder12)
        {
            ...
            _billing_Contracts44_Builder3 = billing_Contracts44_Builder3 ?? throw new ArgumentNullException(nameof(billing_Contracts44_Builder3));
            _billing_Contracts44_Command = billing_Contracts44_Command ?? throw new ArgumentNullException(nameof(billing_Contracts44_Command));
            _billing_Contracts44_Response2 = billing_Contracts44_Response2 ?? throw new ArgumentNullException(nameof(billing_Contracts44_Response2));
            _admin_Api255_Handler4 = admin_Api255_Handler4 ?? throw new ArgumentNullException(nameof(admin_Api255_Handler4));
            _integration_Handlers17_Helper11 = integration_Handlers17_Helper11 ?? throw new ArgumentNullException(nameof(integration_Handlers17_Helper11));
            _integration_Handlers17_Builder12 = integration_Handlers17_Builder12 ?? throw new ArgumentNullException(nameof(integration_Handlers17_Builder12));
        }
        ...
        public Billing_Contracts44_Builder3 GetBilling_Contracts44_Builder3() => _billing_Contracts44_Builder3;
        public Billing_Contracts44_Command GetBilling_Contracts44_Command() => _billing_Contracts44_Command;
        public Billing_Contracts44_Response2 GetBilling_Contracts44_Response2() => _billing_Contracts44_Response2;
        public Admin_Api255_Handler4 GetAdmin_Api255_Handler4() => _admin_Api255_Handler4;
        public Integration_Handlers17_Helper11 GetIntegration_Handlers17_Helper11() => _integration_Handlers17_Helper11;
        public Integration_Handlers17_Builder12 GetIntegration_Handlers17_Builder12() => _integration_Handlers17_Builder12;
