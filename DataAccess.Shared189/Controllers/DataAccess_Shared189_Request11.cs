...
{
    /// <summary>Immutable data transfer record for DataAccess_Shared189_Request11.</summary>
    public record DataAccess_Shared189_Request11(string Value, int Count, DateTime Timestamp);
