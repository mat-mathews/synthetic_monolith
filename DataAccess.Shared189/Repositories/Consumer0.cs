...
namespace DataAccess.Shared189
{
    ...
    public class Consumer0
    {
        ...
        private readonly IIntegration_Handlers17_Validator4 _iIntegration_Handlers17_Validator4;
        private readonly Integration_Handlers17_Repository3 _integration_Handlers17_Repository3;

        public Consumer0(Admin_Client177_Service12 admin_Client177_Service12, Auth_Models236_Processor1 auth_Models236_Processor1, Billing_Contracts44_Handler5 billing_Contracts44_Handler5, Billing_Contracts44_Handler1 billing_Contracts44_Handler1, Admin_Api255_ViewModel1 admin_Api255_ViewModel1, Admin_Api255_Controller3 admin_Api255_Controller3, IIntegration_Handlers17_Validator4 iIntegration_Handlers17_Validator4, Integration_Handlers17_Repository3 integration_Handlers17_Repository3)
        {
            ...
            _iIntegration_Handlers17_Validator4 = iIntegration_Handlers17_Validator4 ?? throw new ArgumentNullException(nameof(iIntegration_Handlers17_Validator4));
        ...
        public IIntegration_Handlers17_Validator4 GetIIntegration_Handlers17_Validator4() => _iIntegration_Handlers17_Validator4;
