...
{
    /// <summary>Immutable data transfer record for Imaging_Web_ViewModel1.</summary>
    internal record Imaging_Web_ViewModel1(string Value, int Count, DateTime Timestamp);
