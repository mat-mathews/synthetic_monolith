...
{
    /// <summary>Immutable data transfer record for Logging_Handlers455_Event5.</summary>
    public record Logging_Handlers455_Event5(string Value, int Count, DateTime Timestamp);
