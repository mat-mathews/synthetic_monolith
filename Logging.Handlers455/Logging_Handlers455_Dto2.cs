...
{
    /// <summary>Immutable data transfer record for Logging_Handlers455_Dto2.</summary>
    internal record Logging_Handlers455_Dto2(string Value, int Count, DateTime Timestamp);
