...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Contracts_Response7.</summary>
    internal record GalaxyWorks_Contracts_Response7(string Value, int Count, DateTime Timestamp);
