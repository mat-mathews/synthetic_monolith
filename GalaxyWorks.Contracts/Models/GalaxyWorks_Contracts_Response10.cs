...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Contracts_Response10.</summary>
    internal record GalaxyWorks_Contracts_Response10(string Value, int Count, DateTime Timestamp);
