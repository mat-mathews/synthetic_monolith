...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Contracts_Command2.</summary>
    public record GalaxyWorks_Contracts_Command2(string Value, int Count, DateTime Timestamp);
