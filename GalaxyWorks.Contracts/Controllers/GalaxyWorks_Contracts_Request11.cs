...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Contracts_Request11.</summary>
    public record GalaxyWorks_Contracts_Request11(string Value, int Count, DateTime Timestamp);
