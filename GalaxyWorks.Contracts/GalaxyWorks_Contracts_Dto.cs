...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Contracts_Dto.</summary>
    public record GalaxyWorks_Contracts_Dto(string Value, int Count, DateTime Timestamp);
