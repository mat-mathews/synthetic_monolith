...
namespace GalaxyWorks.Tests
{
    ...
    public class Consumer28
    {
        ...
        private readonly Logging_Data_Response4 _logging_Data_Response4;
        private readonly ILogging_Data_Validator7 _iLogging_Data_Validator7;

        public Consumer28(Auth_Mappers208_Processor5 auth_Mappers208_Processor5, Admin_Events_Dto4 admin_Events_Dto4, Admin_Web4_Manager6 admin_Web4_Manager6, Admin_Web4_Repository admin_Web4_Repository, Import_Service291_Request3 import_Service291_Request3, Security_Models136_Manager1 security_Models136_Manager1, Logging_Data_Response4 logging_Data_Response4, ILogging_Data_Validator7 iLogging_Data_Validator7)
        {
            ...
            _logging_Data_Response4 = logging_Data_Response4 ?? throw new ArgumentNullException(nameof(logging_Data_Response4));
            _iLogging_Data_Validator7 = iLogging_Data_Validator7 ?? throw new ArgumentNullException(nameof(iLogging_Data_Validator7));
        }
        ...
        public Logging_Data_Response4 GetLogging_Data_Response4() => _logging_Data_Response4;
        public ILogging_Data_Validator7 GetILogging_Data_Validator7() => _iLogging_Data_Validator7;
