...
namespace GalaxyWorks.Contracts94
{
    public interface IGalaxyWorks_Contracts94_Handler8
    {
        /// <summary>Processes the GalaxyWorks_Contracts94_Handler8 operation.</summary>
        void ProcessGalaxyWorks_Contracts94_Handler8();

        /// <summary>Validates the GalaxyWorks_Contracts94_Handler8 state.</summary>
        bool ValidateGalaxyWorks_Contracts94_Handler8();
    }
