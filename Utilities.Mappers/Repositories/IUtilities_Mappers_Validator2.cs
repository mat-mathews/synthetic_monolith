...
{
    internal interface IUtilities_Mappers_Validator2
    {
        /// <summary>Processes the Utilities_Mappers_Validator2 operation.</summary>
        void ProcessUtilities_Mappers_Validator2();

        /// <summary>Validates the Utilities_Mappers_Validator2 state.</summary>
        bool ValidateUtilities_Mappers_Validator2();
    }
