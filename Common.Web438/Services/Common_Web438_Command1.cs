...
{
    /// <summary>Immutable data transfer record for Common_Web438_Command1.</summary>
    public record Common_Web438_Command1(string Value, int Count, DateTime Timestamp);
