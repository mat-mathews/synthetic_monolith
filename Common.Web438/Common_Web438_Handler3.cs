...
{
    public abstract class Common_Web438_Handler3
    {
        private readonly string _sql = "SELECT * FROM Users WHERE Id = @Id";
        public void Execute()
        {
            // Common_Web438_Handler3 implementation
        }
...
public int Config29SortOrder { get; set; }
    ...
    public class Web438Context : DbContext
    {
        public DbSet<Common_Web438_Handler3> Common_Web438_Handler3s { get; set; }
    }
