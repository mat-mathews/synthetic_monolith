...
{
    /// <summary>Immutable data transfer record for Logging_Handlers_Event6.</summary>
    internal record Logging_Handlers_Event6(string Value, int Count, DateTime Timestamp);
