...
namespace Security.Tests223
{
    ...
    public class Consumer10
    {
        ...
        private readonly Admin_Events306_Event4 _admin_Events306_Event4;
        private readonly Admin_Web4_Event3 _admin_Web4_Event3;
        private readonly Admin_Web4_Controller5 _admin_Web4_Controller5;
        private readonly Security_Mappers_Processor7 _security_Mappers_Processor7;
        private readonly IDocuments_Contracts_Validator9 _iDocuments_Contracts_Validator9;
        private readonly IReporting_Contracts_Factory10 _iReporting_Contracts_Factory10;
        private readonly Common_Mappers_Builder _common_Mappers_Builder;

        public Consumer10(IAdmin_Models_Validator1 iAdmin_Models_Validator1, Admin_Events306_Event4 admin_Events306_Event4, Admin_Web4_Event3 admin_Web4_Event3, Admin_Web4_Controller5 admin_Web4_Controller5, Security_Mappers_Processor7 security_Mappers_Processor7, IDocuments_Contracts_Validator9 iDocuments_Contracts_Validator9, IReporting_Contracts_Factory10 iReporting_Contracts_Factory10, Common_Mappers_Builder common_Mappers_Builder)
        {
            _iAdmin_Models_Validator1 = iAdmin_Models_Validator1 ?? throw new ArgumentNullException(nameof(iAdmin_Models_Validator1));
            _admin_Events306_Event4 = admin_Events306_Event4 ?? throw new ArgumentNullException(nameof(admin_Events306_Event4));
            _admin_Web4_Event3 = admin_Web4_Event3 ?? throw new ArgumentNullException(nameof(admin_Web4_Event3));
            _admin_Web4_Controller5 = admin_Web4_Controller5 ?? throw new ArgumentNullException(nameof(admin_Web4_Controller5));
            _security_Mappers_Processor7 = security_Mappers_Processor7 ?? throw new ArgumentNullException(nameof(security_Mappers_Processor7));
            _iDocuments_Contracts_Validator9 = iDocuments_Contracts_Validator9 ?? throw new ArgumentNullException(nameof(iDocuments_Contracts_Validator9));
            _iReporting_Contracts_Factory10 = iReporting_Contracts_Factory10 ?? throw new ArgumentNullException(nameof(iReporting_Contracts_Factory10));
            _common_Mappers_Builder = common_Mappers_Builder ?? throw new ArgumentNullException(nameof(common_Mappers_Builder));
        }

        public IAdmin_Models_Validator1 GetIAdmin_Models_Validator1() => _iAdmin_Models_Validator1;
        public Admin_Events306_Event4 GetAdmin_Events306_Event4() => _admin_Events306_Event4;
        public Admin_Web4_Event3 GetAdmin_Web4_Event3() => _admin_Web4_Event3;
        public Admin_Web4_Controller5 GetAdmin_Web4_Controller5() => _admin_Web4_Controller5;
        public Security_Mappers_Processor7 GetSecurity_Mappers_Processor7() => _security_Mappers_Processor7;
        public IDocuments_Contracts_Validator9 GetIDocuments_Contracts_Validator9() => _iDocuments_Contracts_Validator9;
        public IReporting_Contracts_Factory10 GetIReporting_Contracts_Factory10() => _iReporting_Contracts_Factory10;
        public Common_Mappers_Builder GetCommon_Mappers_Builder() => _common_Mappers_Builder;
