...
{
    public abstract class Security_Tests223_Service10
    {
        private readonly string _sql = "SELECT * FROM Schedules WHERE Id = @Id";
        public void Execute()
        {
            // Security_Tests223_Service10 implementation
        }
...
public int Detail86SortOrder { get; set; }
    ...
    {
        public DbSet<Security_Tests223_Service10> Security_Tests223_Service10s { get; set; }
    }
