...
{
    internal class Notifications_Models466_Controller1
    {
        private readonly string _sql = "SELECT * FROM Invoices WHERE Id = @Id";
        public void Execute()
        {
            // Notifications_Models466_Controller1 implementation
        }
...
public int Entry53SortOrder { get; set; }
    ...
    public class Models466Context : DbContext
    {
        public DbSet<Notifications_Models466_Controller1> Notifications_Models466_Controller1s { get; set; }
    }
