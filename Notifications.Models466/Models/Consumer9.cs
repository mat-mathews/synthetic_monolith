...
namespace Notifications.Models466
{
    ...
    public class Consumer9
    {
        ...
        private readonly Security_Client_Command7 _security_Client_Command7;
        private readonly Common_Events280_Handler13 _common_Events280_Handler13;
        private readonly Common_Events280_Dto5 _common_Events280_Dto5;
        private readonly Common_Events280_Provider _common_Events280_Provider;
        ...
        public Consumer9(Auth_Events_Manager2 auth_Events_Manager2, Auth_Events_Builder1 auth_Events_Builder1, Security_Client_Command7 security_Client_Command7, Common_Events280_Handler13 common_Events280_Handler13, Common_Events280_Dto5 common_Events280_Dto5, Common_Events280_Provider common_Events280_Provider, IBilling_Mappers_Validator1 iBilling_Mappers_Validator1, Billing_Mappers_Provider6 billing_Mappers_Provider6)
        {
            ...
            _security_Client_Command7 = security_Client_Command7 ?? throw new ArgumentNullException(nameof(security_Client_Command7));
            _common_Events280_Handler13 = common_Events280_Handler13 ?? throw new ArgumentNullException(nameof(common_Events280_Handler13));
            _common_Events280_Dto5 = common_Events280_Dto5 ?? throw new ArgumentNullException(nameof(common_Events280_Dto5));
            _common_Events280_Provider = common_Events280_Provider ?? throw new ArgumentNullException(nameof(common_Events280_Provider));
        ...
        public Security_Client_Command7 GetSecurity_Client_Command7() => _security_Client_Command7;
        public Common_Events280_Handler13 GetCommon_Events280_Handler13() => _common_Events280_Handler13;
        public Common_Events280_Dto5 GetCommon_Events280_Dto5() => _common_Events280_Dto5;
        public Common_Events280_Provider GetCommon_Events280_Provider() => _common_Events280_Provider;
