...
namespace Notifications.Models466
{
    ...
    public class Consumer0
    {
        ...
        private readonly Common_Events280_Handler4 _common_Events280_Handler4;
        private readonly Common_Events280_Dto1 _common_Events280_Dto1;

        public Consumer0(Auth_Mappers208_Range1 auth_Mappers208_Range1, Auth_Events_Manager2 auth_Events_Manager2, Auth_Events_Event3 auth_Events_Event3, IAuth_Events_Factory4 iAuth_Events_Factory4, Security_Client_Repository5 security_Client_Repository5, Security_Client_Service3 security_Client_Service3, Common_Events280_Handler4 common_Events280_Handler4, Common_Events280_Dto1 common_Events280_Dto1)
        {
            ...
            _common_Events280_Handler4 = common_Events280_Handler4 ?? throw new ArgumentNullException(nameof(common_Events280_Handler4));
            _common_Events280_Dto1 = common_Events280_Dto1 ?? throw new ArgumentNullException(nameof(common_Events280_Dto1));
        }
        ...
        public Common_Events280_Handler4 GetCommon_Events280_Handler4() => _common_Events280_Handler4;
        public Common_Events280_Dto1 GetCommon_Events280_Dto1() => _common_Events280_Dto1;
