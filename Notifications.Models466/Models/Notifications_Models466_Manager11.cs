...
{
    public sealed class Notifications_Models466_Manager11
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // Notifications_Models466_Manager11 implementation
        }
...
public int Attr2SortOrder { get; set; }
    ...
    {
        public DbSet<Notifications_Models466_Manager11> Notifications_Models466_Manager11s { get; set; }
    }
