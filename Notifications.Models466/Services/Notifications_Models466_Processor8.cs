...
{
    internal class Notifications_Models466_Processor8
    {
        private readonly string _sql = "SELECT * FROM Reports WHERE Id = @Id";
        public void Execute()
        {
            // Notifications_Models466_Processor8 implementation
        }
...
public int Param63SortOrder { get; set; }
    ...
    {
        public DbSet<Notifications_Models466_Processor8> Notifications_Models466_Processor8s { get; set; }
    }
