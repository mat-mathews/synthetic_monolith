...
namespace Notifications.Models466
{
    ...
    public class Consumer19
    {
        ...
        private readonly Common_Events280_Helper12 _common_Events280_Helper12;

        public Consumer19(Auth_Mappers208_Processor5 auth_Mappers208_Processor5, Auth_Mappers208_Processor2 auth_Mappers208_Processor2, Auth_Mappers208_Range1 auth_Mappers208_Range1, Auth_Events_Manager2 auth_Events_Manager2, Auth_Events_Factory5 auth_Events_Factory5, Security_Client_Provider6 security_Client_Provider6, Security_Client_Repository5 security_Client_Repository5, Common_Events280_Helper12 common_Events280_Helper12)
        {
            ...
            _common_Events280_Helper12 = common_Events280_Helper12 ?? throw new ArgumentNullException(nameof(common_Events280_Helper12));
        }
        ...
        public Common_Events280_Helper12 GetCommon_Events280_Helper12() => _common_Events280_Helper12;
