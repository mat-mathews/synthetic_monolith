...
namespace Notifications.Models466
{
    ...
    public class Consumer18
    {
        ...
        private readonly Common_Events280_Repository3 _common_Events280_Repository3;
        private readonly Common_Events280_Controller2 _common_Events280_Controller2;
        private readonly ICommon_Events280_Provider9 _iCommon_Events280_Provider9;
        private readonly Billing_Mappers_Options2 _billing_Mappers_Options2;

        public Consumer18(Auth_Events_Processor auth_Events_Processor, Security_Client_Command7 security_Client_Command7, Security_Client_Key security_Client_Key, ISecurity_Client_Service2 iSecurity_Client_Service2, Common_Events280_Repository3 common_Events280_Repository3, Common_Events280_Controller2 common_Events280_Controller2, ICommon_Events280_Provider9 iCommon_Events280_Provider9, Billing_Mappers_Options2 billing_Mappers_Options2)
        {
            ...
            _common_Events280_Repository3 = common_Events280_Repository3 ?? throw new ArgumentNullException(nameof(common_Events280_Repository3));
            _common_Events280_Controller2 = common_Events280_Controller2 ?? throw new ArgumentNullException(nameof(common_Events280_Controller2));
            _iCommon_Events280_Provider9 = iCommon_Events280_Provider9 ?? throw new ArgumentNullException(nameof(iCommon_Events280_Provider9));
        ...
        public Common_Events280_Repository3 GetCommon_Events280_Repository3() => _common_Events280_Repository3;
        public Common_Events280_Controller2 GetCommon_Events280_Controller2() => _common_Events280_Controller2;
        public ICommon_Events280_Provider9 GetICommon_Events280_Provider9() => _iCommon_Events280_Provider9;
