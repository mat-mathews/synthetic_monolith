...
namespace Notifications.Models466
{
    ...
    public class Consumer25
    {
        ...
        private readonly Common_Events280_Provider10 _common_Events280_Provider10;
        private readonly Billing_Mappers_Processor _billing_Mappers_Processor;

        public Consumer25(Auth_Mappers208_Processor5 auth_Mappers208_Processor5, Auth_Events_Factory5 auth_Events_Factory5, Auth_Events_Manager2 auth_Events_Manager2, Security_Client_Provider6 security_Client_Provider6, Security_Client_Repository5 security_Client_Repository5, Common_Events280_Controller2 common_Events280_Controller2, Common_Events280_Provider10 common_Events280_Provider10, Billing_Mappers_Processor billing_Mappers_Processor)
        {
            ...
            _common_Events280_Provider10 = common_Events280_Provider10 ?? throw new ArgumentNullException(nameof(common_Events280_Provider10));
        ...
        public Common_Events280_Provider10 GetCommon_Events280_Provider10() => _common_Events280_Provider10;
