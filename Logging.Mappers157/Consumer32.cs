...
namespace Logging.Mappers157
{
    ...
    public class Consumer32
    {
        ...
        private readonly Export_Data6_Builder2 _export_Data6_Builder2;
        private readonly BatchJobs_Web_Key7 _batchJobs_Web_Key7;
        private readonly BatchJobs_Web_Repository2 _batchJobs_Web_Repository2;
        private readonly IWorkflow_Contracts_Repository2 _iWorkflow_Contracts_Repository2;
        private readonly Common_Web488_Manager9 _common_Web488_Manager9;
        private readonly ICommon_Web488_Repository6 _iCommon_Web488_Repository6;

        public Consumer32(Admin_Web154_Manager11 admin_Web154_Manager11, Admin_Shared363_Response4 admin_Shared363_Response4, Export_Data6_Builder2 export_Data6_Builder2, BatchJobs_Web_Key7 batchJobs_Web_Key7, BatchJobs_Web_Repository2 batchJobs_Web_Repository2, IWorkflow_Contracts_Repository2 iWorkflow_Contracts_Repository2, Common_Web488_Manager9 common_Web488_Manager9, ICommon_Web488_Repository6 iCommon_Web488_Repository6)
        {
            ...
            _export_Data6_Builder2 = export_Data6_Builder2 ?? throw new ArgumentNullException(nameof(export_Data6_Builder2));
            _batchJobs_Web_Key7 = batchJobs_Web_Key7 ?? throw new ArgumentNullException(nameof(batchJobs_Web_Key7));
            _batchJobs_Web_Repository2 = batchJobs_Web_Repository2 ?? throw new ArgumentNullException(nameof(batchJobs_Web_Repository2));
            _iWorkflow_Contracts_Repository2 = iWorkflow_Contracts_Repository2 ?? throw new ArgumentNullException(nameof(iWorkflow_Contracts_Repository2));
            _common_Web488_Manager9 = common_Web488_Manager9 ?? throw new ArgumentNullException(nameof(common_Web488_Manager9));
            _iCommon_Web488_Repository6 = iCommon_Web488_Repository6 ?? throw new ArgumentNullException(nameof(iCommon_Web488_Repository6));
        }
        ...
        public Export_Data6_Builder2 GetExport_Data6_Builder2() => _export_Data6_Builder2;
        public BatchJobs_Web_Key7 GetBatchJobs_Web_Key7() => _batchJobs_Web_Key7;
        public BatchJobs_Web_Repository2 GetBatchJobs_Web_Repository2() => _batchJobs_Web_Repository2;
        public IWorkflow_Contracts_Repository2 GetIWorkflow_Contracts_Repository2() => _iWorkflow_Contracts_Repository2;
        public Common_Web488_Manager9 GetCommon_Web488_Manager9() => _common_Web488_Manager9;
        public ICommon_Web488_Repository6 GetICommon_Web488_Repository6() => _iCommon_Web488_Repository6;
