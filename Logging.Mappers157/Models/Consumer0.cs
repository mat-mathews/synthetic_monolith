...
namespace Logging.Mappers157
{
    ...
    public class Consumer0
    {
        ...
        private readonly IExport_Data6_Validator12 _iExport_Data6_Validator12;
        private readonly Export_Data6_Response5 _export_Data6_Response5;
        private readonly BatchJobs_Web_Point6 _batchJobs_Web_Point6;
        private readonly Workflow_Contracts_Service6 _workflow_Contracts_Service6;
        private readonly IWorkflow_Contracts_Factory5 _iWorkflow_Contracts_Factory5;
        private readonly Workflow_Contracts_Processor3 _workflow_Contracts_Processor3;
        private readonly Common_Web488_Repository2 _common_Web488_Repository2;

        public Consumer0(Admin_Web154_Request1 admin_Web154_Request1, IExport_Data6_Validator12 iExport_Data6_Validator12, Export_Data6_Response5 export_Data6_Response5, BatchJobs_Web_Point6 batchJobs_Web_Point6, Workflow_Contracts_Service6 workflow_Contracts_Service6, IWorkflow_Contracts_Factory5 iWorkflow_Contracts_Factory5, Workflow_Contracts_Processor3 workflow_Contracts_Processor3, Common_Web488_Repository2 common_Web488_Repository2)
        {
            _admin_Web154_Request1 = admin_Web154_Request1 ?? throw new ArgumentNullException(nameof(admin_Web154_Request1));
            _iExport_Data6_Validator12 = iExport_Data6_Validator12 ?? throw new ArgumentNullException(nameof(iExport_Data6_Validator12));
            _export_Data6_Response5 = export_Data6_Response5 ?? throw new ArgumentNullException(nameof(export_Data6_Response5));
            _batchJobs_Web_Point6 = batchJobs_Web_Point6 ?? throw new ArgumentNullException(nameof(batchJobs_Web_Point6));
            _workflow_Contracts_Service6 = workflow_Contracts_Service6 ?? throw new ArgumentNullException(nameof(workflow_Contracts_Service6));
            _iWorkflow_Contracts_Factory5 = iWorkflow_Contracts_Factory5 ?? throw new ArgumentNullException(nameof(iWorkflow_Contracts_Factory5));
            _workflow_Contracts_Processor3 = workflow_Contracts_Processor3 ?? throw new ArgumentNullException(nameof(workflow_Contracts_Processor3));
            _common_Web488_Repository2 = common_Web488_Repository2 ?? throw new ArgumentNullException(nameof(common_Web488_Repository2));
        }

        public Admin_Web154_Request1 GetAdmin_Web154_Request1() => _admin_Web154_Request1;
        public IExport_Data6_Validator12 GetIExport_Data6_Validator12() => _iExport_Data6_Validator12;
        public Export_Data6_Response5 GetExport_Data6_Response5() => _export_Data6_Response5;
        public BatchJobs_Web_Point6 GetBatchJobs_Web_Point6() => _batchJobs_Web_Point6;
        public Workflow_Contracts_Service6 GetWorkflow_Contracts_Service6() => _workflow_Contracts_Service6;
        public IWorkflow_Contracts_Factory5 GetIWorkflow_Contracts_Factory5() => _iWorkflow_Contracts_Factory5;
        public Workflow_Contracts_Processor3 GetWorkflow_Contracts_Processor3() => _workflow_Contracts_Processor3;
        public Common_Web488_Repository2 GetCommon_Web488_Repository2() => _common_Web488_Repository2;
