...
namespace Billing.Mappers225
{
    ...
    public class Consumer30
    {
        ...
        private readonly Integration_Handlers_Response2 _integration_Handlers_Response2;
        private readonly IAdmin_Models199_Service2 _iAdmin_Models199_Service2;
        private readonly Utilities_Models41_Controller2 _utilities_Models41_Controller2;
        private readonly Notifications_Validators_Provider5 _notifications_Validators_Provider5;
        private readonly Scheduling_Core_Helper7 _scheduling_Core_Helper7;
        private readonly Reporting_Api393_Repository5 _reporting_Api393_Repository5;
        private readonly Export_Events163_Repository14 _export_Events163_Repository14;

        public Consumer30(Integration_Handlers_Processor9 integration_Handlers_Processor9, Integration_Handlers_Response2 integration_Handlers_Response2, IAdmin_Models199_Service2 iAdmin_Models199_Service2, Utilities_Models41_Controller2 utilities_Models41_Controller2, Notifications_Validators_Provider5 notifications_Validators_Provider5, Scheduling_Core_Helper7 scheduling_Core_Helper7, Reporting_Api393_Repository5 reporting_Api393_Repository5, Export_Events163_Repository14 export_Events163_Repository14)
        {
            ...
            _integration_Handlers_Response2 = integration_Handlers_Response2 ?? throw new ArgumentNullException(nameof(integration_Handlers_Response2));
            _iAdmin_Models199_Service2 = iAdmin_Models199_Service2 ?? throw new ArgumentNullException(nameof(iAdmin_Models199_Service2));
            _utilities_Models41_Controller2 = utilities_Models41_Controller2 ?? throw new ArgumentNullException(nameof(utilities_Models41_Controller2));
            _notifications_Validators_Provider5 = notifications_Validators_Provider5 ?? throw new ArgumentNullException(nameof(notifications_Validators_Provider5));
            _scheduling_Core_Helper7 = scheduling_Core_Helper7 ?? throw new ArgumentNullException(nameof(scheduling_Core_Helper7));
            _reporting_Api393_Repository5 = reporting_Api393_Repository5 ?? throw new ArgumentNullException(nameof(reporting_Api393_Repository5));
            _export_Events163_Repository14 = export_Events163_Repository14 ?? throw new ArgumentNullException(nameof(export_Events163_Repository14));
        }

        public Integration_Handlers_Processor9 GetIntegration_Handlers_Processor9() => _integration_Handlers_Processor9;
        public Integration_Handlers_Response2 GetIntegration_Handlers_Response2() => _integration_Handlers_Response2;
        public IAdmin_Models199_Service2 GetIAdmin_Models199_Service2() => _iAdmin_Models199_Service2;
        public Utilities_Models41_Controller2 GetUtilities_Models41_Controller2() => _utilities_Models41_Controller2;
        public Notifications_Validators_Provider5 GetNotifications_Validators_Provider5() => _notifications_Validators_Provider5;
        public Scheduling_Core_Helper7 GetScheduling_Core_Helper7() => _scheduling_Core_Helper7;
        public Reporting_Api393_Repository5 GetReporting_Api393_Repository5() => _reporting_Api393_Repository5;
        public Export_Events163_Repository14 GetExport_Events163_Repository14() => _export_Events163_Repository14;
