...
{
    /// <summary>Immutable data transfer record for Integration_Handlers423_Command1.</summary>
    internal record Integration_Handlers423_Command1(string Value, int Count, DateTime Timestamp);
