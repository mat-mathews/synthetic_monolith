...
{
    /// <summary>Immutable data transfer record for Integration_Handlers423_Response6.</summary>
    internal record Integration_Handlers423_Response6(string Value, int Count, DateTime Timestamp);
