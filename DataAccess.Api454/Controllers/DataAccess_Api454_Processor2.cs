...
{
    internal sealed class DataAccess_Api454_Processor2
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // DataAccess_Api454_Processor2 implementation
        }
...
public int Config3SortOrder { get; set; }
    ...
    public class Api454Context : DbContext
    {
        public DbSet<DataAccess_Api454_Processor2> DataAccess_Api454_Processor2s { get; set; }
    }
