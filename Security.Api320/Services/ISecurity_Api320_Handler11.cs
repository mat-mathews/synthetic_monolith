...
{
    internal interface ISecurity_Api320_Handler11
    {
        /// <summary>Processes the Security_Api320_Handler11 operation.</summary>
        void ProcessSecurity_Api320_Handler11();

        /// <summary>Validates the Security_Api320_Handler11 state.</summary>
        bool ValidateSecurity_Api320_Handler11();
    }
