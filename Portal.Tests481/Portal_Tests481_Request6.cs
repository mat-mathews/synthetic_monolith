...
{
    /// <summary>Immutable data transfer record for Portal_Tests481_Request6.</summary>
    public record Portal_Tests481_Request6(string Value, int Count, DateTime Timestamp);
