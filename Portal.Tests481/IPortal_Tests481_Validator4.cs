...
{
    internal interface IPortal_Tests481_Validator4
    {
        /// <summary>Processes the Portal_Tests481_Validator4 operation.</summary>
        void ProcessPortal_Tests481_Validator4();

        /// <summary>Validates the Portal_Tests481_Validator4 state.</summary>
        bool ValidatePortal_Tests481_Validator4();
    }
