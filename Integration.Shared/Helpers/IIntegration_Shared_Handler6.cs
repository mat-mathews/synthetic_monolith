...
{
    internal interface IIntegration_Shared_Handler6
    {
        /// <summary>Processes the Integration_Shared_Handler6 operation.</summary>
        void ProcessIntegration_Shared_Handler6();

        /// <summary>Validates the Integration_Shared_Handler6 state.</summary>
        bool ValidateIntegration_Shared_Handler6();
    }
