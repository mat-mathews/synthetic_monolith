...
namespace Auth.Validators
{
    ...
    {
        private readonly Common_Shared_Provider11 _common_Shared_Provider11;
        private readonly Common_Shared_Service10 _common_Shared_Service10;
        private readonly Notifications_Shared380_Service3 _notifications_Shared380_Service3;
        private readonly IWorkflow_Mappers370_Service10 _iWorkflow_Mappers370_Service10;
        private readonly Workflow_Mappers370_Provider _workflow_Mappers370_Provider;
        private readonly Workflow_Mappers370_Provider8 _workflow_Mappers370_Provider8;
        private readonly GalaxyWorks_Events_Range1 _galaxyWorks_Events_Range1;
        private readonly IUtilities_Events_Repository5 _iUtilities_Events_Repository5;

        public Consumer15(Common_Shared_Provider11 common_Shared_Provider11, Common_Shared_Service10 common_Shared_Service10, Notifications_Shared380_Service3 notifications_Shared380_Service3, IWorkflow_Mappers370_Service10 iWorkflow_Mappers370_Service10, Workflow_Mappers370_Provider workflow_Mappers370_Provider, Workflow_Mappers370_Provider8 workflow_Mappers370_Provider8, GalaxyWorks_Events_Range1 galaxyWorks_Events_Range1, IUtilities_Events_Repository5 iUtilities_Events_Repository5)
        {
            _common_Shared_Provider11 = common_Shared_Provider11 ?? throw new ArgumentNullException(nameof(common_Shared_Provider11));
            _common_Shared_Service10 = common_Shared_Service10 ?? throw new ArgumentNullException(nameof(common_Shared_Service10));
            ...
            _iWorkflow_Mappers370_Service10 = iWorkflow_Mappers370_Service10 ?? throw new ArgumentNullException(nameof(iWorkflow_Mappers370_Service10));
            _workflow_Mappers370_Provider = workflow_Mappers370_Provider ?? throw new ArgumentNullException(nameof(workflow_Mappers370_Provider));
            _workflow_Mappers370_Provider8 = workflow_Mappers370_Provider8 ?? throw new ArgumentNullException(nameof(workflow_Mappers370_Provider8));
            _galaxyWorks_Events_Range1 = galaxyWorks_Events_Range1 ?? throw new ArgumentNullException(nameof(galaxyWorks_Events_Range1));
            _iUtilities_Events_Repository5 = iUtilities_Events_Repository5 ?? throw new ArgumentNullException(nameof(iUtilities_Events_Repository5));
        }

        public Common_Shared_Provider11 GetCommon_Shared_Provider11() => _common_Shared_Provider11;
        public Common_Shared_Service10 GetCommon_Shared_Service10() => _common_Shared_Service10;
        public Notifications_Shared380_Service3 GetNotifications_Shared380_Service3() => _notifications_Shared380_Service3;
        public IWorkflow_Mappers370_Service10 GetIWorkflow_Mappers370_Service10() => _iWorkflow_Mappers370_Service10;
        public Workflow_Mappers370_Provider GetWorkflow_Mappers370_Provider() => _workflow_Mappers370_Provider;
        public Workflow_Mappers370_Provider8 GetWorkflow_Mappers370_Provider8() => _workflow_Mappers370_Provider8;
        public GalaxyWorks_Events_Range1 GetGalaxyWorks_Events_Range1() => _galaxyWorks_Events_Range1;
        public IUtilities_Events_Repository5 GetIUtilities_Events_Repository5() => _iUtilities_Events_Repository5;
