...
{
    /// <summary>Immutable data transfer record for Auth_Validators_Response6.</summary>
    public record Auth_Validators_Response6(string Value, int Count, DateTime Timestamp);
