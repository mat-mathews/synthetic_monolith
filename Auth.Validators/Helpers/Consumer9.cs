...
namespace Auth.Validators
{
    ...
    public class Consumer9
    {
        ...
        private readonly ICommon_Shared_Provider8 _iCommon_Shared_Provider8;
        private readonly Notifications_Shared380_Key1 _notifications_Shared380_Key1;
        private readonly Notifications_Shared380_Controller4 _notifications_Shared380_Controller4;
        private readonly Workflow_Mappers370_Controller9 _workflow_Mappers370_Controller9;
        private readonly GalaxyWorks_Events_ViewModel9 _galaxyWorks_Events_ViewModel9;
        private readonly GalaxyWorks_Events_Dto2 _galaxyWorks_Events_Dto2;
        private readonly GalaxyWorks_Events_Manager7 _galaxyWorks_Events_Manager7;

        public Consumer9(Admin_Validators37_Service admin_Validators37_Service, ICommon_Shared_Provider8 iCommon_Shared_Provider8, Notifications_Shared380_Key1 notifications_Shared380_Key1, Notifications_Shared380_Controller4 notifications_Shared380_Controller4, Workflow_Mappers370_Controller9 workflow_Mappers370_Controller9, GalaxyWorks_Events_ViewModel9 galaxyWorks_Events_ViewModel9, GalaxyWorks_Events_Dto2 galaxyWorks_Events_Dto2, GalaxyWorks_Events_Manager7 galaxyWorks_Events_Manager7)
        {
            _admin_Validators37_Service = admin_Validators37_Service ?? throw new ArgumentNullException(nameof(admin_Validators37_Service));
            _iCommon_Shared_Provider8 = iCommon_Shared_Provider8 ?? throw new ArgumentNullException(nameof(iCommon_Shared_Provider8));
            _notifications_Shared380_Key1 = notifications_Shared380_Key1 ?? throw new ArgumentNullException(nameof(notifications_Shared380_Key1));
            ...
            _workflow_Mappers370_Controller9 = workflow_Mappers370_Controller9 ?? throw new ArgumentNullException(nameof(workflow_Mappers370_Controller9));
            _galaxyWorks_Events_ViewModel9 = galaxyWorks_Events_ViewModel9 ?? throw new ArgumentNullException(nameof(galaxyWorks_Events_ViewModel9));
            _galaxyWorks_Events_Dto2 = galaxyWorks_Events_Dto2 ?? throw new ArgumentNullException(nameof(galaxyWorks_Events_Dto2));
            _galaxyWorks_Events_Manager7 = galaxyWorks_Events_Manager7 ?? throw new ArgumentNullException(nameof(galaxyWorks_Events_Manager7));
        }

        public Admin_Validators37_Service GetAdmin_Validators37_Service() => _admin_Validators37_Service;
        public ICommon_Shared_Provider8 GetICommon_Shared_Provider8() => _iCommon_Shared_Provider8;
        public Notifications_Shared380_Key1 GetNotifications_Shared380_Key1() => _notifications_Shared380_Key1;
        public Notifications_Shared380_Controller4 GetNotifications_Shared380_Controller4() => _notifications_Shared380_Controller4;
        public Workflow_Mappers370_Controller9 GetWorkflow_Mappers370_Controller9() => _workflow_Mappers370_Controller9;
        public GalaxyWorks_Events_ViewModel9 GetGalaxyWorks_Events_ViewModel9() => _galaxyWorks_Events_ViewModel9;
        public GalaxyWorks_Events_Dto2 GetGalaxyWorks_Events_Dto2() => _galaxyWorks_Events_Dto2;
        public GalaxyWorks_Events_Manager7 GetGalaxyWorks_Events_Manager7() => _galaxyWorks_Events_Manager7;
