...
{
    /// <summary>Immutable data transfer record for Auth_Validators_Response8.</summary>
    internal record Auth_Validators_Response8(string Value, int Count, DateTime Timestamp);
