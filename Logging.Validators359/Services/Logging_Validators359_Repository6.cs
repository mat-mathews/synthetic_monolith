...
{
    internal abstract class Logging_Validators359_Repository6
    {
        private readonly string _sql = "SELECT * FROM Configurations WHERE Id = @Id";
        public void Execute()
        {
            // Logging_Validators359_Repository6 implementation
        }
...
public int Item44SortOrder { get; set; }
    ...
    public class Validators359Context : DbContext
    {
        public DbSet<Logging_Validators359_Repository6> Logging_Validators359_Repository6s { get; set; }
    }
