...
namespace Billing.Mappers
{
    ...
    public class Consumer30
    {
        ...
        private readonly Notifications_Events42_Handler3 _notifications_Events42_Handler3;

        public Consumer30(Auth_Contracts395_Point4 auth_Contracts395_Point4, Admin_Models199_Provider3 admin_Models199_Provider3, DataAccess_Data36_Repository3 dataAccess_Data36_Repository3, Utilities_Shared114_Result1 utilities_Shared114_Result1, Security_Models284_Helper4 security_Models284_Helper4, Security_Models284_Manager2 security_Models284_Manager2, Security_Models284_Handler9 security_Models284_Handler9, Notifications_Events42_Handler3 notifications_Events42_Handler3)
        {
            ...
            _notifications_Events42_Handler3 = notifications_Events42_Handler3 ?? throw new ArgumentNullException(nameof(notifications_Events42_Handler3));
        }
        ...
        public Notifications_Events42_Handler3 GetNotifications_Events42_Handler3() => _notifications_Events42_Handler3;
