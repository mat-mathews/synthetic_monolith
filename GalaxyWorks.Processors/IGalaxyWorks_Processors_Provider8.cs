...
{
    public interface IGalaxyWorks_Processors_Provider8
    {
        /// <summary>Processes the GalaxyWorks_Processors_Provider8 operation.</summary>
        void ProcessGalaxyWorks_Processors_Provider8();

        /// <summary>Validates the GalaxyWorks_Processors_Provider8 state.</summary>
        bool ValidateGalaxyWorks_Processors_Provider8();
    }
