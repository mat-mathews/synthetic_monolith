...
{
    internal interface IGalaxyWorks_Processors_Service5
    {
        /// <summary>Processes the GalaxyWorks_Processors_Service5 operation.</summary>
        void ProcessGalaxyWorks_Processors_Service5();

        /// <summary>Validates the GalaxyWorks_Processors_Service5 state.</summary>
        bool ValidateGalaxyWorks_Processors_Service5();
    }
