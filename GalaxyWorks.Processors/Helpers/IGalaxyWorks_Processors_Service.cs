...
{
    internal interface IGalaxyWorks_Processors_Service
    {
        /// <summary>Processes the GalaxyWorks_Processors_Service operation.</summary>
        void ProcessGalaxyWorks_Processors_Service();

        /// <summary>Validates the GalaxyWorks_Processors_Service state.</summary>
        bool ValidateGalaxyWorks_Processors_Service();
    }
