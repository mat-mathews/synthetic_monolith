...
{
    public interface IBatchJobs_Handlers_Service6
    {
        /// <summary>Processes the BatchJobs_Handlers_Service6 operation.</summary>
        void ProcessBatchJobs_Handlers_Service6();

        /// <summary>Validates the BatchJobs_Handlers_Service6 state.</summary>
        bool ValidateBatchJobs_Handlers_Service6();
    }
