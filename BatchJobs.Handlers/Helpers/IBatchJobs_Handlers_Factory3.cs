...
{
    public interface IBatchJobs_Handlers_Factory3
    {
        /// <summary>Processes the BatchJobs_Handlers_Factory3 operation.</summary>
        void ProcessBatchJobs_Handlers_Factory3();

        /// <summary>Validates the BatchJobs_Handlers_Factory3 state.</summary>
        bool ValidateBatchJobs_Handlers_Factory3();
    }
