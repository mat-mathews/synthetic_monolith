...
{
    internal interface IBatchJobs_Handlers_Service8
    {
        /// <summary>Processes the BatchJobs_Handlers_Service8 operation.</summary>
        void ProcessBatchJobs_Handlers_Service8();

        /// <summary>Validates the BatchJobs_Handlers_Service8 state.</summary>
        bool ValidateBatchJobs_Handlers_Service8();
    }
