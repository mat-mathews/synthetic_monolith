...
{
    internal interface IPortal_Web494_Handler1
    {
        /// <summary>Processes the Portal_Web494_Handler1 operation.</summary>
        void ProcessPortal_Web494_Handler1();

        /// <summary>Validates the Portal_Web494_Handler1 state.</summary>
        bool ValidatePortal_Web494_Handler1();
    }
