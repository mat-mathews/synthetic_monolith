...
{
    /// <summary>Immutable data transfer record for Portal_Web494_Response4.</summary>
    public record Portal_Web494_Response4(string Value, int Count, DateTime Timestamp);
