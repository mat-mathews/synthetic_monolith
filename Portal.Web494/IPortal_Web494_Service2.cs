...
{
    internal interface IPortal_Web494_Service2
    {
        /// <summary>Processes the Portal_Web494_Service2 operation.</summary>
        void ProcessPortal_Web494_Service2();

        /// <summary>Validates the Portal_Web494_Service2 state.</summary>
        bool ValidatePortal_Web494_Service2();
    }
