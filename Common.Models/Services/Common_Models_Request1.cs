...
{
    /// <summary>Immutable data transfer record for Common_Models_Request1.</summary>
    public record Common_Models_Request1(string Value, int Count, DateTime Timestamp);
