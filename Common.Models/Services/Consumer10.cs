...
namespace Common.Models
{
    ...
    public class Consumer10
    {
        ...
        private readonly Admin_Client_Handler9 _admin_Client_Handler9;
        private readonly Auth_Handlers_Service _auth_Handlers_Service;
        private readonly Security_Processors_Handler3 _security_Processors_Handler3;
        ...
        public Consumer10(Admin_Client_Response11 admin_Client_Response11, Admin_Client_Handler9 admin_Client_Handler9, Auth_Handlers_Service auth_Handlers_Service, Security_Processors_Handler3 security_Processors_Handler3, ISecurity_Processors_Repository7 iSecurity_Processors_Repository7, Security_Processors_Processor1 security_Processors_Processor1, Notifications_Mappers110_Processor4 notifications_Mappers110_Processor4, Notifications_Mappers110_Command10 notifications_Mappers110_Command10)
        {
            _admin_Client_Response11 = admin_Client_Response11 ?? throw new ArgumentNullException(nameof(admin_Client_Response11));
            _admin_Client_Handler9 = admin_Client_Handler9 ?? throw new ArgumentNullException(nameof(admin_Client_Handler9));
            _auth_Handlers_Service = auth_Handlers_Service ?? throw new ArgumentNullException(nameof(auth_Handlers_Service));
            _security_Processors_Handler3 = security_Processors_Handler3 ?? throw new ArgumentNullException(nameof(security_Processors_Handler3));
        ...
        public Admin_Client_Handler9 GetAdmin_Client_Handler9() => _admin_Client_Handler9;
        public Auth_Handlers_Service GetAuth_Handlers_Service() => _auth_Handlers_Service;
        public Security_Processors_Handler3 GetSecurity_Processors_Handler3() => _security_Processors_Handler3;
