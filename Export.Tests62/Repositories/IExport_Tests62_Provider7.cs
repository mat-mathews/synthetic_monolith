...
{
    public interface IExport_Tests62_Provider7
    {
        /// <summary>Processes the Export_Tests62_Provider7 operation.</summary>
        void ProcessExport_Tests62_Provider7();

        /// <summary>Validates the Export_Tests62_Provider7 state.</summary>
        bool ValidateExport_Tests62_Provider7();
    }
