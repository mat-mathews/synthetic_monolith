...
namespace Export.Tests62
{
    ...
    public class Consumer17
    {
        ...
        private readonly IBatchJobs_Events_Validator3 _iBatchJobs_Events_Validator3;
        private readonly IBatchJobs_Events_Service6 _iBatchJobs_Events_Service6;
        private readonly ICommon_Web438_Repository2 _iCommon_Web438_Repository2;
        private readonly Common_Web438_Command1 _common_Web438_Command1;
        private readonly Common_Web438_Point _common_Web438_Point;

        public Consumer17(Auth_Mappers178_Builder4 auth_Mappers178_Builder4, IAuth_Mappers178_Repository1 iAuth_Mappers178_Repository1, IAdmin_Web_Provider iAdmin_Web_Provider, IBatchJobs_Events_Validator3 iBatchJobs_Events_Validator3, IBatchJobs_Events_Service6 iBatchJobs_Events_Service6, ICommon_Web438_Repository2 iCommon_Web438_Repository2, Common_Web438_Command1 common_Web438_Command1, Common_Web438_Point common_Web438_Point)
        {
            ...
            _iBatchJobs_Events_Validator3 = iBatchJobs_Events_Validator3 ?? throw new ArgumentNullException(nameof(iBatchJobs_Events_Validator3));
            _iBatchJobs_Events_Service6 = iBatchJobs_Events_Service6 ?? throw new ArgumentNullException(nameof(iBatchJobs_Events_Service6));
            _iCommon_Web438_Repository2 = iCommon_Web438_Repository2 ?? throw new ArgumentNullException(nameof(iCommon_Web438_Repository2));
            _common_Web438_Command1 = common_Web438_Command1 ?? throw new ArgumentNullException(nameof(common_Web438_Command1));
            _common_Web438_Point = common_Web438_Point ?? throw new ArgumentNullException(nameof(common_Web438_Point));
        }
        ...
        public IBatchJobs_Events_Validator3 GetIBatchJobs_Events_Validator3() => _iBatchJobs_Events_Validator3;
        public IBatchJobs_Events_Service6 GetIBatchJobs_Events_Service6() => _iBatchJobs_Events_Service6;
        public ICommon_Web438_Repository2 GetICommon_Web438_Repository2() => _iCommon_Web438_Repository2;
        public Common_Web438_Command1 GetCommon_Web438_Command1() => _common_Web438_Command1;
        public Common_Web438_Point GetCommon_Web438_Point() => _common_Web438_Point;
