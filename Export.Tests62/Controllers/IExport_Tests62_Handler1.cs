...
{
    public interface IExport_Tests62_Handler1
    {
        /// <summary>Processes the Export_Tests62_Handler1 operation.</summary>
        void ProcessExport_Tests62_Handler1();

        /// <summary>Validates the Export_Tests62_Handler1 state.</summary>
        bool ValidateExport_Tests62_Handler1();
    }
