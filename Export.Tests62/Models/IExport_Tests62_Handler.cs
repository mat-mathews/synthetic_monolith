...
{
    public interface IExport_Tests62_Handler
    {
        /// <summary>Processes the Export_Tests62_Handler operation.</summary>
        void ProcessExport_Tests62_Handler();

        /// <summary>Validates the Export_Tests62_Handler state.</summary>
        bool ValidateExport_Tests62_Handler();
    }
