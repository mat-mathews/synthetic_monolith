...
{
    /// <summary>Immutable data transfer record for Portal_Data216_Command5.</summary>
    internal record Portal_Data216_Command5(string Value, int Count, DateTime Timestamp);
