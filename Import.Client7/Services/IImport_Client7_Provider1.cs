...
{
    public interface IImport_Client7_Provider1
    {
        /// <summary>Processes the Import_Client7_Provider1 operation.</summary>
        void ProcessImport_Client7_Provider1();

        /// <summary>Validates the Import_Client7_Provider1 state.</summary>
        bool ValidateImport_Client7_Provider1();
    }
