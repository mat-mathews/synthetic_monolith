...
{
    internal interface ISecurity_Data278_Handler7
    {
        /// <summary>Processes the Security_Data278_Handler7 operation.</summary>
        void ProcessSecurity_Data278_Handler7();

        /// <summary>Validates the Security_Data278_Handler7 state.</summary>
        bool ValidateSecurity_Data278_Handler7();
    }
