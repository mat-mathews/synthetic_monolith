...
{
    internal interface ISecurity_Data278_Validator1
    {
        /// <summary>Processes the Security_Data278_Validator1 operation.</summary>
        void ProcessSecurity_Data278_Validator1();

        /// <summary>Validates the Security_Data278_Validator1 state.</summary>
        bool ValidateSecurity_Data278_Validator1();
    }
