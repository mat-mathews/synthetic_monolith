...
{
    internal interface ISecurity_Data278_Factory11
    {
        /// <summary>Processes the Security_Data278_Factory11 operation.</summary>
        void ProcessSecurity_Data278_Factory11();

        /// <summary>Validates the Security_Data278_Factory11 state.</summary>
        bool ValidateSecurity_Data278_Factory11();
    }
