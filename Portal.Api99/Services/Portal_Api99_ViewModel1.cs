...
{
    /// <summary>Immutable data transfer record for Portal_Api99_ViewModel1.</summary>
    public record Portal_Api99_ViewModel1(string Value, int Count, DateTime Timestamp);
