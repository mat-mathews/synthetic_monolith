...
namespace Portal.Api99
{
    ...
    public class Consumer10
    {
        ...
        private readonly Security_Shared155_Builder _security_Shared155_Builder;
        private readonly GalaxyWorks_Events_Handler5 _galaxyWorks_Events_Handler5;
        private readonly BatchJobs_Client_Provider4 _batchJobs_Client_Provider4;
        private readonly BatchJobs_Client_Repository3 _batchJobs_Client_Repository3;
        private readonly Imaging_Processors_Command3 _imaging_Processors_Command3;
        private readonly Imaging_Processors_Controller1 _imaging_Processors_Controller1;
        private readonly Imaging_Processors_Event2 _imaging_Processors_Event2;

        public Consumer10(Auth_Processors_Builder3 auth_Processors_Builder3, Security_Shared155_Builder security_Shared155_Builder, GalaxyWorks_Events_Handler5 galaxyWorks_Events_Handler5, BatchJobs_Client_Provider4 batchJobs_Client_Provider4, BatchJobs_Client_Repository3 batchJobs_Client_Repository3, Imaging_Processors_Command3 imaging_Processors_Command3, Imaging_Processors_Controller1 imaging_Processors_Controller1, Imaging_Processors_Event2 imaging_Processors_Event2)
        {
            _auth_Processors_Builder3 = auth_Processors_Builder3 ?? throw new ArgumentNullException(nameof(auth_Processors_Builder3));
            _security_Shared155_Builder = security_Shared155_Builder ?? throw new ArgumentNullException(nameof(security_Shared155_Builder));
            _galaxyWorks_Events_Handler5 = galaxyWorks_Events_Handler5 ?? throw new ArgumentNullException(nameof(galaxyWorks_Events_Handler5));
            _batchJobs_Client_Provider4 = batchJobs_Client_Provider4 ?? throw new ArgumentNullException(nameof(batchJobs_Client_Provider4));
            _batchJobs_Client_Repository3 = batchJobs_Client_Repository3 ?? throw new ArgumentNullException(nameof(batchJobs_Client_Repository3));
            _imaging_Processors_Command3 = imaging_Processors_Command3 ?? throw new ArgumentNullException(nameof(imaging_Processors_Command3));
            _imaging_Processors_Controller1 = imaging_Processors_Controller1 ?? throw new ArgumentNullException(nameof(imaging_Processors_Controller1));
            _imaging_Processors_Event2 = imaging_Processors_Event2 ?? throw new ArgumentNullException(nameof(imaging_Processors_Event2));
        }

        public Auth_Processors_Builder3 GetAuth_Processors_Builder3() => _auth_Processors_Builder3;
        public Security_Shared155_Builder GetSecurity_Shared155_Builder() => _security_Shared155_Builder;
        public GalaxyWorks_Events_Handler5 GetGalaxyWorks_Events_Handler5() => _galaxyWorks_Events_Handler5;
        public BatchJobs_Client_Provider4 GetBatchJobs_Client_Provider4() => _batchJobs_Client_Provider4;
        public BatchJobs_Client_Repository3 GetBatchJobs_Client_Repository3() => _batchJobs_Client_Repository3;
        public Imaging_Processors_Command3 GetImaging_Processors_Command3() => _imaging_Processors_Command3;
        public Imaging_Processors_Controller1 GetImaging_Processors_Controller1() => _imaging_Processors_Controller1;
        public Imaging_Processors_Event2 GetImaging_Processors_Event2() => _imaging_Processors_Event2;
