...
{
    /// <summary>Immutable data transfer record for Export_Web479_ViewModel10.</summary>
    public record Export_Web479_ViewModel10(string Value, int Count, DateTime Timestamp);

    public class Web479Context : DbContext
    {
    }
