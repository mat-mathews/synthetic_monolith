...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Contracts392_Dto6.</summary>
    internal record GalaxyWorks_Contracts392_Dto6(string Value, int Count, DateTime Timestamp);
