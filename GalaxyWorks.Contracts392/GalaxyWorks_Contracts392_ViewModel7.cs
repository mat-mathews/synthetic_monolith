...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Contracts392_ViewModel7.</summary>
    public record GalaxyWorks_Contracts392_ViewModel7(string Value, int Count, DateTime Timestamp);
