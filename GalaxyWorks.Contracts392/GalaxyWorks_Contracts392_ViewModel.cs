...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Contracts392_ViewModel.</summary>
    internal record GalaxyWorks_Contracts392_ViewModel(string Value, int Count, DateTime Timestamp);
