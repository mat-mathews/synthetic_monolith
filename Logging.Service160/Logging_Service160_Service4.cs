...
{
    public class Logging_Service160_Service4
    {
        private readonly string _sql = "SELECT * FROM Payments WHERE Id = @Id";
        public void Execute()
        {
            // Logging_Service160_Service4 implementation
        }
...
public int Record54SortOrder { get; set; }
    ...
    {
        public DbSet<Logging_Service160_Service4> Logging_Service160_Service4s { get; set; }
    }
