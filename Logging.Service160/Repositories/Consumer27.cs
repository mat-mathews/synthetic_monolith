...
namespace Logging.Service160
{
    ...
    public class Consumer27
    {
        ...
        private readonly GalaxyWorks_Data96_Handler12 _galaxyWorks_Data96_Handler12;
        private readonly IGalaxyWorks_Data96_Provider10 _iGalaxyWorks_Data96_Provider10;
        private readonly GalaxyWorks_Data96_Service3 _galaxyWorks_Data96_Service3;
        private readonly Scheduling_Core_Helper1 _scheduling_Core_Helper1;
        private readonly Scheduling_Core_Manager9 _scheduling_Core_Manager9;
        private readonly Scheduling_Core_Helper7 _scheduling_Core_Helper7;
        private readonly Export_Tests_Processor _export_Tests_Processor;

        public Consumer27(Auth_Events78_Controller1 auth_Events78_Controller1, GalaxyWorks_Data96_Handler12 galaxyWorks_Data96_Handler12, IGalaxyWorks_Data96_Provider10 iGalaxyWorks_Data96_Provider10, GalaxyWorks_Data96_Service3 galaxyWorks_Data96_Service3, Scheduling_Core_Helper1 scheduling_Core_Helper1, Scheduling_Core_Manager9 scheduling_Core_Manager9, Scheduling_Core_Helper7 scheduling_Core_Helper7, Export_Tests_Processor export_Tests_Processor)
        {
            _auth_Events78_Controller1 = auth_Events78_Controller1 ?? throw new ArgumentNullException(nameof(auth_Events78_Controller1));
            _galaxyWorks_Data96_Handler12 = galaxyWorks_Data96_Handler12 ?? throw new ArgumentNullException(nameof(galaxyWorks_Data96_Handler12));
            _iGalaxyWorks_Data96_Provider10 = iGalaxyWorks_Data96_Provider10 ?? throw new ArgumentNullException(nameof(iGalaxyWorks_Data96_Provider10));
            _galaxyWorks_Data96_Service3 = galaxyWorks_Data96_Service3 ?? throw new ArgumentNullException(nameof(galaxyWorks_Data96_Service3));
            _scheduling_Core_Helper1 = scheduling_Core_Helper1 ?? throw new ArgumentNullException(nameof(scheduling_Core_Helper1));
            _scheduling_Core_Manager9 = scheduling_Core_Manager9 ?? throw new ArgumentNullException(nameof(scheduling_Core_Manager9));
            _scheduling_Core_Helper7 = scheduling_Core_Helper7 ?? throw new ArgumentNullException(nameof(scheduling_Core_Helper7));
            _export_Tests_Processor = export_Tests_Processor ?? throw new ArgumentNullException(nameof(export_Tests_Processor));
        }

        public Auth_Events78_Controller1 GetAuth_Events78_Controller1() => _auth_Events78_Controller1;
        public GalaxyWorks_Data96_Handler12 GetGalaxyWorks_Data96_Handler12() => _galaxyWorks_Data96_Handler12;
        public IGalaxyWorks_Data96_Provider10 GetIGalaxyWorks_Data96_Provider10() => _iGalaxyWorks_Data96_Provider10;
        public GalaxyWorks_Data96_Service3 GetGalaxyWorks_Data96_Service3() => _galaxyWorks_Data96_Service3;
        public Scheduling_Core_Helper1 GetScheduling_Core_Helper1() => _scheduling_Core_Helper1;
        public Scheduling_Core_Manager9 GetScheduling_Core_Manager9() => _scheduling_Core_Manager9;
        public Scheduling_Core_Helper7 GetScheduling_Core_Helper7() => _scheduling_Core_Helper7;
        public Export_Tests_Processor GetExport_Tests_Processor() => _export_Tests_Processor;
