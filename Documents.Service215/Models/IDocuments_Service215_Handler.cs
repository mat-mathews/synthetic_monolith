...
{
    internal interface IDocuments_Service215_Handler
    {
        /// <summary>Processes the Documents_Service215_Handler operation.</summary>
        void ProcessDocuments_Service215_Handler();

        /// <summary>Validates the Documents_Service215_Handler state.</summary>
        bool ValidateDocuments_Service215_Handler();
    }
