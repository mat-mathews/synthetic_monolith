...
{
    internal interface IDocuments_Service215_Handler9
    {
        /// <summary>Processes the Documents_Service215_Handler9 operation.</summary>
        void ProcessDocuments_Service215_Handler9();

        /// <summary>Validates the Documents_Service215_Handler9 state.</summary>
        bool ValidateDocuments_Service215_Handler9();
    }
