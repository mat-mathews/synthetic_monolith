...
{
    /// <summary>Immutable data transfer record for Documents_Service215_Dto13.</summary>
    internal record Documents_Service215_Dto13(string Value, int Count, DateTime Timestamp);
