...
{
    public interface IDocuments_Service215_Service2
    {
        /// <summary>Processes the Documents_Service215_Service2 operation.</summary>
        void ProcessDocuments_Service215_Service2();

        /// <summary>Validates the Documents_Service215_Service2 state.</summary>
        bool ValidateDocuments_Service215_Service2();
    }
