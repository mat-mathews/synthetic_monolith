...
{
    public interface IDocuments_Client58_Validator9
    {
        /// <summary>Processes the Documents_Client58_Validator9 operation.</summary>
        void ProcessDocuments_Client58_Validator9();

        /// <summary>Validates the Documents_Client58_Validator9 state.</summary>
        bool ValidateDocuments_Client58_Validator9();
    }
