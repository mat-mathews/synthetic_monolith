...
{
    public interface IDocuments_Client58_Provider3
    {
        /// <summary>Processes the Documents_Client58_Provider3 operation.</summary>
        void ProcessDocuments_Client58_Provider3();

        /// <summary>Validates the Documents_Client58_Provider3 state.</summary>
        bool ValidateDocuments_Client58_Provider3();
    }
