...
{
    public interface IDocuments_Client58_Service
    {
        /// <summary>Processes the Documents_Client58_Service operation.</summary>
        void ProcessDocuments_Client58_Service();

        /// <summary>Validates the Documents_Client58_Service state.</summary>
        bool ValidateDocuments_Client58_Service();
    }
