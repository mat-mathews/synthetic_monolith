...
{
    internal class Security_Events_Repository
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // Security_Events_Repository implementation
        }
...
public int Param67SortOrder { get; set; }
    ...
    {
        public DbSet<Security_Events_Repository> Security_Events_Repositorys { get; set; }
    }
