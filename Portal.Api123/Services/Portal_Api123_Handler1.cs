...
{
    public class Portal_Api123_Handler1
    {
        private readonly string _sql = "SELECT * FROM Customers WHERE Id = @Id";
        public void Execute()
        {
            // Portal_Api123_Handler1 implementation
        }
...
public int Record30SortOrder { get; set; }
    ...
    public class Api123Context : DbContext
    {
        public DbSet<Portal_Api123_Handler1> Portal_Api123_Handler1s { get; set; }
    }
