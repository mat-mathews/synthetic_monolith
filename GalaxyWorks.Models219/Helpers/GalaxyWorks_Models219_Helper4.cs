...
{
    public sealed class GalaxyWorks_Models219_Helper4
    {
        private readonly string _sql = "SELECT * FROM Customers WHERE Id = @Id";
        public void Execute()
        {
            // GalaxyWorks_Models219_Helper4 implementation
        }
...
public int Item36SortOrder { get; set; }
    ...
    public class Models219Context : DbContext
    {
        public DbSet<GalaxyWorks_Models219_Helper4> GalaxyWorks_Models219_Helper4s { get; set; }
    }
