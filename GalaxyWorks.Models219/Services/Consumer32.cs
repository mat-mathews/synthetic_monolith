...
namespace GalaxyWorks.Models219
{
    ...
    public class Consumer32
    {
        ...
        private readonly ISecurity_Client137_Repository _iSecurity_Client137_Repository;
        private readonly ISecurity_Client137_Provider4 _iSecurity_Client137_Provider4;
        private readonly Export_Processors468_Provider2 _export_Processors468_Provider2;
        private readonly Export_Processors468_Manager5 _export_Processors468_Manager5;
        private readonly Common_Data_Event5 _common_Data_Event5;

        public Consumer32(Admin_Models199_Repository1 admin_Models199_Repository1, IAdmin_Models199_Service2 iAdmin_Models199_Service2, Admin_Models199_Repository4 admin_Models199_Repository4, ISecurity_Client137_Repository iSecurity_Client137_Repository, ISecurity_Client137_Provider4 iSecurity_Client137_Provider4, Export_Processors468_Provider2 export_Processors468_Provider2, Export_Processors468_Manager5 export_Processors468_Manager5, Common_Data_Event5 common_Data_Event5)
        {
            ...
            _iSecurity_Client137_Repository = iSecurity_Client137_Repository ?? throw new ArgumentNullException(nameof(iSecurity_Client137_Repository));
            _iSecurity_Client137_Provider4 = iSecurity_Client137_Provider4 ?? throw new ArgumentNullException(nameof(iSecurity_Client137_Provider4));
            _export_Processors468_Provider2 = export_Processors468_Provider2 ?? throw new ArgumentNullException(nameof(export_Processors468_Provider2));
            _export_Processors468_Manager5 = export_Processors468_Manager5 ?? throw new ArgumentNullException(nameof(export_Processors468_Manager5));
        ...
        public ISecurity_Client137_Repository GetISecurity_Client137_Repository() => _iSecurity_Client137_Repository;
        public ISecurity_Client137_Provider4 GetISecurity_Client137_Provider4() => _iSecurity_Client137_Provider4;
        public Export_Processors468_Provider2 GetExport_Processors468_Provider2() => _export_Processors468_Provider2;
        public Export_Processors468_Manager5 GetExport_Processors468_Manager5() => _export_Processors468_Manager5;
