...
{
    internal interface IWorkflow_Core_Handler8
    {
        /// <summary>Processes the Workflow_Core_Handler8 operation.</summary>
        void ProcessWorkflow_Core_Handler8();

        /// <summary>Validates the Workflow_Core_Handler8 state.</summary>
        bool ValidateWorkflow_Core_Handler8();
    }
