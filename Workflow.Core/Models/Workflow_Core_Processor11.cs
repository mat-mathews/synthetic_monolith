...
{
    public class Workflow_Core_Processor11
    {
        private readonly string _sql = "SELECT * FROM Payments WHERE Id = @Id";
        public void Execute()
        {
            // Workflow_Core_Processor11 implementation
        }
...
public int Field86SortOrder { get; set; }
    ...
    {
        public DbSet<Workflow_Core_Processor11> Workflow_Core_Processor11s { get; set; }
    }
