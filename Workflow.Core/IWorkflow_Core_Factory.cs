...
{
    public interface IWorkflow_Core_Factory
    {
        /// <summary>Processes the Workflow_Core_Factory operation.</summary>
        void ProcessWorkflow_Core_Factory();

        /// <summary>Validates the Workflow_Core_Factory state.</summary>
        bool ValidateWorkflow_Core_Factory();
    }
