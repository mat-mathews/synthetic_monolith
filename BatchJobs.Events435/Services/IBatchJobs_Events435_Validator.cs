...
{
    public interface IBatchJobs_Events435_Validator
    {
        /// <summary>Processes the BatchJobs_Events435_Validator operation.</summary>
        void ProcessBatchJobs_Events435_Validator();

        /// <summary>Validates the BatchJobs_Events435_Validator state.</summary>
        bool ValidateBatchJobs_Events435_Validator();
    }
