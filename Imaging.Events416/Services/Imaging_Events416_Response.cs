...
{
    /// <summary>Immutable data transfer record for Imaging_Events416_Response.</summary>
    public record Imaging_Events416_Response(string Value, int Count, DateTime Timestamp);
