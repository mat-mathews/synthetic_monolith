...
{
    internal interface IIntegration_Validators369_Handler11
    {
        /// <summary>Processes the Integration_Validators369_Handler11 operation.</summary>
        void ProcessIntegration_Validators369_Handler11();

        /// <summary>Validates the Integration_Validators369_Handler11 state.</summary>
        bool ValidateIntegration_Validators369_Handler11();
    }
