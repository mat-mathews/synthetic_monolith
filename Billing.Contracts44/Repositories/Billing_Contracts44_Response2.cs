...
{
    /// <summary>Immutable data transfer record for Billing_Contracts44_Response2.</summary>
    public record Billing_Contracts44_Response2(string Value, int Count, DateTime Timestamp);
