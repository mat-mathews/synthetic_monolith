...
{
    public static class Notifications_Client_Provider5
    {
        ...
        public void Execute()
        {
            // Notifications_Client_Provider5 implementation
        }
...
public int Detail76SortOrder { get; set; }
    ...
    {
        public DbSet<Notifications_Client_Provider5> Notifications_Client_Provider5s { get; set; }
    }
