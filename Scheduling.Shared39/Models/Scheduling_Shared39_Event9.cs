...
{
    /// <summary>Immutable data transfer record for Scheduling_Shared39_Event9.</summary>
    public record Scheduling_Shared39_Event9(string Value, int Count, DateTime Timestamp);
