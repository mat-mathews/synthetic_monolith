...
{
    public interface ILogging_Shared315_Service1
    {
        /// <summary>Processes the Logging_Shared315_Service1 operation.</summary>
        void ProcessLogging_Shared315_Service1();

        /// <summary>Validates the Logging_Shared315_Service1 state.</summary>
        bool ValidateLogging_Shared315_Service1();
    }
