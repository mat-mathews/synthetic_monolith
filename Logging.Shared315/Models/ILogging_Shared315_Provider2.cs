...
{
    public interface ILogging_Shared315_Provider2
    {
        /// <summary>Processes the Logging_Shared315_Provider2 operation.</summary>
        void ProcessLogging_Shared315_Provider2();

        /// <summary>Validates the Logging_Shared315_Provider2 state.</summary>
        bool ValidateLogging_Shared315_Provider2();
    }
