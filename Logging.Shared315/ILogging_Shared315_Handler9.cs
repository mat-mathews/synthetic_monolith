...
{
    internal interface ILogging_Shared315_Handler9
    {
        /// <summary>Processes the Logging_Shared315_Handler9 operation.</summary>
        void ProcessLogging_Shared315_Handler9();

        /// <summary>Validates the Logging_Shared315_Handler9 state.</summary>
        bool ValidateLogging_Shared315_Handler9();
    }
