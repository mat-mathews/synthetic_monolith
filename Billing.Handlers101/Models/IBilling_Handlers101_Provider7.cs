...
{
    internal interface IBilling_Handlers101_Provider7
    {
        /// <summary>Processes the Billing_Handlers101_Provider7 operation.</summary>
        void ProcessBilling_Handlers101_Provider7();

        /// <summary>Validates the Billing_Handlers101_Provider7 state.</summary>
        bool ValidateBilling_Handlers101_Provider7();
    }
