...
{
    public interface IBilling_Handlers101_Handler6
    {
        /// <summary>Processes the Billing_Handlers101_Handler6 operation.</summary>
        void ProcessBilling_Handlers101_Handler6();

        /// <summary>Validates the Billing_Handlers101_Handler6 state.</summary>
        bool ValidateBilling_Handlers101_Handler6();
    }
