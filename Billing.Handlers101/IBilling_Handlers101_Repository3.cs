...
{
    internal interface IBilling_Handlers101_Repository3
    {
        /// <summary>Processes the Billing_Handlers101_Repository3 operation.</summary>
        void ProcessBilling_Handlers101_Repository3();

        /// <summary>Validates the Billing_Handlers101_Repository3 state.</summary>
        bool ValidateBilling_Handlers101_Repository3();
    }
