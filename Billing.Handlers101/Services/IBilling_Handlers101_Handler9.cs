...
{
    public interface IBilling_Handlers101_Handler9
    {
        /// <summary>Processes the Billing_Handlers101_Handler9 operation.</summary>
        void ProcessBilling_Handlers101_Handler9();

        /// <summary>Validates the Billing_Handlers101_Handler9 state.</summary>
        bool ValidateBilling_Handlers101_Handler9();
    }
