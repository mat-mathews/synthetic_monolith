...
{
    internal interface IImaging_Service_Handler3
    {
        /// <summary>Processes the Imaging_Service_Handler3 operation.</summary>
        void ProcessImaging_Service_Handler3();

        /// <summary>Validates the Imaging_Service_Handler3 state.</summary>
        bool ValidateImaging_Service_Handler3();
    }
