...
{
    internal interface IImaging_Service_Provider2
    {
        /// <summary>Processes the Imaging_Service_Provider2 operation.</summary>
        void ProcessImaging_Service_Provider2();

        /// <summary>Validates the Imaging_Service_Provider2 state.</summary>
        bool ValidateImaging_Service_Provider2();
    }
