...
namespace DataAccess.Events
{
    ...
    public class Consumer7
    {
        ...
        private readonly Export_Processors111_Repository2 _export_Processors111_Repository2;
        private readonly IScheduling_Core218_Service9 _iScheduling_Core218_Service9;
        private readonly IScheduling_Core218_Handler4 _iScheduling_Core218_Handler4;
        private readonly Reporting_Tests67_Request2 _reporting_Tests67_Request2;
        private readonly Reporting_Tests67_Handler3 _reporting_Tests67_Handler3;
        private readonly BatchJobs_Contracts399_Processor1 _batchJobs_Contracts399_Processor1;
        private readonly DataAccess_Service464_Controller7 _dataAccess_Service464_Controller7;

        public Consumer7(Auth_Mappers_Key5 auth_Mappers_Key5, Export_Processors111_Repository2 export_Processors111_Repository2, IScheduling_Core218_Service9 iScheduling_Core218_Service9, IScheduling_Core218_Handler4 iScheduling_Core218_Handler4, Reporting_Tests67_Request2 reporting_Tests67_Request2, Reporting_Tests67_Handler3 reporting_Tests67_Handler3, BatchJobs_Contracts399_Processor1 batchJobs_Contracts399_Processor1, DataAccess_Service464_Controller7 dataAccess_Service464_Controller7)
        {
            _auth_Mappers_Key5 = auth_Mappers_Key5 ?? throw new ArgumentNullException(nameof(auth_Mappers_Key5));
            _export_Processors111_Repository2 = export_Processors111_Repository2 ?? throw new ArgumentNullException(nameof(export_Processors111_Repository2));
            _iScheduling_Core218_Service9 = iScheduling_Core218_Service9 ?? throw new ArgumentNullException(nameof(iScheduling_Core218_Service9));
            _iScheduling_Core218_Handler4 = iScheduling_Core218_Handler4 ?? throw new ArgumentNullException(nameof(iScheduling_Core218_Handler4));
            _reporting_Tests67_Request2 = reporting_Tests67_Request2 ?? throw new ArgumentNullException(nameof(reporting_Tests67_Request2));
            _reporting_Tests67_Handler3 = reporting_Tests67_Handler3 ?? throw new ArgumentNullException(nameof(reporting_Tests67_Handler3));
            _batchJobs_Contracts399_Processor1 = batchJobs_Contracts399_Processor1 ?? throw new ArgumentNullException(nameof(batchJobs_Contracts399_Processor1));
        ...
        public Export_Processors111_Repository2 GetExport_Processors111_Repository2() => _export_Processors111_Repository2;
        public IScheduling_Core218_Service9 GetIScheduling_Core218_Service9() => _iScheduling_Core218_Service9;
        public IScheduling_Core218_Handler4 GetIScheduling_Core218_Handler4() => _iScheduling_Core218_Handler4;
        public Reporting_Tests67_Request2 GetReporting_Tests67_Request2() => _reporting_Tests67_Request2;
        public Reporting_Tests67_Handler3 GetReporting_Tests67_Handler3() => _reporting_Tests67_Handler3;
        public BatchJobs_Contracts399_Processor1 GetBatchJobs_Contracts399_Processor1() => _batchJobs_Contracts399_Processor1;
