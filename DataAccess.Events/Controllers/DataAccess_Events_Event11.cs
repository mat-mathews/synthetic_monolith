...
{
    /// <summary>Immutable data transfer record for DataAccess_Events_Event11.</summary>
    internal record DataAccess_Events_Event11(string Value, int Count, DateTime Timestamp);
