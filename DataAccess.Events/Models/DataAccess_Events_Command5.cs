...
{
    /// <summary>Immutable data transfer record for DataAccess_Events_Command5.</summary>
    public record DataAccess_Events_Command5(string Value, int Count, DateTime Timestamp);
