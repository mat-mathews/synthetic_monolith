...
{
    internal interface IScheduling_Shared_Handler4
    {
        /// <summary>Processes the Scheduling_Shared_Handler4 operation.</summary>
        void ProcessScheduling_Shared_Handler4();

        /// <summary>Validates the Scheduling_Shared_Handler4 state.</summary>
        bool ValidateScheduling_Shared_Handler4();
    }
