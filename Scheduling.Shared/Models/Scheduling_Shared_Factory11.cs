...
{
    public sealed class Scheduling_Shared_Factory11
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Shared_Factory11 implementation
        }
...
public int Item89SortOrder { get; set; }
    ...
    {
        public DbSet<Scheduling_Shared_Factory11> Scheduling_Shared_Factory11s { get; set; }
    }
