...
{
    /// <summary>Immutable data transfer record for Scheduling_Shared_Command1.</summary>
    public record Scheduling_Shared_Command1(string Value, int Count, DateTime Timestamp);
