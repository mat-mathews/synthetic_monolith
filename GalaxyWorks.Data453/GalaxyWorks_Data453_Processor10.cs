...
{
    internal class GalaxyWorks_Data453_Processor10
    {
        private readonly string _sql = "SELECT * FROM Customers WHERE Id = @Id";
        public void Execute()
        {
            // GalaxyWorks_Data453_Processor10 implementation
        }
...
public int Field17SortOrder { get; set; }
    ...
    public class Data453Context : DbContext
    {
        public DbSet<GalaxyWorks_Data453_Processor10> GalaxyWorks_Data453_Processor10s { get; set; }
    }
