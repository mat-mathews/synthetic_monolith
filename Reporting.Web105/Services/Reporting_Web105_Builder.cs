...
{
    internal class Reporting_Web105_Builder
    {
        private const string SprocName = "dbo.usp_InsertSchedule";
        // Execute stored procedure dbo.usp_InsertSchedule
        private const string SprocName = "dbo.sp_ValidateProduct";
        // Execute stored procedure dbo.sp_ValidateProduct
        private const string SprocName = "dbo.usp_GetConfiguration";
        // Execute stored procedure dbo.usp_GetConfiguration
        private const string SprocName = "dbo.sp_DeletePreference";
        // Execute stored procedure dbo.sp_DeletePreference
        public void Execute()
        {
            // Reporting_Web105_Builder implementation
        }
