...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Service293_Dto9.</summary>
    internal record GalaxyWorks_Service293_Dto9(string Value, int Count, DateTime Timestamp);
