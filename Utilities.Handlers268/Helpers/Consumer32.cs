...
namespace Utilities.Handlers268
{
    ...
    public class Consumer32
    {
        ...
        private readonly Logging_Handlers455_Controller7 _logging_Handlers455_Controller7;
        private readonly Logging_Handlers455_Info _logging_Handlers455_Info;
        private readonly Logging_Handlers455_Manager9 _logging_Handlers455_Manager9;
        private readonly Import_Client65_Repository2 _import_Client65_Repository2;
        private readonly Import_Client65_Repository8 _import_Client65_Repository8;
        private readonly IImport_Client65_Provider3 _iImport_Client65_Provider3;

        public Consumer32(Admin_Core121_Helper11 admin_Core121_Helper11, Auth_Client_Processor6 auth_Client_Processor6, Logging_Handlers455_Controller7 logging_Handlers455_Controller7, Logging_Handlers455_Info logging_Handlers455_Info, Logging_Handlers455_Manager9 logging_Handlers455_Manager9, Import_Client65_Repository2 import_Client65_Repository2, Import_Client65_Repository8 import_Client65_Repository8, IImport_Client65_Provider3 iImport_Client65_Provider3)
        {
            ...
            _logging_Handlers455_Controller7 = logging_Handlers455_Controller7 ?? throw new ArgumentNullException(nameof(logging_Handlers455_Controller7));
            _logging_Handlers455_Info = logging_Handlers455_Info ?? throw new ArgumentNullException(nameof(logging_Handlers455_Info));
            _logging_Handlers455_Manager9 = logging_Handlers455_Manager9 ?? throw new ArgumentNullException(nameof(logging_Handlers455_Manager9));
            ...
            _import_Client65_Repository8 = import_Client65_Repository8 ?? throw new ArgumentNullException(nameof(import_Client65_Repository8));
            _iImport_Client65_Provider3 = iImport_Client65_Provider3 ?? throw new ArgumentNullException(nameof(iImport_Client65_Provider3));
        }
        ...
        public Logging_Handlers455_Controller7 GetLogging_Handlers455_Controller7() => _logging_Handlers455_Controller7;
        public Logging_Handlers455_Info GetLogging_Handlers455_Info() => _logging_Handlers455_Info;
        public Logging_Handlers455_Manager9 GetLogging_Handlers455_Manager9() => _logging_Handlers455_Manager9;
        public Import_Client65_Repository2 GetImport_Client65_Repository2() => _import_Client65_Repository2;
        public Import_Client65_Repository8 GetImport_Client65_Repository8() => _import_Client65_Repository8;
        public IImport_Client65_Provider3 GetIImport_Client65_Provider3() => _iImport_Client65_Provider3;
