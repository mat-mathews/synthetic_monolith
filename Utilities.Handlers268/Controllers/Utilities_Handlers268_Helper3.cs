...
{
    internal class Utilities_Handlers268_Helper3
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // Utilities_Handlers268_Helper3 implementation
        }
...
public int Entry62SortOrder { get; set; }
    ...
    public class Handlers268Context : DbContext
    {
        public DbSet<Utilities_Handlers268_Helper3> Utilities_Handlers268_Helper3s { get; set; }
    }
