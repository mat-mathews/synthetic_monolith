...
{
    internal abstract class Export_Processors449_Helper4
    {
        private readonly string _sql = "SELECT * FROM Accounts WHERE Id = @Id";
        public void Execute()
        {
            // Export_Processors449_Helper4 implementation
        }
...
public int Detail23SortOrder { get; set; }
    ...
    public class Processors449Context : DbContext
    {
        public DbSet<Export_Processors449_Helper4> Export_Processors449_Helper4s { get; set; }
    }
