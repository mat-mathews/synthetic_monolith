...
{
    public interface IImaging_Api127_Provider3
    {
        /// <summary>Processes the Imaging_Api127_Provider3 operation.</summary>
        void ProcessImaging_Api127_Provider3();

        /// <summary>Validates the Imaging_Api127_Provider3 state.</summary>
        bool ValidateImaging_Api127_Provider3();
    }
