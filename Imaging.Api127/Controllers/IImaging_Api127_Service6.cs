...
{
    public interface IImaging_Api127_Service6
    {
        /// <summary>Processes the Imaging_Api127_Service6 operation.</summary>
        void ProcessImaging_Api127_Service6();

        /// <summary>Validates the Imaging_Api127_Service6 state.</summary>
        bool ValidateImaging_Api127_Service6();
    }
