...
{
    internal interface IReporting_Core_Service7
    {
        /// <summary>Processes the Reporting_Core_Service7 operation.</summary>
        void ProcessReporting_Core_Service7();

        /// <summary>Validates the Reporting_Core_Service7 state.</summary>
        bool ValidateReporting_Core_Service7();
    }
