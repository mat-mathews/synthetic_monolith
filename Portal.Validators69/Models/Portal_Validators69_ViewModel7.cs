...
{
    /// <summary>Immutable data transfer record for Portal_Validators69_ViewModel7.</summary>
    public record Portal_Validators69_ViewModel7(string Value, int Count, DateTime Timestamp);
