...
{
    /// <summary>Immutable data transfer record for Portal_Validators69_Command9.</summary>
    public record Portal_Validators69_Command9(string Value, int Count, DateTime Timestamp);
