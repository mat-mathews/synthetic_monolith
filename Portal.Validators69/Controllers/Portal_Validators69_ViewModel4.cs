...
{
    /// <summary>Immutable data transfer record for Portal_Validators69_ViewModel4.</summary>
    internal record Portal_Validators69_ViewModel4(string Value, int Count, DateTime Timestamp);
