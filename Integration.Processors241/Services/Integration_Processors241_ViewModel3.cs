...
{
    /// <summary>Immutable data transfer record for Integration_Processors241_ViewModel3.</summary>
    public record Integration_Processors241_ViewModel3(string Value, int Count, DateTime Timestamp);
