...
{
    /// <summary>Immutable data transfer record for Integration_Processors241_Event6.</summary>
    internal record Integration_Processors241_Event6(string Value, int Count, DateTime Timestamp);
