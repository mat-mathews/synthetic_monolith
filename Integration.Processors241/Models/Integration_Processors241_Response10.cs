...
{
    /// <summary>Immutable data transfer record for Integration_Processors241_Response10.</summary>
    internal record Integration_Processors241_Response10(string Value, int Count, DateTime Timestamp);
