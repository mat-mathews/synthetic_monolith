...
{
    internal interface IPortal_Validators125_Repository1
    {
        /// <summary>Processes the Portal_Validators125_Repository1 operation.</summary>
        void ProcessPortal_Validators125_Repository1();

        /// <summary>Validates the Portal_Validators125_Repository1 state.</summary>
        bool ValidatePortal_Validators125_Repository1();
    }
