...
{
    public interface IPortal_Validators125_Provider2
    {
        /// <summary>Processes the Portal_Validators125_Provider2 operation.</summary>
        void ProcessPortal_Validators125_Provider2();

        /// <summary>Validates the Portal_Validators125_Provider2 state.</summary>
        bool ValidatePortal_Validators125_Provider2();
    }
