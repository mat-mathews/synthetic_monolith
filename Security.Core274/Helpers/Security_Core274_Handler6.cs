...
{
    internal class Security_Core274_Handler6
    {
        private readonly string _sql = "SELECT * FROM Invoices WHERE Id = @Id";
        public void Execute()
        {
            // Security_Core274_Handler6 implementation
        }
...
public int Config52SortOrder { get; set; }
    ...
    {
        public DbSet<Security_Core274_Handler6> Security_Core274_Handler6s { get; set; }
    }
