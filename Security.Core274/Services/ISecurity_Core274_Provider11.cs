...
{
    public interface ISecurity_Core274_Provider11
    {
        /// <summary>Processes the Security_Core274_Provider11 operation.</summary>
        void ProcessSecurity_Core274_Provider11();

        /// <summary>Validates the Security_Core274_Provider11 state.</summary>
        bool ValidateSecurity_Core274_Provider11();
    }
