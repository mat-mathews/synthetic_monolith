...
{
    internal interface ISecurity_Core274_Provider1
    {
        /// <summary>Processes the Security_Core274_Provider1 operation.</summary>
        void ProcessSecurity_Core274_Provider1();

        /// <summary>Validates the Security_Core274_Provider1 state.</summary>
        bool ValidateSecurity_Core274_Provider1();
    }
