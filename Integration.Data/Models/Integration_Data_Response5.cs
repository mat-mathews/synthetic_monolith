...
{
    /// <summary>Immutable data transfer record for Integration_Data_Response5.</summary>
    public record Integration_Data_Response5(string Value, int Count, DateTime Timestamp);
