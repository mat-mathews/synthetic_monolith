...
{
    public interface IIntegration_Data_Handler6
    {
        /// <summary>Processes the Integration_Data_Handler6 operation.</summary>
        void ProcessIntegration_Data_Handler6();

        /// <summary>Validates the Integration_Data_Handler6 state.</summary>
        bool ValidateIntegration_Data_Handler6();
    }
