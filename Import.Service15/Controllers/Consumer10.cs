...
namespace Import.Service15
{
    ...
    public class Consumer10
    {
        ...
        private readonly IAuth_Tests498_Service5 _iAuth_Tests498_Service5;
        private readonly Utilities_Mappers_Processor4 _utilities_Mappers_Processor4;
        private readonly Common_Service_Processor3 _common_Service_Processor3;
        private readonly Common_Service_Handler8 _common_Service_Handler8;
        private readonly Common_Service_Factory7 _common_Service_Factory7;
        private readonly Documents_Data484_Builder6 _documents_Data484_Builder6;
        private readonly Documents_Data484_Range12 _documents_Data484_Range12;

        public Consumer10(Admin_Shared363_Response4 admin_Shared363_Response4, IAuth_Tests498_Service5 iAuth_Tests498_Service5, Utilities_Mappers_Processor4 utilities_Mappers_Processor4, Common_Service_Processor3 common_Service_Processor3, Common_Service_Handler8 common_Service_Handler8, Common_Service_Factory7 common_Service_Factory7, Documents_Data484_Builder6 documents_Data484_Builder6, Documents_Data484_Range12 documents_Data484_Range12)
        {
            _admin_Shared363_Response4 = admin_Shared363_Response4 ?? throw new ArgumentNullException(nameof(admin_Shared363_Response4));
            _iAuth_Tests498_Service5 = iAuth_Tests498_Service5 ?? throw new ArgumentNullException(nameof(iAuth_Tests498_Service5));
            _utilities_Mappers_Processor4 = utilities_Mappers_Processor4 ?? throw new ArgumentNullException(nameof(utilities_Mappers_Processor4));
            _common_Service_Processor3 = common_Service_Processor3 ?? throw new ArgumentNullException(nameof(common_Service_Processor3));
            _common_Service_Handler8 = common_Service_Handler8 ?? throw new ArgumentNullException(nameof(common_Service_Handler8));
            _common_Service_Factory7 = common_Service_Factory7 ?? throw new ArgumentNullException(nameof(common_Service_Factory7));
            _documents_Data484_Builder6 = documents_Data484_Builder6 ?? throw new ArgumentNullException(nameof(documents_Data484_Builder6));
            _documents_Data484_Range12 = documents_Data484_Range12 ?? throw new ArgumentNullException(nameof(documents_Data484_Range12));
        }

        public Admin_Shared363_Response4 GetAdmin_Shared363_Response4() => _admin_Shared363_Response4;
        public IAuth_Tests498_Service5 GetIAuth_Tests498_Service5() => _iAuth_Tests498_Service5;
        public Utilities_Mappers_Processor4 GetUtilities_Mappers_Processor4() => _utilities_Mappers_Processor4;
        public Common_Service_Processor3 GetCommon_Service_Processor3() => _common_Service_Processor3;
        public Common_Service_Handler8 GetCommon_Service_Handler8() => _common_Service_Handler8;
        public Common_Service_Factory7 GetCommon_Service_Factory7() => _common_Service_Factory7;
        public Documents_Data484_Builder6 GetDocuments_Data484_Builder6() => _documents_Data484_Builder6;
        public Documents_Data484_Range12 GetDocuments_Data484_Range12() => _documents_Data484_Range12;
