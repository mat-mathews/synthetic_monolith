...
{
    /// <summary>Immutable data transfer record for Integration_Core_Command5.</summary>
    public record Integration_Core_Command5(string Value, int Count, DateTime Timestamp);
