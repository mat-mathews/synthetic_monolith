...
namespace Utilities.Handlers
{
    ...
    {
        private readonly Security_Events_Helper2 _security_Events_Helper2;
        private readonly ISecurity_Events_Handler1 _iSecurity_Events_Handler1;
        private readonly Billing_Service_Manager3 _billing_Service_Manager3;
        private readonly Workflow_Validators138_Provider8 _workflow_Validators138_Provider8;
        private readonly Documents_Core_Provider12 _documents_Core_Provider12;
        private readonly Common_Validators430_Factory4 _common_Validators430_Factory4;
        private readonly Integration_Handlers_Processor9 _integration_Handlers_Processor9;
        private readonly Scheduling_Processors335_Processor5 _scheduling_Processors335_Processor5;

        public Consumer10(Security_Events_Helper2 security_Events_Helper2, ISecurity_Events_Handler1 iSecurity_Events_Handler1, Billing_Service_Manager3 billing_Service_Manager3, Workflow_Validators138_Provider8 workflow_Validators138_Provider8, Documents_Core_Provider12 documents_Core_Provider12, Common_Validators430_Factory4 common_Validators430_Factory4, Integration_Handlers_Processor9 integration_Handlers_Processor9, Scheduling_Processors335_Processor5 scheduling_Processors335_Processor5)
        {
            _security_Events_Helper2 = security_Events_Helper2 ?? throw new ArgumentNullException(nameof(security_Events_Helper2));
            _iSecurity_Events_Handler1 = iSecurity_Events_Handler1 ?? throw new ArgumentNullException(nameof(iSecurity_Events_Handler1));
            _billing_Service_Manager3 = billing_Service_Manager3 ?? throw new ArgumentNullException(nameof(billing_Service_Manager3));
            _workflow_Validators138_Provider8 = workflow_Validators138_Provider8 ?? throw new ArgumentNullException(nameof(workflow_Validators138_Provider8));
            _documents_Core_Provider12 = documents_Core_Provider12 ?? throw new ArgumentNullException(nameof(documents_Core_Provider12));
            _common_Validators430_Factory4 = common_Validators430_Factory4 ?? throw new ArgumentNullException(nameof(common_Validators430_Factory4));
            _integration_Handlers_Processor9 = integration_Handlers_Processor9 ?? throw new ArgumentNullException(nameof(integration_Handlers_Processor9));
            _scheduling_Processors335_Processor5 = scheduling_Processors335_Processor5 ?? throw new ArgumentNullException(nameof(scheduling_Processors335_Processor5));
        }

        public Security_Events_Helper2 GetSecurity_Events_Helper2() => _security_Events_Helper2;
        public ISecurity_Events_Handler1 GetISecurity_Events_Handler1() => _iSecurity_Events_Handler1;
        public Billing_Service_Manager3 GetBilling_Service_Manager3() => _billing_Service_Manager3;
        public Workflow_Validators138_Provider8 GetWorkflow_Validators138_Provider8() => _workflow_Validators138_Provider8;
        public Documents_Core_Provider12 GetDocuments_Core_Provider12() => _documents_Core_Provider12;
        public Common_Validators430_Factory4 GetCommon_Validators430_Factory4() => _common_Validators430_Factory4;
        public Integration_Handlers_Processor9 GetIntegration_Handlers_Processor9() => _integration_Handlers_Processor9;
        public Scheduling_Processors335_Processor5 GetScheduling_Processors335_Processor5() => _scheduling_Processors335_Processor5;
