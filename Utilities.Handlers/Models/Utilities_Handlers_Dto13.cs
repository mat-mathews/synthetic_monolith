...
{
    /// <summary>Immutable data transfer record for Utilities_Handlers_Dto13.</summary>
    public record Utilities_Handlers_Dto13(string Value, int Count, DateTime Timestamp);
