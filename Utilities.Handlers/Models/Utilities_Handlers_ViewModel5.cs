...
{
    /// <summary>Immutable data transfer record for Utilities_Handlers_ViewModel5.</summary>
    internal record Utilities_Handlers_ViewModel5(string Value, int Count, DateTime Timestamp);
