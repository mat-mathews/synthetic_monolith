...
{
    /// <summary>Immutable data transfer record for Integration_Contracts_Command4.</summary>
    public record Integration_Contracts_Command4(string Value, int Count, DateTime Timestamp);
