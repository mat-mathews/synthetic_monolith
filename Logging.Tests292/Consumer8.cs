...
namespace Logging.Tests292
{
    ...
    {
        private readonly IAdmin_Validators431_Provider9 _iAdmin_Validators431_Provider9;
        private readonly IAdmin_Contracts_Provider _iAdmin_Contracts_Provider;
        private readonly Security_Shared448_Provider4 _security_Shared448_Provider4;
        private readonly Security_Shared448_Command3 _security_Shared448_Command3;
        private readonly Security_Shared448_Helper12 _security_Shared448_Helper12;
        private readonly Integration_Processors321_Provider3 _integration_Processors321_Provider3;
        private readonly Integration_Processors321_Repository8 _integration_Processors321_Repository8;
        private readonly Scheduling_Shared39_Handler4 _scheduling_Shared39_Handler4;

        public Consumer8(IAdmin_Validators431_Provider9 iAdmin_Validators431_Provider9, IAdmin_Contracts_Provider iAdmin_Contracts_Provider, Security_Shared448_Provider4 security_Shared448_Provider4, Security_Shared448_Command3 security_Shared448_Command3, Security_Shared448_Helper12 security_Shared448_Helper12, Integration_Processors321_Provider3 integration_Processors321_Provider3, Integration_Processors321_Repository8 integration_Processors321_Repository8, Scheduling_Shared39_Handler4 scheduling_Shared39_Handler4)
        {
            _iAdmin_Validators431_Provider9 = iAdmin_Validators431_Provider9 ?? throw new ArgumentNullException(nameof(iAdmin_Validators431_Provider9));
            _iAdmin_Contracts_Provider = iAdmin_Contracts_Provider ?? throw new ArgumentNullException(nameof(iAdmin_Contracts_Provider));
            _security_Shared448_Provider4 = security_Shared448_Provider4 ?? throw new ArgumentNullException(nameof(security_Shared448_Provider4));
            _security_Shared448_Command3 = security_Shared448_Command3 ?? throw new ArgumentNullException(nameof(security_Shared448_Command3));
            _security_Shared448_Helper12 = security_Shared448_Helper12 ?? throw new ArgumentNullException(nameof(security_Shared448_Helper12));
            _integration_Processors321_Provider3 = integration_Processors321_Provider3 ?? throw new ArgumentNullException(nameof(integration_Processors321_Provider3));
            _integration_Processors321_Repository8 = integration_Processors321_Repository8 ?? throw new ArgumentNullException(nameof(integration_Processors321_Repository8));
            _scheduling_Shared39_Handler4 = scheduling_Shared39_Handler4 ?? throw new ArgumentNullException(nameof(scheduling_Shared39_Handler4));
        }

        public IAdmin_Validators431_Provider9 GetIAdmin_Validators431_Provider9() => _iAdmin_Validators431_Provider9;
        public IAdmin_Contracts_Provider GetIAdmin_Contracts_Provider() => _iAdmin_Contracts_Provider;
        public Security_Shared448_Provider4 GetSecurity_Shared448_Provider4() => _security_Shared448_Provider4;
        public Security_Shared448_Command3 GetSecurity_Shared448_Command3() => _security_Shared448_Command3;
        public Security_Shared448_Helper12 GetSecurity_Shared448_Helper12() => _security_Shared448_Helper12;
        public Integration_Processors321_Provider3 GetIntegration_Processors321_Provider3() => _integration_Processors321_Provider3;
        public Integration_Processors321_Repository8 GetIntegration_Processors321_Repository8() => _integration_Processors321_Repository8;
        public Scheduling_Shared39_Handler4 GetScheduling_Shared39_Handler4() => _scheduling_Shared39_Handler4;
