...
{
    internal class Reporting_Events_Repository4
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // Reporting_Events_Repository4 implementation
        }
...
public int Config94SortOrder { get; set; }
    ...
    {
        public DbSet<Reporting_Events_Repository4> Reporting_Events_Repository4s { get; set; }
    }
