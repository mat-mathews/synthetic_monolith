...
{
    internal sealed class Common_Data81_Handler4
    {
        private readonly string _sql = "SELECT * FROM Orders WHERE Id = @Id";
        public void Execute()
        {
            // Common_Data81_Handler4 implementation
        }
...
public int Attr24SortOrder { get; set; }
    ...
    public class Data81Context : DbContext
    {
        public DbSet<Common_Data81_Handler4> Common_Data81_Handler4s { get; set; }
    }
