...
{
    internal interface ICommon_Data81_Service
    {
        /// <summary>Processes the Common_Data81_Service operation.</summary>
        void ProcessCommon_Data81_Service();

        /// <summary>Validates the Common_Data81_Service state.</summary>
        bool ValidateCommon_Data81_Service();
    }
