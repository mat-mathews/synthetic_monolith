...
{
    internal interface ICommon_Api213_Handler8
    {
        /// <summary>Processes the Common_Api213_Handler8 operation.</summary>
        void ProcessCommon_Api213_Handler8();

        /// <summary>Validates the Common_Api213_Handler8 state.</summary>
        bool ValidateCommon_Api213_Handler8();
    }
