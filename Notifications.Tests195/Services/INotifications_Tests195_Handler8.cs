...
{
    internal interface INotifications_Tests195_Handler8
    {
        /// <summary>Processes the Notifications_Tests195_Handler8 operation.</summary>
        void ProcessNotifications_Tests195_Handler8();

        /// <summary>Validates the Notifications_Tests195_Handler8 state.</summary>
        bool ValidateNotifications_Tests195_Handler8();
    }
