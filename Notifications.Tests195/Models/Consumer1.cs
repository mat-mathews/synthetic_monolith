...
namespace Notifications.Tests195
{
    ...
    public class Consumer1
    {
        ...
        private readonly BatchJobs_Events435_Processor1 _batchJobs_Events435_Processor1;
        private readonly Notifications_Models277_Provider4 _notifications_Models277_Provider4;

        public Consumer1(Auth_Core_Processor8 auth_Core_Processor8, IAuth_Core_Validator7 iAuth_Core_Validator7, IReporting_Web_Factory2 iReporting_Web_Factory2, Reporting_Web_Provider5 reporting_Web_Provider5, IReporting_Web_Handler4 iReporting_Web_Handler4, Import_Data_Builder6 import_Data_Builder6, BatchJobs_Events435_Processor1 batchJobs_Events435_Processor1, Notifications_Models277_Provider4 notifications_Models277_Provider4)
        {
            ...
            _batchJobs_Events435_Processor1 = batchJobs_Events435_Processor1 ?? throw new ArgumentNullException(nameof(batchJobs_Events435_Processor1));
            _notifications_Models277_Provider4 = notifications_Models277_Provider4 ?? throw new ArgumentNullException(nameof(notifications_Models277_Provider4));
        }
        ...
        public BatchJobs_Events435_Processor1 GetBatchJobs_Events435_Processor1() => _batchJobs_Events435_Processor1;
        public Notifications_Models277_Provider4 GetNotifications_Models277_Provider4() => _notifications_Models277_Provider4;
