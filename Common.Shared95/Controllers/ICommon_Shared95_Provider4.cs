...
{
    internal interface ICommon_Shared95_Provider4
    {
        /// <summary>Processes the Common_Shared95_Provider4 operation.</summary>
        void ProcessCommon_Shared95_Provider4();

        /// <summary>Validates the Common_Shared95_Provider4 state.</summary>
        bool ValidateCommon_Shared95_Provider4();
    }
