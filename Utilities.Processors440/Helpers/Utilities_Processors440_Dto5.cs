...
{
    /// <summary>Immutable data transfer record for Utilities_Processors440_Dto5.</summary>
    public record Utilities_Processors440_Dto5(string Value, int Count, DateTime Timestamp);

    public class Processors440Context : DbContext
    {
    }
