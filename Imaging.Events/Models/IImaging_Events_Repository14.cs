...
{
    public interface IImaging_Events_Repository14
    {
        /// <summary>Processes the Imaging_Events_Repository14 operation.</summary>
        void ProcessImaging_Events_Repository14();

        /// <summary>Validates the Imaging_Events_Repository14 state.</summary>
        bool ValidateImaging_Events_Repository14();
    }
