...
{
    /// <summary>Immutable data transfer record for Logging_Events_Command1.</summary>
    public record Logging_Events_Command1(string Value, int Count, DateTime Timestamp);
