...
namespace Logging.Events
{
    ...
    public class Consumer13
    {
        ...
        private readonly Portal_Data_Processor _portal_Data_Processor;
        private readonly Import_Events493_Provider11 _import_Events493_Provider11;
        private readonly Common_Tests_Factory3 _common_Tests_Factory3;

        public Consumer13(Auth_Client249_Provider6 auth_Client249_Provider6, Auth_Client249_Point10 auth_Client249_Point10, Auth_Client249_Dto2 auth_Client249_Dto2, Admin_Mappers324_Request6 admin_Mappers324_Request6, Integration_Handlers333_Service8 integration_Handlers333_Service8, Portal_Data_Processor portal_Data_Processor, Import_Events493_Provider11 import_Events493_Provider11, Common_Tests_Factory3 common_Tests_Factory3)
        {
            ...
            _portal_Data_Processor = portal_Data_Processor ?? throw new ArgumentNullException(nameof(portal_Data_Processor));
            _import_Events493_Provider11 = import_Events493_Provider11 ?? throw new ArgumentNullException(nameof(import_Events493_Provider11));
            _common_Tests_Factory3 = common_Tests_Factory3 ?? throw new ArgumentNullException(nameof(common_Tests_Factory3));
        }
        ...
        public Portal_Data_Processor GetPortal_Data_Processor() => _portal_Data_Processor;
        public Import_Events493_Provider11 GetImport_Events493_Provider11() => _import_Events493_Provider11;
        public Common_Tests_Factory3 GetCommon_Tests_Factory3() => _common_Tests_Factory3;
