...
{
    public interface IScheduling_Client_Factory3
    {
        /// <summary>Processes the Scheduling_Client_Factory3 operation.</summary>
        void ProcessScheduling_Client_Factory3();

        /// <summary>Validates the Scheduling_Client_Factory3 state.</summary>
        bool ValidateScheduling_Client_Factory3();
    }
