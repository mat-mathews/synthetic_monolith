...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Contracts485_Event3.</summary>
    internal record GalaxyWorks_Contracts485_Event3(string Value, int Count, DateTime Timestamp);
