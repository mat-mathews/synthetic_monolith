...
{
    internal interface IGalaxyWorks_Data263_Validator6
    {
        /// <summary>Processes the GalaxyWorks_Data263_Validator6 operation.</summary>
        void ProcessGalaxyWorks_Data263_Validator6();

        /// <summary>Validates the GalaxyWorks_Data263_Validator6 state.</summary>
        bool ValidateGalaxyWorks_Data263_Validator6();
    }
