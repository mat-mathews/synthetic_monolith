...
namespace GalaxyWorks.Data263
{
    ...
    public class Consumer18
    {
        ...
        private readonly IAuth_Mappers28_Handler2 _iAuth_Mappers28_Handler2;
        private readonly Auth_Mappers28_Provider7 _auth_Mappers28_Provider7;
        private readonly Auth_Mappers28_Processor1 _auth_Mappers28_Processor1;
        private readonly Export_Data150_Processor5 _export_Data150_Processor5;

        public Consumer18(Admin_Web4_Provider1 admin_Web4_Provider1, IAdmin_Web4_Validator4 iAdmin_Web4_Validator4, Auth_Processors400_Info2 auth_Processors400_Info2, IAuth_Processors400_Handler4 iAuth_Processors400_Handler4, IAuth_Mappers28_Handler2 iAuth_Mappers28_Handler2, Auth_Mappers28_Provider7 auth_Mappers28_Provider7, Auth_Mappers28_Processor1 auth_Mappers28_Processor1, Export_Data150_Processor5 export_Data150_Processor5)
        {
            ...
            _iAuth_Mappers28_Handler2 = iAuth_Mappers28_Handler2 ?? throw new ArgumentNullException(nameof(iAuth_Mappers28_Handler2));
            _auth_Mappers28_Provider7 = auth_Mappers28_Provider7 ?? throw new ArgumentNullException(nameof(auth_Mappers28_Provider7));
            _auth_Mappers28_Processor1 = auth_Mappers28_Processor1 ?? throw new ArgumentNullException(nameof(auth_Mappers28_Processor1));
            _export_Data150_Processor5 = export_Data150_Processor5 ?? throw new ArgumentNullException(nameof(export_Data150_Processor5));
        }
        ...
        public IAuth_Mappers28_Handler2 GetIAuth_Mappers28_Handler2() => _iAuth_Mappers28_Handler2;
        public Auth_Mappers28_Provider7 GetAuth_Mappers28_Provider7() => _auth_Mappers28_Provider7;
        public Auth_Mappers28_Processor1 GetAuth_Mappers28_Processor1() => _auth_Mappers28_Processor1;
        public Export_Data150_Processor5 GetExport_Data150_Processor5() => _export_Data150_Processor5;
