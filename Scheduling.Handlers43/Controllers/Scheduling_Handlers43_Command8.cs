...
{
    /// <summary>Immutable data transfer record for Scheduling_Handlers43_Command8.</summary>
    public record Scheduling_Handlers43_Command8(string Value, int Count, DateTime Timestamp);
