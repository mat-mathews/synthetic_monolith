...
namespace Scheduling.Handlers43
{
    ...
    public class Consumer17
    {
        ...
        private readonly Workflow_Web_Builder4 _workflow_Web_Builder4;
        private readonly IGalaxyWorks_Processors_Provider8 _iGalaxyWorks_Processors_Provider8;
        private readonly Auth_Handlers_Manager3 _auth_Handlers_Manager3;
        private readonly Integration_Processors71_Factory9 _integration_Processors71_Factory9;
        private readonly Integration_Processors71_Service3 _integration_Processors71_Service3;
        private readonly Export_Processors449_Factory3 _export_Processors449_Factory3;
        private readonly Export_Processors449_Controller5 _export_Processors449_Controller5;

        public Consumer17(Admin_Service_Builder1 admin_Service_Builder1, Workflow_Web_Builder4 workflow_Web_Builder4, IGalaxyWorks_Processors_Provider8 iGalaxyWorks_Processors_Provider8, Auth_Handlers_Manager3 auth_Handlers_Manager3, Integration_Processors71_Factory9 integration_Processors71_Factory9, Integration_Processors71_Service3 integration_Processors71_Service3, Export_Processors449_Factory3 export_Processors449_Factory3, Export_Processors449_Controller5 export_Processors449_Controller5)
        {
            _admin_Service_Builder1 = admin_Service_Builder1 ?? throw new ArgumentNullException(nameof(admin_Service_Builder1));
            _workflow_Web_Builder4 = workflow_Web_Builder4 ?? throw new ArgumentNullException(nameof(workflow_Web_Builder4));
            _iGalaxyWorks_Processors_Provider8 = iGalaxyWorks_Processors_Provider8 ?? throw new ArgumentNullException(nameof(iGalaxyWorks_Processors_Provider8));
            _auth_Handlers_Manager3 = auth_Handlers_Manager3 ?? throw new ArgumentNullException(nameof(auth_Handlers_Manager3));
            _integration_Processors71_Factory9 = integration_Processors71_Factory9 ?? throw new ArgumentNullException(nameof(integration_Processors71_Factory9));
            _integration_Processors71_Service3 = integration_Processors71_Service3 ?? throw new ArgumentNullException(nameof(integration_Processors71_Service3));
            _export_Processors449_Factory3 = export_Processors449_Factory3 ?? throw new ArgumentNullException(nameof(export_Processors449_Factory3));
            _export_Processors449_Controller5 = export_Processors449_Controller5 ?? throw new ArgumentNullException(nameof(export_Processors449_Controller5));
        }

        public Admin_Service_Builder1 GetAdmin_Service_Builder1() => _admin_Service_Builder1;
        public Workflow_Web_Builder4 GetWorkflow_Web_Builder4() => _workflow_Web_Builder4;
        public IGalaxyWorks_Processors_Provider8 GetIGalaxyWorks_Processors_Provider8() => _iGalaxyWorks_Processors_Provider8;
        public Auth_Handlers_Manager3 GetAuth_Handlers_Manager3() => _auth_Handlers_Manager3;
        public Integration_Processors71_Factory9 GetIntegration_Processors71_Factory9() => _integration_Processors71_Factory9;
        public Integration_Processors71_Service3 GetIntegration_Processors71_Service3() => _integration_Processors71_Service3;
        public Export_Processors449_Factory3 GetExport_Processors449_Factory3() => _export_Processors449_Factory3;
        public Export_Processors449_Controller5 GetExport_Processors449_Controller5() => _export_Processors449_Controller5;
