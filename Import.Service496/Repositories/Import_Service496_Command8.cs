...
{
    /// <summary>Immutable data transfer record for Import_Service496_Command8.</summary>
    public record Import_Service496_Command8(string Value, int Count, DateTime Timestamp);
