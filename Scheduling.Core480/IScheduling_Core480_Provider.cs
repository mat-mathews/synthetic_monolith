...
{
    internal interface IScheduling_Core480_Provider
    {
        /// <summary>Processes the Scheduling_Core480_Provider operation.</summary>
        void ProcessScheduling_Core480_Provider();

        /// <summary>Validates the Scheduling_Core480_Provider state.</summary>
        bool ValidateScheduling_Core480_Provider();
    }
