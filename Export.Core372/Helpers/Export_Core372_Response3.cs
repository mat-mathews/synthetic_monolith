...
{
    /// <summary>Immutable data transfer record for Export_Core372_Response3.</summary>
    internal record Export_Core372_Response3(string Value, int Count, DateTime Timestamp);
