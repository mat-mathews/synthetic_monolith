...
{
    /// <summary>Immutable data transfer record for Security_Shared155_Command5.</summary>
    public record Security_Shared155_Command5(string Value, int Count, DateTime Timestamp);
