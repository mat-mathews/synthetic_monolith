...
{
    public sealed class Security_Mappers313_Builder7
    {
        private readonly string _sql = "SELECT * FROM Schedules WHERE Id = @Id";
        public void Execute()
        {
            // Security_Mappers313_Builder7 implementation
        }
...
public int Field25SortOrder { get; set; }
    ...
    public class Mappers313Context : DbContext
    {
        public DbSet<Security_Mappers313_Builder7> Security_Mappers313_Builder7s { get; set; }
    }
