...
namespace BatchJobs.Api
{
    ...
    public class Consumer26
    {
        ...
        private readonly IDataAccess_Data_Handler1 _iDataAccess_Data_Handler1;
        private readonly Import_Api179_Manager6 _import_Api179_Manager6;
        private readonly Export_Service205_Result11 _export_Service205_Result11;
        private readonly BatchJobs_Api501_Processor8 _batchJobs_Api501_Processor8;
        private readonly GalaxyWorks_Contracts392_Processor8 _galaxyWorks_Contracts392_Processor8;
        private readonly Integration_Processors241_ViewModel3 _integration_Processors241_ViewModel3;
        private readonly BatchJobs_Processors_Handler5 _batchJobs_Processors_Handler5;

        public Consumer26(Admin_Web46_Factory12 admin_Web46_Factory12, IDataAccess_Data_Handler1 iDataAccess_Data_Handler1, Import_Api179_Manager6 import_Api179_Manager6, Export_Service205_Result11 export_Service205_Result11, BatchJobs_Api501_Processor8 batchJobs_Api501_Processor8, GalaxyWorks_Contracts392_Processor8 galaxyWorks_Contracts392_Processor8, Integration_Processors241_ViewModel3 integration_Processors241_ViewModel3, BatchJobs_Processors_Handler5 batchJobs_Processors_Handler5)
        {
            _admin_Web46_Factory12 = admin_Web46_Factory12 ?? throw new ArgumentNullException(nameof(admin_Web46_Factory12));
            _iDataAccess_Data_Handler1 = iDataAccess_Data_Handler1 ?? throw new ArgumentNullException(nameof(iDataAccess_Data_Handler1));
            _import_Api179_Manager6 = import_Api179_Manager6 ?? throw new ArgumentNullException(nameof(import_Api179_Manager6));
            _export_Service205_Result11 = export_Service205_Result11 ?? throw new ArgumentNullException(nameof(export_Service205_Result11));
            _batchJobs_Api501_Processor8 = batchJobs_Api501_Processor8 ?? throw new ArgumentNullException(nameof(batchJobs_Api501_Processor8));
            _galaxyWorks_Contracts392_Processor8 = galaxyWorks_Contracts392_Processor8 ?? throw new ArgumentNullException(nameof(galaxyWorks_Contracts392_Processor8));
            ...
            _batchJobs_Processors_Handler5 = batchJobs_Processors_Handler5 ?? throw new ArgumentNullException(nameof(batchJobs_Processors_Handler5));
        }

        public Admin_Web46_Factory12 GetAdmin_Web46_Factory12() => _admin_Web46_Factory12;
        public IDataAccess_Data_Handler1 GetIDataAccess_Data_Handler1() => _iDataAccess_Data_Handler1;
        public Import_Api179_Manager6 GetImport_Api179_Manager6() => _import_Api179_Manager6;
        public Export_Service205_Result11 GetExport_Service205_Result11() => _export_Service205_Result11;
        public BatchJobs_Api501_Processor8 GetBatchJobs_Api501_Processor8() => _batchJobs_Api501_Processor8;
        public GalaxyWorks_Contracts392_Processor8 GetGalaxyWorks_Contracts392_Processor8() => _galaxyWorks_Contracts392_Processor8;
        ...
        public BatchJobs_Processors_Handler5 GetBatchJobs_Processors_Handler5() => _batchJobs_Processors_Handler5;
