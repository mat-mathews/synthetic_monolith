...
{
    internal interface IBatchJobs_Api_Service6
    {
        /// <summary>Processes the BatchJobs_Api_Service6 operation.</summary>
        void ProcessBatchJobs_Api_Service6();

        /// <summary>Validates the BatchJobs_Api_Service6 state.</summary>
        bool ValidateBatchJobs_Api_Service6();
    }
