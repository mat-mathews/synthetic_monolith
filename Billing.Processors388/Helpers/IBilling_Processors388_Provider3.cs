...
{
    internal interface IBilling_Processors388_Provider3
    {
        /// <summary>Processes the Billing_Processors388_Provider3 operation.</summary>
        void ProcessBilling_Processors388_Provider3();

        /// <summary>Validates the Billing_Processors388_Provider3 state.</summary>
        bool ValidateBilling_Processors388_Provider3();
    }
