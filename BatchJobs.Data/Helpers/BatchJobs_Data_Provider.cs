...
{
    internal static class BatchJobs_Data_Provider
    {
        private const string SprocName = "dbo.sp_ValidateSession";
        // Execute stored procedure dbo.sp_ValidateSession
        private const string SprocName = "dbo.sp_InsertDocument";
        // Execute stored procedure dbo.sp_InsertDocument
        private const string SprocName = "dbo.usp_DeleteUser";
        // Execute stored procedure dbo.usp_DeleteUser
        public void Execute()
        {
            // BatchJobs_Data_Provider implementation
        }
