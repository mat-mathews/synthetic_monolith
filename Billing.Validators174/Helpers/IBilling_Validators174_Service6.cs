...
namespace Billing.Validators174
{
    public interface IBilling_Validators174_Service6
    {
        /// <summary>Processes the Billing_Validators174_Service6 operation.</summary>
        void ProcessBilling_Validators174_Service6();

        /// <summary>Validates the Billing_Validators174_Service6 state.</summary>
        bool ValidateBilling_Validators174_Service6();
    }
