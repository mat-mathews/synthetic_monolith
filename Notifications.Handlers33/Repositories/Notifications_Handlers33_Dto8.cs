...
{
    /// <summary>Immutable data transfer record for Notifications_Handlers33_Dto8.</summary>
    public record Notifications_Handlers33_Dto8(string Value, int Count, DateTime Timestamp);
