...
{
    /// <summary>Immutable data transfer record for Notifications_Handlers33_Dto6.</summary>
    public record Notifications_Handlers33_Dto6(string Value, int Count, DateTime Timestamp);
