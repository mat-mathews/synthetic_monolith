...
{
    public interface IBilling_Mappers124_Service2
    {
        /// <summary>Processes the Billing_Mappers124_Service2 operation.</summary>
        void ProcessBilling_Mappers124_Service2();

        /// <summary>Validates the Billing_Mappers124_Service2 state.</summary>
        bool ValidateBilling_Mappers124_Service2();
    }
