...
{
    public interface IImaging_Mappers_Factory1
    {
        /// <summary>Processes the Imaging_Mappers_Factory1 operation.</summary>
        void ProcessImaging_Mappers_Factory1();

        /// <summary>Validates the Imaging_Mappers_Factory1 state.</summary>
        bool ValidateImaging_Mappers_Factory1();
    }
