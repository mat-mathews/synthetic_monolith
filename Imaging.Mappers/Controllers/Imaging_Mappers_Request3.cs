...
{
    /// <summary>Immutable data transfer record for Imaging_Mappers_Request3.</summary>
    internal record Imaging_Mappers_Request3(string Value, int Count, DateTime Timestamp);
