...
{
    public interface IImaging_Mappers_Validator9
    {
        /// <summary>Processes the Imaging_Mappers_Validator9 operation.</summary>
        void ProcessImaging_Mappers_Validator9();

        /// <summary>Validates the Imaging_Mappers_Validator9 state.</summary>
        bool ValidateImaging_Mappers_Validator9();
    }
