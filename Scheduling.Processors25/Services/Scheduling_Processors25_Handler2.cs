...
{
    internal class Scheduling_Processors25_Handler2
    {
        private readonly string _sql = "SELECT * FROM Schedules WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Processors25_Handler2 implementation
        }
...
public int Detail94SortOrder { get; set; }
    ...
    public class Processors25Context : DbContext
    {
        public DbSet<Scheduling_Processors25_Handler2> Scheduling_Processors25_Handler2s { get; set; }
    }
