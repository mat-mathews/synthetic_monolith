...
namespace Documents.Shared452
{
    ...
    {
        private readonly Import_Client_Service11 _import_Client_Service11;
        private readonly IImport_Client_Validator5 _iImport_Client_Validator5;
        private readonly Security_Handlers460_Controller5 _security_Handlers460_Controller5;
        private readonly Security_Handlers460_Repository4 _security_Handlers460_Repository4;
        private readonly Logging_Models379_Dto _logging_Models379_Dto;
        private readonly Export_Api49_Builder _export_Api49_Builder;
        private readonly BatchJobs_Mappers362_Info2 _batchJobs_Mappers362_Info2;
        private readonly IBatchJobs_Mappers362_Factory3 _iBatchJobs_Mappers362_Factory3;

        public Consumer13(Import_Client_Service11 import_Client_Service11, IImport_Client_Validator5 iImport_Client_Validator5, Security_Handlers460_Controller5 security_Handlers460_Controller5, Security_Handlers460_Repository4 security_Handlers460_Repository4, Logging_Models379_Dto logging_Models379_Dto, Export_Api49_Builder export_Api49_Builder, BatchJobs_Mappers362_Info2 batchJobs_Mappers362_Info2, IBatchJobs_Mappers362_Factory3 iBatchJobs_Mappers362_Factory3)
        {
            _import_Client_Service11 = import_Client_Service11 ?? throw new ArgumentNullException(nameof(import_Client_Service11));
            _iImport_Client_Validator5 = iImport_Client_Validator5 ?? throw new ArgumentNullException(nameof(iImport_Client_Validator5));
            _security_Handlers460_Controller5 = security_Handlers460_Controller5 ?? throw new ArgumentNullException(nameof(security_Handlers460_Controller5));
            _security_Handlers460_Repository4 = security_Handlers460_Repository4 ?? throw new ArgumentNullException(nameof(security_Handlers460_Repository4));
            _logging_Models379_Dto = logging_Models379_Dto ?? throw new ArgumentNullException(nameof(logging_Models379_Dto));
            _export_Api49_Builder = export_Api49_Builder ?? throw new ArgumentNullException(nameof(export_Api49_Builder));
            _batchJobs_Mappers362_Info2 = batchJobs_Mappers362_Info2 ?? throw new ArgumentNullException(nameof(batchJobs_Mappers362_Info2));
            _iBatchJobs_Mappers362_Factory3 = iBatchJobs_Mappers362_Factory3 ?? throw new ArgumentNullException(nameof(iBatchJobs_Mappers362_Factory3));
        }

        public Import_Client_Service11 GetImport_Client_Service11() => _import_Client_Service11;
        public IImport_Client_Validator5 GetIImport_Client_Validator5() => _iImport_Client_Validator5;
        public Security_Handlers460_Controller5 GetSecurity_Handlers460_Controller5() => _security_Handlers460_Controller5;
        public Security_Handlers460_Repository4 GetSecurity_Handlers460_Repository4() => _security_Handlers460_Repository4;
        public Logging_Models379_Dto GetLogging_Models379_Dto() => _logging_Models379_Dto;
        public Export_Api49_Builder GetExport_Api49_Builder() => _export_Api49_Builder;
        public BatchJobs_Mappers362_Info2 GetBatchJobs_Mappers362_Info2() => _batchJobs_Mappers362_Info2;
        public IBatchJobs_Mappers362_Factory3 GetIBatchJobs_Mappers362_Factory3() => _iBatchJobs_Mappers362_Factory3;
