...
{
    /// <summary>Immutable data transfer record for Documents_Shared452_Request11.</summary>
    public record Documents_Shared452_Request11(string Value, int Count, DateTime Timestamp);
