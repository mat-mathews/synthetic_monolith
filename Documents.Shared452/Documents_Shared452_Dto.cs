...
{
    /// <summary>Immutable data transfer record for Documents_Shared452_Dto.</summary>
    internal record Documents_Shared452_Dto(string Value, int Count, DateTime Timestamp);

    public class Shared452Context : DbContext
    {
    }
