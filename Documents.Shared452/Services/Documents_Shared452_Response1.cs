...
{
    /// <summary>Immutable data transfer record for Documents_Shared452_Response1.</summary>
    public record Documents_Shared452_Response1(string Value, int Count, DateTime Timestamp);
