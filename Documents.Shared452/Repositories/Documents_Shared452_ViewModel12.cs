...
{
    /// <summary>Immutable data transfer record for Documents_Shared452_ViewModel12.</summary>
    internal record Documents_Shared452_ViewModel12(string Value, int Count, DateTime Timestamp);
