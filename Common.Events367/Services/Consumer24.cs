...
namespace Common.Events367
{
    ...
    public class Consumer24
    {
        ...
        private readonly Billing_Client22_Repository2 _billing_Client22_Repository2;
        private readonly Billing_Service432_Provider6 _billing_Service432_Provider6;
        private readonly Notifications_Tests299_Dto _notifications_Tests299_Dto;
        private readonly INotifications_Tests299_Validator2 _iNotifications_Tests299_Validator2;
        private readonly Integration_Processors71_Helper _integration_Processors71_Helper;
        private readonly Logging_Validators359_Repository6 _logging_Validators359_Repository6;
        private readonly Logging_Validators359_Manager4 _logging_Validators359_Manager4;

        public Consumer24(Auth_Models236_Handler2 auth_Models236_Handler2, Billing_Client22_Repository2 billing_Client22_Repository2, Billing_Service432_Provider6 billing_Service432_Provider6, Notifications_Tests299_Dto notifications_Tests299_Dto, INotifications_Tests299_Validator2 iNotifications_Tests299_Validator2, Integration_Processors71_Helper integration_Processors71_Helper, Logging_Validators359_Repository6 logging_Validators359_Repository6, Logging_Validators359_Manager4 logging_Validators359_Manager4)
        {
            _auth_Models236_Handler2 = auth_Models236_Handler2 ?? throw new ArgumentNullException(nameof(auth_Models236_Handler2));
            _billing_Client22_Repository2 = billing_Client22_Repository2 ?? throw new ArgumentNullException(nameof(billing_Client22_Repository2));
            _billing_Service432_Provider6 = billing_Service432_Provider6 ?? throw new ArgumentNullException(nameof(billing_Service432_Provider6));
            _notifications_Tests299_Dto = notifications_Tests299_Dto ?? throw new ArgumentNullException(nameof(notifications_Tests299_Dto));
            ...
            _integration_Processors71_Helper = integration_Processors71_Helper ?? throw new ArgumentNullException(nameof(integration_Processors71_Helper));
            _logging_Validators359_Repository6 = logging_Validators359_Repository6 ?? throw new ArgumentNullException(nameof(logging_Validators359_Repository6));
            _logging_Validators359_Manager4 = logging_Validators359_Manager4 ?? throw new ArgumentNullException(nameof(logging_Validators359_Manager4));
        }

        public Auth_Models236_Handler2 GetAuth_Models236_Handler2() => _auth_Models236_Handler2;
        public Billing_Client22_Repository2 GetBilling_Client22_Repository2() => _billing_Client22_Repository2;
        public Billing_Service432_Provider6 GetBilling_Service432_Provider6() => _billing_Service432_Provider6;
        public Notifications_Tests299_Dto GetNotifications_Tests299_Dto() => _notifications_Tests299_Dto;
        public INotifications_Tests299_Validator2 GetINotifications_Tests299_Validator2() => _iNotifications_Tests299_Validator2;
        public Integration_Processors71_Helper GetIntegration_Processors71_Helper() => _integration_Processors71_Helper;
        public Logging_Validators359_Repository6 GetLogging_Validators359_Repository6() => _logging_Validators359_Repository6;
        public Logging_Validators359_Manager4 GetLogging_Validators359_Manager4() => _logging_Validators359_Manager4;
