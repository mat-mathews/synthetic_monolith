...
namespace Common.Events367
{
    ...
    public class Consumer27
    {
        ...
        private readonly Billing_Client22_Helper4 _billing_Client22_Helper4;
        private readonly Billing_Client22_Repository2 _billing_Client22_Repository2;
        private readonly IBilling_Service432_Handler _iBilling_Service432_Handler;
        private readonly INotifications_Tests299_Validator2 _iNotifications_Tests299_Validator2;
        private readonly Integration_Processors71_Factory4 _integration_Processors71_Factory4;
        private readonly Logging_Validators359_Key5 _logging_Validators359_Key5;
        private readonly Logging_Validators359_Response1 _logging_Validators359_Response1;

        public Consumer27(Auth_Models236_Processor1 auth_Models236_Processor1, Billing_Client22_Helper4 billing_Client22_Helper4, Billing_Client22_Repository2 billing_Client22_Repository2, IBilling_Service432_Handler iBilling_Service432_Handler, INotifications_Tests299_Validator2 iNotifications_Tests299_Validator2, Integration_Processors71_Factory4 integration_Processors71_Factory4, Logging_Validators359_Key5 logging_Validators359_Key5, Logging_Validators359_Response1 logging_Validators359_Response1)
        {
            _auth_Models236_Processor1 = auth_Models236_Processor1 ?? throw new ArgumentNullException(nameof(auth_Models236_Processor1));
            _billing_Client22_Helper4 = billing_Client22_Helper4 ?? throw new ArgumentNullException(nameof(billing_Client22_Helper4));
            ...
            _iBilling_Service432_Handler = iBilling_Service432_Handler ?? throw new ArgumentNullException(nameof(iBilling_Service432_Handler));
            ...
            _integration_Processors71_Factory4 = integration_Processors71_Factory4 ?? throw new ArgumentNullException(nameof(integration_Processors71_Factory4));
            _logging_Validators359_Key5 = logging_Validators359_Key5 ?? throw new ArgumentNullException(nameof(logging_Validators359_Key5));
            _logging_Validators359_Response1 = logging_Validators359_Response1 ?? throw new ArgumentNullException(nameof(logging_Validators359_Response1));
        }

        public Auth_Models236_Processor1 GetAuth_Models236_Processor1() => _auth_Models236_Processor1;
        public Billing_Client22_Helper4 GetBilling_Client22_Helper4() => _billing_Client22_Helper4;
        public Billing_Client22_Repository2 GetBilling_Client22_Repository2() => _billing_Client22_Repository2;
        public IBilling_Service432_Handler GetIBilling_Service432_Handler() => _iBilling_Service432_Handler;
        public INotifications_Tests299_Validator2 GetINotifications_Tests299_Validator2() => _iNotifications_Tests299_Validator2;
        public Integration_Processors71_Factory4 GetIntegration_Processors71_Factory4() => _integration_Processors71_Factory4;
        public Logging_Validators359_Key5 GetLogging_Validators359_Key5() => _logging_Validators359_Key5;
        public Logging_Validators359_Response1 GetLogging_Validators359_Response1() => _logging_Validators359_Response1;
