...
namespace DataAccess.Web
{
    ...
    public class Consumer2
    {
        ...
        private readonly BatchJobs_Contracts_Handler1 _batchJobs_Contracts_Handler1;
        private readonly BatchJobs_Contracts_Range2 _batchJobs_Contracts_Range2;
        private readonly Import_Mappers_Processor7 _import_Mappers_Processor7;
        private readonly Import_Mappers_Manager8 _import_Mappers_Manager8;

        public Consumer2(Auth_Events78_Processor5 auth_Events78_Processor5, Auth_Events78_Controller4 auth_Events78_Controller4, Auth_Events78_Service8 auth_Events78_Service8, IBatchJobs_Contracts_Handler5 iBatchJobs_Contracts_Handler5, BatchJobs_Contracts_Handler1 batchJobs_Contracts_Handler1, BatchJobs_Contracts_Range2 batchJobs_Contracts_Range2, Import_Mappers_Processor7 import_Mappers_Processor7, Import_Mappers_Manager8 import_Mappers_Manager8)
        {
            ...
            _batchJobs_Contracts_Handler1 = batchJobs_Contracts_Handler1 ?? throw new ArgumentNullException(nameof(batchJobs_Contracts_Handler1));
            _batchJobs_Contracts_Range2 = batchJobs_Contracts_Range2 ?? throw new ArgumentNullException(nameof(batchJobs_Contracts_Range2));
            _import_Mappers_Processor7 = import_Mappers_Processor7 ?? throw new ArgumentNullException(nameof(import_Mappers_Processor7));
            _import_Mappers_Manager8 = import_Mappers_Manager8 ?? throw new ArgumentNullException(nameof(import_Mappers_Manager8));
        }
        ...
        public BatchJobs_Contracts_Handler1 GetBatchJobs_Contracts_Handler1() => _batchJobs_Contracts_Handler1;
        public BatchJobs_Contracts_Range2 GetBatchJobs_Contracts_Range2() => _batchJobs_Contracts_Range2;
        public Import_Mappers_Processor7 GetImport_Mappers_Processor7() => _import_Mappers_Processor7;
        public Import_Mappers_Manager8 GetImport_Mappers_Manager8() => _import_Mappers_Manager8;
