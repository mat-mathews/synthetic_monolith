...
{
    /// <summary>Immutable data transfer record for Auth_Validators87_Response6.</summary>
    internal record Auth_Validators87_Response6(string Value, int Count, DateTime Timestamp);
