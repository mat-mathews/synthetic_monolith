...
{
    internal interface IImaging_Data_Validator7
    {
        /// <summary>Processes the Imaging_Data_Validator7 operation.</summary>
        void ProcessImaging_Data_Validator7();

        /// <summary>Validates the Imaging_Data_Validator7 state.</summary>
        bool ValidateImaging_Data_Validator7();
    }
