...
{
    internal interface IImaging_Data_Validator3
    {
        /// <summary>Processes the Imaging_Data_Validator3 operation.</summary>
        void ProcessImaging_Data_Validator3();

        /// <summary>Validates the Imaging_Data_Validator3 state.</summary>
        bool ValidateImaging_Data_Validator3();
    }
