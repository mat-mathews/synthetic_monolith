...
{
    internal interface IImaging_Data_Validator4
    {
        /// <summary>Processes the Imaging_Data_Validator4 operation.</summary>
        void ProcessImaging_Data_Validator4();

        /// <summary>Validates the Imaging_Data_Validator4 state.</summary>
        bool ValidateImaging_Data_Validator4();
    }
