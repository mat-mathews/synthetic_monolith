...
namespace Billing.Mappers198
{
    ...
    public class Consumer32
    {
        ...
        private readonly Admin_Shared14_Builder7 _admin_Shared14_Builder7;
        private readonly IAdmin_Data465_Validator4 _iAdmin_Data465_Validator4;
        private readonly Portal_Api99_Service4 _portal_Api99_Service4;
        private readonly Auth_Web_Range4 _auth_Web_Range4;
        private readonly Auth_Web_Helper _auth_Web_Helper;
        private readonly Auth_Web_Factory3 _auth_Web_Factory3;
        private readonly Documents_Api156_Helper10 _documents_Api156_Helper10;

        public Consumer32(Admin_Client177_Builder1 admin_Client177_Builder1, Admin_Shared14_Builder7 admin_Shared14_Builder7, IAdmin_Data465_Validator4 iAdmin_Data465_Validator4, Portal_Api99_Service4 portal_Api99_Service4, Auth_Web_Range4 auth_Web_Range4, Auth_Web_Helper auth_Web_Helper, Auth_Web_Factory3 auth_Web_Factory3, Documents_Api156_Helper10 documents_Api156_Helper10)
        {
            _admin_Client177_Builder1 = admin_Client177_Builder1 ?? throw new ArgumentNullException(nameof(admin_Client177_Builder1));
            _admin_Shared14_Builder7 = admin_Shared14_Builder7 ?? throw new ArgumentNullException(nameof(admin_Shared14_Builder7));
            _iAdmin_Data465_Validator4 = iAdmin_Data465_Validator4 ?? throw new ArgumentNullException(nameof(iAdmin_Data465_Validator4));
            _portal_Api99_Service4 = portal_Api99_Service4 ?? throw new ArgumentNullException(nameof(portal_Api99_Service4));
            _auth_Web_Range4 = auth_Web_Range4 ?? throw new ArgumentNullException(nameof(auth_Web_Range4));
            _auth_Web_Helper = auth_Web_Helper ?? throw new ArgumentNullException(nameof(auth_Web_Helper));
            _auth_Web_Factory3 = auth_Web_Factory3 ?? throw new ArgumentNullException(nameof(auth_Web_Factory3));
            _documents_Api156_Helper10 = documents_Api156_Helper10 ?? throw new ArgumentNullException(nameof(documents_Api156_Helper10));
        }

        public Admin_Client177_Builder1 GetAdmin_Client177_Builder1() => _admin_Client177_Builder1;
        public Admin_Shared14_Builder7 GetAdmin_Shared14_Builder7() => _admin_Shared14_Builder7;
        public IAdmin_Data465_Validator4 GetIAdmin_Data465_Validator4() => _iAdmin_Data465_Validator4;
        public Portal_Api99_Service4 GetPortal_Api99_Service4() => _portal_Api99_Service4;
        public Auth_Web_Range4 GetAuth_Web_Range4() => _auth_Web_Range4;
        public Auth_Web_Helper GetAuth_Web_Helper() => _auth_Web_Helper;
        public Auth_Web_Factory3 GetAuth_Web_Factory3() => _auth_Web_Factory3;
        public Documents_Api156_Helper10 GetDocuments_Api156_Helper10() => _documents_Api156_Helper10;
