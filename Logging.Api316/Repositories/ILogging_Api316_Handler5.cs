...
{
    public interface ILogging_Api316_Handler5
    {
        /// <summary>Processes the Logging_Api316_Handler5 operation.</summary>
        void ProcessLogging_Api316_Handler5();

        /// <summary>Validates the Logging_Api316_Handler5 state.</summary>
        bool ValidateLogging_Api316_Handler5();
    }
