...
{
    public interface ILogging_Api316_Validator2
    {
        /// <summary>Processes the Logging_Api316_Validator2 operation.</summary>
        void ProcessLogging_Api316_Validator2();

        /// <summary>Validates the Logging_Api316_Validator2 state.</summary>
        bool ValidateLogging_Api316_Validator2();
    }
