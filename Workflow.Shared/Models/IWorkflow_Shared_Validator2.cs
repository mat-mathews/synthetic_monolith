...
{
    public interface IWorkflow_Shared_Validator2
    {
        /// <summary>Processes the Workflow_Shared_Validator2 operation.</summary>
        void ProcessWorkflow_Shared_Validator2();

        /// <summary>Validates the Workflow_Shared_Validator2 state.</summary>
        bool ValidateWorkflow_Shared_Validator2();
    }
