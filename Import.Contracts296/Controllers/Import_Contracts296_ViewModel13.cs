...
{
    /// <summary>Immutable data transfer record for Import_Contracts296_ViewModel13.</summary>
    public record Import_Contracts296_ViewModel13(string Value, int Count, DateTime Timestamp);
