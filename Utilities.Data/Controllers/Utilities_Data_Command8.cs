...
{
    /// <summary>Immutable data transfer record for Utilities_Data_Command8.</summary>
    public record Utilities_Data_Command8(string Value, int Count, DateTime Timestamp);
