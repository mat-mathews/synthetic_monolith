...
{
    /// <summary>Immutable data transfer record for Billing_Models_Command1.</summary>
    public record Billing_Models_Command1(string Value, int Count, DateTime Timestamp);
