...
{
    /// <summary>Immutable data transfer record for Billing_Models_Command13.</summary>
    public record Billing_Models_Command13(string Value, int Count, DateTime Timestamp);
