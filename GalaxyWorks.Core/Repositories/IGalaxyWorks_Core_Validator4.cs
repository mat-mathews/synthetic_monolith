...
{
    internal interface IGalaxyWorks_Core_Validator4
    {
        /// <summary>Processes the GalaxyWorks_Core_Validator4 operation.</summary>
        void ProcessGalaxyWorks_Core_Validator4();

        /// <summary>Validates the GalaxyWorks_Core_Validator4 state.</summary>
        bool ValidateGalaxyWorks_Core_Validator4();
    }
