...
{
    public interface IGalaxyWorks_Core_Validator
    {
        /// <summary>Processes the GalaxyWorks_Core_Validator operation.</summary>
        void ProcessGalaxyWorks_Core_Validator();

        /// <summary>Validates the GalaxyWorks_Core_Validator state.</summary>
        bool ValidateGalaxyWorks_Core_Validator();
    }
