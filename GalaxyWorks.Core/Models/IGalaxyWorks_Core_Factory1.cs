...
{
    public interface IGalaxyWorks_Core_Factory1
    {
        /// <summary>Processes the GalaxyWorks_Core_Factory1 operation.</summary>
        void ProcessGalaxyWorks_Core_Factory1();

        /// <summary>Validates the GalaxyWorks_Core_Factory1 state.</summary>
        bool ValidateGalaxyWorks_Core_Factory1();
    }
