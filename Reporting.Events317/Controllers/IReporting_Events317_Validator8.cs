...
{
    public interface IReporting_Events317_Validator8
    {
        /// <summary>Processes the Reporting_Events317_Validator8 operation.</summary>
        void ProcessReporting_Events317_Validator8();

        /// <summary>Validates the Reporting_Events317_Validator8 state.</summary>
        bool ValidateReporting_Events317_Validator8();
    }
