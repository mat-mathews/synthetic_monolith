...
{
    /// <summary>Immutable data transfer record for Utilities_Tests_Command1.</summary>
    public record Utilities_Tests_Command1(string Value, int Count, DateTime Timestamp);
