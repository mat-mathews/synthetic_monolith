...
{
    internal interface IGalaxyWorks_Models_Provider
    {
        /// <summary>Processes the GalaxyWorks_Models_Provider operation.</summary>
        void ProcessGalaxyWorks_Models_Provider();

        /// <summary>Validates the GalaxyWorks_Models_Provider state.</summary>
        bool ValidateGalaxyWorks_Models_Provider();
    }
