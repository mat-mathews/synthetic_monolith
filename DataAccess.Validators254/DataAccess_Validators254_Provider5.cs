...
{
    internal class DataAccess_Validators254_Provider5 : IDisposable
    {
        private readonly string _sql = "SELECT * FROM Documents WHERE Id = @Id";
        public void Execute()
        {
            // DataAccess_Validators254_Provider5 implementation
        }
...
public int Record79SortOrder { get; set; }
    ...
    public class Validators254Context : DbContext
    {
        public DbSet<DataAccess_Validators254_Provider5> DataAccess_Validators254_Provider5s { get; set; }
    }
