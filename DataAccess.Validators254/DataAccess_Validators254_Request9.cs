...
{
    /// <summary>Immutable data transfer record for DataAccess_Validators254_Request9.</summary>
    internal record DataAccess_Validators254_Request9(string Value, int Count, DateTime Timestamp);
