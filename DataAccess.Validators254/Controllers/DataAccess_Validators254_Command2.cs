...
{
    /// <summary>Immutable data transfer record for DataAccess_Validators254_Command2.</summary>
    internal record DataAccess_Validators254_Command2(string Value, int Count, DateTime Timestamp);
