...
{
    /// <summary>Immutable data transfer record for DataAccess_Validators254_Response.</summary>
    public record DataAccess_Validators254_Response(string Value, int Count, DateTime Timestamp);
