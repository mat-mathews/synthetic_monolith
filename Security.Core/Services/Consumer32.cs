...
namespace Security.Core
{
    ...
    public class Consumer32
    {
        ...
        private readonly Export_Data344_Event11 _export_Data344_Event11;
        private readonly Common_Data_Event8 _common_Data_Event8;
        private readonly ICommon_Data_Factory4 _iCommon_Data_Factory4;
        private readonly Documents_Data68_Helper _documents_Data68_Helper;

        public Consumer32(Admin_Events306_Repository2 admin_Events306_Repository2, Admin_Events306_Helper1 admin_Events306_Helper1, Admin_Events306_Event4 admin_Events306_Event4, IAuth_Mappers28_Handler2 iAuth_Mappers28_Handler2, Export_Data344_Event11 export_Data344_Event11, Common_Data_Event8 common_Data_Event8, ICommon_Data_Factory4 iCommon_Data_Factory4, Documents_Data68_Helper documents_Data68_Helper)
        {
            ...
            _export_Data344_Event11 = export_Data344_Event11 ?? throw new ArgumentNullException(nameof(export_Data344_Event11));
            _common_Data_Event8 = common_Data_Event8 ?? throw new ArgumentNullException(nameof(common_Data_Event8));
            _iCommon_Data_Factory4 = iCommon_Data_Factory4 ?? throw new ArgumentNullException(nameof(iCommon_Data_Factory4));
            _documents_Data68_Helper = documents_Data68_Helper ?? throw new ArgumentNullException(nameof(documents_Data68_Helper));
        }
        ...
        public Export_Data344_Event11 GetExport_Data344_Event11() => _export_Data344_Event11;
        public Common_Data_Event8 GetCommon_Data_Event8() => _common_Data_Event8;
        public ICommon_Data_Factory4 GetICommon_Data_Factory4() => _iCommon_Data_Factory4;
        public Documents_Data68_Helper GetDocuments_Data68_Helper() => _documents_Data68_Helper;
