...
{
    public interface IBatchJobs_Client_Factory2
    {
        /// <summary>Processes the BatchJobs_Client_Factory2 operation.</summary>
        void ProcessBatchJobs_Client_Factory2();

        /// <summary>Validates the BatchJobs_Client_Factory2 state.</summary>
        bool ValidateBatchJobs_Client_Factory2();
    }
