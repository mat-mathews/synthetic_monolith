...
{
    /// <summary>Immutable data transfer record for BatchJobs_Client_Dto7.</summary>
    internal record BatchJobs_Client_Dto7(string Value, int Count, DateTime Timestamp);
