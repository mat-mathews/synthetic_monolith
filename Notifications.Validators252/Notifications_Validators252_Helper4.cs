...
{
    internal static class Notifications_Validators252_Helper4
    {
        private readonly string _sql = "SELECT * FROM Products WHERE Id = @Id";
        public void Execute()
        {
            // Notifications_Validators252_Helper4 implementation
        }
...
public int Attr65SortOrder { get; set; }
    ...
    public class Validators252Context : DbContext
    {
        public DbSet<Notifications_Validators252_Helper4> Notifications_Validators252_Helper4s { get; set; }
    }
