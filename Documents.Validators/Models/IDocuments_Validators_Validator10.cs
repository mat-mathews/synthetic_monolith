...
{
    public interface IDocuments_Validators_Validator10
    {
        /// <summary>Processes the Documents_Validators_Validator10 operation.</summary>
        void ProcessDocuments_Validators_Validator10();

        /// <summary>Validates the Documents_Validators_Validator10 state.</summary>
        bool ValidateDocuments_Validators_Validator10();
    }
