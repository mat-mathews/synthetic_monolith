...
namespace Imaging.Client261
{
    /// <summary>Immutable data transfer record for Imaging_Client261_Command5.</summary>
    internal record Imaging_Client261_Command5(string Value, int Count, DateTime Timestamp);
