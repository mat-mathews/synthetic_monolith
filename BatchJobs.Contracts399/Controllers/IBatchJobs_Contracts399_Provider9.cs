...
{
    public interface IBatchJobs_Contracts399_Provider9
    {
        /// <summary>Processes the BatchJobs_Contracts399_Provider9 operation.</summary>
        void ProcessBatchJobs_Contracts399_Provider9();

        /// <summary>Validates the BatchJobs_Contracts399_Provider9 state.</summary>
        bool ValidateBatchJobs_Contracts399_Provider9();
    }
