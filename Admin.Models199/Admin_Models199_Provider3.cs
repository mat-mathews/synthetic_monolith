...
namespace Admin.Models199
{
    internal static class Admin_Models199_Provider3
    {
        private readonly string _sql = "SELECT * FROM Configurations WHERE Id = @Id";
        public void Execute()
        {
            // Admin_Models199_Provider3 implementation
        }
...
public int Record50SortOrder { get; set; }
    ...
    public class Models199Context : DbContext
    {
        public DbSet<Admin_Models199_Provider3> Admin_Models199_Provider3s { get; set; }
    }
