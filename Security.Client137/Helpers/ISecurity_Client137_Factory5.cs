...
{
    public interface ISecurity_Client137_Factory5
    {
        /// <summary>Processes the Security_Client137_Factory5 operation.</summary>
        void ProcessSecurity_Client137_Factory5();

        /// <summary>Validates the Security_Client137_Factory5 state.</summary>
        bool ValidateSecurity_Client137_Factory5();
    }
