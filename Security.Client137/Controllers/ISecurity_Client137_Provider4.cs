...
{
    internal interface ISecurity_Client137_Provider4
    {
        /// <summary>Processes the Security_Client137_Provider4 operation.</summary>
        void ProcessSecurity_Client137_Provider4();

        /// <summary>Validates the Security_Client137_Provider4 state.</summary>
        bool ValidateSecurity_Client137_Provider4();
    }
