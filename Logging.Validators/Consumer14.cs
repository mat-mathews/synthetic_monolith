...
namespace Logging.Validators
{
    ...
    public class Consumer14
    {
        ...
        private readonly Integration_Events_Builder2 _integration_Events_Builder2;
        private readonly Integration_Events_Command5 _integration_Events_Command5;
        private readonly Documents_Tests_Command1 _documents_Tests_Command1;
        private readonly Import_Service_Manager4 _import_Service_Manager4;
        private readonly Reporting_Contracts371_Manager11 _reporting_Contracts371_Manager11;
        private readonly INotifications_Core_Repository13 _iNotifications_Core_Repository13;

        public Consumer14(Admin_Service456_Controller1 admin_Service456_Controller1, Admin_Service456_Dto12 admin_Service456_Dto12, Integration_Events_Builder2 integration_Events_Builder2, Integration_Events_Command5 integration_Events_Command5, Documents_Tests_Command1 documents_Tests_Command1, Import_Service_Manager4 import_Service_Manager4, Reporting_Contracts371_Manager11 reporting_Contracts371_Manager11, INotifications_Core_Repository13 iNotifications_Core_Repository13)
        {
            ...
            _integration_Events_Builder2 = integration_Events_Builder2 ?? throw new ArgumentNullException(nameof(integration_Events_Builder2));
            ...
            _documents_Tests_Command1 = documents_Tests_Command1 ?? throw new ArgumentNullException(nameof(documents_Tests_Command1));
            _import_Service_Manager4 = import_Service_Manager4 ?? throw new ArgumentNullException(nameof(import_Service_Manager4));
            _reporting_Contracts371_Manager11 = reporting_Contracts371_Manager11 ?? throw new ArgumentNullException(nameof(reporting_Contracts371_Manager11));
            _iNotifications_Core_Repository13 = iNotifications_Core_Repository13 ?? throw new ArgumentNullException(nameof(iNotifications_Core_Repository13));
        }
        ...
        public Integration_Events_Builder2 GetIntegration_Events_Builder2() => _integration_Events_Builder2;
        public Integration_Events_Command5 GetIntegration_Events_Command5() => _integration_Events_Command5;
        public Documents_Tests_Command1 GetDocuments_Tests_Command1() => _documents_Tests_Command1;
        public Import_Service_Manager4 GetImport_Service_Manager4() => _import_Service_Manager4;
        public Reporting_Contracts371_Manager11 GetReporting_Contracts371_Manager11() => _reporting_Contracts371_Manager11;
        public INotifications_Core_Repository13 GetINotifications_Core_Repository13() => _iNotifications_Core_Repository13;
