...
namespace Logging.Validators
{
    ...
    {
        private readonly Integration_Events_Factory4 _integration_Events_Factory4;
        private readonly Integration_Events_Manager3 _integration_Events_Manager3;
        private readonly IDocuments_Tests_Validator5 _iDocuments_Tests_Validator5;
        private readonly Documents_Tests_Info _documents_Tests_Info;
        ...
        private readonly Notifications_Core_Provider1 _notifications_Core_Provider1;

        public Consumer18(Integration_Events_Factory4 integration_Events_Factory4, Integration_Events_Manager3 integration_Events_Manager3, IDocuments_Tests_Validator5 iDocuments_Tests_Validator5, Documents_Tests_Info documents_Tests_Info, Reporting_Contracts371_Handler reporting_Contracts371_Handler, Reporting_Contracts371_Controller7 reporting_Contracts371_Controller7, IReporting_Contracts371_Factory2 iReporting_Contracts371_Factory2, Notifications_Core_Provider1 notifications_Core_Provider1)
        {
            _integration_Events_Factory4 = integration_Events_Factory4 ?? throw new ArgumentNullException(nameof(integration_Events_Factory4));
            _integration_Events_Manager3 = integration_Events_Manager3 ?? throw new ArgumentNullException(nameof(integration_Events_Manager3));
            _iDocuments_Tests_Validator5 = iDocuments_Tests_Validator5 ?? throw new ArgumentNullException(nameof(iDocuments_Tests_Validator5));
            _documents_Tests_Info = documents_Tests_Info ?? throw new ArgumentNullException(nameof(documents_Tests_Info));
            ...
            _notifications_Core_Provider1 = notifications_Core_Provider1 ?? throw new ArgumentNullException(nameof(notifications_Core_Provider1));
        }

        public Integration_Events_Factory4 GetIntegration_Events_Factory4() => _integration_Events_Factory4;
        public Integration_Events_Manager3 GetIntegration_Events_Manager3() => _integration_Events_Manager3;
        public IDocuments_Tests_Validator5 GetIDocuments_Tests_Validator5() => _iDocuments_Tests_Validator5;
        public Documents_Tests_Info GetDocuments_Tests_Info() => _documents_Tests_Info;
        ...
        public Notifications_Core_Provider1 GetNotifications_Core_Provider1() => _notifications_Core_Provider1;
