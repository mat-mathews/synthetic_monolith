...
namespace Common.Core
{
    ...
    public class Consumer15
    {
        ...
        private readonly BatchJobs_Processors500_Controller1 _batchJobs_Processors500_Controller1;
        private readonly IBatchJobs_Processors500_Provider5 _iBatchJobs_Processors500_Provider5;
        private readonly BatchJobs_Processors500_Factory2 _batchJobs_Processors500_Factory2;
        private readonly Common_Contracts_Controller4 _common_Contracts_Controller4;
        private readonly Common_Contracts_Point7 _common_Contracts_Point7;

        public Consumer15(Admin_Handlers450_Result3 admin_Handlers450_Result3, Admin_Handlers450_Service12 admin_Handlers450_Service12, Utilities_Models_Handler utilities_Models_Handler, BatchJobs_Processors500_Controller1 batchJobs_Processors500_Controller1, IBatchJobs_Processors500_Provider5 iBatchJobs_Processors500_Provider5, BatchJobs_Processors500_Factory2 batchJobs_Processors500_Factory2, Common_Contracts_Controller4 common_Contracts_Controller4, Common_Contracts_Point7 common_Contracts_Point7)
        {
            ...
            _batchJobs_Processors500_Controller1 = batchJobs_Processors500_Controller1 ?? throw new ArgumentNullException(nameof(batchJobs_Processors500_Controller1));
            _iBatchJobs_Processors500_Provider5 = iBatchJobs_Processors500_Provider5 ?? throw new ArgumentNullException(nameof(iBatchJobs_Processors500_Provider5));
            _batchJobs_Processors500_Factory2 = batchJobs_Processors500_Factory2 ?? throw new ArgumentNullException(nameof(batchJobs_Processors500_Factory2));
            _common_Contracts_Controller4 = common_Contracts_Controller4 ?? throw new ArgumentNullException(nameof(common_Contracts_Controller4));
            _common_Contracts_Point7 = common_Contracts_Point7 ?? throw new ArgumentNullException(nameof(common_Contracts_Point7));
        }
        ...
        public BatchJobs_Processors500_Controller1 GetBatchJobs_Processors500_Controller1() => _batchJobs_Processors500_Controller1;
        public IBatchJobs_Processors500_Provider5 GetIBatchJobs_Processors500_Provider5() => _iBatchJobs_Processors500_Provider5;
        public BatchJobs_Processors500_Factory2 GetBatchJobs_Processors500_Factory2() => _batchJobs_Processors500_Factory2;
        public Common_Contracts_Controller4 GetCommon_Contracts_Controller4() => _common_Contracts_Controller4;
        public Common_Contracts_Point7 GetCommon_Contracts_Point7() => _common_Contracts_Point7;
