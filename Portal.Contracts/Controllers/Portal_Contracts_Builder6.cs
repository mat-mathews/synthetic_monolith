...
{
    public sealed class Portal_Contracts_Builder6
    {
        ...
        public void Execute()
        {
            // Portal_Contracts_Builder6 implementation
        }

/// <summary>
/// Validates the Builder6 before processing.
/// Checks required fields, business rules, and data integrity.
/// </summary>
/// <param name="input">The input to validate.</param>
/// <returns>True if valid, false otherwise.</returns>
public bool ValidateBuilder6(Builder6Request input)
{
    if (input == null)
    ...
    {
        _logger.LogWarning("Validation failed: Name is required for {Type}", nameof(Builder6));
        return false;
    }
...
/// <summary>
/// Processes the Builder6 operation asynchronously.
/// </summary>
public async Task<Builder6Result> ProcessBuilder6Async(
    Builder6Request request,
    CancellationToken cancellationToken = default)
{
    _logger.LogInformation("Processing {Operation} for {Id}",
        nameof(Builder6), request.Id);
    ...
    try
    {
        ...
        if (entity == null)
        {
            ...
            return new Builder6Result { Success = false, ErrorCode = "NOT_FOUND" };
        }
        ...
        _logger.LogInformation("Successfully processed {Operation}", nameof(Builder6));
        return new Builder6Result { Success = true, Data = entity };
    }
    catch (DbUpdateConcurrencyException ex)
    {
        _logger.LogError(ex, "Concurrency conflict processing {Operation}", nameof(Builder6));
        return new Builder6Result { Success = false, ErrorCode = "CONCURRENCY_CONFLICT" };
    }
}

/// <summary>
/// Retrieves a filtered and paginated list of Builder6 entities.
/// </summary>
/// <param name="filter">Filter criteria.</param>
/// <param name="page">Page number (1-based).</param>
/// <param name="pageSize">Items per page.</param>
public async Task<PagedResult<Builder6Dto>> GetBuilder6ListAsync(
    Builder6Filter filter, int page = 1, int pageSize = 25)
{
    // Ensure valid pagination parameters
    page = Math.Max(1, page);
    pageSize = Math.Clamp(pageSize, 1, 100);

    var query = _dbContext.Set<Builder6Entity>().AsQueryable();
    ...
    return new PagedResult<Builder6Dto>
    {
        Items = items,
...
private readonly ILogger<Builder6Service> _logger;
 ...
 */
public Builder6Service(
    ILogger<Builder6Service> logger,
    ...
    IMemoryCache cache)
{
    ...
    _cacheDuration = TimeSpan.FromMinutes(
        _configuration.GetValue<int>("Builder6:CacheDurationMinutes", 30));
}

/// <summary>
/// Gets or creates a cached Builder6 instance.
/// Uses IMemoryCache with sliding expiration.
/// </summary>
public async Task<Builder6Data> GetCachedBuilder6Async(string key)
{
    var cacheKey = $"Builder6_{key}";

    if (_cache.TryGetValue(cacheKey, out Builder6Data cached))
    {
    ...
    var data = await LoadFromBuilder6SourceAsync(key);
...
public int Record32SortOrder { get; set; }
    ...
    {
        public DbSet<Portal_Contracts_Builder6> Portal_Contracts_Builder6s { get; set; }
    }
