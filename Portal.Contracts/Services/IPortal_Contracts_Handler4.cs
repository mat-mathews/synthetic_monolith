...
{
    public interface IPortal_Contracts_Handler4
    {
        /// <summary>Processes the Portal_Contracts_Handler4 operation.</summary>
        void ProcessPortal_Contracts_Handler4();

        /// <summary>Validates the Portal_Contracts_Handler4 state.</summary>
        bool ValidatePortal_Contracts_Handler4();
    }
