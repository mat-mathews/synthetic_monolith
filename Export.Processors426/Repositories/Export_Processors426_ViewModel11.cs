...
{
    /// <summary>Immutable data transfer record for Export_Processors426_ViewModel11.</summary>
    public record Export_Processors426_ViewModel11(string Value, int Count, DateTime Timestamp);
