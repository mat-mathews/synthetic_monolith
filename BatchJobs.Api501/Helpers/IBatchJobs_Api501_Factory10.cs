...
{
    public interface IBatchJobs_Api501_Factory10
    {
        /// <summary>Processes the BatchJobs_Api501_Factory10 operation.</summary>
        void ProcessBatchJobs_Api501_Factory10();

        /// <summary>Validates the BatchJobs_Api501_Factory10 state.</summary>
        bool ValidateBatchJobs_Api501_Factory10();
    }
