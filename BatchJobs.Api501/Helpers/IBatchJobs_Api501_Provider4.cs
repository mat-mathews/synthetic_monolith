...
{
    public interface IBatchJobs_Api501_Provider4
    {
        /// <summary>Processes the BatchJobs_Api501_Provider4 operation.</summary>
        void ProcessBatchJobs_Api501_Provider4();

        /// <summary>Validates the BatchJobs_Api501_Provider4 state.</summary>
        bool ValidateBatchJobs_Api501_Provider4();
    }
