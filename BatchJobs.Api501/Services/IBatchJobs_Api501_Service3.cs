...
{
    internal interface IBatchJobs_Api501_Service3
    {
        /// <summary>Processes the BatchJobs_Api501_Service3 operation.</summary>
        void ProcessBatchJobs_Api501_Service3();

        /// <summary>Validates the BatchJobs_Api501_Service3 state.</summary>
        bool ValidateBatchJobs_Api501_Service3();
    }
