...
{
    /// <summary>Immutable data transfer record for Workflow_Events_Response6.</summary>
    public record Workflow_Events_Response6(string Value, int Count, DateTime Timestamp);
