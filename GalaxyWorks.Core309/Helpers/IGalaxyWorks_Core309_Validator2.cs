...
{
    public interface IGalaxyWorks_Core309_Validator2
    {
        /// <summary>Processes the GalaxyWorks_Core309_Validator2 operation.</summary>
        void ProcessGalaxyWorks_Core309_Validator2();

        /// <summary>Validates the GalaxyWorks_Core309_Validator2 state.</summary>
        bool ValidateGalaxyWorks_Core309_Validator2();
    }
