...
namespace GalaxyWorks.Core309
{
    ...
    {
        private readonly Admin_Client_Manager3 _admin_Client_Manager3;
        private readonly Utilities_Contracts24_Key2 _utilities_Contracts24_Key2;
        private readonly Utilities_Processors440_Repository1 _utilities_Processors440_Repository1;
        private readonly IUtilities_Processors440_Factory6 _iUtilities_Processors440_Factory6;
        private readonly Billing_Tests_Processor10 _billing_Tests_Processor10;
        private readonly ISecurity_Tests360_Service2 _iSecurity_Tests360_Service2;
        private readonly Security_Tests360_Handler4 _security_Tests360_Handler4;
        private readonly Imaging_Mappers93_Builder9 _imaging_Mappers93_Builder9;

        public Consumer26(Admin_Client_Manager3 admin_Client_Manager3, Utilities_Contracts24_Key2 utilities_Contracts24_Key2, Utilities_Processors440_Repository1 utilities_Processors440_Repository1, IUtilities_Processors440_Factory6 iUtilities_Processors440_Factory6, Billing_Tests_Processor10 billing_Tests_Processor10, ISecurity_Tests360_Service2 iSecurity_Tests360_Service2, Security_Tests360_Handler4 security_Tests360_Handler4, Imaging_Mappers93_Builder9 imaging_Mappers93_Builder9)
        {
            _admin_Client_Manager3 = admin_Client_Manager3 ?? throw new ArgumentNullException(nameof(admin_Client_Manager3));
            _utilities_Contracts24_Key2 = utilities_Contracts24_Key2 ?? throw new ArgumentNullException(nameof(utilities_Contracts24_Key2));
            _utilities_Processors440_Repository1 = utilities_Processors440_Repository1 ?? throw new ArgumentNullException(nameof(utilities_Processors440_Repository1));
            _iUtilities_Processors440_Factory6 = iUtilities_Processors440_Factory6 ?? throw new ArgumentNullException(nameof(iUtilities_Processors440_Factory6));
            _billing_Tests_Processor10 = billing_Tests_Processor10 ?? throw new ArgumentNullException(nameof(billing_Tests_Processor10));
            _iSecurity_Tests360_Service2 = iSecurity_Tests360_Service2 ?? throw new ArgumentNullException(nameof(iSecurity_Tests360_Service2));
            _security_Tests360_Handler4 = security_Tests360_Handler4 ?? throw new ArgumentNullException(nameof(security_Tests360_Handler4));
            _imaging_Mappers93_Builder9 = imaging_Mappers93_Builder9 ?? throw new ArgumentNullException(nameof(imaging_Mappers93_Builder9));
        }

        public Admin_Client_Manager3 GetAdmin_Client_Manager3() => _admin_Client_Manager3;
        public Utilities_Contracts24_Key2 GetUtilities_Contracts24_Key2() => _utilities_Contracts24_Key2;
        public Utilities_Processors440_Repository1 GetUtilities_Processors440_Repository1() => _utilities_Processors440_Repository1;
        public IUtilities_Processors440_Factory6 GetIUtilities_Processors440_Factory6() => _iUtilities_Processors440_Factory6;
        public Billing_Tests_Processor10 GetBilling_Tests_Processor10() => _billing_Tests_Processor10;
        public ISecurity_Tests360_Service2 GetISecurity_Tests360_Service2() => _iSecurity_Tests360_Service2;
        public Security_Tests360_Handler4 GetSecurity_Tests360_Handler4() => _security_Tests360_Handler4;
        public Imaging_Mappers93_Builder9 GetImaging_Mappers93_Builder9() => _imaging_Mappers93_Builder9;
