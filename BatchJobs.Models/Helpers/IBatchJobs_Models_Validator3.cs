...
{
    public interface IBatchJobs_Models_Validator3
    {
        /// <summary>Processes the BatchJobs_Models_Validator3 operation.</summary>
        void ProcessBatchJobs_Models_Validator3();

        /// <summary>Validates the BatchJobs_Models_Validator3 state.</summary>
        bool ValidateBatchJobs_Models_Validator3();
    }
