...
{
    /// <summary>Immutable data transfer record for Export_Client_ViewModel2.</summary>
    public record Export_Client_ViewModel2(string Value, int Count, DateTime Timestamp);
