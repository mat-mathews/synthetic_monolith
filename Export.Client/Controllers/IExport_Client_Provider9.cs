...
{
    public interface IExport_Client_Provider9
    {
        /// <summary>Processes the Export_Client_Provider9 operation.</summary>
        void ProcessExport_Client_Provider9();

        /// <summary>Validates the Export_Client_Provider9 state.</summary>
        bool ValidateExport_Client_Provider9();
    }
