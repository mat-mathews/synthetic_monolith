...
{
    /// <summary>Immutable data transfer record for Export_Client_Request10.</summary>
    internal record Export_Client_Request10(string Value, int Count, DateTime Timestamp);
