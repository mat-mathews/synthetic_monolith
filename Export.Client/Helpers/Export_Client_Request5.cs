...
{
    /// <summary>Immutable data transfer record for Export_Client_Request5.</summary>
    public record Export_Client_Request5(string Value, int Count, DateTime Timestamp);
