...
{
    public interface IExport_Client_Handler6
    {
        /// <summary>Processes the Export_Client_Handler6 operation.</summary>
        void ProcessExport_Client_Handler6();

        /// <summary>Validates the Export_Client_Handler6 state.</summary>
        bool ValidateExport_Client_Handler6();
    }
