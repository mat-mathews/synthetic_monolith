...
{
    internal interface ISecurity_Api_Factory4
    {
        /// <summary>Processes the Security_Api_Factory4 operation.</summary>
        void ProcessSecurity_Api_Factory4();

        /// <summary>Validates the Security_Api_Factory4 state.</summary>
        bool ValidateSecurity_Api_Factory4();
    }
