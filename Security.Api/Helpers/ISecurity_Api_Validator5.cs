...
{
    public interface ISecurity_Api_Validator5
    {
        /// <summary>Processes the Security_Api_Validator5 operation.</summary>
        void ProcessSecurity_Api_Validator5();

        /// <summary>Validates the Security_Api_Validator5 state.</summary>
        bool ValidateSecurity_Api_Validator5();
    }
