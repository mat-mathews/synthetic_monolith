...
{
    internal interface IReporting_Mappers_Handler3
    {
        /// <summary>Processes the Reporting_Mappers_Handler3 operation.</summary>
        void ProcessReporting_Mappers_Handler3();

        /// <summary>Validates the Reporting_Mappers_Handler3 state.</summary>
        bool ValidateReporting_Mappers_Handler3();
    }
