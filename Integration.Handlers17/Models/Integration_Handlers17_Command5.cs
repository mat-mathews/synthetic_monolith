...
{
    /// <summary>Immutable data transfer record for Integration_Handlers17_Command5.</summary>
    public record Integration_Handlers17_Command5(string Value, int Count, DateTime Timestamp);
