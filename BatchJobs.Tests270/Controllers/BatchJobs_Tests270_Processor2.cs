...
{
    internal partial class BatchJobs_Tests270_Processor2 : IDisposable
    {
        ...
        public void Execute()
        {
            // BatchJobs_Tests270_Processor2 implementation
        }
...
public int Field21SortOrder { get; set; }
    ...
    public class Tests270Context : DbContext
    {
        public DbSet<BatchJobs_Tests270_Processor2> BatchJobs_Tests270_Processor2s { get; set; }
    }
