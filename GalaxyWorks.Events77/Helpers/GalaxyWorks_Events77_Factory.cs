...
{
    internal class GalaxyWorks_Events77_Factory
    {
        private readonly string _sql = "SELECT * FROM Invoices WHERE Id = @Id";
        public void Execute()
        {
            // GalaxyWorks_Events77_Factory implementation
        }
...
public int Record15SortOrder { get; set; }
    ...
    {
        public DbSet<GalaxyWorks_Events77_Factory> GalaxyWorks_Events77_Factorys { get; set; }
    }
