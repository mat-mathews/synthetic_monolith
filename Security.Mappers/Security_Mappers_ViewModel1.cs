...
{
    /// <summary>Immutable data transfer record for Security_Mappers_ViewModel1.</summary>
    internal record Security_Mappers_ViewModel1(string Value, int Count, DateTime Timestamp);
