...
{
    /// <summary>Immutable data transfer record for Documents_Data492_ViewModel.</summary>
    public record Documents_Data492_ViewModel(string Value, int Count, DateTime Timestamp);
