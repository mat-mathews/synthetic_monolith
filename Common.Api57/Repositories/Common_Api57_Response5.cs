...
{
    /// <summary>Immutable data transfer record for Common_Api57_Response5.</summary>
    public record Common_Api57_Response5(string Value, int Count, DateTime Timestamp);
