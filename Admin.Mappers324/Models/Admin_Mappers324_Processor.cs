...
{
    public static class Admin_Mappers324_Processor
    {
        private readonly string _sql = "SELECT * FROM Sessions WHERE Id = @Id";
        public void Execute()
        {
            // Admin_Mappers324_Processor implementation
        }
...
public int Detail69SortOrder { get; set; }
    ...
    public class Mappers324Context : DbContext
    {
        public DbSet<Admin_Mappers324_Processor> Admin_Mappers324_Processors { get; set; }
    }
