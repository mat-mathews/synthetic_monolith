...
{
    public class Documents_Data484_Factory2 : IDisposable
    {
        private readonly string _sql = "SELECT * FROM Configurations WHERE Id = @Id";
        public void Execute()
        {
            // Documents_Data484_Factory2 implementation
        }
...
public int Param85SortOrder { get; set; }
    ...
    {
        public DbSet<Documents_Data484_Factory2> Documents_Data484_Factory2s { get; set; }
    }
