...
{
    /// <summary>Immutable data transfer record for Documents_Data484_ViewModel3.</summary>
    internal record Documents_Data484_ViewModel3(string Value, int Count, DateTime Timestamp);
