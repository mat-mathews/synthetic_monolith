...
{
    /// <summary>Immutable data transfer record for Documents_Data484_Request4.</summary>
    internal record Documents_Data484_Request4(string Value, int Count, DateTime Timestamp);
