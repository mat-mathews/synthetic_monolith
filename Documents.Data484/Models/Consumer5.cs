...
namespace Documents.Data484
{
    ...
    public class Consumer5
    {
        ...
        private readonly Workflow_Web_Handler3 _workflow_Web_Handler3;
        private readonly IWorkflow_Web_Validator5 _iWorkflow_Web_Validator5;

        public Consumer5(IAuth_Core140_Factory4 iAuth_Core140_Factory4, Export_Api49_Service5 export_Api49_Service5, Billing_Mappers_Options2 billing_Mappers_Options2, Documents_Api439_Key11 documents_Api439_Key11, Documents_Api439_Dto5 documents_Api439_Dto5, Imaging_Core_Provider imaging_Core_Provider, Workflow_Web_Handler3 workflow_Web_Handler3, IWorkflow_Web_Validator5 iWorkflow_Web_Validator5)
        {
            ...
            _workflow_Web_Handler3 = workflow_Web_Handler3 ?? throw new ArgumentNullException(nameof(workflow_Web_Handler3));
        ...
        public Workflow_Web_Handler3 GetWorkflow_Web_Handler3() => _workflow_Web_Handler3;
