...
{
    internal interface IBatchJobs_Events_Validator3
    {
        /// <summary>Processes the BatchJobs_Events_Validator3 operation.</summary>
        void ProcessBatchJobs_Events_Validator3();

        /// <summary>Validates the BatchJobs_Events_Validator3 state.</summary>
        bool ValidateBatchJobs_Events_Validator3();
    }
