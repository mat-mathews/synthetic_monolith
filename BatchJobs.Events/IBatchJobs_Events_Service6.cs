...
{
    internal interface IBatchJobs_Events_Service6
    {
        /// <summary>Processes the BatchJobs_Events_Service6 operation.</summary>
        void ProcessBatchJobs_Events_Service6();

        /// <summary>Validates the BatchJobs_Events_Service6 state.</summary>
        bool ValidateBatchJobs_Events_Service6();
    }
