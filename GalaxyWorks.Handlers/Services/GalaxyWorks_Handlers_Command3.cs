...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Handlers_Command3.</summary>
    internal record GalaxyWorks_Handlers_Command3(string Value, int Count, DateTime Timestamp);
