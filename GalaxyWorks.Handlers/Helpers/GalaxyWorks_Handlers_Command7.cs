...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Handlers_Command7.</summary>
    internal record GalaxyWorks_Handlers_Command7(string Value, int Count, DateTime Timestamp);
