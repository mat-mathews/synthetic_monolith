...
namespace Security.Validators418
{
    ...
    {
        private readonly Admin_Core121_Repository _admin_Core121_Repository;
        ...
        private readonly Auth_Handlers_Repository5 _auth_Handlers_Repository5;
        private readonly Utilities_Web_Handler _utilities_Web_Handler;
        private readonly Utilities_Web_Command11 _utilities_Web_Command11;
        private readonly IImaging_Core204_Repository9 _iImaging_Core204_Repository9;
        private readonly GalaxyWorks_Shared437_Controller7 _galaxyWorks_Shared437_Controller7;

        public Consumer13(Admin_Core121_Repository admin_Core121_Repository, Admin_Core121_ViewModel2 admin_Core121_ViewModel2, Admin_Core121_Manager1 admin_Core121_Manager1, Auth_Handlers_Repository5 auth_Handlers_Repository5, Utilities_Web_Handler utilities_Web_Handler, Utilities_Web_Command11 utilities_Web_Command11, IImaging_Core204_Repository9 iImaging_Core204_Repository9, GalaxyWorks_Shared437_Controller7 galaxyWorks_Shared437_Controller7)
        {
            _admin_Core121_Repository = admin_Core121_Repository ?? throw new ArgumentNullException(nameof(admin_Core121_Repository));
            ...
            _auth_Handlers_Repository5 = auth_Handlers_Repository5 ?? throw new ArgumentNullException(nameof(auth_Handlers_Repository5));
            _utilities_Web_Handler = utilities_Web_Handler ?? throw new ArgumentNullException(nameof(utilities_Web_Handler));
            _utilities_Web_Command11 = utilities_Web_Command11 ?? throw new ArgumentNullException(nameof(utilities_Web_Command11));
            _iImaging_Core204_Repository9 = iImaging_Core204_Repository9 ?? throw new ArgumentNullException(nameof(iImaging_Core204_Repository9));
        ...
        public Admin_Core121_Repository GetAdmin_Core121_Repository() => _admin_Core121_Repository;
        ...
        public Auth_Handlers_Repository5 GetAuth_Handlers_Repository5() => _auth_Handlers_Repository5;
        public Utilities_Web_Handler GetUtilities_Web_Handler() => _utilities_Web_Handler;
        public Utilities_Web_Command11 GetUtilities_Web_Command11() => _utilities_Web_Command11;
        public IImaging_Core204_Repository9 GetIImaging_Core204_Repository9() => _iImaging_Core204_Repository9;
