...
{
    public interface ISecurity_Validators418_Validator4
    {
        /// <summary>Processes the Security_Validators418_Validator4 operation.</summary>
        void ProcessSecurity_Validators418_Validator4();

        /// <summary>Validates the Security_Validators418_Validator4 state.</summary>
        bool ValidateSecurity_Validators418_Validator4();
    }
