...
{
    public class Security_Validators418_Manager2
    {
        private readonly string _sql = "SELECT * FROM Customers WHERE Id = @Id";
        public void Execute()
        {
            // Security_Validators418_Manager2 implementation
        }
...
public int Record55SortOrder { get; set; }
    ...
    public class Validators418Context : DbContext
    {
        public DbSet<Security_Validators418_Manager2> Security_Validators418_Manager2s { get; set; }
    }
