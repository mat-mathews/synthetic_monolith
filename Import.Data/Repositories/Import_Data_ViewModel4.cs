...
{
    /// <summary>Immutable data transfer record for Import_Data_ViewModel4.</summary>
    internal record Import_Data_ViewModel4(string Value, int Count, DateTime Timestamp);
