...
{
    /// <summary>Immutable data transfer record for Billing_Client73_Command2.</summary>
    internal record Billing_Client73_Command2(string Value, int Count, DateTime Timestamp);
