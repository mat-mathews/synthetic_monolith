...
{
    public class GalaxyWorks_Tests445_Repository8
    {
        private readonly string _sql = "SELECT * FROM AuditLogs WHERE Id = @Id";
        public void Execute()
        {
            // GalaxyWorks_Tests445_Repository8 implementation
        }
...
public int Record40SortOrder { get; set; }
    ...
    public class Tests445Context : DbContext
    {
        public DbSet<GalaxyWorks_Tests445_Repository8> GalaxyWorks_Tests445_Repository8s { get; set; }
    }
