...
{
    public interface IGalaxyWorks_Mappers318_Factory6
    {
        /// <summary>Processes the GalaxyWorks_Mappers318_Factory6 operation.</summary>
        void ProcessGalaxyWorks_Mappers318_Factory6();

        /// <summary>Validates the GalaxyWorks_Mappers318_Factory6 state.</summary>
        bool ValidateGalaxyWorks_Mappers318_Factory6();
    }
