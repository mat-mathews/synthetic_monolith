...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Mappers318_Command8.</summary>
    public record GalaxyWorks_Mappers318_Command8(string Value, int Count, DateTime Timestamp);
