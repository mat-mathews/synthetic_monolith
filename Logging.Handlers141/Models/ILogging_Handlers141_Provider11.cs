...
{
    public interface ILogging_Handlers141_Provider11
    {
        /// <summary>Processes the Logging_Handlers141_Provider11 operation.</summary>
        void ProcessLogging_Handlers141_Provider11();

        /// <summary>Validates the Logging_Handlers141_Provider11 state.</summary>
        bool ValidateLogging_Handlers141_Provider11();
    }

    public class Handlers141Context : DbContext
    {
    }
