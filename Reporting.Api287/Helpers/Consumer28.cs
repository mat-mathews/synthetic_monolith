...
namespace Reporting.Api287
{
    ...
    public class Consumer28
    {
        ...
        private readonly Workflow_Validators201_Builder5 _workflow_Validators201_Builder5;
        private readonly Workflow_Validators201_Helper4 _workflow_Validators201_Helper4;
        private readonly Workflow_Validators201_Provider2 _workflow_Validators201_Provider2;
        private readonly ILogging_Validators359_Service _iLogging_Validators359_Service;
        private readonly Logging_Validators359_Controller7 _logging_Validators359_Controller7;

        public Consumer28(IAuth_Events_Factory4 iAuth_Events_Factory4, Auth_Handlers_Range7 auth_Handlers_Range7, IAuth_Handlers_Validator1 iAuth_Handlers_Validator1, Workflow_Validators201_Builder5 workflow_Validators201_Builder5, Workflow_Validators201_Helper4 workflow_Validators201_Helper4, Workflow_Validators201_Provider2 workflow_Validators201_Provider2, ILogging_Validators359_Service iLogging_Validators359_Service, Logging_Validators359_Controller7 logging_Validators359_Controller7)
        {
            ...
            _workflow_Validators201_Builder5 = workflow_Validators201_Builder5 ?? throw new ArgumentNullException(nameof(workflow_Validators201_Builder5));
            _workflow_Validators201_Helper4 = workflow_Validators201_Helper4 ?? throw new ArgumentNullException(nameof(workflow_Validators201_Helper4));
            _workflow_Validators201_Provider2 = workflow_Validators201_Provider2 ?? throw new ArgumentNullException(nameof(workflow_Validators201_Provider2));
            _iLogging_Validators359_Service = iLogging_Validators359_Service ?? throw new ArgumentNullException(nameof(iLogging_Validators359_Service));
            _logging_Validators359_Controller7 = logging_Validators359_Controller7 ?? throw new ArgumentNullException(nameof(logging_Validators359_Controller7));
        }
        ...
        public Workflow_Validators201_Builder5 GetWorkflow_Validators201_Builder5() => _workflow_Validators201_Builder5;
        public Workflow_Validators201_Helper4 GetWorkflow_Validators201_Helper4() => _workflow_Validators201_Helper4;
        public Workflow_Validators201_Provider2 GetWorkflow_Validators201_Provider2() => _workflow_Validators201_Provider2;
        public ILogging_Validators359_Service GetILogging_Validators359_Service() => _iLogging_Validators359_Service;
        public Logging_Validators359_Controller7 GetLogging_Validators359_Controller7() => _logging_Validators359_Controller7;
