...
{
    /// <summary>Immutable data transfer record for Integration_Handlers244_Event12.</summary>
    public record Integration_Handlers244_Event12(string Value, int Count, DateTime Timestamp);
