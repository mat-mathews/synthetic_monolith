...
{
    /// <summary>Immutable data transfer record for Integration_Handlers244_Request5.</summary>
    internal record Integration_Handlers244_Request5(string Value, int Count, DateTime Timestamp);
