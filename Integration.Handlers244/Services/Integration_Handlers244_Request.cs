...
{
    /// <summary>Immutable data transfer record for Integration_Handlers244_Request.</summary>
    internal record Integration_Handlers244_Request(string Value, int Count, DateTime Timestamp);
