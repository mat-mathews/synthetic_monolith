...
{
    /// <summary>Immutable data transfer record for Integration_Handlers244_Command13.</summary>
    public record Integration_Handlers244_Command13(string Value, int Count, DateTime Timestamp);
