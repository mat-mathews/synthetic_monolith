...
namespace Logging.Models
{
    ...
    public class Consumer15
    {
        ...
        private readonly Security_Processors246_Handler5 _security_Processors246_Handler5;
        private readonly Security_Processors246_Provider2 _security_Processors246_Provider2;
        private readonly ISecurity_Processors246_Handler3 _iSecurity_Processors246_Handler3;
        private readonly DataAccess_Contracts203_Service2 _dataAccess_Contracts203_Service2;
        private readonly Documents_Events_Repository11 _documents_Events_Repository11;
        private readonly Export_Handlers_Handler5 _export_Handlers_Handler5;

        public Consumer15(Auth_Contracts_Helper4 auth_Contracts_Helper4, Auth_Contracts_Dto7 auth_Contracts_Dto7, Security_Processors246_Handler5 security_Processors246_Handler5, Security_Processors246_Provider2 security_Processors246_Provider2, ISecurity_Processors246_Handler3 iSecurity_Processors246_Handler3, DataAccess_Contracts203_Service2 dataAccess_Contracts203_Service2, Documents_Events_Repository11 documents_Events_Repository11, Export_Handlers_Handler5 export_Handlers_Handler5)
        {
            ...
            _security_Processors246_Handler5 = security_Processors246_Handler5 ?? throw new ArgumentNullException(nameof(security_Processors246_Handler5));
            _security_Processors246_Provider2 = security_Processors246_Provider2 ?? throw new ArgumentNullException(nameof(security_Processors246_Provider2));
            _iSecurity_Processors246_Handler3 = iSecurity_Processors246_Handler3 ?? throw new ArgumentNullException(nameof(iSecurity_Processors246_Handler3));
            _dataAccess_Contracts203_Service2 = dataAccess_Contracts203_Service2 ?? throw new ArgumentNullException(nameof(dataAccess_Contracts203_Service2));
            _documents_Events_Repository11 = documents_Events_Repository11 ?? throw new ArgumentNullException(nameof(documents_Events_Repository11));
            _export_Handlers_Handler5 = export_Handlers_Handler5 ?? throw new ArgumentNullException(nameof(export_Handlers_Handler5));
        }
        ...
        public Security_Processors246_Handler5 GetSecurity_Processors246_Handler5() => _security_Processors246_Handler5;
        public Security_Processors246_Provider2 GetSecurity_Processors246_Provider2() => _security_Processors246_Provider2;
        public ISecurity_Processors246_Handler3 GetISecurity_Processors246_Handler3() => _iSecurity_Processors246_Handler3;
        public DataAccess_Contracts203_Service2 GetDataAccess_Contracts203_Service2() => _dataAccess_Contracts203_Service2;
        public Documents_Events_Repository11 GetDocuments_Events_Repository11() => _documents_Events_Repository11;
        public Export_Handlers_Handler5 GetExport_Handlers_Handler5() => _export_Handlers_Handler5;
