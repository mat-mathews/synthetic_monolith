...
namespace Notifications.Validators391
{
    ...
    public class Consumer23
    {
        ...
        private readonly Admin_Models476_Handler7 _admin_Models476_Handler7;
        private readonly IExport_Models461_Handler _iExport_Models461_Handler;
        private readonly Export_Models461_Options2 _export_Models461_Options2;
        private readonly Export_Models461_Manager5 _export_Models461_Manager5;
        private readonly Utilities_Processors_Controller4 _utilities_Processors_Controller4;
        private readonly Utilities_Processors_Controller8 _utilities_Processors_Controller8;
        private readonly Common_Processors142_Helper2 _common_Processors142_Helper2;

        public Consumer23(Admin_Models476_Event9 admin_Models476_Event9, Admin_Models476_Handler7 admin_Models476_Handler7, IExport_Models461_Handler iExport_Models461_Handler, Export_Models461_Options2 export_Models461_Options2, Export_Models461_Manager5 export_Models461_Manager5, Utilities_Processors_Controller4 utilities_Processors_Controller4, Utilities_Processors_Controller8 utilities_Processors_Controller8, Common_Processors142_Helper2 common_Processors142_Helper2)
        {
            _admin_Models476_Event9 = admin_Models476_Event9 ?? throw new ArgumentNullException(nameof(admin_Models476_Event9));
            _admin_Models476_Handler7 = admin_Models476_Handler7 ?? throw new ArgumentNullException(nameof(admin_Models476_Handler7));
            _iExport_Models461_Handler = iExport_Models461_Handler ?? throw new ArgumentNullException(nameof(iExport_Models461_Handler));
            _export_Models461_Options2 = export_Models461_Options2 ?? throw new ArgumentNullException(nameof(export_Models461_Options2));
            _export_Models461_Manager5 = export_Models461_Manager5 ?? throw new ArgumentNullException(nameof(export_Models461_Manager5));
            _utilities_Processors_Controller4 = utilities_Processors_Controller4 ?? throw new ArgumentNullException(nameof(utilities_Processors_Controller4));
            _utilities_Processors_Controller8 = utilities_Processors_Controller8 ?? throw new ArgumentNullException(nameof(utilities_Processors_Controller8));
            _common_Processors142_Helper2 = common_Processors142_Helper2 ?? throw new ArgumentNullException(nameof(common_Processors142_Helper2));
        }

        public Admin_Models476_Event9 GetAdmin_Models476_Event9() => _admin_Models476_Event9;
        public Admin_Models476_Handler7 GetAdmin_Models476_Handler7() => _admin_Models476_Handler7;
        public IExport_Models461_Handler GetIExport_Models461_Handler() => _iExport_Models461_Handler;
        public Export_Models461_Options2 GetExport_Models461_Options2() => _export_Models461_Options2;
        public Export_Models461_Manager5 GetExport_Models461_Manager5() => _export_Models461_Manager5;
        public Utilities_Processors_Controller4 GetUtilities_Processors_Controller4() => _utilities_Processors_Controller4;
        public Utilities_Processors_Controller8 GetUtilities_Processors_Controller8() => _utilities_Processors_Controller8;
        public Common_Processors142_Helper2 GetCommon_Processors142_Helper2() => _common_Processors142_Helper2;
