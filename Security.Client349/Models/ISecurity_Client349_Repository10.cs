...
{
    internal interface ISecurity_Client349_Repository10
    {
        /// <summary>Processes the Security_Client349_Repository10 operation.</summary>
        void ProcessSecurity_Client349_Repository10();

        /// <summary>Validates the Security_Client349_Repository10 state.</summary>
        bool ValidateSecurity_Client349_Repository10();
    }
