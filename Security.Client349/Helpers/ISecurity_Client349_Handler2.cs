...
{
    public interface ISecurity_Client349_Handler2
    {
        /// <summary>Processes the Security_Client349_Handler2 operation.</summary>
        void ProcessSecurity_Client349_Handler2();

        /// <summary>Validates the Security_Client349_Handler2 state.</summary>
        bool ValidateSecurity_Client349_Handler2();
    }
