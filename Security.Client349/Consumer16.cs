...
namespace Security.Client349
{
    ...
    public class Consumer16
    {
        ...
        private readonly Billing_Shared384_Repository1 _billing_Shared384_Repository1;
        private readonly Notifications_Service_Service11 _notifications_Service_Service11;
        private readonly Notifications_Service_Service3 _notifications_Service_Service3;
        private readonly IPortal_Handlers26_Validator9 _iPortal_Handlers26_Validator9;
        private readonly Import_Handlers407_Controller2 _import_Handlers407_Controller2;
        private readonly Import_Handlers407_Builder1 _import_Handlers407_Builder1;
        private readonly Import_Handlers407_Options _import_Handlers407_Options;

        public Consumer16(Admin_Client346_Manager2 admin_Client346_Manager2, Billing_Shared384_Repository1 billing_Shared384_Repository1, Notifications_Service_Service11 notifications_Service_Service11, Notifications_Service_Service3 notifications_Service_Service3, IPortal_Handlers26_Validator9 iPortal_Handlers26_Validator9, Import_Handlers407_Controller2 import_Handlers407_Controller2, Import_Handlers407_Builder1 import_Handlers407_Builder1, Import_Handlers407_Options import_Handlers407_Options)
        {
            _admin_Client346_Manager2 = admin_Client346_Manager2 ?? throw new ArgumentNullException(nameof(admin_Client346_Manager2));
            _billing_Shared384_Repository1 = billing_Shared384_Repository1 ?? throw new ArgumentNullException(nameof(billing_Shared384_Repository1));
            _notifications_Service_Service11 = notifications_Service_Service11 ?? throw new ArgumentNullException(nameof(notifications_Service_Service11));
            _notifications_Service_Service3 = notifications_Service_Service3 ?? throw new ArgumentNullException(nameof(notifications_Service_Service3));
            _iPortal_Handlers26_Validator9 = iPortal_Handlers26_Validator9 ?? throw new ArgumentNullException(nameof(iPortal_Handlers26_Validator9));
            _import_Handlers407_Controller2 = import_Handlers407_Controller2 ?? throw new ArgumentNullException(nameof(import_Handlers407_Controller2));
            _import_Handlers407_Builder1 = import_Handlers407_Builder1 ?? throw new ArgumentNullException(nameof(import_Handlers407_Builder1));
            _import_Handlers407_Options = import_Handlers407_Options ?? throw new ArgumentNullException(nameof(import_Handlers407_Options));
        }

        public Admin_Client346_Manager2 GetAdmin_Client346_Manager2() => _admin_Client346_Manager2;
        public Billing_Shared384_Repository1 GetBilling_Shared384_Repository1() => _billing_Shared384_Repository1;
        public Notifications_Service_Service11 GetNotifications_Service_Service11() => _notifications_Service_Service11;
        public Notifications_Service_Service3 GetNotifications_Service_Service3() => _notifications_Service_Service3;
        public IPortal_Handlers26_Validator9 GetIPortal_Handlers26_Validator9() => _iPortal_Handlers26_Validator9;
        public Import_Handlers407_Controller2 GetImport_Handlers407_Controller2() => _import_Handlers407_Controller2;
        public Import_Handlers407_Builder1 GetImport_Handlers407_Builder1() => _import_Handlers407_Builder1;
        public Import_Handlers407_Options GetImport_Handlers407_Options() => _import_Handlers407_Options;
