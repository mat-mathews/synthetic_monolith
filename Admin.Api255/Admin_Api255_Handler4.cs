...
namespace Admin.Api255
{
    internal static class Admin_Api255_Handler4
    {
        private readonly string _sql = "SELECT * FROM Reports WHERE Id = @Id";
        public void Execute()
        {
            // Admin_Api255_Handler4 implementation
        }
...
public int Attr80SortOrder { get; set; }
    ...
    public class Api255Context : DbContext
    {
        public DbSet<Admin_Api255_Handler4> Admin_Api255_Handler4s { get; set; }
    }
