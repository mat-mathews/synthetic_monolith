...
{
    internal sealed class Common_Handlers_Controller6
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // Common_Handlers_Controller6 implementation
        }
...
public int Field33SortOrder { get; set; }
    ...
    {
        public DbSet<Common_Handlers_Controller6> Common_Handlers_Controller6s { get; set; }
    }
