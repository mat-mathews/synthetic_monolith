...
{
    public interface ICommon_Handlers_Provider8
    {
        /// <summary>Processes the Common_Handlers_Provider8 operation.</summary>
        void ProcessCommon_Handlers_Provider8();

        /// <summary>Validates the Common_Handlers_Provider8 state.</summary>
        bool ValidateCommon_Handlers_Provider8();
    }
