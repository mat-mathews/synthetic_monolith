...
{
    internal interface ICommon_Handlers_Handler1
    {
        /// <summary>Processes the Common_Handlers_Handler1 operation.</summary>
        void ProcessCommon_Handlers_Handler1();

        /// <summary>Validates the Common_Handlers_Handler1 state.</summary>
        bool ValidateCommon_Handlers_Handler1();
    }
