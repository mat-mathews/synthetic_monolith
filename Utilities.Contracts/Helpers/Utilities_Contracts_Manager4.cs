...
{
    public class Utilities_Contracts_Manager4
    {
        private readonly string _sql = "SELECT * FROM Roles WHERE Id = @Id";
        public void Execute()
        {
            // Utilities_Contracts_Manager4 implementation
        }
...
public int Entry11SortOrder { get; set; }
    ...
    {
        public DbSet<Utilities_Contracts_Manager4> Utilities_Contracts_Manager4s { get; set; }
    }
