...
namespace Utilities.Contracts
{
    ...
    public class Consumer32
    {
        ...
        private readonly IBilling_Models_Service7 _iBilling_Models_Service7;
        private readonly Billing_Models_Command1 _billing_Models_Command1;
        private readonly Billing_Models_Builder _billing_Models_Builder;
        private readonly Admin_Web_Response2 _admin_Web_Response2;

        public Consumer32(Admin_Processors35_Helper11 admin_Processors35_Helper11, Auth_Handlers281_Handler1 auth_Handlers281_Handler1, Auth_Handlers281_Controller auth_Handlers281_Controller, IAuth_Handlers281_Factory5 iAuth_Handlers281_Factory5, IBilling_Models_Service7 iBilling_Models_Service7, Billing_Models_Command1 billing_Models_Command1, Billing_Models_Builder billing_Models_Builder, Admin_Web_Response2 admin_Web_Response2)
        {
            ...
            _iBilling_Models_Service7 = iBilling_Models_Service7 ?? throw new ArgumentNullException(nameof(iBilling_Models_Service7));
            _billing_Models_Command1 = billing_Models_Command1 ?? throw new ArgumentNullException(nameof(billing_Models_Command1));
            _billing_Models_Builder = billing_Models_Builder ?? throw new ArgumentNullException(nameof(billing_Models_Builder));
        ...
        public IBilling_Models_Service7 GetIBilling_Models_Service7() => _iBilling_Models_Service7;
        public Billing_Models_Command1 GetBilling_Models_Command1() => _billing_Models_Command1;
        public Billing_Models_Builder GetBilling_Models_Builder() => _billing_Models_Builder;
