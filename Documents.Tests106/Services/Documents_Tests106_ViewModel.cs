...
{
    /// <summary>Immutable data transfer record for Documents_Tests106_ViewModel.</summary>
    internal record Documents_Tests106_ViewModel(string Value, int Count, DateTime Timestamp);
