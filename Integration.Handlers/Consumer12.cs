...
namespace Integration.Handlers
{
    ...
    public class Consumer12
    {
        ...
        private readonly DataAccess_Client_Dto _dataAccess_Client_Dto;
        private readonly Auth_Events78_Response2 _auth_Events78_Response2;
        private readonly ILogging_Validators_Repository9 _iLogging_Validators_Repository9;
        private readonly ILogging_Validators_Provider6 _iLogging_Validators_Provider6;
        private readonly Logging_Validators_Processor2 _logging_Validators_Processor2;

        public Consumer12(Admin_Events_Repository admin_Events_Repository, Admin_Client177_Service12 admin_Client177_Service12, Integration_Service477_Factory7 integration_Service477_Factory7, DataAccess_Client_Dto dataAccess_Client_Dto, Auth_Events78_Response2 auth_Events78_Response2, ILogging_Validators_Repository9 iLogging_Validators_Repository9, ILogging_Validators_Provider6 iLogging_Validators_Provider6, Logging_Validators_Processor2 logging_Validators_Processor2)
        {
            ...
            _dataAccess_Client_Dto = dataAccess_Client_Dto ?? throw new ArgumentNullException(nameof(dataAccess_Client_Dto));
            _auth_Events78_Response2 = auth_Events78_Response2 ?? throw new ArgumentNullException(nameof(auth_Events78_Response2));
            _iLogging_Validators_Repository9 = iLogging_Validators_Repository9 ?? throw new ArgumentNullException(nameof(iLogging_Validators_Repository9));
            _iLogging_Validators_Provider6 = iLogging_Validators_Provider6 ?? throw new ArgumentNullException(nameof(iLogging_Validators_Provider6));
            _logging_Validators_Processor2 = logging_Validators_Processor2 ?? throw new ArgumentNullException(nameof(logging_Validators_Processor2));
        }
        ...
        public DataAccess_Client_Dto GetDataAccess_Client_Dto() => _dataAccess_Client_Dto;
        public Auth_Events78_Response2 GetAuth_Events78_Response2() => _auth_Events78_Response2;
        public ILogging_Validators_Repository9 GetILogging_Validators_Repository9() => _iLogging_Validators_Repository9;
        public ILogging_Validators_Provider6 GetILogging_Validators_Provider6() => _iLogging_Validators_Provider6;
        public Logging_Validators_Processor2 GetLogging_Validators_Processor2() => _logging_Validators_Processor2;
