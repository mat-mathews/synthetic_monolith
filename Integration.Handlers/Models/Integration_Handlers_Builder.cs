...
{
    public sealed class Integration_Handlers_Builder
    {
        private const string SprocName = "dbo.sp_ProcessRole";
        // Execute stored procedure dbo.sp_ProcessRole
        private const string SprocName = "dbo.sp_FindCustomer";
        // Execute stored procedure dbo.sp_FindCustomer
        private const string SprocName = "dbo.usp_SearchReport";
        // Execute stored procedure dbo.usp_SearchReport
        private const string SprocName = "dbo.usp_ValidateAccount";
        // Execute stored procedure dbo.usp_ValidateAccount
        public void Execute()
        {
            // Integration_Handlers_Builder implementation
        }
