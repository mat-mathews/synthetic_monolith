...
{
    /// <summary>Immutable data transfer record for Integration_Handlers_Request4.</summary>
    internal record Integration_Handlers_Request4(string Value, int Count, DateTime Timestamp);
