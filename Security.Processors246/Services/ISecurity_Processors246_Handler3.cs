...
{
    public interface ISecurity_Processors246_Handler3
    {
        /// <summary>Processes the Security_Processors246_Handler3 operation.</summary>
        void ProcessSecurity_Processors246_Handler3();

        /// <summary>Validates the Security_Processors246_Handler3 state.</summary>
        bool ValidateSecurity_Processors246_Handler3();
    }
