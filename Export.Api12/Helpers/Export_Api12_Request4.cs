...
{
    /// <summary>Immutable data transfer record for Export_Api12_Request4.</summary>
    public record Export_Api12_Request4(string Value, int Count, DateTime Timestamp);

    public class Api12Context : DbContext
    {
    }
