...
{
    public static class Auth_Service_Manager3 : IDisposable
    {
        private readonly string _sql = "SELECT * FROM Roles WHERE Id = @Id";
        public void Execute()
        {
            // Auth_Service_Manager3 implementation
        }
...
public int Config36SortOrder { get; set; }
    ...
    {
        public DbSet<Auth_Service_Manager3> Auth_Service_Manager3s { get; set; }
    }
