...
{
    public interface IImport_Shared_Service1
    {
        /// <summary>Processes the Import_Shared_Service1 operation.</summary>
        void ProcessImport_Shared_Service1();

        /// <summary>Validates the Import_Shared_Service1 state.</summary>
        bool ValidateImport_Shared_Service1();
    }
