...
namespace DataAccess.Shared486
{
    ...
    {
        private readonly Admin_Data465_Command11 _admin_Data465_Command11;
        private readonly Auth_Processors_Service2 _auth_Processors_Service2;
        private readonly Utilities_Mappers197_Key5 _utilities_Mappers197_Key5;
        private readonly Utilities_Mappers197_Event2 _utilities_Mappers197_Event2;
        private readonly Scheduling_Web264_Factory6 _scheduling_Web264_Factory6;
        private readonly Common_Data81_Handler4 _common_Data81_Handler4;
        private readonly ICommon_Data81_Service _iCommon_Data81_Service;
        private readonly Common_Data81_Builder5 _common_Data81_Builder5;

        public Consumer26(Admin_Data465_Command11 admin_Data465_Command11, Auth_Processors_Service2 auth_Processors_Service2, Utilities_Mappers197_Key5 utilities_Mappers197_Key5, Utilities_Mappers197_Event2 utilities_Mappers197_Event2, Scheduling_Web264_Factory6 scheduling_Web264_Factory6, Common_Data81_Handler4 common_Data81_Handler4, ICommon_Data81_Service iCommon_Data81_Service, Common_Data81_Builder5 common_Data81_Builder5)
        {
            _admin_Data465_Command11 = admin_Data465_Command11 ?? throw new ArgumentNullException(nameof(admin_Data465_Command11));
            _auth_Processors_Service2 = auth_Processors_Service2 ?? throw new ArgumentNullException(nameof(auth_Processors_Service2));
            _utilities_Mappers197_Key5 = utilities_Mappers197_Key5 ?? throw new ArgumentNullException(nameof(utilities_Mappers197_Key5));
            _utilities_Mappers197_Event2 = utilities_Mappers197_Event2 ?? throw new ArgumentNullException(nameof(utilities_Mappers197_Event2));
            _scheduling_Web264_Factory6 = scheduling_Web264_Factory6 ?? throw new ArgumentNullException(nameof(scheduling_Web264_Factory6));
            _common_Data81_Handler4 = common_Data81_Handler4 ?? throw new ArgumentNullException(nameof(common_Data81_Handler4));
            _iCommon_Data81_Service = iCommon_Data81_Service ?? throw new ArgumentNullException(nameof(iCommon_Data81_Service));
            _common_Data81_Builder5 = common_Data81_Builder5 ?? throw new ArgumentNullException(nameof(common_Data81_Builder5));
        }

        public Admin_Data465_Command11 GetAdmin_Data465_Command11() => _admin_Data465_Command11;
        public Auth_Processors_Service2 GetAuth_Processors_Service2() => _auth_Processors_Service2;
        public Utilities_Mappers197_Key5 GetUtilities_Mappers197_Key5() => _utilities_Mappers197_Key5;
        public Utilities_Mappers197_Event2 GetUtilities_Mappers197_Event2() => _utilities_Mappers197_Event2;
        public Scheduling_Web264_Factory6 GetScheduling_Web264_Factory6() => _scheduling_Web264_Factory6;
        public Common_Data81_Handler4 GetCommon_Data81_Handler4() => _common_Data81_Handler4;
        public ICommon_Data81_Service GetICommon_Data81_Service() => _iCommon_Data81_Service;
        public Common_Data81_Builder5 GetCommon_Data81_Builder5() => _common_Data81_Builder5;
