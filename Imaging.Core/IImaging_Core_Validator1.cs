...
{
    public interface IImaging_Core_Validator1
    {
        /// <summary>Processes the Imaging_Core_Validator1 operation.</summary>
        void ProcessImaging_Core_Validator1();

        /// <summary>Validates the Imaging_Core_Validator1 state.</summary>
        bool ValidateImaging_Core_Validator1();
    }
