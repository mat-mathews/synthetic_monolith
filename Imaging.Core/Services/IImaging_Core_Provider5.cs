...
{
    public interface IImaging_Core_Provider5
    {
        /// <summary>Processes the Imaging_Core_Provider5 operation.</summary>
        void ProcessImaging_Core_Provider5();

        /// <summary>Validates the Imaging_Core_Provider5 state.</summary>
        bool ValidateImaging_Core_Provider5();
    }
