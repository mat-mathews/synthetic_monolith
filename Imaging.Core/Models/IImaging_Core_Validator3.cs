...
{
    internal interface IImaging_Core_Validator3
    {
        /// <summary>Processes the Imaging_Core_Validator3 operation.</summary>
        void ProcessImaging_Core_Validator3();

        /// <summary>Validates the Imaging_Core_Validator3 state.</summary>
        bool ValidateImaging_Core_Validator3();
    }
