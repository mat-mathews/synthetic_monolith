...
{
    internal class Scheduling_Web264_Factory6
    {
        private readonly string _sql = "SELECT * FROM Products WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Web264_Factory6 implementation
        }
...
public int Param81SortOrder { get; set; }
    ...
    public class Web264Context : DbContext
    {
        public DbSet<Scheduling_Web264_Factory6> Scheduling_Web264_Factory6s { get; set; }
    }
