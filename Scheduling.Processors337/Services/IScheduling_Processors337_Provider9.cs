...
{
    public interface IScheduling_Processors337_Provider9
    {
        /// <summary>Processes the Scheduling_Processors337_Provider9 operation.</summary>
        void ProcessScheduling_Processors337_Provider9();

        /// <summary>Validates the Scheduling_Processors337_Provider9 state.</summary>
        bool ValidateScheduling_Processors337_Provider9();
    }
