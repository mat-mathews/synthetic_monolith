...
{
    internal interface IScheduling_Processors337_Handler8
    {
        /// <summary>Processes the Scheduling_Processors337_Handler8 operation.</summary>
        void ProcessScheduling_Processors337_Handler8();

        /// <summary>Validates the Scheduling_Processors337_Handler8 state.</summary>
        bool ValidateScheduling_Processors337_Handler8();
    }
