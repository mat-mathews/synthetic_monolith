...
{
    internal interface IScheduling_Processors337_Service12
    {
        /// <summary>Processes the Scheduling_Processors337_Service12 operation.</summary>
        void ProcessScheduling_Processors337_Service12();

        /// <summary>Validates the Scheduling_Processors337_Service12 state.</summary>
        bool ValidateScheduling_Processors337_Service12();
    }
