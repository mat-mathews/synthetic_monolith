...
{
    /// <summary>Immutable data transfer record for Common_Validators_Dto11.</summary>
    public record Common_Validators_Dto11(string Value, int Count, DateTime Timestamp);
