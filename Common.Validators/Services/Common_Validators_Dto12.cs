...
{
    /// <summary>Immutable data transfer record for Common_Validators_Dto12.</summary>
    internal record Common_Validators_Dto12(string Value, int Count, DateTime Timestamp);
