...
{
    public interface IPortal_Service231_Service3
    {
        /// <summary>Processes the Portal_Service231_Service3 operation.</summary>
        void ProcessPortal_Service231_Service3();

        /// <summary>Validates the Portal_Service231_Service3 state.</summary>
        bool ValidatePortal_Service231_Service3();
    }
