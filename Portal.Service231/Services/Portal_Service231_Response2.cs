...
{
    /// <summary>Immutable data transfer record for Portal_Service231_Response2.</summary>
    public record Portal_Service231_Response2(string Value, int Count, DateTime Timestamp);
