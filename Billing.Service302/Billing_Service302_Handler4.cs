...
{
    internal class Billing_Service302_Handler4
    {
        private readonly string _sql = "SELECT * FROM Invoices WHERE Id = @Id";
        public void Execute()
        {
            // Billing_Service302_Handler4 implementation
        }
...
public int Item23SortOrder { get; set; }
    ...
    public class Service302Context : DbContext
    {
        public DbSet<Billing_Service302_Handler4> Billing_Service302_Handler4s { get; set; }
    }
