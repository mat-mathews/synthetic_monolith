...
{
    public interface IReporting_Web_Handler
    {
        /// <summary>Processes the Reporting_Web_Handler operation.</summary>
        void ProcessReporting_Web_Handler();

        /// <summary>Validates the Reporting_Web_Handler state.</summary>
        bool ValidateReporting_Web_Handler();
    }
