...
{
    internal interface IBatchJobs_Client109_Provider8
    {
        /// <summary>Processes the BatchJobs_Client109_Provider8 operation.</summary>
        void ProcessBatchJobs_Client109_Provider8();

        /// <summary>Validates the BatchJobs_Client109_Provider8 state.</summary>
        bool ValidateBatchJobs_Client109_Provider8();
    }
