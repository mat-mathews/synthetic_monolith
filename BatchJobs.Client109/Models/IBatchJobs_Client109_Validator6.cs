...
{
    internal interface IBatchJobs_Client109_Validator6
    {
        /// <summary>Processes the BatchJobs_Client109_Validator6 operation.</summary>
        void ProcessBatchJobs_Client109_Validator6();

        /// <summary>Validates the BatchJobs_Client109_Validator6 state.</summary>
        bool ValidateBatchJobs_Client109_Validator6();
    }
