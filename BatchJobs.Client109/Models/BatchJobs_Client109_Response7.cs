...
{
    /// <summary>Immutable data transfer record for BatchJobs_Client109_Response7.</summary>
    public record BatchJobs_Client109_Response7(string Value, int Count, DateTime Timestamp);
