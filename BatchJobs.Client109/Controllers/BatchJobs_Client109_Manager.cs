...
{
    internal class BatchJobs_Client109_Manager
    {
        private const string SprocName = "dbo.sp_SearchProduct";
        // Execute stored procedure dbo.sp_SearchProduct
        private const string SprocName = "dbo.usp_InsertAccount";
        // Execute stored procedure dbo.usp_InsertAccount
        private const string SprocName = "dbo.usp_FindPreference";
        // Execute stored procedure dbo.usp_FindPreference
        public void Execute()
        {
            // BatchJobs_Client109_Manager implementation
        }
