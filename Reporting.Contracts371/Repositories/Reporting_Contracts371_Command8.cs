...
{
    /// <summary>Immutable data transfer record for Reporting_Contracts371_Command8.</summary>
    internal record Reporting_Contracts371_Command8(string Value, int Count, DateTime Timestamp);
