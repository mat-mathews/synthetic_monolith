...
{
    internal interface IExport_Contracts_Factory3
    {
        /// <summary>Processes the Export_Contracts_Factory3 operation.</summary>
        void ProcessExport_Contracts_Factory3();

        /// <summary>Validates the Export_Contracts_Factory3 state.</summary>
        bool ValidateExport_Contracts_Factory3();
    }
