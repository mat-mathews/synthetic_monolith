...
{
    internal interface IExport_Models461_Handler
    {
        /// <summary>Processes the Export_Models461_Handler operation.</summary>
        void ProcessExport_Models461_Handler();

        /// <summary>Validates the Export_Models461_Handler state.</summary>
        bool ValidateExport_Models461_Handler();
    }
