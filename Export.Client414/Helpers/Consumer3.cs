...
namespace Export.Client414
{
    ...
    public class Consumer3
    {
        ...
        private readonly Notifications_Service_Handler8 _notifications_Service_Handler8;
        private readonly Notifications_Service_Request9 _notifications_Service_Request9;
        private readonly Common_Api57_Helper _common_Api57_Helper;
        private readonly Common_Api57_Controller1 _common_Api57_Controller1;
        ...
        private readonly Import_Handlers_Factory3 _import_Handlers_Factory3;

        public Consumer3(Admin_Mappers_Repository8 admin_Mappers_Repository8, Notifications_Service_Handler8 notifications_Service_Handler8, Notifications_Service_Request9 notifications_Service_Request9, Common_Api57_Helper common_Api57_Helper, Common_Api57_Controller1 common_Api57_Controller1, Integration_Shared_Controller4 integration_Shared_Controller4, Import_Handlers_Builder7 import_Handlers_Builder7, Import_Handlers_Factory3 import_Handlers_Factory3)
        {
            _admin_Mappers_Repository8 = admin_Mappers_Repository8 ?? throw new ArgumentNullException(nameof(admin_Mappers_Repository8));
            _notifications_Service_Handler8 = notifications_Service_Handler8 ?? throw new ArgumentNullException(nameof(notifications_Service_Handler8));
            _notifications_Service_Request9 = notifications_Service_Request9 ?? throw new ArgumentNullException(nameof(notifications_Service_Request9));
            _common_Api57_Helper = common_Api57_Helper ?? throw new ArgumentNullException(nameof(common_Api57_Helper));
            _common_Api57_Controller1 = common_Api57_Controller1 ?? throw new ArgumentNullException(nameof(common_Api57_Controller1));
            ...
            _import_Handlers_Factory3 = import_Handlers_Factory3 ?? throw new ArgumentNullException(nameof(import_Handlers_Factory3));
        }

        public Admin_Mappers_Repository8 GetAdmin_Mappers_Repository8() => _admin_Mappers_Repository8;
        public Notifications_Service_Handler8 GetNotifications_Service_Handler8() => _notifications_Service_Handler8;
        public Notifications_Service_Request9 GetNotifications_Service_Request9() => _notifications_Service_Request9;
        public Common_Api57_Helper GetCommon_Api57_Helper() => _common_Api57_Helper;
        public Common_Api57_Controller1 GetCommon_Api57_Controller1() => _common_Api57_Controller1;
        ...
        public Import_Handlers_Factory3 GetImport_Handlers_Factory3() => _import_Handlers_Factory3;
