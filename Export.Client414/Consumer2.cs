...
namespace Export.Client414
{
    ...
    public class Consumer2
    {
        ...
        private readonly Common_Api57_Factory3 _common_Api57_Factory3;
        private readonly IIntegration_Shared_Validator3 _iIntegration_Shared_Validator3;
        private readonly Import_Handlers_Builder7 _import_Handlers_Builder7;
        private readonly Security_Contracts72_Handler5 _security_Contracts72_Handler5;
        private readonly Security_Contracts72_Processor3 _security_Contracts72_Processor3;
        private readonly Security_Contracts72_Builder2 _security_Contracts72_Builder2;
        private readonly DataAccess_Client82_Response3 _dataAccess_Client82_Response3;

        public Consumer2(Admin_Mappers_Result11 admin_Mappers_Result11, Common_Api57_Factory3 common_Api57_Factory3, IIntegration_Shared_Validator3 iIntegration_Shared_Validator3, Import_Handlers_Builder7 import_Handlers_Builder7, Security_Contracts72_Handler5 security_Contracts72_Handler5, Security_Contracts72_Processor3 security_Contracts72_Processor3, Security_Contracts72_Builder2 security_Contracts72_Builder2, DataAccess_Client82_Response3 dataAccess_Client82_Response3)
        {
            _admin_Mappers_Result11 = admin_Mappers_Result11 ?? throw new ArgumentNullException(nameof(admin_Mappers_Result11));
            _common_Api57_Factory3 = common_Api57_Factory3 ?? throw new ArgumentNullException(nameof(common_Api57_Factory3));
            ...
            _import_Handlers_Builder7 = import_Handlers_Builder7 ?? throw new ArgumentNullException(nameof(import_Handlers_Builder7));
            _security_Contracts72_Handler5 = security_Contracts72_Handler5 ?? throw new ArgumentNullException(nameof(security_Contracts72_Handler5));
            _security_Contracts72_Processor3 = security_Contracts72_Processor3 ?? throw new ArgumentNullException(nameof(security_Contracts72_Processor3));
            _security_Contracts72_Builder2 = security_Contracts72_Builder2 ?? throw new ArgumentNullException(nameof(security_Contracts72_Builder2));
            _dataAccess_Client82_Response3 = dataAccess_Client82_Response3 ?? throw new ArgumentNullException(nameof(dataAccess_Client82_Response3));
        }

        public Admin_Mappers_Result11 GetAdmin_Mappers_Result11() => _admin_Mappers_Result11;
        public Common_Api57_Factory3 GetCommon_Api57_Factory3() => _common_Api57_Factory3;
        public IIntegration_Shared_Validator3 GetIIntegration_Shared_Validator3() => _iIntegration_Shared_Validator3;
        public Import_Handlers_Builder7 GetImport_Handlers_Builder7() => _import_Handlers_Builder7;
        public Security_Contracts72_Handler5 GetSecurity_Contracts72_Handler5() => _security_Contracts72_Handler5;
        public Security_Contracts72_Processor3 GetSecurity_Contracts72_Processor3() => _security_Contracts72_Processor3;
        public Security_Contracts72_Builder2 GetSecurity_Contracts72_Builder2() => _security_Contracts72_Builder2;
        public DataAccess_Client82_Response3 GetDataAccess_Client82_Response3() => _dataAccess_Client82_Response3;
