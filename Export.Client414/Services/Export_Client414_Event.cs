...
{
    /// <summary>Immutable data transfer record for Export_Client414_Event.</summary>
    internal record Export_Client414_Event(string Value, int Count, DateTime Timestamp);
