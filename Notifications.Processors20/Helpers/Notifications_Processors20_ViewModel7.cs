...
{
    /// <summary>Immutable data transfer record for Notifications_Processors20_ViewModel7.</summary>
    internal record Notifications_Processors20_ViewModel7(string Value, int Count, DateTime Timestamp);
