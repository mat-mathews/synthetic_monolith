...
{
    /// <summary>Immutable data transfer record for Notifications_Service_Request9.</summary>
    public record Notifications_Service_Request9(string Value, int Count, DateTime Timestamp);
