...
{
    internal interface IExport_Models_Repository6
    {
        /// <summary>Processes the Export_Models_Repository6 operation.</summary>
        void ProcessExport_Models_Repository6();

        /// <summary>Validates the Export_Models_Repository6 state.</summary>
        bool ValidateExport_Models_Repository6();
    }
