...
{
    /// <summary>Immutable data transfer record for Export_Models_Command12.</summary>
    public record Export_Models_Command12(string Value, int Count, DateTime Timestamp);
