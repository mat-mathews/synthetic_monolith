...
{
    internal interface IIntegration_Api_Validator12
    {
        /// <summary>Processes the Integration_Api_Validator12 operation.</summary>
        void ProcessIntegration_Api_Validator12();

        /// <summary>Validates the Integration_Api_Validator12 state.</summary>
        bool ValidateIntegration_Api_Validator12();
    }
