...
namespace Logging.Handlers368
{
    ...
    public class Consumer19
    {
        ...
        private readonly Export_Core_Handler1 _export_Core_Handler1;
        private readonly Export_Core_Provider4 _export_Core_Provider4;
        private readonly Security_Mappers313_Result _security_Mappers313_Result;
        private readonly Security_Mappers313_Handler3 _security_Mappers313_Handler3;

        public Consumer19(Admin_Client346_Manager2 admin_Client346_Manager2, Admin_Validators37_Service admin_Validators37_Service, Import_Client65_Repository8 import_Client65_Repository8, IImport_Client65_Provider3 iImport_Client65_Provider3, Export_Core_Handler1 export_Core_Handler1, Export_Core_Provider4 export_Core_Provider4, Security_Mappers313_Result security_Mappers313_Result, Security_Mappers313_Handler3 security_Mappers313_Handler3)
        {
            ...
            _export_Core_Handler1 = export_Core_Handler1 ?? throw new ArgumentNullException(nameof(export_Core_Handler1));
            _export_Core_Provider4 = export_Core_Provider4 ?? throw new ArgumentNullException(nameof(export_Core_Provider4));
            _security_Mappers313_Result = security_Mappers313_Result ?? throw new ArgumentNullException(nameof(security_Mappers313_Result));
            _security_Mappers313_Handler3 = security_Mappers313_Handler3 ?? throw new ArgumentNullException(nameof(security_Mappers313_Handler3));
        }
        ...
        public Export_Core_Handler1 GetExport_Core_Handler1() => _export_Core_Handler1;
        public Export_Core_Provider4 GetExport_Core_Provider4() => _export_Core_Provider4;
        public Security_Mappers313_Result GetSecurity_Mappers313_Result() => _security_Mappers313_Result;
        public Security_Mappers313_Handler3 GetSecurity_Mappers313_Handler3() => _security_Mappers313_Handler3;
