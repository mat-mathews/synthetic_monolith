...
{
    /// <summary>Immutable data transfer record for Logging_Handlers368_Dto.</summary>
    public record Logging_Handlers368_Dto(string Value, int Count, DateTime Timestamp);
