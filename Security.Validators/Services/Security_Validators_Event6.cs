...
{
    /// <summary>Immutable data transfer record for Security_Validators_Event6.</summary>
    public record Security_Validators_Event6(string Value, int Count, DateTime Timestamp);
