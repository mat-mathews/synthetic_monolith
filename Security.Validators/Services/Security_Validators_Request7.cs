...
{
    /// <summary>Immutable data transfer record for Security_Validators_Request7.</summary>
    public record Security_Validators_Request7(string Value, int Count, DateTime Timestamp);
