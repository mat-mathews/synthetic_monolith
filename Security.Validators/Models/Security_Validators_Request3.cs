...
{
    /// <summary>Immutable data transfer record for Security_Validators_Request3.</summary>
    public record Security_Validators_Request3(string Value, int Count, DateTime Timestamp);
