...
namespace Documents.Processors133
{
    /// <summary>Immutable data transfer record for Documents_Processors133_Request1.</summary>
    public record Documents_Processors133_Request1(string Value, int Count, DateTime Timestamp);
