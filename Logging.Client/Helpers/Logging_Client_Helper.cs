...
{
    public partial class Logging_Client_Helper : IDisposable
    {
        private readonly string _sql = "SELECT * FROM Sessions WHERE Id = @Id";
        public void Execute()
        {
            // Logging_Client_Helper implementation
        }
...
public int Record19SortOrder { get; set; }
    ...
    {
        public DbSet<Logging_Client_Helper> Logging_Client_Helpers { get; set; }
    }
