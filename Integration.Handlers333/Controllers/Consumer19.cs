...
namespace Integration.Handlers333
{
    ...
    public class Consumer19
    {
        ...
        private readonly Auth_Client249_Provider6 _auth_Client249_Provider6;
        private readonly Billing_Shared149_Handler4 _billing_Shared149_Handler4;
        private readonly Billing_Shared149_Processor _billing_Shared149_Processor;
        private readonly Integration_Models_Handler3 _integration_Models_Handler3;
        private readonly Integration_Models_Handler4 _integration_Models_Handler4;
        private readonly IIntegration_Models_Factory _iIntegration_Models_Factory;

        public Consumer19(Auth_Handlers281_Handler1 auth_Handlers281_Handler1, Auth_Client249_Processor3 auth_Client249_Processor3, Auth_Client249_Provider6 auth_Client249_Provider6, Billing_Shared149_Handler4 billing_Shared149_Handler4, Billing_Shared149_Processor billing_Shared149_Processor, Integration_Models_Handler3 integration_Models_Handler3, Integration_Models_Handler4 integration_Models_Handler4, IIntegration_Models_Factory iIntegration_Models_Factory)
        {
            ...
            _auth_Client249_Provider6 = auth_Client249_Provider6 ?? throw new ArgumentNullException(nameof(auth_Client249_Provider6));
            _billing_Shared149_Handler4 = billing_Shared149_Handler4 ?? throw new ArgumentNullException(nameof(billing_Shared149_Handler4));
            _billing_Shared149_Processor = billing_Shared149_Processor ?? throw new ArgumentNullException(nameof(billing_Shared149_Processor));
            _integration_Models_Handler3 = integration_Models_Handler3 ?? throw new ArgumentNullException(nameof(integration_Models_Handler3));
            _integration_Models_Handler4 = integration_Models_Handler4 ?? throw new ArgumentNullException(nameof(integration_Models_Handler4));
            _iIntegration_Models_Factory = iIntegration_Models_Factory ?? throw new ArgumentNullException(nameof(iIntegration_Models_Factory));
        }
        ...
        public Auth_Client249_Provider6 GetAuth_Client249_Provider6() => _auth_Client249_Provider6;
        public Billing_Shared149_Handler4 GetBilling_Shared149_Handler4() => _billing_Shared149_Handler4;
        public Billing_Shared149_Processor GetBilling_Shared149_Processor() => _billing_Shared149_Processor;
        public Integration_Models_Handler3 GetIntegration_Models_Handler3() => _integration_Models_Handler3;
        public Integration_Models_Handler4 GetIntegration_Models_Handler4() => _integration_Models_Handler4;
        public IIntegration_Models_Factory GetIIntegration_Models_Factory() => _iIntegration_Models_Factory;
