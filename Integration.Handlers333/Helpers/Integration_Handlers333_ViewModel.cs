...
{
    /// <summary>Immutable data transfer record for Integration_Handlers333_ViewModel.</summary>
    public record Integration_Handlers333_ViewModel(string Value, int Count, DateTime Timestamp);
