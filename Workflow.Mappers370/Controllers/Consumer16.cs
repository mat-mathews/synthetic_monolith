...
namespace Workflow.Mappers370
{
    ...
    public class Consumer16
    {
        ...
        private readonly BatchJobs_Data176_Handler _batchJobs_Data176_Handler;

        public Consumer16(Admin_Events_Builder5 admin_Events_Builder5, Admin_Events_Repository admin_Events_Repository, Import_Contracts183_Helper import_Contracts183_Helper, Logging_Handlers141_Service3 logging_Handlers141_Service3, IImport_Service265_Validator6 iImport_Service265_Validator6, Logging_Core_Manager5 logging_Core_Manager5, Security_Models18_Factory6 security_Models18_Factory6, BatchJobs_Data176_Handler batchJobs_Data176_Handler)
        {
            ...
            _batchJobs_Data176_Handler = batchJobs_Data176_Handler ?? throw new ArgumentNullException(nameof(batchJobs_Data176_Handler));
        }
        ...
        public BatchJobs_Data176_Handler GetBatchJobs_Data176_Handler() => _batchJobs_Data176_Handler;
