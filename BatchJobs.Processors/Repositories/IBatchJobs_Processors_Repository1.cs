...
{
    public interface IBatchJobs_Processors_Repository1
    {
        /// <summary>Processes the BatchJobs_Processors_Repository1 operation.</summary>
        void ProcessBatchJobs_Processors_Repository1();

        /// <summary>Validates the BatchJobs_Processors_Repository1 state.</summary>
        bool ValidateBatchJobs_Processors_Repository1();
    }
