...
namespace Portal.Service489
{
    ...
    public class Consumer23
    {
        ...
        private readonly Imaging_Mappers_Helper4 _imaging_Mappers_Helper4;
        private readonly Reporting_Web345_Repository1 _reporting_Web345_Repository1;
        private readonly Reporting_Web345_Range3 _reporting_Web345_Range3;
        ...
        public Consumer23(Auth_Client_Key1 auth_Client_Key1, Imaging_Mappers_Helper4 imaging_Mappers_Helper4, Reporting_Web345_Repository1 reporting_Web345_Repository1, Reporting_Web345_Range3 reporting_Web345_Range3, Reporting_Core_Provider3 reporting_Core_Provider3, Reporting_Core_Builder2 reporting_Core_Builder2, Reporting_Core_Handler5 reporting_Core_Handler5, Scheduling_Tests_Repository scheduling_Tests_Repository)
        {
            _auth_Client_Key1 = auth_Client_Key1 ?? throw new ArgumentNullException(nameof(auth_Client_Key1));
            _imaging_Mappers_Helper4 = imaging_Mappers_Helper4 ?? throw new ArgumentNullException(nameof(imaging_Mappers_Helper4));
            _reporting_Web345_Repository1 = reporting_Web345_Repository1 ?? throw new ArgumentNullException(nameof(reporting_Web345_Repository1));
            _reporting_Web345_Range3 = reporting_Web345_Range3 ?? throw new ArgumentNullException(nameof(reporting_Web345_Range3));
        ...
        public Imaging_Mappers_Helper4 GetImaging_Mappers_Helper4() => _imaging_Mappers_Helper4;
        public Reporting_Web345_Repository1 GetReporting_Web345_Repository1() => _reporting_Web345_Repository1;
        public Reporting_Web345_Range3 GetReporting_Web345_Range3() => _reporting_Web345_Range3;
