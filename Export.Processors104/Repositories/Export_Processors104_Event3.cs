...
{
    /// <summary>Immutable data transfer record for Export_Processors104_Event3.</summary>
    internal record Export_Processors104_Event3(string Value, int Count, DateTime Timestamp);
