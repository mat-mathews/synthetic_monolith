...
{
    public interface IScheduling_Models441_Service
    {
        /// <summary>Processes the Scheduling_Models441_Service operation.</summary>
        void ProcessScheduling_Models441_Service();

        /// <summary>Validates the Scheduling_Models441_Service state.</summary>
        bool ValidateScheduling_Models441_Service();
    }
