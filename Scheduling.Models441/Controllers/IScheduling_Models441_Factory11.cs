...
{
    public interface IScheduling_Models441_Factory11
    {
        /// <summary>Processes the Scheduling_Models441_Factory11 operation.</summary>
        void ProcessScheduling_Models441_Factory11();

        /// <summary>Validates the Scheduling_Models441_Factory11 state.</summary>
        bool ValidateScheduling_Models441_Factory11();
    }
