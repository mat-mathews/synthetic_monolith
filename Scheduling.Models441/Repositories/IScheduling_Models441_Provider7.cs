...
{
    internal interface IScheduling_Models441_Provider7
    {
        /// <summary>Processes the Scheduling_Models441_Provider7 operation.</summary>
        void ProcessScheduling_Models441_Provider7();

        /// <summary>Validates the Scheduling_Models441_Provider7 state.</summary>
        bool ValidateScheduling_Models441_Provider7();
    }
