...
{
    /// <summary>Immutable data transfer record for Export_Data6_ViewModel4.</summary>
    internal record Export_Data6_ViewModel4(string Value, int Count, DateTime Timestamp);
