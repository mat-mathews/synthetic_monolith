...
{
    /// <summary>Immutable data transfer record for Export_Data6_Response5.</summary>
    public record Export_Data6_Response5(string Value, int Count, DateTime Timestamp);
