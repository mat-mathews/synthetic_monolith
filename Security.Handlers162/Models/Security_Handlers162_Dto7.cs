...
{
    /// <summary>Immutable data transfer record for Security_Handlers162_Dto7.</summary>
    internal record Security_Handlers162_Dto7(string Value, int Count, DateTime Timestamp);
