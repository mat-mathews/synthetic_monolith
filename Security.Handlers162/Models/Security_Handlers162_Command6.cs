...
{
    /// <summary>Immutable data transfer record for Security_Handlers162_Command6.</summary>
    public record Security_Handlers162_Command6(string Value, int Count, DateTime Timestamp);
