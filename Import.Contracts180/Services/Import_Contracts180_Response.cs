...
{
    /// <summary>Immutable data transfer record for Import_Contracts180_Response.</summary>
    internal record Import_Contracts180_Response(string Value, int Count, DateTime Timestamp);
