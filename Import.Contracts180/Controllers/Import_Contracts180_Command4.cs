...
{
    /// <summary>Immutable data transfer record for Import_Contracts180_Command4.</summary>
    public record Import_Contracts180_Command4(string Value, int Count, DateTime Timestamp);
