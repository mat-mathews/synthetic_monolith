...
namespace Portal.Web158
{
    ...
    public class Consumer32
    {
        ...
        private readonly IBilling_Core_Provider6 _iBilling_Core_Provider6;
        private readonly Billing_Core_Key11 _billing_Core_Key11;
        private readonly Billing_Events_Options4 _billing_Events_Options4;
        private readonly Billing_Events_Processor9 _billing_Events_Processor9;
        private readonly IWorkflow_Client_Validator7 _iWorkflow_Client_Validator7;
        private readonly Workflow_Client_Controller1 _workflow_Client_Controller1;

        public Consumer32(Admin_Tests10_Command2 admin_Tests10_Command2, Admin_Service_Processor9 admin_Service_Processor9, IBilling_Core_Provider6 iBilling_Core_Provider6, Billing_Core_Key11 billing_Core_Key11, Billing_Events_Options4 billing_Events_Options4, Billing_Events_Processor9 billing_Events_Processor9, IWorkflow_Client_Validator7 iWorkflow_Client_Validator7, Workflow_Client_Controller1 workflow_Client_Controller1)
        {
            ...
            _iBilling_Core_Provider6 = iBilling_Core_Provider6 ?? throw new ArgumentNullException(nameof(iBilling_Core_Provider6));
            _billing_Core_Key11 = billing_Core_Key11 ?? throw new ArgumentNullException(nameof(billing_Core_Key11));
            _billing_Events_Options4 = billing_Events_Options4 ?? throw new ArgumentNullException(nameof(billing_Events_Options4));
            _billing_Events_Processor9 = billing_Events_Processor9 ?? throw new ArgumentNullException(nameof(billing_Events_Processor9));
            _iWorkflow_Client_Validator7 = iWorkflow_Client_Validator7 ?? throw new ArgumentNullException(nameof(iWorkflow_Client_Validator7));
            _workflow_Client_Controller1 = workflow_Client_Controller1 ?? throw new ArgumentNullException(nameof(workflow_Client_Controller1));
        }
        ...
        public IBilling_Core_Provider6 GetIBilling_Core_Provider6() => _iBilling_Core_Provider6;
        public Billing_Core_Key11 GetBilling_Core_Key11() => _billing_Core_Key11;
        public Billing_Events_Options4 GetBilling_Events_Options4() => _billing_Events_Options4;
        public Billing_Events_Processor9 GetBilling_Events_Processor9() => _billing_Events_Processor9;
        public IWorkflow_Client_Validator7 GetIWorkflow_Client_Validator7() => _iWorkflow_Client_Validator7;
        public Workflow_Client_Controller1 GetWorkflow_Client_Controller1() => _workflow_Client_Controller1;
