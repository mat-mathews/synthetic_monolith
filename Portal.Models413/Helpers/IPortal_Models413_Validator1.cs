...
{
    public interface IPortal_Models413_Validator1
    {
        /// <summary>Processes the Portal_Models413_Validator1 operation.</summary>
        void ProcessPortal_Models413_Validator1();

        /// <summary>Validates the Portal_Models413_Validator1 state.</summary>
        bool ValidatePortal_Models413_Validator1();
    }
