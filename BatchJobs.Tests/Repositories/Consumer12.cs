...
namespace BatchJobs.Tests
{
    ...
    public class Consumer12
    {
        ...
        private readonly Security_Models_Point6 _security_Models_Point6;
        private readonly Security_Models_Service _security_Models_Service;
        private readonly Security_Tests_Repository3 _security_Tests_Repository3;
        private readonly Integration_Service401_Provider3 _integration_Service401_Provider3;
        private readonly Import_Data193_Point10 _import_Data193_Point10;
        ...
        public Consumer12(Admin_Events306_Helper1 admin_Events306_Helper1, Security_Models_Point6 security_Models_Point6, Security_Models_Service security_Models_Service, Security_Tests_Repository3 security_Tests_Repository3, Integration_Service401_Provider3 integration_Service401_Provider3, Import_Data193_Point10 import_Data193_Point10, Import_Data193_Factory8 import_Data193_Factory8, Integration_Tests86_Point2 integration_Tests86_Point2)
        {
            _admin_Events306_Helper1 = admin_Events306_Helper1 ?? throw new ArgumentNullException(nameof(admin_Events306_Helper1));
            _security_Models_Point6 = security_Models_Point6 ?? throw new ArgumentNullException(nameof(security_Models_Point6));
            _security_Models_Service = security_Models_Service ?? throw new ArgumentNullException(nameof(security_Models_Service));
            _security_Tests_Repository3 = security_Tests_Repository3 ?? throw new ArgumentNullException(nameof(security_Tests_Repository3));
            ...
            _import_Data193_Point10 = import_Data193_Point10 ?? throw new ArgumentNullException(nameof(import_Data193_Point10));
        ...
        public Security_Models_Point6 GetSecurity_Models_Point6() => _security_Models_Point6;
        public Security_Models_Service GetSecurity_Models_Service() => _security_Models_Service;
        public Security_Tests_Repository3 GetSecurity_Tests_Repository3() => _security_Tests_Repository3;
        public Integration_Service401_Provider3 GetIntegration_Service401_Provider3() => _integration_Service401_Provider3;
        public Import_Data193_Point10 GetImport_Data193_Point10() => _import_Data193_Point10;
