...
namespace BatchJobs.Tests
{
    ...
    {
        private readonly Admin_Events306_Helper1 _admin_Events306_Helper1;
        private readonly Security_Models_Helper2 _security_Models_Helper2;
        private readonly Security_Tests_Helper1 _security_Tests_Helper1;
        private readonly Integration_Service401_Provider3 _integration_Service401_Provider3;
        private readonly Import_Data193_Repository4 _import_Data193_Repository4;
        private readonly Integration_Tests86_Point2 _integration_Tests86_Point2;
        private readonly Integration_Tests86_Builder1 _integration_Tests86_Builder1;
        private readonly Workflow_Contracts434_Key6 _workflow_Contracts434_Key6;

        public Consumer24(Admin_Events306_Helper1 admin_Events306_Helper1, Security_Models_Helper2 security_Models_Helper2, Security_Tests_Helper1 security_Tests_Helper1, Integration_Service401_Provider3 integration_Service401_Provider3, Import_Data193_Repository4 import_Data193_Repository4, Integration_Tests86_Point2 integration_Tests86_Point2, Integration_Tests86_Builder1 integration_Tests86_Builder1, Workflow_Contracts434_Key6 workflow_Contracts434_Key6)
        {
            _admin_Events306_Helper1 = admin_Events306_Helper1 ?? throw new ArgumentNullException(nameof(admin_Events306_Helper1));
            _security_Models_Helper2 = security_Models_Helper2 ?? throw new ArgumentNullException(nameof(security_Models_Helper2));
            _security_Tests_Helper1 = security_Tests_Helper1 ?? throw new ArgumentNullException(nameof(security_Tests_Helper1));
            _integration_Service401_Provider3 = integration_Service401_Provider3 ?? throw new ArgumentNullException(nameof(integration_Service401_Provider3));
            _import_Data193_Repository4 = import_Data193_Repository4 ?? throw new ArgumentNullException(nameof(import_Data193_Repository4));
            _integration_Tests86_Point2 = integration_Tests86_Point2 ?? throw new ArgumentNullException(nameof(integration_Tests86_Point2));
            ...
            _workflow_Contracts434_Key6 = workflow_Contracts434_Key6 ?? throw new ArgumentNullException(nameof(workflow_Contracts434_Key6));
        }

        public Admin_Events306_Helper1 GetAdmin_Events306_Helper1() => _admin_Events306_Helper1;
        public Security_Models_Helper2 GetSecurity_Models_Helper2() => _security_Models_Helper2;
        public Security_Tests_Helper1 GetSecurity_Tests_Helper1() => _security_Tests_Helper1;
        public Integration_Service401_Provider3 GetIntegration_Service401_Provider3() => _integration_Service401_Provider3;
        public Import_Data193_Repository4 GetImport_Data193_Repository4() => _import_Data193_Repository4;
        public Integration_Tests86_Point2 GetIntegration_Tests86_Point2() => _integration_Tests86_Point2;
        public Integration_Tests86_Builder1 GetIntegration_Tests86_Builder1() => _integration_Tests86_Builder1;
        public Workflow_Contracts434_Key6 GetWorkflow_Contracts434_Key6() => _workflow_Contracts434_Key6;
