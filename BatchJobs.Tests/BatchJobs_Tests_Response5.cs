...
{
    /// <summary>Immutable data transfer record for BatchJobs_Tests_Response5.</summary>
    public record BatchJobs_Tests_Response5(string Value, int Count, DateTime Timestamp);
