...
namespace Security.Tests360
{
    ...
    public class Consumer3
    {
        ...
        private readonly Billing_Client_Helper5 _billing_Client_Helper5;
        private readonly DataAccess_Validators409_Builder3 _dataAccess_Validators409_Builder3;
        private readonly Reporting_Api_Result _reporting_Api_Result;
        private readonly Reporting_Api_Helper2 _reporting_Api_Helper2;
        private readonly Billing_Web_Builder _billing_Web_Builder;
        private readonly Logging_Tests_Dto8 _logging_Tests_Dto8;

        public Consumer3(Admin_Service_Response4 admin_Service_Response4, Admin_Service_Builder1 admin_Service_Builder1, Billing_Client_Helper5 billing_Client_Helper5, DataAccess_Validators409_Builder3 dataAccess_Validators409_Builder3, Reporting_Api_Result reporting_Api_Result, Reporting_Api_Helper2 reporting_Api_Helper2, Billing_Web_Builder billing_Web_Builder, Logging_Tests_Dto8 logging_Tests_Dto8)
        {
            ...
            _billing_Client_Helper5 = billing_Client_Helper5 ?? throw new ArgumentNullException(nameof(billing_Client_Helper5));
            _dataAccess_Validators409_Builder3 = dataAccess_Validators409_Builder3 ?? throw new ArgumentNullException(nameof(dataAccess_Validators409_Builder3));
            _reporting_Api_Result = reporting_Api_Result ?? throw new ArgumentNullException(nameof(reporting_Api_Result));
            _reporting_Api_Helper2 = reporting_Api_Helper2 ?? throw new ArgumentNullException(nameof(reporting_Api_Helper2));
            _billing_Web_Builder = billing_Web_Builder ?? throw new ArgumentNullException(nameof(billing_Web_Builder));
            _logging_Tests_Dto8 = logging_Tests_Dto8 ?? throw new ArgumentNullException(nameof(logging_Tests_Dto8));
        }
        ...
        public Billing_Client_Helper5 GetBilling_Client_Helper5() => _billing_Client_Helper5;
        public DataAccess_Validators409_Builder3 GetDataAccess_Validators409_Builder3() => _dataAccess_Validators409_Builder3;
        public Reporting_Api_Result GetReporting_Api_Result() => _reporting_Api_Result;
        public Reporting_Api_Helper2 GetReporting_Api_Helper2() => _reporting_Api_Helper2;
        public Billing_Web_Builder GetBilling_Web_Builder() => _billing_Web_Builder;
        public Logging_Tests_Dto8 GetLogging_Tests_Dto8() => _logging_Tests_Dto8;
