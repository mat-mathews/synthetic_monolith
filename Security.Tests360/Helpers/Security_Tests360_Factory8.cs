...
{
    internal class Security_Tests360_Factory8
    {
        private readonly string _sql = "SELECT * FROM Sessions WHERE Id = @Id";
        public void Execute()
        {
            // Security_Tests360_Factory8 implementation
        }
...
public int Config75SortOrder { get; set; }
    ...
    public class Tests360Context : DbContext
    {
        public DbSet<Security_Tests360_Factory8> Security_Tests360_Factory8s { get; set; }
    }
