...
{
    public interface ICommon_Mappers190_Provider5
    {
        /// <summary>Processes the Common_Mappers190_Provider5 operation.</summary>
        void ProcessCommon_Mappers190_Provider5();

        /// <summary>Validates the Common_Mappers190_Provider5 state.</summary>
        bool ValidateCommon_Mappers190_Provider5();
    }
