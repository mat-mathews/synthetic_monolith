...
namespace Common.Mappers190
{
    ...
    public class Consumer32
    {
        ...
        private readonly Common_Contracts_Repository _common_Contracts_Repository;
        private readonly Notifications_Mappers55_Provider2 _notifications_Mappers55_Provider2;
        private readonly Documents_Api251_Repository _documents_Api251_Repository;
        private readonly Documents_Api251_Service6 _documents_Api251_Service6;
        private readonly Documents_Client_Processor3 _documents_Client_Processor3;

        public Consumer32(Admin_Service247_Repository admin_Service247_Repository, Auth_Models23_Controller5 auth_Models23_Controller5, Auth_Core_Request5 auth_Core_Request5, Common_Contracts_Repository common_Contracts_Repository, Notifications_Mappers55_Provider2 notifications_Mappers55_Provider2, Documents_Api251_Repository documents_Api251_Repository, Documents_Api251_Service6 documents_Api251_Service6, Documents_Client_Processor3 documents_Client_Processor3)
        {
            ...
            _common_Contracts_Repository = common_Contracts_Repository ?? throw new ArgumentNullException(nameof(common_Contracts_Repository));
            ...
            _documents_Api251_Repository = documents_Api251_Repository ?? throw new ArgumentNullException(nameof(documents_Api251_Repository));
            _documents_Api251_Service6 = documents_Api251_Service6 ?? throw new ArgumentNullException(nameof(documents_Api251_Service6));
            _documents_Client_Processor3 = documents_Client_Processor3 ?? throw new ArgumentNullException(nameof(documents_Client_Processor3));
        }
        ...
        public Common_Contracts_Repository GetCommon_Contracts_Repository() => _common_Contracts_Repository;
        public Notifications_Mappers55_Provider2 GetNotifications_Mappers55_Provider2() => _notifications_Mappers55_Provider2;
        public Documents_Api251_Repository GetDocuments_Api251_Repository() => _documents_Api251_Repository;
        public Documents_Api251_Service6 GetDocuments_Api251_Service6() => _documents_Api251_Service6;
        public Documents_Client_Processor3 GetDocuments_Client_Processor3() => _documents_Client_Processor3;
