...
{
    internal interface IImport_Mappers_Service9
    {
        /// <summary>Processes the Import_Mappers_Service9 operation.</summary>
        void ProcessImport_Mappers_Service9();

        /// <summary>Validates the Import_Mappers_Service9 state.</summary>
        bool ValidateImport_Mappers_Service9();
    }
