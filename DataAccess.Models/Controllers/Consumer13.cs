...
namespace DataAccess.Models
{
    ...
    public class Consumer13
    {
        ...
        private readonly Admin_Tests_Builder4 _admin_Tests_Builder4;
        private readonly BatchJobs_Models_Builder _batchJobs_Models_Builder;
        private readonly Integration_Service147_Repository2 _integration_Service147_Repository2;
        private readonly Notifications_Validators_Repository3 _notifications_Validators_Repository3;
        private readonly Notifications_Validators_Repository12 _notifications_Validators_Repository12;
        private readonly Documents_Models_Controller2 _documents_Models_Controller2;
        private readonly Common_Processors142_Factory1 _common_Processors142_Factory1;

        public Consumer13(Admin_Tests_Processor5 admin_Tests_Processor5, Admin_Tests_Builder4 admin_Tests_Builder4, BatchJobs_Models_Builder batchJobs_Models_Builder, Integration_Service147_Repository2 integration_Service147_Repository2, Notifications_Validators_Repository3 notifications_Validators_Repository3, Notifications_Validators_Repository12 notifications_Validators_Repository12, Documents_Models_Controller2 documents_Models_Controller2, Common_Processors142_Factory1 common_Processors142_Factory1)
        {
            _admin_Tests_Processor5 = admin_Tests_Processor5 ?? throw new ArgumentNullException(nameof(admin_Tests_Processor5));
            _admin_Tests_Builder4 = admin_Tests_Builder4 ?? throw new ArgumentNullException(nameof(admin_Tests_Builder4));
            _batchJobs_Models_Builder = batchJobs_Models_Builder ?? throw new ArgumentNullException(nameof(batchJobs_Models_Builder));
            _integration_Service147_Repository2 = integration_Service147_Repository2 ?? throw new ArgumentNullException(nameof(integration_Service147_Repository2));
            _notifications_Validators_Repository3 = notifications_Validators_Repository3 ?? throw new ArgumentNullException(nameof(notifications_Validators_Repository3));
            _notifications_Validators_Repository12 = notifications_Validators_Repository12 ?? throw new ArgumentNullException(nameof(notifications_Validators_Repository12));
            _documents_Models_Controller2 = documents_Models_Controller2 ?? throw new ArgumentNullException(nameof(documents_Models_Controller2));
        ...
        public Admin_Tests_Builder4 GetAdmin_Tests_Builder4() => _admin_Tests_Builder4;
        public BatchJobs_Models_Builder GetBatchJobs_Models_Builder() => _batchJobs_Models_Builder;
        public Integration_Service147_Repository2 GetIntegration_Service147_Repository2() => _integration_Service147_Repository2;
        public Notifications_Validators_Repository3 GetNotifications_Validators_Repository3() => _notifications_Validators_Repository3;
        public Notifications_Validators_Repository12 GetNotifications_Validators_Repository12() => _notifications_Validators_Repository12;
        public Documents_Models_Controller2 GetDocuments_Models_Controller2() => _documents_Models_Controller2;
