...
namespace Scheduling.Handlers
{
    ...
    {
        private readonly Logging_Client_Builder2 _logging_Client_Builder2;
        private readonly Integration_Models_Helper2 _integration_Models_Helper2;
        private readonly Reporting_Tests67_Command5 _reporting_Tests67_Command5;
        private readonly Auth_Models_Factory9 _auth_Models_Factory9;
        private readonly Auth_Models_Event _auth_Models_Event;
        private readonly Billing_Shared312_Repository9 _billing_Shared312_Repository9;
        private readonly Export_Processors449_Handler _export_Processors449_Handler;
        private readonly Export_Processors449_Helper1 _export_Processors449_Helper1;

        public Consumer15(Logging_Client_Builder2 logging_Client_Builder2, Integration_Models_Helper2 integration_Models_Helper2, Reporting_Tests67_Command5 reporting_Tests67_Command5, Auth_Models_Factory9 auth_Models_Factory9, Auth_Models_Event auth_Models_Event, Billing_Shared312_Repository9 billing_Shared312_Repository9, Export_Processors449_Handler export_Processors449_Handler, Export_Processors449_Helper1 export_Processors449_Helper1)
        {
            _logging_Client_Builder2 = logging_Client_Builder2 ?? throw new ArgumentNullException(nameof(logging_Client_Builder2));
            _integration_Models_Helper2 = integration_Models_Helper2 ?? throw new ArgumentNullException(nameof(integration_Models_Helper2));
            _reporting_Tests67_Command5 = reporting_Tests67_Command5 ?? throw new ArgumentNullException(nameof(reporting_Tests67_Command5));
            _auth_Models_Factory9 = auth_Models_Factory9 ?? throw new ArgumentNullException(nameof(auth_Models_Factory9));
            _auth_Models_Event = auth_Models_Event ?? throw new ArgumentNullException(nameof(auth_Models_Event));
            _billing_Shared312_Repository9 = billing_Shared312_Repository9 ?? throw new ArgumentNullException(nameof(billing_Shared312_Repository9));
            _export_Processors449_Handler = export_Processors449_Handler ?? throw new ArgumentNullException(nameof(export_Processors449_Handler));
            _export_Processors449_Helper1 = export_Processors449_Helper1 ?? throw new ArgumentNullException(nameof(export_Processors449_Helper1));
        }

        public Logging_Client_Builder2 GetLogging_Client_Builder2() => _logging_Client_Builder2;
        public Integration_Models_Helper2 GetIntegration_Models_Helper2() => _integration_Models_Helper2;
        public Reporting_Tests67_Command5 GetReporting_Tests67_Command5() => _reporting_Tests67_Command5;
        public Auth_Models_Factory9 GetAuth_Models_Factory9() => _auth_Models_Factory9;
        public Auth_Models_Event GetAuth_Models_Event() => _auth_Models_Event;
        public Billing_Shared312_Repository9 GetBilling_Shared312_Repository9() => _billing_Shared312_Repository9;
        public Export_Processors449_Handler GetExport_Processors449_Handler() => _export_Processors449_Handler;
        public Export_Processors449_Helper1 GetExport_Processors449_Helper1() => _export_Processors449_Helper1;
