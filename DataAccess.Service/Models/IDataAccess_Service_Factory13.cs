...
{
    internal interface IDataAccess_Service_Factory13
    {
        /// <summary>Processes the DataAccess_Service_Factory13 operation.</summary>
        void ProcessDataAccess_Service_Factory13();

        /// <summary>Validates the DataAccess_Service_Factory13 state.</summary>
        bool ValidateDataAccess_Service_Factory13();
    }
