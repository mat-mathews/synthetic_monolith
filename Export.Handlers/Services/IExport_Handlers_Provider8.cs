...
{
    internal interface IExport_Handlers_Provider8
    {
        /// <summary>Processes the Export_Handlers_Provider8 operation.</summary>
        void ProcessExport_Handlers_Provider8();

        /// <summary>Validates the Export_Handlers_Provider8 state.</summary>
        bool ValidateExport_Handlers_Provider8();
    }
