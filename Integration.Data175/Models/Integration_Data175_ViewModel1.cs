...
{
    /// <summary>Immutable data transfer record for Integration_Data175_ViewModel1.</summary>
    internal record Integration_Data175_ViewModel1(string Value, int Count, DateTime Timestamp);
