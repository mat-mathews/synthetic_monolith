...
{
    /// <summary>Immutable data transfer record for Export_Web210_Command6.</summary>
    public record Export_Web210_Command6(string Value, int Count, DateTime Timestamp);
