...
{
    /// <summary>Immutable data transfer record for Export_Web210_Command12.</summary>
    public record Export_Web210_Command12(string Value, int Count, DateTime Timestamp);
