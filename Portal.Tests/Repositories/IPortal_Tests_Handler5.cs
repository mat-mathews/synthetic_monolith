...
{
    public interface IPortal_Tests_Handler5
    {
        /// <summary>Processes the Portal_Tests_Handler5 operation.</summary>
        void ProcessPortal_Tests_Handler5();

        /// <summary>Validates the Portal_Tests_Handler5 state.</summary>
        bool ValidatePortal_Tests_Handler5();
    }
