...
{
    public interface IPortal_Tests_Service6
    {
        /// <summary>Processes the Portal_Tests_Service6 operation.</summary>
        void ProcessPortal_Tests_Service6();

        /// <summary>Validates the Portal_Tests_Service6 state.</summary>
        bool ValidatePortal_Tests_Service6();
    }
