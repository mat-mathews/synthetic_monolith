...
{
    /// <summary>Immutable data transfer record for Integration_Service107_Command8.</summary>
    internal record Integration_Service107_Command8(string Value, int Count, DateTime Timestamp);
