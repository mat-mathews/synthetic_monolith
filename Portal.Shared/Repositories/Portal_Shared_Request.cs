...
{
    /// <summary>Immutable data transfer record for Portal_Shared_Request.</summary>
    internal record Portal_Shared_Request(string Value, int Count, DateTime Timestamp);
