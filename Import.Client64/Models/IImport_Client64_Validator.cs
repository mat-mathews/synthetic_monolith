...
{
    public interface IImport_Client64_Validator
    {
        /// <summary>Processes the Import_Client64_Validator operation.</summary>
        void ProcessImport_Client64_Validator();

        /// <summary>Validates the Import_Client64_Validator state.</summary>
        bool ValidateImport_Client64_Validator();
    }
