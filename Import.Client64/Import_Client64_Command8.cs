...
{
    /// <summary>Immutable data transfer record for Import_Client64_Command8.</summary>
    public record Import_Client64_Command8(string Value, int Count, DateTime Timestamp);
