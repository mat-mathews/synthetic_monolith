...
{
    public interface IImport_Client64_Validator4
    {
        /// <summary>Processes the Import_Client64_Validator4 operation.</summary>
        void ProcessImport_Client64_Validator4();

        /// <summary>Validates the Import_Client64_Validator4 state.</summary>
        bool ValidateImport_Client64_Validator4();
    }
