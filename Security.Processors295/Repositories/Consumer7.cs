...
namespace Security.Processors295
{
    ...
    public class Consumer7
    {
        ...
        private readonly Workflow_Events_Request1 _workflow_Events_Request1;
        private readonly Workflow_Events_Range4 _workflow_Events_Range4;
        private readonly Documents_Web_Result _documents_Web_Result;
        private readonly Documents_Web_Command10 _documents_Web_Command10;
        private readonly Documents_Web_Handler8 _documents_Web_Handler8;
        private readonly Imaging_Events_Key12 _imaging_Events_Key12;
        private readonly IImaging_Events_Repository1 _iImaging_Events_Repository1;

        public Consumer7(Auth_Core_Processor8 auth_Core_Processor8, Workflow_Events_Request1 workflow_Events_Request1, Workflow_Events_Range4 workflow_Events_Range4, Documents_Web_Result documents_Web_Result, Documents_Web_Command10 documents_Web_Command10, Documents_Web_Handler8 documents_Web_Handler8, Imaging_Events_Key12 imaging_Events_Key12, IImaging_Events_Repository1 iImaging_Events_Repository1)
        {
            _auth_Core_Processor8 = auth_Core_Processor8 ?? throw new ArgumentNullException(nameof(auth_Core_Processor8));
            _workflow_Events_Request1 = workflow_Events_Request1 ?? throw new ArgumentNullException(nameof(workflow_Events_Request1));
            _workflow_Events_Range4 = workflow_Events_Range4 ?? throw new ArgumentNullException(nameof(workflow_Events_Range4));
            _documents_Web_Result = documents_Web_Result ?? throw new ArgumentNullException(nameof(documents_Web_Result));
            _documents_Web_Command10 = documents_Web_Command10 ?? throw new ArgumentNullException(nameof(documents_Web_Command10));
            _documents_Web_Handler8 = documents_Web_Handler8 ?? throw new ArgumentNullException(nameof(documents_Web_Handler8));
            _imaging_Events_Key12 = imaging_Events_Key12 ?? throw new ArgumentNullException(nameof(imaging_Events_Key12));
        ...
        public Workflow_Events_Request1 GetWorkflow_Events_Request1() => _workflow_Events_Request1;
        public Workflow_Events_Range4 GetWorkflow_Events_Range4() => _workflow_Events_Range4;
        public Documents_Web_Result GetDocuments_Web_Result() => _documents_Web_Result;
        public Documents_Web_Command10 GetDocuments_Web_Command10() => _documents_Web_Command10;
        public Documents_Web_Handler8 GetDocuments_Web_Handler8() => _documents_Web_Handler8;
        public Imaging_Events_Key12 GetImaging_Events_Key12() => _imaging_Events_Key12;
