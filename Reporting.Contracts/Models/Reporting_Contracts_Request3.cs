...
{
    /// <summary>Immutable data transfer record for Reporting_Contracts_Request3.</summary>
    internal record Reporting_Contracts_Request3(string Value, int Count, DateTime Timestamp);
