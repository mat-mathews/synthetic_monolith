...
namespace Utilities.Shared114
{
    /// <summary>Immutable data transfer record for Utilities_Shared114_Command4.</summary>
    internal record Utilities_Shared114_Command4(string Value, int Count, DateTime Timestamp);
