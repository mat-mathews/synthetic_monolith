...
{
    /// <summary>Immutable data transfer record for BatchJobs_Data176_Command7.</summary>
    internal record BatchJobs_Data176_Command7(string Value, int Count, DateTime Timestamp);
