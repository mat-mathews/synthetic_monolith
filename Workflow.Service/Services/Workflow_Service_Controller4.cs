...
{
    public static class Workflow_Service_Controller4 : IDisposable
    {
        private readonly string _sql = "SELECT * FROM Schedules WHERE Id = @Id";
        public void Execute()
        {
            // Workflow_Service_Controller4 implementation
        }
...
public int Field41SortOrder { get; set; }
    ...
    {
        public DbSet<Workflow_Service_Controller4> Workflow_Service_Controller4s { get; set; }
    }
