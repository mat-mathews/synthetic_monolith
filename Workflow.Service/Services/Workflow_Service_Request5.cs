...
{
    /// <summary>Immutable data transfer record for Workflow_Service_Request5.</summary>
    public record Workflow_Service_Request5(string Value, int Count, DateTime Timestamp);
