...
{
    internal class Workflow_Service_Service6
    {
        private readonly string _sql = "SELECT * FROM Permissions WHERE Id = @Id";
        public void Execute()
        {
            // Workflow_Service_Service6 implementation
        }
...
public int Config94SortOrder { get; set; }
    ...
    {
        public DbSet<Workflow_Service_Service6> Workflow_Service_Service6s { get; set; }
    }
