...
{
    /// <summary>Immutable data transfer record for BatchJobs_Processors410_Command6.</summary>
    internal record BatchJobs_Processors410_Command6(string Value, int Count, DateTime Timestamp);
