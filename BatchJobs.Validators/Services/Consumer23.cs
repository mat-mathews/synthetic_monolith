...
namespace BatchJobs.Validators
{
    ...
    public class Consumer23
    {
        ...
        private readonly Workflow_Client47_Helper _workflow_Client47_Helper;

        public Consumer23(Auth_Handlers281_Handler1 auth_Handlers281_Handler1, Auth_Contracts402_Event5 auth_Contracts402_Event5, Auth_Contracts402_Factory auth_Contracts402_Factory, Admin_Service456_Handler10 admin_Service456_Handler10, Admin_Service456_Handler13 admin_Service456_Handler13, DataAccess_Api307_Helper dataAccess_Api307_Helper, DataAccess_Api307_Dto1 dataAccess_Api307_Dto1, Workflow_Client47_Helper workflow_Client47_Helper)
        {
            ...
            _workflow_Client47_Helper = workflow_Client47_Helper ?? throw new ArgumentNullException(nameof(workflow_Client47_Helper));
        }
        ...
        public Workflow_Client47_Helper GetWorkflow_Client47_Helper() => _workflow_Client47_Helper;
