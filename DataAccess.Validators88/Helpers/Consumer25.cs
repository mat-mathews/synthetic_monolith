...
namespace DataAccess.Validators88
{
    ...
    {
        private readonly Billing_Core34_Processor _billing_Core34_Processor;
        ...
        private readonly Logging_Shared_Provider7 _logging_Shared_Provider7;
        private readonly GalaxyWorks_Web_Provider _galaxyWorks_Web_Provider;

        public Consumer25(Billing_Core34_Processor billing_Core34_Processor, Billing_Core34_Provider1 billing_Core34_Provider1, Utilities_Contracts24_Repository7 utilities_Contracts24_Repository7, Utilities_Contracts24_Controller3 utilities_Contracts24_Controller3, Integration_Contracts290_Controller3 integration_Contracts290_Controller3, IIntegration_Contracts290_Factory10 iIntegration_Contracts290_Factory10, Logging_Shared_Provider7 logging_Shared_Provider7, GalaxyWorks_Web_Provider galaxyWorks_Web_Provider)
        {
            _billing_Core34_Processor = billing_Core34_Processor ?? throw new ArgumentNullException(nameof(billing_Core34_Processor));
            ...
            _logging_Shared_Provider7 = logging_Shared_Provider7 ?? throw new ArgumentNullException(nameof(logging_Shared_Provider7));
            _galaxyWorks_Web_Provider = galaxyWorks_Web_Provider ?? throw new ArgumentNullException(nameof(galaxyWorks_Web_Provider));
        }

        public Billing_Core34_Processor GetBilling_Core34_Processor() => _billing_Core34_Processor;
        ...
        public Logging_Shared_Provider7 GetLogging_Shared_Provider7() => _logging_Shared_Provider7;
