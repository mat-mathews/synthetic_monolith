...
{
    /// <summary>Immutable data transfer record for DataAccess_Validators88_ViewModel4.</summary>
    public record DataAccess_Validators88_ViewModel4(string Value, int Count, DateTime Timestamp);
