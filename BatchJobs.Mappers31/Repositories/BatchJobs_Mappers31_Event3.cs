...
{
    /// <summary>Immutable data transfer record for BatchJobs_Mappers31_Event3.</summary>
    internal record BatchJobs_Mappers31_Event3(string Value, int Count, DateTime Timestamp);
