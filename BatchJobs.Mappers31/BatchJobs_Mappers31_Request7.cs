...
{
    /// <summary>Immutable data transfer record for BatchJobs_Mappers31_Request7.</summary>
    public record BatchJobs_Mappers31_Request7(string Value, int Count, DateTime Timestamp);
