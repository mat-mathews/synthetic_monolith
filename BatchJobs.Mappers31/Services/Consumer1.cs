...
namespace BatchJobs.Mappers31
{
    ...
    {
        private readonly Admin_Validators37_Service _admin_Validators37_Service;
        private readonly Scheduling_Tests_Repository _scheduling_Tests_Repository;
        private readonly Imaging_Client331_Handler11 _imaging_Client331_Handler11;
        private readonly Imaging_Client331_Builder7 _imaging_Client331_Builder7;
        private readonly Imaging_Client331_Helper _imaging_Client331_Helper;
        private readonly Security_Tests360_Factory8 _security_Tests360_Factory8;
        private readonly Documents_Data_Response5 _documents_Data_Response5;
        private readonly IDocuments_Data_Handler _iDocuments_Data_Handler;

        public Consumer1(Admin_Validators37_Service admin_Validators37_Service, Scheduling_Tests_Repository scheduling_Tests_Repository, Imaging_Client331_Handler11 imaging_Client331_Handler11, Imaging_Client331_Builder7 imaging_Client331_Builder7, Imaging_Client331_Helper imaging_Client331_Helper, Security_Tests360_Factory8 security_Tests360_Factory8, Documents_Data_Response5 documents_Data_Response5, IDocuments_Data_Handler iDocuments_Data_Handler)
        {
            _admin_Validators37_Service = admin_Validators37_Service ?? throw new ArgumentNullException(nameof(admin_Validators37_Service));
            _scheduling_Tests_Repository = scheduling_Tests_Repository ?? throw new ArgumentNullException(nameof(scheduling_Tests_Repository));
            _imaging_Client331_Handler11 = imaging_Client331_Handler11 ?? throw new ArgumentNullException(nameof(imaging_Client331_Handler11));
            _imaging_Client331_Builder7 = imaging_Client331_Builder7 ?? throw new ArgumentNullException(nameof(imaging_Client331_Builder7));
            _imaging_Client331_Helper = imaging_Client331_Helper ?? throw new ArgumentNullException(nameof(imaging_Client331_Helper));
            _security_Tests360_Factory8 = security_Tests360_Factory8 ?? throw new ArgumentNullException(nameof(security_Tests360_Factory8));
            _documents_Data_Response5 = documents_Data_Response5 ?? throw new ArgumentNullException(nameof(documents_Data_Response5));
            _iDocuments_Data_Handler = iDocuments_Data_Handler ?? throw new ArgumentNullException(nameof(iDocuments_Data_Handler));
        }

        public Admin_Validators37_Service GetAdmin_Validators37_Service() => _admin_Validators37_Service;
        public Scheduling_Tests_Repository GetScheduling_Tests_Repository() => _scheduling_Tests_Repository;
        public Imaging_Client331_Handler11 GetImaging_Client331_Handler11() => _imaging_Client331_Handler11;
        public Imaging_Client331_Builder7 GetImaging_Client331_Builder7() => _imaging_Client331_Builder7;
        public Imaging_Client331_Helper GetImaging_Client331_Helper() => _imaging_Client331_Helper;
        public Security_Tests360_Factory8 GetSecurity_Tests360_Factory8() => _security_Tests360_Factory8;
        public Documents_Data_Response5 GetDocuments_Data_Response5() => _documents_Data_Response5;
        public IDocuments_Data_Handler GetIDocuments_Data_Handler() => _iDocuments_Data_Handler;
