...
namespace BatchJobs.Mappers31
{
    ...
    {
        private readonly IScheduling_Tests_Factory4 _iScheduling_Tests_Factory4;
        private readonly Imaging_Client331_Response8 _imaging_Client331_Response8;
        private readonly Security_Tests360_Handler4 _security_Tests360_Handler4;
        private readonly Documents_Data_Result2 _documents_Data_Result2;
        private readonly Portal_Validators_Controller5 _portal_Validators_Controller5;
        private readonly Notifications_Web_Event3 _notifications_Web_Event3;
        private readonly DataAccess_Client_Event1 _dataAccess_Client_Event1;
        private readonly Export_Web479_Helper8 _export_Web479_Helper8;

        public Consumer14(IScheduling_Tests_Factory4 iScheduling_Tests_Factory4, Imaging_Client331_Response8 imaging_Client331_Response8, Security_Tests360_Handler4 security_Tests360_Handler4, Documents_Data_Result2 documents_Data_Result2, Portal_Validators_Controller5 portal_Validators_Controller5, Notifications_Web_Event3 notifications_Web_Event3, DataAccess_Client_Event1 dataAccess_Client_Event1, Export_Web479_Helper8 export_Web479_Helper8)
        {
            _iScheduling_Tests_Factory4 = iScheduling_Tests_Factory4 ?? throw new ArgumentNullException(nameof(iScheduling_Tests_Factory4));
            _imaging_Client331_Response8 = imaging_Client331_Response8 ?? throw new ArgumentNullException(nameof(imaging_Client331_Response8));
            _security_Tests360_Handler4 = security_Tests360_Handler4 ?? throw new ArgumentNullException(nameof(security_Tests360_Handler4));
            _documents_Data_Result2 = documents_Data_Result2 ?? throw new ArgumentNullException(nameof(documents_Data_Result2));
            _portal_Validators_Controller5 = portal_Validators_Controller5 ?? throw new ArgumentNullException(nameof(portal_Validators_Controller5));
            _notifications_Web_Event3 = notifications_Web_Event3 ?? throw new ArgumentNullException(nameof(notifications_Web_Event3));
            _dataAccess_Client_Event1 = dataAccess_Client_Event1 ?? throw new ArgumentNullException(nameof(dataAccess_Client_Event1));
            _export_Web479_Helper8 = export_Web479_Helper8 ?? throw new ArgumentNullException(nameof(export_Web479_Helper8));
        }

        public IScheduling_Tests_Factory4 GetIScheduling_Tests_Factory4() => _iScheduling_Tests_Factory4;
        public Imaging_Client331_Response8 GetImaging_Client331_Response8() => _imaging_Client331_Response8;
        public Security_Tests360_Handler4 GetSecurity_Tests360_Handler4() => _security_Tests360_Handler4;
        public Documents_Data_Result2 GetDocuments_Data_Result2() => _documents_Data_Result2;
        public Portal_Validators_Controller5 GetPortal_Validators_Controller5() => _portal_Validators_Controller5;
        public Notifications_Web_Event3 GetNotifications_Web_Event3() => _notifications_Web_Event3;
        public DataAccess_Client_Event1 GetDataAccess_Client_Event1() => _dataAccess_Client_Event1;
        public Export_Web479_Helper8 GetExport_Web479_Helper8() => _export_Web479_Helper8;
