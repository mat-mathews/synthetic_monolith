...
{
    /// <summary>Immutable data transfer record for Integration_Events301_Command9.</summary>
    public record Integration_Events301_Command9(string Value, int Count, DateTime Timestamp);
