...
namespace Integration.Events301
{
    ...
    public class Consumer12
    {
        ...
        private readonly Utilities_Shared114_Range _utilities_Shared114_Range;
        private readonly Imaging_Core204_Controller1 _imaging_Core204_Controller1;
        private readonly Workflow_Tests27_Handler5 _workflow_Tests27_Handler5;
        private readonly Export_Client414_Range5 _export_Client414_Range5;

        public Consumer12(Admin_Tests10_Helper8 admin_Tests10_Helper8, Export_Handlers_Processor1 export_Handlers_Processor1, IImport_Web_Provider iImport_Web_Provider, Workflow_Handlers_Service12 workflow_Handlers_Service12, Utilities_Shared114_Range utilities_Shared114_Range, Imaging_Core204_Controller1 imaging_Core204_Controller1, Workflow_Tests27_Handler5 workflow_Tests27_Handler5, Export_Client414_Range5 export_Client414_Range5)
        {
            ...
            _utilities_Shared114_Range = utilities_Shared114_Range ?? throw new ArgumentNullException(nameof(utilities_Shared114_Range));
            ...
            _workflow_Tests27_Handler5 = workflow_Tests27_Handler5 ?? throw new ArgumentNullException(nameof(workflow_Tests27_Handler5));
            _export_Client414_Range5 = export_Client414_Range5 ?? throw new ArgumentNullException(nameof(export_Client414_Range5));
        }
        ...
        public Utilities_Shared114_Range GetUtilities_Shared114_Range() => _utilities_Shared114_Range;
        public Imaging_Core204_Controller1 GetImaging_Core204_Controller1() => _imaging_Core204_Controller1;
        public Workflow_Tests27_Handler5 GetWorkflow_Tests27_Handler5() => _workflow_Tests27_Handler5;
        public Export_Client414_Range5 GetExport_Client414_Range5() => _export_Client414_Range5;
