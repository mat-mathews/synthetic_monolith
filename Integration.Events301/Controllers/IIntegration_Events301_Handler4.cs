...
{
    public interface IIntegration_Events301_Handler4
    {
        /// <summary>Processes the Integration_Events301_Handler4 operation.</summary>
        void ProcessIntegration_Events301_Handler4();

        /// <summary>Validates the Integration_Events301_Handler4 state.</summary>
        bool ValidateIntegration_Events301_Handler4();
    }
