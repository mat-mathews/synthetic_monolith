...
{
    internal interface IIntegration_Events301_Validator5
    {
        /// <summary>Processes the Integration_Events301_Validator5 operation.</summary>
        void ProcessIntegration_Events301_Validator5();

        /// <summary>Validates the Integration_Events301_Validator5 state.</summary>
        bool ValidateIntegration_Events301_Validator5();
    }
