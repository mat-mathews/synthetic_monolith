...
namespace Scheduling.Mappers48
{
    ...
    {
        private readonly Auth_Handlers467_Processor _auth_Handlers467_Processor;
        private readonly Auth_Handlers467_Repository7 _auth_Handlers467_Repository7;
        private readonly Notifications_Tests_Factory7 _notifications_Tests_Factory7;
        private readonly Notifications_Tests_Provider1 _notifications_Tests_Provider1;
        private readonly INotifications_Tests_Validator _iNotifications_Tests_Validator;
        private readonly DataAccess_Validators_Key7 _dataAccess_Validators_Key7;
        private readonly IDataAccess_Validators_Repository _iDataAccess_Validators_Repository;
        private readonly IDataAccess_Validators_Handler6 _iDataAccess_Validators_Handler6;

        public Consumer22(Auth_Handlers467_Processor auth_Handlers467_Processor, Auth_Handlers467_Repository7 auth_Handlers467_Repository7, Notifications_Tests_Factory7 notifications_Tests_Factory7, Notifications_Tests_Provider1 notifications_Tests_Provider1, INotifications_Tests_Validator iNotifications_Tests_Validator, DataAccess_Validators_Key7 dataAccess_Validators_Key7, IDataAccess_Validators_Repository iDataAccess_Validators_Repository, IDataAccess_Validators_Handler6 iDataAccess_Validators_Handler6)
        {
            _auth_Handlers467_Processor = auth_Handlers467_Processor ?? throw new ArgumentNullException(nameof(auth_Handlers467_Processor));
            ...
            _notifications_Tests_Factory7 = notifications_Tests_Factory7 ?? throw new ArgumentNullException(nameof(notifications_Tests_Factory7));
            _notifications_Tests_Provider1 = notifications_Tests_Provider1 ?? throw new ArgumentNullException(nameof(notifications_Tests_Provider1));
            ...
            _dataAccess_Validators_Key7 = dataAccess_Validators_Key7 ?? throw new ArgumentNullException(nameof(dataAccess_Validators_Key7));
            _iDataAccess_Validators_Repository = iDataAccess_Validators_Repository ?? throw new ArgumentNullException(nameof(iDataAccess_Validators_Repository));
            _iDataAccess_Validators_Handler6 = iDataAccess_Validators_Handler6 ?? throw new ArgumentNullException(nameof(iDataAccess_Validators_Handler6));
        }

        public Auth_Handlers467_Processor GetAuth_Handlers467_Processor() => _auth_Handlers467_Processor;
        public Auth_Handlers467_Repository7 GetAuth_Handlers467_Repository7() => _auth_Handlers467_Repository7;
        public Notifications_Tests_Factory7 GetNotifications_Tests_Factory7() => _notifications_Tests_Factory7;
        public Notifications_Tests_Provider1 GetNotifications_Tests_Provider1() => _notifications_Tests_Provider1;
        public INotifications_Tests_Validator GetINotifications_Tests_Validator() => _iNotifications_Tests_Validator;
        public DataAccess_Validators_Key7 GetDataAccess_Validators_Key7() => _dataAccess_Validators_Key7;
        public IDataAccess_Validators_Repository GetIDataAccess_Validators_Repository() => _iDataAccess_Validators_Repository;
        public IDataAccess_Validators_Handler6 GetIDataAccess_Validators_Handler6() => _iDataAccess_Validators_Handler6;
