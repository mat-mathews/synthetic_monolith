...
{
    internal interface IScheduling_Tests76_Provider6
    {
        /// <summary>Processes the Scheduling_Tests76_Provider6 operation.</summary>
        void ProcessScheduling_Tests76_Provider6();

        /// <summary>Validates the Scheduling_Tests76_Provider6 state.</summary>
        bool ValidateScheduling_Tests76_Provider6();
    }
