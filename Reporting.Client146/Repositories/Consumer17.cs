...
namespace Reporting.Client146
{
    ...
    public class Consumer17
    {
        ...
        private readonly Documents_Client58_Builder1 _documents_Client58_Builder1;
        private readonly IDocuments_Client58_Service _iDocuments_Client58_Service;
        private readonly Admin_Client177_Repository2 _admin_Client177_Repository2;
        private readonly Scheduling_Api3_Response _scheduling_Api3_Response;
        private readonly IIntegration_Events301_Validator5 _iIntegration_Events301_Validator5;
        private readonly Integration_Events301_Dto _integration_Events301_Dto;
        private readonly Billing_Validators_Builder2 _billing_Validators_Builder2;

        public Consumer17(Auth_Mappers_Helper3 auth_Mappers_Helper3, Documents_Client58_Builder1 documents_Client58_Builder1, IDocuments_Client58_Service iDocuments_Client58_Service, Admin_Client177_Repository2 admin_Client177_Repository2, Scheduling_Api3_Response scheduling_Api3_Response, IIntegration_Events301_Validator5 iIntegration_Events301_Validator5, Integration_Events301_Dto integration_Events301_Dto, Billing_Validators_Builder2 billing_Validators_Builder2)
        {
            _auth_Mappers_Helper3 = auth_Mappers_Helper3 ?? throw new ArgumentNullException(nameof(auth_Mappers_Helper3));
            _documents_Client58_Builder1 = documents_Client58_Builder1 ?? throw new ArgumentNullException(nameof(documents_Client58_Builder1));
            _iDocuments_Client58_Service = iDocuments_Client58_Service ?? throw new ArgumentNullException(nameof(iDocuments_Client58_Service));
            ...
            _scheduling_Api3_Response = scheduling_Api3_Response ?? throw new ArgumentNullException(nameof(scheduling_Api3_Response));
            _iIntegration_Events301_Validator5 = iIntegration_Events301_Validator5 ?? throw new ArgumentNullException(nameof(iIntegration_Events301_Validator5));
            _integration_Events301_Dto = integration_Events301_Dto ?? throw new ArgumentNullException(nameof(integration_Events301_Dto));
            _billing_Validators_Builder2 = billing_Validators_Builder2 ?? throw new ArgumentNullException(nameof(billing_Validators_Builder2));
        }

        public Auth_Mappers_Helper3 GetAuth_Mappers_Helper3() => _auth_Mappers_Helper3;
        public Documents_Client58_Builder1 GetDocuments_Client58_Builder1() => _documents_Client58_Builder1;
        public IDocuments_Client58_Service GetIDocuments_Client58_Service() => _iDocuments_Client58_Service;
        public Admin_Client177_Repository2 GetAdmin_Client177_Repository2() => _admin_Client177_Repository2;
        public Scheduling_Api3_Response GetScheduling_Api3_Response() => _scheduling_Api3_Response;
        public IIntegration_Events301_Validator5 GetIIntegration_Events301_Validator5() => _iIntegration_Events301_Validator5;
        public Integration_Events301_Dto GetIntegration_Events301_Dto() => _integration_Events301_Dto;
        public Billing_Validators_Builder2 GetBilling_Validators_Builder2() => _billing_Validators_Builder2;
