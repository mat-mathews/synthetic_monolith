...
{
    /// <summary>Immutable data transfer record for Billing_Tests194_Response3.</summary>
    public record Billing_Tests194_Response3(string Value, int Count, DateTime Timestamp);
