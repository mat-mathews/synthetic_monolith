...
{
    /// <summary>Immutable data transfer record for Billing_Tests194_Request4.</summary>
    public record Billing_Tests194_Request4(string Value, int Count, DateTime Timestamp);
