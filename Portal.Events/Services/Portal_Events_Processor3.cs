...
{
    internal sealed class Portal_Events_Processor3
    {
        private readonly string _sql = "SELECT * FROM Users WHERE Id = @Id";
        public void Execute()
        {
            // Portal_Events_Processor3 implementation
        }
...
public int Param51SortOrder { get; set; }
    ...
    {
        public DbSet<Portal_Events_Processor3> Portal_Events_Processor3s { get; set; }
    }
