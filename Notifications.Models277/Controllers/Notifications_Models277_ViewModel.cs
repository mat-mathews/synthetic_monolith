...
{
    /// <summary>Immutable data transfer record for Notifications_Models277_ViewModel.</summary>
    internal record Notifications_Models277_ViewModel(string Value, int Count, DateTime Timestamp);
