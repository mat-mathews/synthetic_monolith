...
{
    internal interface IBilling_Processors_Validator12
    {
        /// <summary>Processes the Billing_Processors_Validator12 operation.</summary>
        void ProcessBilling_Processors_Validator12();

        /// <summary>Validates the Billing_Processors_Validator12 state.</summary>
        bool ValidateBilling_Processors_Validator12();
    }
