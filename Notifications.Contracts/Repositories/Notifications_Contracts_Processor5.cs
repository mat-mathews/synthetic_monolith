...
{
    internal class Notifications_Contracts_Processor5 : IDisposable
    {
        private readonly string _sql = "SELECT * FROM Configurations WHERE Id = @Id";
        public void Execute()
        {
            // Notifications_Contracts_Processor5 implementation
        }
...
public int Field54SortOrder { get; set; }
    ...
    {
        public DbSet<Notifications_Contracts_Processor5> Notifications_Contracts_Processor5s { get; set; }
    }
