...
{
    /// <summary>Immutable data transfer record for Documents_Web_Response11.</summary>
    internal record Documents_Web_Response11(string Value, int Count, DateTime Timestamp);
