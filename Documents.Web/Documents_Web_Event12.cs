...
{
    /// <summary>Immutable data transfer record for Documents_Web_Event12.</summary>
    internal record Documents_Web_Event12(string Value, int Count, DateTime Timestamp);
