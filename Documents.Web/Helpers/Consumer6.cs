...
namespace Documents.Web
{
    ...
    public class Consumer6
    {
        ...
        private readonly Documents_Api251_Point5 _documents_Api251_Point5;

        public Consumer6(Auth_Processors400_Info2 auth_Processors400_Info2, IAuth_Processors400_Repository5 iAuth_Processors400_Repository5, Auth_Data_Helper1 auth_Data_Helper1, Auth_Data_Provider7 auth_Data_Provider7, Auth_Mappers_Dto7 auth_Mappers_Dto7, Import_Processors412_Provider import_Processors412_Provider, GalaxyWorks_Shared437_Result galaxyWorks_Shared437_Result, Documents_Api251_Point5 documents_Api251_Point5)
        {
            ...
            _documents_Api251_Point5 = documents_Api251_Point5 ?? throw new ArgumentNullException(nameof(documents_Api251_Point5));
        }
        ...
        public Documents_Api251_Point5 GetDocuments_Api251_Point5() => _documents_Api251_Point5;
