...
{
    /// <summary>Immutable data transfer record for Documents_Web_Command10.</summary>
    public record Documents_Web_Command10(string Value, int Count, DateTime Timestamp);
