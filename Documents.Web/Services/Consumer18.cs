...
namespace Documents.Web
{
    ...
    public class Consumer18
    {
        ...
        private readonly Documents_Api251_Handler7 _documents_Api251_Handler7;

        public Consumer18(Auth_Processors400_Helper7 auth_Processors400_Helper7, IAuth_Data_Validator8 iAuth_Data_Validator8, Auth_Data_Controller3 auth_Data_Controller3, Auth_Mappers_Helper4 auth_Mappers_Helper4, Auth_Mappers_Controller9 auth_Mappers_Controller9, Auth_Mappers_Service1 auth_Mappers_Service1, Import_Processors412_Provider import_Processors412_Provider, Documents_Api251_Handler7 documents_Api251_Handler7)
        {
            ...
            _documents_Api251_Handler7 = documents_Api251_Handler7 ?? throw new ArgumentNullException(nameof(documents_Api251_Handler7));
        }
        ...
        public Documents_Api251_Handler7 GetDocuments_Api251_Handler7() => _documents_Api251_Handler7;
