...
{
    internal interface IDocuments_Web_Handler6
    {
        /// <summary>Processes the Documents_Web_Handler6 operation.</summary>
        void ProcessDocuments_Web_Handler6();

        /// <summary>Validates the Documents_Web_Handler6 state.</summary>
        bool ValidateDocuments_Web_Handler6();
    }
