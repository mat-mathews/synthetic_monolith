...
{
    internal abstract class Documents_Web_Processor4
    {
        ...
        public void Execute()
        {
            // Documents_Web_Processor4 implementation
        }

/// <summary>
/// Validates the Processor4 before processing.
/// Checks required fields, business rules, and data integrity.
/// </summary>
/// <param name="input">The input to validate.</param>
/// <returns>True if valid, false otherwise.</returns>
public bool ValidateProcessor4(Processor4Request input)
{
    if (input == null)
    ...
    {
        _logger.LogWarning("Validation failed: Name is required for {Type}", nameof(Processor4));
        return false;
    }
...
/// <summary>
/// Processes the Processor4 operation asynchronously.
/// </summary>
public async Task<Processor4Result> ProcessProcessor4Async(
    Processor4Request request,
    CancellationToken cancellationToken = default)
{
    _logger.LogInformation("Processing {Operation} for {Id}",
        nameof(Processor4), request.Id);
    ...
    try
    {
        ...
        if (entity == null)
        {
            ...
            return new Processor4Result { Success = false, ErrorCode = "NOT_FOUND" };
        }
        ...
        _logger.LogInformation("Successfully processed {Operation}", nameof(Processor4));
        return new Processor4Result { Success = true, Data = entity };
    }
    catch (DbUpdateConcurrencyException ex)
    {
        _logger.LogError(ex, "Concurrency conflict processing {Operation}", nameof(Processor4));
        return new Processor4Result { Success = false, ErrorCode = "CONCURRENCY_CONFLICT" };
    }
}

/// <summary>
/// Retrieves a filtered and paginated list of Processor4 entities.
/// </summary>
/// <param name="filter">Filter criteria.</param>
/// <param name="page">Page number (1-based).</param>
/// <param name="pageSize">Items per page.</param>
public async Task<PagedResult<Processor4Dto>> GetProcessor4ListAsync(
    Processor4Filter filter, int page = 1, int pageSize = 25)
{
    // Ensure valid pagination parameters
    page = Math.Max(1, page);
    pageSize = Math.Clamp(pageSize, 1, 100);

    var query = _dbContext.Set<Processor4Entity>().AsQueryable();
    ...
    return new PagedResult<Processor4Dto>
    {
        Items = items,
...
private readonly ILogger<Processor4Service> _logger;
 ...
 */
public Processor4Service(
    ILogger<Processor4Service> logger,
    ...
    IMemoryCache cache)
{
    ...
    _cacheDuration = TimeSpan.FromMinutes(
        _configuration.GetValue<int>("Processor4:CacheDurationMinutes", 30));
}

/// <summary>
/// Gets or creates a cached Processor4 instance.
/// Uses IMemoryCache with sliding expiration.
/// </summary>
public async Task<Processor4Data> GetCachedProcessor4Async(string key)
{
    var cacheKey = $"Processor4_{key}";

    if (_cache.TryGetValue(cacheKey, out Processor4Data cached))
    {
    ...
    var data = await LoadFromProcessor4SourceAsync(key);
...
public int Item24SortOrder { get; set; }
    ...
    {
        public DbSet<Documents_Web_Processor4> Documents_Web_Processor4s { get; set; }
    }
