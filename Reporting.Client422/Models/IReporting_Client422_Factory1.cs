...
{
    public interface IReporting_Client422_Factory1
    {
        /// <summary>Processes the Reporting_Client422_Factory1 operation.</summary>
        void ProcessReporting_Client422_Factory1();

        /// <summary>Validates the Reporting_Client422_Factory1 state.</summary>
        bool ValidateReporting_Client422_Factory1();
    }
