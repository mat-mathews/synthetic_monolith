...
namespace Reporting.Client422
{
    ...
    {
        private readonly Auth_Client249_Manager _auth_Client249_Manager;
        private readonly Auth_Client249_Controller12 _auth_Client249_Controller12;
        private readonly Admin_Handlers_Provider10 _admin_Handlers_Provider10;
        ...
        private readonly BatchJobs_Events435_Repository9 _batchJobs_Events435_Repository9;
        private readonly Import_Mappers56_Event1 _import_Mappers56_Event1;
        private readonly IImport_Mappers56_Service4 _iImport_Mappers56_Service4;

        public Consumer1(Auth_Client249_Manager auth_Client249_Manager, Auth_Client249_Controller12 auth_Client249_Controller12, Admin_Handlers_Provider10 admin_Handlers_Provider10, Admin_Core_Handler2 admin_Core_Handler2, BatchJobs_Events435_Handler2 batchJobs_Events435_Handler2, BatchJobs_Events435_Repository9 batchJobs_Events435_Repository9, Import_Mappers56_Event1 import_Mappers56_Event1, IImport_Mappers56_Service4 iImport_Mappers56_Service4)
        {
            _auth_Client249_Manager = auth_Client249_Manager ?? throw new ArgumentNullException(nameof(auth_Client249_Manager));
            ...
            _admin_Handlers_Provider10 = admin_Handlers_Provider10 ?? throw new ArgumentNullException(nameof(admin_Handlers_Provider10));
            ...
            _batchJobs_Events435_Repository9 = batchJobs_Events435_Repository9 ?? throw new ArgumentNullException(nameof(batchJobs_Events435_Repository9));
            _import_Mappers56_Event1 = import_Mappers56_Event1 ?? throw new ArgumentNullException(nameof(import_Mappers56_Event1));
            _iImport_Mappers56_Service4 = iImport_Mappers56_Service4 ?? throw new ArgumentNullException(nameof(iImport_Mappers56_Service4));
        }

        public Auth_Client249_Manager GetAuth_Client249_Manager() => _auth_Client249_Manager;
        public Auth_Client249_Controller12 GetAuth_Client249_Controller12() => _auth_Client249_Controller12;
        public Admin_Handlers_Provider10 GetAdmin_Handlers_Provider10() => _admin_Handlers_Provider10;
        ...
        public BatchJobs_Events435_Repository9 GetBatchJobs_Events435_Repository9() => _batchJobs_Events435_Repository9;
        public Import_Mappers56_Event1 GetImport_Mappers56_Event1() => _import_Mappers56_Event1;
        public IImport_Mappers56_Service4 GetIImport_Mappers56_Service4() => _iImport_Mappers56_Service4;
