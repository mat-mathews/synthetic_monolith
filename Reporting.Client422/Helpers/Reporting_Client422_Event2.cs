...
{
    /// <summary>Immutable data transfer record for Reporting_Client422_Event2.</summary>
    public record Reporting_Client422_Event2(string Value, int Count, DateTime Timestamp);
