...
{
    /// <summary>Immutable data transfer record for Reporting_Client422_Response3.</summary>
    internal record Reporting_Client422_Response3(string Value, int Count, DateTime Timestamp);
