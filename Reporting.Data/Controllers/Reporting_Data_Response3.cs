...
{
    /// <summary>Immutable data transfer record for Reporting_Data_Response3.</summary>
    public record Reporting_Data_Response3(string Value, int Count, DateTime Timestamp);
