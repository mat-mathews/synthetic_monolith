...
{
    public class Portal_Events151_Controller
    {
        private readonly string _sql = "SELECT * FROM Customers WHERE Id = @Id";
        public void Execute()
        {
            // Portal_Events151_Controller implementation
        }
...
public int Entry37SortOrder { get; set; }
    ...
    public class Events151Context : DbContext
    {
        public DbSet<Portal_Events151_Controller> Portal_Events151_Controllers { get; set; }
    }
