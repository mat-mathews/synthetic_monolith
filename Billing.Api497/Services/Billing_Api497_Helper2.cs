...
{
    internal abstract class Billing_Api497_Helper2
    {
        private readonly string _sql = "SELECT * FROM AuditLogs WHERE Id = @Id";
        public void Execute()
        {
            // Billing_Api497_Helper2 implementation
        }
...
public int Param42SortOrder { get; set; }
    ...
    {
        public DbSet<Billing_Api497_Helper2> Billing_Api497_Helper2s { get; set; }
    }
