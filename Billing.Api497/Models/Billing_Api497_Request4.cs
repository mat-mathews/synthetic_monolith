...
{
    /// <summary>Immutable data transfer record for Billing_Api497_Request4.</summary>
    public record Billing_Api497_Request4(string Value, int Count, DateTime Timestamp);
