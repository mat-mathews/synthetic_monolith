...
{
    /// <summary>Immutable data transfer record for Imaging_Models_Command9.</summary>
    internal record Imaging_Models_Command9(string Value, int Count, DateTime Timestamp);
