...
{
    /// <summary>Immutable data transfer record for Imaging_Models_Command1.</summary>
    public record Imaging_Models_Command1(string Value, int Count, DateTime Timestamp);
