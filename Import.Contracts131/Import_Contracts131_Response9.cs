...
{
    /// <summary>Immutable data transfer record for Import_Contracts131_Response9.</summary>
    public record Import_Contracts131_Response9(string Value, int Count, DateTime Timestamp);
