...
{
    /// <summary>Immutable data transfer record for Import_Contracts131_Dto8.</summary>
    public record Import_Contracts131_Dto8(string Value, int Count, DateTime Timestamp);
