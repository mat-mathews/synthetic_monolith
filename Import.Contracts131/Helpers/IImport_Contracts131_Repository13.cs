...
{
    internal interface IImport_Contracts131_Repository13
    {
        /// <summary>Processes the Import_Contracts131_Repository13 operation.</summary>
        void ProcessImport_Contracts131_Repository13();

        /// <summary>Validates the Import_Contracts131_Repository13 state.</summary>
        bool ValidateImport_Contracts131_Repository13();
    }
