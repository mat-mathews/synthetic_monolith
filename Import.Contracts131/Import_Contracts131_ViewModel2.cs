...
{
    /// <summary>Immutable data transfer record for Import_Contracts131_ViewModel2.</summary>
    internal record Import_Contracts131_ViewModel2(string Value, int Count, DateTime Timestamp);
