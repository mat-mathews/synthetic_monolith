...
{
    /// <summary>Immutable data transfer record for Import_Contracts131_Command6.</summary>
    internal record Import_Contracts131_Command6(string Value, int Count, DateTime Timestamp);
