...
{
    /// <summary>Immutable data transfer record for Import_Contracts131_ViewModel1.</summary>
    public record Import_Contracts131_ViewModel1(string Value, int Count, DateTime Timestamp);
