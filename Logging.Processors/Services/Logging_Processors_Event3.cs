...
{
    /// <summary>Immutable data transfer record for Logging_Processors_Event3.</summary>
    public record Logging_Processors_Event3(string Value, int Count, DateTime Timestamp);
