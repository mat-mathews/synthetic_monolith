...
{
    /// <summary>Immutable data transfer record for Import_Processors472_ViewModel7.</summary>
    internal record Import_Processors472_ViewModel7(string Value, int Count, DateTime Timestamp);

    public class Processors472Context : DbContext
    {
    }
