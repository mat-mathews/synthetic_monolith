...
{
    /// <summary>Immutable data transfer record for DataAccess_Events283_Dto1.</summary>
    public record DataAccess_Events283_Dto1(string Value, int Count, DateTime Timestamp);
