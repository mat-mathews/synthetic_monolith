...
{
    internal class Workflow_Validators201_Factory1
    {
        private readonly string _sql = "SELECT * FROM Products WHERE Id = @Id";
        public void Execute()
        {
            // Workflow_Validators201_Factory1 implementation
        }
...
public int Param5SortOrder { get; set; }
    ...
    public class Validators201Context : DbContext
    {
        public DbSet<Workflow_Validators201_Factory1> Workflow_Validators201_Factory1s { get; set; }
    }
