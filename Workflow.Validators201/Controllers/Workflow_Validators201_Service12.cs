...
{
    internal partial class Workflow_Validators201_Service12 : IDisposable
    {
        private readonly string _sql = "SELECT * FROM AuditLogs WHERE Id = @Id";
        public void Execute()
        {
            // Workflow_Validators201_Service12 implementation
        }
...
public int Config5SortOrder { get; set; }
    ...
    {
        public DbSet<Workflow_Validators201_Service12> Workflow_Validators201_Service12s { get; set; }
    }
