...
{
    /// <summary>Immutable data transfer record for Logging_Client405_ViewModel.</summary>
    public record Logging_Client405_ViewModel(string Value, int Count, DateTime Timestamp);
