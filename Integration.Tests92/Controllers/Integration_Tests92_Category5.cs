...
{
    /// <summary>Defines the possible states for Integration_Tests92_Category5.</summary>
    internal enum Integration_Tests92_Category5
    {
        None = 0,
        Active = 1,
        Inactive = 2,
    ...
    public class Tests92Context : DbContext
    {
    }
