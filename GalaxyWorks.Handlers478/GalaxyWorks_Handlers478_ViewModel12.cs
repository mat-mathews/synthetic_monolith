...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Handlers478_ViewModel12.</summary>
    public record GalaxyWorks_Handlers478_ViewModel12(string Value, int Count, DateTime Timestamp);
