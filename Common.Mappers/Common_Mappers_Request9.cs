...
{
    /// <summary>Immutable data transfer record for Common_Mappers_Request9.</summary>
    internal record Common_Mappers_Request9(string Value, int Count, DateTime Timestamp);
