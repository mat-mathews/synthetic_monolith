...
{
    internal interface IScheduling_Models_Provider10
    {
        /// <summary>Processes the Scheduling_Models_Provider10 operation.</summary>
        void ProcessScheduling_Models_Provider10();

        /// <summary>Validates the Scheduling_Models_Provider10 state.</summary>
        bool ValidateScheduling_Models_Provider10();
    }
