...
{
    public interface IExport_Shared_Factory3
    {
        /// <summary>Processes the Export_Shared_Factory3 operation.</summary>
        void ProcessExport_Shared_Factory3();

        /// <summary>Validates the Export_Shared_Factory3 state.</summary>
        bool ValidateExport_Shared_Factory3();
    }
