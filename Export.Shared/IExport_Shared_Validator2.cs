...
{
    internal interface IExport_Shared_Validator2
    {
        /// <summary>Processes the Export_Shared_Validator2 operation.</summary>
        void ProcessExport_Shared_Validator2();

        /// <summary>Validates the Export_Shared_Validator2 state.</summary>
        bool ValidateExport_Shared_Validator2();
    }
