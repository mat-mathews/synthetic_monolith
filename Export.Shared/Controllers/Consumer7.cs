...
namespace Export.Shared
{
    ...
    public class Consumer7
    {
        ...
        private readonly ICommon_Processors245_Validator4 _iCommon_Processors245_Validator4;
        private readonly Common_Processors245_Processor _common_Processors245_Processor;
        private readonly Common_Processors245_Repository3 _common_Processors245_Repository3;
        private readonly Integration_Processors_Provider2 _integration_Processors_Provider2;
        private readonly Integration_Processors_Point3 _integration_Processors_Point3;
        ...
        public Consumer7(Admin_Shared310_Processor11 admin_Shared310_Processor11, ICommon_Processors245_Validator4 iCommon_Processors245_Validator4, Common_Processors245_Processor common_Processors245_Processor, Common_Processors245_Repository3 common_Processors245_Repository3, Integration_Processors_Provider2 integration_Processors_Provider2, Integration_Processors_Point3 integration_Processors_Point3, Logging_Shared_Service1 logging_Shared_Service1, Logging_Client405_Repository6 logging_Client405_Repository6)
        {
            ...
            _iCommon_Processors245_Validator4 = iCommon_Processors245_Validator4 ?? throw new ArgumentNullException(nameof(iCommon_Processors245_Validator4));
            _common_Processors245_Processor = common_Processors245_Processor ?? throw new ArgumentNullException(nameof(common_Processors245_Processor));
            ...
            _integration_Processors_Provider2 = integration_Processors_Provider2 ?? throw new ArgumentNullException(nameof(integration_Processors_Provider2));
            _integration_Processors_Point3 = integration_Processors_Point3 ?? throw new ArgumentNullException(nameof(integration_Processors_Point3));
        ...
        public ICommon_Processors245_Validator4 GetICommon_Processors245_Validator4() => _iCommon_Processors245_Validator4;
        public Common_Processors245_Processor GetCommon_Processors245_Processor() => _common_Processors245_Processor;
        public Common_Processors245_Repository3 GetCommon_Processors245_Repository3() => _common_Processors245_Repository3;
        public Integration_Processors_Provider2 GetIntegration_Processors_Provider2() => _integration_Processors_Provider2;
        public Integration_Processors_Point3 GetIntegration_Processors_Point3() => _integration_Processors_Point3;
