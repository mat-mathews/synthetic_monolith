...
{
    public interface IImport_Tests_Repository9
    {
        /// <summary>Processes the Import_Tests_Repository9 operation.</summary>
        void ProcessImport_Tests_Repository9();

        /// <summary>Validates the Import_Tests_Repository9 state.</summary>
        bool ValidateImport_Tests_Repository9();
    }
