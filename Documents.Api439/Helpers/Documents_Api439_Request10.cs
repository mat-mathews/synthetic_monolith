...
{
    /// <summary>Immutable data transfer record for Documents_Api439_Request10.</summary>
    public record Documents_Api439_Request10(string Value, int Count, DateTime Timestamp);
