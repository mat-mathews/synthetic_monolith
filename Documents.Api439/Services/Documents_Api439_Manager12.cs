...
{
    public static class Documents_Api439_Manager12
    {
        private readonly string _sql = "SELECT * FROM AuditLogs WHERE Id = @Id";
        public void Execute()
        {
            // Documents_Api439_Manager12 implementation
        }
...
public int Item53SortOrder { get; set; }
    ...
    public class Api439Context : DbContext
    {
        public DbSet<Documents_Api439_Manager12> Documents_Api439_Manager12s { get; set; }
    }
