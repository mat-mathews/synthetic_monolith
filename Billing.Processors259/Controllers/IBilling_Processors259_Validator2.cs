...
{
    internal interface IBilling_Processors259_Validator2
    {
        /// <summary>Processes the Billing_Processors259_Validator2 operation.</summary>
        void ProcessBilling_Processors259_Validator2();

        /// <summary>Validates the Billing_Processors259_Validator2 state.</summary>
        bool ValidateBilling_Processors259_Validator2();
    }
