...
{
    /// <summary>Immutable data transfer record for DataAccess_Client_Event1.</summary>
    internal record DataAccess_Client_Event1(string Value, int Count, DateTime Timestamp);
