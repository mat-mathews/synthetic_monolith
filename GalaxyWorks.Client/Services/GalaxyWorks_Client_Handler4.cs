...
{
    internal class GalaxyWorks_Client_Handler4
    {
        private readonly string _sql = "SELECT * FROM Reports WHERE Id = @Id";
        public void Execute()
        {
            // GalaxyWorks_Client_Handler4 implementation
        }
...
public int Param65SortOrder { get; set; }
    ...
    {
        public DbSet<GalaxyWorks_Client_Handler4> GalaxyWorks_Client_Handler4s { get; set; }
    }
