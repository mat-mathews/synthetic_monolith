...
namespace GalaxyWorks.Client
{
    ...
    public class Consumer21
    {
        ...
        private readonly Admin_Mappers324_Repository2 _admin_Mappers324_Repository2;
        ...
        private readonly IScheduling_Web196_Handler7 _iScheduling_Web196_Handler7;
        private readonly IPortal_Processors_Factory2 _iPortal_Processors_Factory2;
        private readonly IWorkflow_Shared_Repository5 _iWorkflow_Shared_Repository5;
        private readonly Reporting_Tests226_Result4 _reporting_Tests226_Result4;

        public Consumer21(IAuth_Processors319_Validator4 iAuth_Processors319_Validator4, Admin_Mappers324_Repository2 admin_Mappers324_Repository2, Admin_Mappers324_ViewModel5 admin_Mappers324_ViewModel5, Scheduling_Web196_Helper8 scheduling_Web196_Helper8, IScheduling_Web196_Handler7 iScheduling_Web196_Handler7, IPortal_Processors_Factory2 iPortal_Processors_Factory2, IWorkflow_Shared_Repository5 iWorkflow_Shared_Repository5, Reporting_Tests226_Result4 reporting_Tests226_Result4)
        {
            ...
            _admin_Mappers324_Repository2 = admin_Mappers324_Repository2 ?? throw new ArgumentNullException(nameof(admin_Mappers324_Repository2));
            ...
            _iScheduling_Web196_Handler7 = iScheduling_Web196_Handler7 ?? throw new ArgumentNullException(nameof(iScheduling_Web196_Handler7));
            _iPortal_Processors_Factory2 = iPortal_Processors_Factory2 ?? throw new ArgumentNullException(nameof(iPortal_Processors_Factory2));
            _iWorkflow_Shared_Repository5 = iWorkflow_Shared_Repository5 ?? throw new ArgumentNullException(nameof(iWorkflow_Shared_Repository5));
            _reporting_Tests226_Result4 = reporting_Tests226_Result4 ?? throw new ArgumentNullException(nameof(reporting_Tests226_Result4));
        }

        public IAuth_Processors319_Validator4 GetIAuth_Processors319_Validator4() => _iAuth_Processors319_Validator4;
        public Admin_Mappers324_Repository2 GetAdmin_Mappers324_Repository2() => _admin_Mappers324_Repository2;
        ...
        public IScheduling_Web196_Handler7 GetIScheduling_Web196_Handler7() => _iScheduling_Web196_Handler7;
        public IPortal_Processors_Factory2 GetIPortal_Processors_Factory2() => _iPortal_Processors_Factory2;
        public IWorkflow_Shared_Repository5 GetIWorkflow_Shared_Repository5() => _iWorkflow_Shared_Repository5;
        public Reporting_Tests226_Result4 GetReporting_Tests226_Result4() => _reporting_Tests226_Result4;
