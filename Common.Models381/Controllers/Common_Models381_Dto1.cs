...
{
    /// <summary>Immutable data transfer record for Common_Models381_Dto1.</summary>
    internal record Common_Models381_Dto1(string Value, int Count, DateTime Timestamp);
