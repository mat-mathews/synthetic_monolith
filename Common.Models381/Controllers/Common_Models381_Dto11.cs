...
{
    /// <summary>Immutable data transfer record for Common_Models381_Dto11.</summary>
    public record Common_Models381_Dto11(string Value, int Count, DateTime Timestamp);
