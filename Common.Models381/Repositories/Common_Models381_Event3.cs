...
{
    /// <summary>Immutable data transfer record for Common_Models381_Event3.</summary>
    internal record Common_Models381_Event3(string Value, int Count, DateTime Timestamp);
