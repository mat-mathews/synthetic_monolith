...
namespace Documents.Processors
{
    ...
    public class Consumer15
    {
        ...
        private readonly Billing_Client_Repository12 _billing_Client_Repository12;
        private readonly Common_Web488_Service10 _common_Web488_Service10;
        private readonly Imaging_Models_Handler6 _imaging_Models_Handler6;
        private readonly Scheduling_Client187_Processor8 _scheduling_Client187_Processor8;
        private readonly GalaxyWorks_Mappers403_Service5 _galaxyWorks_Mappers403_Service5;
        private readonly GalaxyWorks_Mappers403_Provider2 _galaxyWorks_Mappers403_Provider2;
        private readonly GalaxyWorks_Service_Event6 _galaxyWorks_Service_Event6;

        public Consumer15(Admin_Processors_Service2 admin_Processors_Service2, Billing_Client_Repository12 billing_Client_Repository12, Common_Web488_Service10 common_Web488_Service10, Imaging_Models_Handler6 imaging_Models_Handler6, Scheduling_Client187_Processor8 scheduling_Client187_Processor8, GalaxyWorks_Mappers403_Service5 galaxyWorks_Mappers403_Service5, GalaxyWorks_Mappers403_Provider2 galaxyWorks_Mappers403_Provider2, GalaxyWorks_Service_Event6 galaxyWorks_Service_Event6)
        {
            _admin_Processors_Service2 = admin_Processors_Service2 ?? throw new ArgumentNullException(nameof(admin_Processors_Service2));
            _billing_Client_Repository12 = billing_Client_Repository12 ?? throw new ArgumentNullException(nameof(billing_Client_Repository12));
            _common_Web488_Service10 = common_Web488_Service10 ?? throw new ArgumentNullException(nameof(common_Web488_Service10));
            _imaging_Models_Handler6 = imaging_Models_Handler6 ?? throw new ArgumentNullException(nameof(imaging_Models_Handler6));
            _scheduling_Client187_Processor8 = scheduling_Client187_Processor8 ?? throw new ArgumentNullException(nameof(scheduling_Client187_Processor8));
            _galaxyWorks_Mappers403_Service5 = galaxyWorks_Mappers403_Service5 ?? throw new ArgumentNullException(nameof(galaxyWorks_Mappers403_Service5));
            _galaxyWorks_Mappers403_Provider2 = galaxyWorks_Mappers403_Provider2 ?? throw new ArgumentNullException(nameof(galaxyWorks_Mappers403_Provider2));
        ...
        public Billing_Client_Repository12 GetBilling_Client_Repository12() => _billing_Client_Repository12;
        public Common_Web488_Service10 GetCommon_Web488_Service10() => _common_Web488_Service10;
        public Imaging_Models_Handler6 GetImaging_Models_Handler6() => _imaging_Models_Handler6;
        public Scheduling_Client187_Processor8 GetScheduling_Client187_Processor8() => _scheduling_Client187_Processor8;
        public GalaxyWorks_Mappers403_Service5 GetGalaxyWorks_Mappers403_Service5() => _galaxyWorks_Mappers403_Service5;
        public GalaxyWorks_Mappers403_Provider2 GetGalaxyWorks_Mappers403_Provider2() => _galaxyWorks_Mappers403_Provider2;
