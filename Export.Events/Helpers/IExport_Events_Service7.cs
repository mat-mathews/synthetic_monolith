...
{
    internal interface IExport_Events_Service7
    {
        /// <summary>Processes the Export_Events_Service7 operation.</summary>
        void ProcessExport_Events_Service7();

        /// <summary>Validates the Export_Events_Service7 state.</summary>
        bool ValidateExport_Events_Service7();
    }
