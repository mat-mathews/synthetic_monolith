...
namespace Export.Core168
{
    ...
    public class Consumer11
    {
        ...
        private readonly Import_Events_Result3 _import_Events_Result3;
        private readonly Import_Events_Handler2 _import_Events_Handler2;

        public Consumer11(Admin_Service247_Builder4 admin_Service247_Builder4, Auth_Mappers28_Controller5 auth_Mappers28_Controller5, IAuth_Mappers28_Handler2 iAuth_Mappers28_Handler2, Auth_Mappers28_Controller3 auth_Mappers28_Controller3, Documents_Validators_Processor documents_Validators_Processor, Documents_Validators_Provider4 documents_Validators_Provider4, Import_Events_Result3 import_Events_Result3, Import_Events_Handler2 import_Events_Handler2)
        {
            ...
            _import_Events_Result3 = import_Events_Result3 ?? throw new ArgumentNullException(nameof(import_Events_Result3));
        ...
        public Import_Events_Result3 GetImport_Events_Result3() => _import_Events_Result3;
