...
namespace Logging.Shared
{
    ...
    {
        private readonly Admin_Tests10_Repository13 _admin_Tests10_Repository13;
        private readonly DataAccess_Service464_Builder1 _dataAccess_Service464_Builder1;
        private readonly IDataAccess_Service464_Validator13 _iDataAccess_Service464_Validator13;
        private readonly IIntegration_Processors248_Provider9 _iIntegration_Processors248_Provider9;
        private readonly Integration_Processors248_Controller8 _integration_Processors248_Controller8;
        private readonly Integration_Processors248_Repository7 _integration_Processors248_Repository7;
        private readonly Notifications_Api144_Manager _notifications_Api144_Manager;
        private readonly Notifications_Mappers55_Repository1 _notifications_Mappers55_Repository1;

        public Consumer17(Admin_Tests10_Repository13 admin_Tests10_Repository13, DataAccess_Service464_Builder1 dataAccess_Service464_Builder1, IDataAccess_Service464_Validator13 iDataAccess_Service464_Validator13, IIntegration_Processors248_Provider9 iIntegration_Processors248_Provider9, Integration_Processors248_Controller8 integration_Processors248_Controller8, Integration_Processors248_Repository7 integration_Processors248_Repository7, Notifications_Api144_Manager notifications_Api144_Manager, Notifications_Mappers55_Repository1 notifications_Mappers55_Repository1)
        {
            _admin_Tests10_Repository13 = admin_Tests10_Repository13 ?? throw new ArgumentNullException(nameof(admin_Tests10_Repository13));
            _dataAccess_Service464_Builder1 = dataAccess_Service464_Builder1 ?? throw new ArgumentNullException(nameof(dataAccess_Service464_Builder1));
            _iDataAccess_Service464_Validator13 = iDataAccess_Service464_Validator13 ?? throw new ArgumentNullException(nameof(iDataAccess_Service464_Validator13));
            _iIntegration_Processors248_Provider9 = iIntegration_Processors248_Provider9 ?? throw new ArgumentNullException(nameof(iIntegration_Processors248_Provider9));
            _integration_Processors248_Controller8 = integration_Processors248_Controller8 ?? throw new ArgumentNullException(nameof(integration_Processors248_Controller8));
            _integration_Processors248_Repository7 = integration_Processors248_Repository7 ?? throw new ArgumentNullException(nameof(integration_Processors248_Repository7));
            _notifications_Api144_Manager = notifications_Api144_Manager ?? throw new ArgumentNullException(nameof(notifications_Api144_Manager));
        ...
        public Admin_Tests10_Repository13 GetAdmin_Tests10_Repository13() => _admin_Tests10_Repository13;
        public DataAccess_Service464_Builder1 GetDataAccess_Service464_Builder1() => _dataAccess_Service464_Builder1;
        public IDataAccess_Service464_Validator13 GetIDataAccess_Service464_Validator13() => _iDataAccess_Service464_Validator13;
        public IIntegration_Processors248_Provider9 GetIIntegration_Processors248_Provider9() => _iIntegration_Processors248_Provider9;
        public Integration_Processors248_Controller8 GetIntegration_Processors248_Controller8() => _integration_Processors248_Controller8;
        public Integration_Processors248_Repository7 GetIntegration_Processors248_Repository7() => _integration_Processors248_Repository7;
        public Notifications_Api144_Manager GetNotifications_Api144_Manager() => _notifications_Api144_Manager;
