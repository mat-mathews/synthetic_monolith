...
namespace Notifications.Handlers470
{
    ...
    public class Consumer13
    {
        ...
        private readonly Scheduling_Web221_Handler _scheduling_Web221_Handler;
        private readonly Scheduling_Validators_Point8 _scheduling_Validators_Point8;
        private readonly Scheduling_Validators_Processor3 _scheduling_Validators_Processor3;

        public Consumer13(Admin_Api255_Handler4 admin_Api255_Handler4, Utilities_Service358_Controller4 utilities_Service358_Controller4, Workflow_Client_Factory2 workflow_Client_Factory2, Workflow_Client_Manager3 workflow_Client_Manager3, Export_Mappers237_Provider8 export_Mappers237_Provider8, Scheduling_Web221_Handler scheduling_Web221_Handler, Scheduling_Validators_Point8 scheduling_Validators_Point8, Scheduling_Validators_Processor3 scheduling_Validators_Processor3)
        {
            ...
            _scheduling_Web221_Handler = scheduling_Web221_Handler ?? throw new ArgumentNullException(nameof(scheduling_Web221_Handler));
            _scheduling_Validators_Point8 = scheduling_Validators_Point8 ?? throw new ArgumentNullException(nameof(scheduling_Validators_Point8));
            _scheduling_Validators_Processor3 = scheduling_Validators_Processor3 ?? throw new ArgumentNullException(nameof(scheduling_Validators_Processor3));
        }
        ...
        public Scheduling_Web221_Handler GetScheduling_Web221_Handler() => _scheduling_Web221_Handler;
        public Scheduling_Validators_Point8 GetScheduling_Validators_Point8() => _scheduling_Validators_Point8;
        public Scheduling_Validators_Processor3 GetScheduling_Validators_Processor3() => _scheduling_Validators_Processor3;
