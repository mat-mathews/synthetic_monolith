...
{
    internal static class Portal_Handlers26_Provider3
    {
        private readonly string _sql = "SELECT * FROM Configurations WHERE Id = @Id";
        public void Execute()
        {
            // Portal_Handlers26_Provider3 implementation
        }
...
public int Field14SortOrder { get; set; }
    ...
    {
        public DbSet<Portal_Handlers26_Provider3> Portal_Handlers26_Provider3s { get; set; }
    }
