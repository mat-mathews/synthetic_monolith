...
{
    internal interface IPortal_Handlers26_Factory4
    {
        /// <summary>Processes the Portal_Handlers26_Factory4 operation.</summary>
        void ProcessPortal_Handlers26_Factory4();

        /// <summary>Validates the Portal_Handlers26_Factory4 state.</summary>
        bool ValidatePortal_Handlers26_Factory4();
    }
