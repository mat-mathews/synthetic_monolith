...
{
    public interface IDocuments_Validators102_Handler3
    {
        /// <summary>Processes the Documents_Validators102_Handler3 operation.</summary>
        void ProcessDocuments_Validators102_Handler3();

        /// <summary>Validates the Documents_Validators102_Handler3 state.</summary>
        bool ValidateDocuments_Validators102_Handler3();
    }
