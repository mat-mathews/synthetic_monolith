...
{
    internal interface IBilling_Api9_Service4
    {
        /// <summary>Processes the Billing_Api9_Service4 operation.</summary>
        void ProcessBilling_Api9_Service4();

        /// <summary>Validates the Billing_Api9_Service4 state.</summary>
        bool ValidateBilling_Api9_Service4();
    }
