...
{
    /// <summary>Immutable data transfer record for Billing_Api9_ViewModel10.</summary>
    internal record Billing_Api9_ViewModel10(string Value, int Count, DateTime Timestamp);
