...
{
    /// <summary>Immutable data transfer record for Billing_Api9_ViewModel12.</summary>
    public record Billing_Api9_ViewModel12(string Value, int Count, DateTime Timestamp);
