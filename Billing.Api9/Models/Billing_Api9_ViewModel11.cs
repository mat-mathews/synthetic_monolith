...
{
    /// <summary>Immutable data transfer record for Billing_Api9_ViewModel11.</summary>
    public record Billing_Api9_ViewModel11(string Value, int Count, DateTime Timestamp);
