...
{
    internal interface IBilling_Api9_Handler8
    {
        /// <summary>Processes the Billing_Api9_Handler8 operation.</summary>
        void ProcessBilling_Api9_Handler8();

        /// <summary>Validates the Billing_Api9_Handler8 state.</summary>
        bool ValidateBilling_Api9_Handler8();
    }
