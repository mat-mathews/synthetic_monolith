...
namespace Notifications.Handlers
{
    ...
    public class Consumer32
    {
        ...
        private readonly Import_Models_Service8 _import_Models_Service8;
        private readonly Import_Models_Builder10 _import_Models_Builder10;
        private readonly INotifications_Web_Repository2 _iNotifications_Web_Repository2;
        private readonly Notifications_Web_Handler7 _notifications_Web_Handler7;

        public Consumer32(Admin_Data408_Builder1 admin_Data408_Builder1, Admin_Data408_Key5 admin_Data408_Key5, Auth_Processors400_Helper7 auth_Processors400_Helper7, Auth_Processors400_Service1 auth_Processors400_Service1, Import_Models_Service8 import_Models_Service8, Import_Models_Builder10 import_Models_Builder10, INotifications_Web_Repository2 iNotifications_Web_Repository2, Notifications_Web_Handler7 notifications_Web_Handler7)
        {
            ...
            _import_Models_Service8 = import_Models_Service8 ?? throw new ArgumentNullException(nameof(import_Models_Service8));
            _import_Models_Builder10 = import_Models_Builder10 ?? throw new ArgumentNullException(nameof(import_Models_Builder10));
            _iNotifications_Web_Repository2 = iNotifications_Web_Repository2 ?? throw new ArgumentNullException(nameof(iNotifications_Web_Repository2));
            _notifications_Web_Handler7 = notifications_Web_Handler7 ?? throw new ArgumentNullException(nameof(notifications_Web_Handler7));
        }
        ...
        public Import_Models_Service8 GetImport_Models_Service8() => _import_Models_Service8;
        public Import_Models_Builder10 GetImport_Models_Builder10() => _import_Models_Builder10;
        public INotifications_Web_Repository2 GetINotifications_Web_Repository2() => _iNotifications_Web_Repository2;
        public Notifications_Web_Handler7 GetNotifications_Web_Handler7() => _notifications_Web_Handler7;
