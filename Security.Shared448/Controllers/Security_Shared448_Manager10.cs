...
{
    internal class Security_Shared448_Manager10
    {
        private readonly string _sql = "SELECT * FROM Schedules WHERE Id = @Id";
        public void Execute()
        {
            // Security_Shared448_Manager10 implementation
        }
...
public int Param25SortOrder { get; set; }
    ...
    public class Shared448Context : DbContext
    {
        public DbSet<Security_Shared448_Manager10> Security_Shared448_Manager10s { get; set; }
    }
