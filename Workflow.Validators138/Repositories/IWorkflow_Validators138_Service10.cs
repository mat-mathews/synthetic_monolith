...
{
    internal interface IWorkflow_Validators138_Service10
    {
        /// <summary>Processes the Workflow_Validators138_Service10 operation.</summary>
        void ProcessWorkflow_Validators138_Service10();

        /// <summary>Validates the Workflow_Validators138_Service10 state.</summary>
        bool ValidateWorkflow_Validators138_Service10();
    }
