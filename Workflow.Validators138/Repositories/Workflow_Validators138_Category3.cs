...
{
    /// <summary>Defines the possible states for Workflow_Validators138_Category3.</summary>
    internal enum Workflow_Validators138_Category3
    {
        None = 0,
        Active = 1,
        Inactive = 2,
    ...
    public class Validators138Context : DbContext
    {
    }
