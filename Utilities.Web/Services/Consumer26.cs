...
namespace Utilities.Web
{
    ...
    public class Consumer26
    {
        ...
        private readonly Utilities_Client_Controller2 _utilities_Client_Controller2;
        private readonly Common_Core_Handler5 _common_Core_Handler5;
        private readonly Logging_Events289_Factory4 _logging_Events289_Factory4;
        private readonly ILogging_Events289_Service1 _iLogging_Events289_Service1;
        private readonly Logging_Client405_Processor1 _logging_Client405_Processor1;
        private readonly Logging_Client405_Builder5 _logging_Client405_Builder5;
        private readonly IIntegration_Validators_Validator4 _iIntegration_Validators_Validator4;

        public Consumer26(Auth_Mappers206_Repository11 auth_Mappers206_Repository11, Utilities_Client_Controller2 utilities_Client_Controller2, Common_Core_Handler5 common_Core_Handler5, Logging_Events289_Factory4 logging_Events289_Factory4, ILogging_Events289_Service1 iLogging_Events289_Service1, Logging_Client405_Processor1 logging_Client405_Processor1, Logging_Client405_Builder5 logging_Client405_Builder5, IIntegration_Validators_Validator4 iIntegration_Validators_Validator4)
        {
            ...
            _utilities_Client_Controller2 = utilities_Client_Controller2 ?? throw new ArgumentNullException(nameof(utilities_Client_Controller2));
            _common_Core_Handler5 = common_Core_Handler5 ?? throw new ArgumentNullException(nameof(common_Core_Handler5));
            _logging_Events289_Factory4 = logging_Events289_Factory4 ?? throw new ArgumentNullException(nameof(logging_Events289_Factory4));
            _iLogging_Events289_Service1 = iLogging_Events289_Service1 ?? throw new ArgumentNullException(nameof(iLogging_Events289_Service1));
            ...
            _logging_Client405_Builder5 = logging_Client405_Builder5 ?? throw new ArgumentNullException(nameof(logging_Client405_Builder5));
            _iIntegration_Validators_Validator4 = iIntegration_Validators_Validator4 ?? throw new ArgumentNullException(nameof(iIntegration_Validators_Validator4));
        }

        public Auth_Mappers206_Repository11 GetAuth_Mappers206_Repository11() => _auth_Mappers206_Repository11;
        public Utilities_Client_Controller2 GetUtilities_Client_Controller2() => _utilities_Client_Controller2;
        public Common_Core_Handler5 GetCommon_Core_Handler5() => _common_Core_Handler5;
        public Logging_Events289_Factory4 GetLogging_Events289_Factory4() => _logging_Events289_Factory4;
        public ILogging_Events289_Service1 GetILogging_Events289_Service1() => _iLogging_Events289_Service1;
        public Logging_Client405_Processor1 GetLogging_Client405_Processor1() => _logging_Client405_Processor1;
        public Logging_Client405_Builder5 GetLogging_Client405_Builder5() => _logging_Client405_Builder5;
        public IIntegration_Validators_Validator4 GetIIntegration_Validators_Validator4() => _iIntegration_Validators_Validator4;
