...
namespace Utilities.Web
{
    ...
    {
        private readonly Auth_Mappers206_Repository6 _auth_Mappers206_Repository6;
        private readonly Utilities_Client_Options5 _utilities_Client_Options5;
        private readonly Common_Core_Processor10 _common_Core_Processor10;
        ...
        private readonly Logging_Client405_Factory4 _logging_Client405_Factory4;
        private readonly Integration_Validators_Handler6 _integration_Validators_Handler6;

        public Consumer15(Auth_Mappers206_Repository6 auth_Mappers206_Repository6, Utilities_Client_Options5 utilities_Client_Options5, Common_Core_Processor10 common_Core_Processor10, ILogging_Events289_Service1 iLogging_Events289_Service1, Logging_Client405_Processor1 logging_Client405_Processor1, Logging_Client405_Repository6 logging_Client405_Repository6, Logging_Client405_Factory4 logging_Client405_Factory4, Integration_Validators_Handler6 integration_Validators_Handler6)
        {
            _auth_Mappers206_Repository6 = auth_Mappers206_Repository6 ?? throw new ArgumentNullException(nameof(auth_Mappers206_Repository6));
            _utilities_Client_Options5 = utilities_Client_Options5 ?? throw new ArgumentNullException(nameof(utilities_Client_Options5));
            _common_Core_Processor10 = common_Core_Processor10 ?? throw new ArgumentNullException(nameof(common_Core_Processor10));
            ...
            _logging_Client405_Factory4 = logging_Client405_Factory4 ?? throw new ArgumentNullException(nameof(logging_Client405_Factory4));
            _integration_Validators_Handler6 = integration_Validators_Handler6 ?? throw new ArgumentNullException(nameof(integration_Validators_Handler6));
        }

        public Auth_Mappers206_Repository6 GetAuth_Mappers206_Repository6() => _auth_Mappers206_Repository6;
        public Utilities_Client_Options5 GetUtilities_Client_Options5() => _utilities_Client_Options5;
        public Common_Core_Processor10 GetCommon_Core_Processor10() => _common_Core_Processor10;
        ...
        public Logging_Client405_Factory4 GetLogging_Client405_Factory4() => _logging_Client405_Factory4;
        public Integration_Validators_Handler6 GetIntegration_Validators_Handler6() => _integration_Validators_Handler6;
