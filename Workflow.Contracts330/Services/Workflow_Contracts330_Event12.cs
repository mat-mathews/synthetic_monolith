...
{
    /// <summary>Immutable data transfer record for Workflow_Contracts330_Event12.</summary>
    public record Workflow_Contracts330_Event12(string Value, int Count, DateTime Timestamp);
