...
{
    /// <summary>Immutable data transfer record for Workflow_Contracts330_ViewModel10.</summary>
    public record Workflow_Contracts330_ViewModel10(string Value, int Count, DateTime Timestamp);
