...
{
    internal abstract class GalaxyWorks_Validators_Controller3
    {
        private readonly string _sql = "SELECT * FROM Roles WHERE Id = @Id";
        public void Execute()
        {
            // GalaxyWorks_Validators_Controller3 implementation
        }
...
public int Field66SortOrder { get; set; }
    ...
    {
        public DbSet<GalaxyWorks_Validators_Controller3> GalaxyWorks_Validators_Controller3s { get; set; }
    }
