...
{
    /// <summary>Immutable data transfer record for GalaxyWorks_Validators_ViewModel8.</summary>
    public record GalaxyWorks_Validators_ViewModel8(string Value, int Count, DateTime Timestamp);
