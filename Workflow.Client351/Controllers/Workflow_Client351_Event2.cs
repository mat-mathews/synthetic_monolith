...
{
    /// <summary>Immutable data transfer record for Workflow_Client351_Event2.</summary>
    public record Workflow_Client351_Event2(string Value, int Count, DateTime Timestamp);
