...
{
    internal abstract class Logging_Service382_Provider3
    {
        private readonly string _sql = "SELECT * FROM Invoices WHERE Id = @Id";
        public void Execute()
        {
            // Logging_Service382_Provider3 implementation
        }
...
public int Entry38SortOrder { get; set; }
    ...
    public class Service382Context : DbContext
    {
        public DbSet<Logging_Service382_Provider3> Logging_Service382_Provider3s { get; set; }
    }
