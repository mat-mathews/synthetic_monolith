...
namespace Export.Data
{
    ...
    public class Consumer2
    {
        ...
        private readonly Admin_Tests_Processor5 _admin_Tests_Processor5;
        private readonly Admin_Tests_Controller3 _admin_Tests_Controller3;
        private readonly Admin_Tests_Factory11 _admin_Tests_Factory11;
        private readonly Scheduling_Events_Manager9 _scheduling_Events_Manager9;
        private readonly Scheduling_Events_Controller11 _scheduling_Events_Controller11;
        private readonly Scheduling_Events_Command _scheduling_Events_Command;

        public Consumer2(Admin_Models476_Handler7 admin_Models476_Handler7, Admin_Models476_Event9 admin_Models476_Event9, Admin_Tests_Processor5 admin_Tests_Processor5, Admin_Tests_Controller3 admin_Tests_Controller3, Admin_Tests_Factory11 admin_Tests_Factory11, Scheduling_Events_Manager9 scheduling_Events_Manager9, Scheduling_Events_Controller11 scheduling_Events_Controller11, Scheduling_Events_Command scheduling_Events_Command)
        {
            ...
            _admin_Tests_Processor5 = admin_Tests_Processor5 ?? throw new ArgumentNullException(nameof(admin_Tests_Processor5));
            _admin_Tests_Controller3 = admin_Tests_Controller3 ?? throw new ArgumentNullException(nameof(admin_Tests_Controller3));
            _admin_Tests_Factory11 = admin_Tests_Factory11 ?? throw new ArgumentNullException(nameof(admin_Tests_Factory11));
            _scheduling_Events_Manager9 = scheduling_Events_Manager9 ?? throw new ArgumentNullException(nameof(scheduling_Events_Manager9));
            _scheduling_Events_Controller11 = scheduling_Events_Controller11 ?? throw new ArgumentNullException(nameof(scheduling_Events_Controller11));
            _scheduling_Events_Command = scheduling_Events_Command ?? throw new ArgumentNullException(nameof(scheduling_Events_Command));
        }
        ...
        public Admin_Tests_Processor5 GetAdmin_Tests_Processor5() => _admin_Tests_Processor5;
        public Admin_Tests_Controller3 GetAdmin_Tests_Controller3() => _admin_Tests_Controller3;
        public Admin_Tests_Factory11 GetAdmin_Tests_Factory11() => _admin_Tests_Factory11;
        public Scheduling_Events_Manager9 GetScheduling_Events_Manager9() => _scheduling_Events_Manager9;
        public Scheduling_Events_Controller11 GetScheduling_Events_Controller11() => _scheduling_Events_Controller11;
        public Scheduling_Events_Command GetScheduling_Events_Command() => _scheduling_Events_Command;
