...
{
    /// <summary>Immutable data transfer record for Scheduling_Handlers63_Event6.</summary>
    public record Scheduling_Handlers63_Event6(string Value, int Count, DateTime Timestamp);
