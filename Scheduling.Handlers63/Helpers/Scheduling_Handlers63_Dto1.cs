...
{
    /// <summary>Immutable data transfer record for Scheduling_Handlers63_Dto1.</summary>
    internal record Scheduling_Handlers63_Dto1(string Value, int Count, DateTime Timestamp);
