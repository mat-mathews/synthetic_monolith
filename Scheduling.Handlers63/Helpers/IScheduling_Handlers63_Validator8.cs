...
{
    internal interface IScheduling_Handlers63_Validator8
    {
        /// <summary>Processes the Scheduling_Handlers63_Validator8 operation.</summary>
        void ProcessScheduling_Handlers63_Validator8();

        /// <summary>Validates the Scheduling_Handlers63_Validator8 state.</summary>
        bool ValidateScheduling_Handlers63_Validator8();
    }
