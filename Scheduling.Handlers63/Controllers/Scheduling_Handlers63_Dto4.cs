...
{
    /// <summary>Immutable data transfer record for Scheduling_Handlers63_Dto4.</summary>
    public record Scheduling_Handlers63_Dto4(string Value, int Count, DateTime Timestamp);
