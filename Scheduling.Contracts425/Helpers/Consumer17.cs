...
namespace Scheduling.Contracts425
{
    ...
    public class Consumer17
    {
        ...
        private readonly BatchJobs_Api212_Provider _batchJobs_Api212_Provider;
        private readonly BatchJobs_Api212_Manager4 _batchJobs_Api212_Manager4;
        private readonly IGalaxyWorks_Data_Repository5 _iGalaxyWorks_Data_Repository5;
        private readonly GalaxyWorks_Data_Factory4 _galaxyWorks_Data_Factory4;
        private readonly GalaxyWorks_Data_Service _galaxyWorks_Data_Service;
        private readonly Portal_Events139_Key6 _portal_Events139_Key6;
        private readonly IPortal_Events139_Factory9 _iPortal_Events139_Factory9;

        public Consumer17(Auth_Mappers208_Processor2 auth_Mappers208_Processor2, BatchJobs_Api212_Provider batchJobs_Api212_Provider, BatchJobs_Api212_Manager4 batchJobs_Api212_Manager4, IGalaxyWorks_Data_Repository5 iGalaxyWorks_Data_Repository5, GalaxyWorks_Data_Factory4 galaxyWorks_Data_Factory4, GalaxyWorks_Data_Service galaxyWorks_Data_Service, Portal_Events139_Key6 portal_Events139_Key6, IPortal_Events139_Factory9 iPortal_Events139_Factory9)
        {
            _auth_Mappers208_Processor2 = auth_Mappers208_Processor2 ?? throw new ArgumentNullException(nameof(auth_Mappers208_Processor2));
            _batchJobs_Api212_Provider = batchJobs_Api212_Provider ?? throw new ArgumentNullException(nameof(batchJobs_Api212_Provider));
            _batchJobs_Api212_Manager4 = batchJobs_Api212_Manager4 ?? throw new ArgumentNullException(nameof(batchJobs_Api212_Manager4));
            _iGalaxyWorks_Data_Repository5 = iGalaxyWorks_Data_Repository5 ?? throw new ArgumentNullException(nameof(iGalaxyWorks_Data_Repository5));
            _galaxyWorks_Data_Factory4 = galaxyWorks_Data_Factory4 ?? throw new ArgumentNullException(nameof(galaxyWorks_Data_Factory4));
            _galaxyWorks_Data_Service = galaxyWorks_Data_Service ?? throw new ArgumentNullException(nameof(galaxyWorks_Data_Service));
            _portal_Events139_Key6 = portal_Events139_Key6 ?? throw new ArgumentNullException(nameof(portal_Events139_Key6));
            _iPortal_Events139_Factory9 = iPortal_Events139_Factory9 ?? throw new ArgumentNullException(nameof(iPortal_Events139_Factory9));
        }

        public Auth_Mappers208_Processor2 GetAuth_Mappers208_Processor2() => _auth_Mappers208_Processor2;
        public BatchJobs_Api212_Provider GetBatchJobs_Api212_Provider() => _batchJobs_Api212_Provider;
        public BatchJobs_Api212_Manager4 GetBatchJobs_Api212_Manager4() => _batchJobs_Api212_Manager4;
        public IGalaxyWorks_Data_Repository5 GetIGalaxyWorks_Data_Repository5() => _iGalaxyWorks_Data_Repository5;
        public GalaxyWorks_Data_Factory4 GetGalaxyWorks_Data_Factory4() => _galaxyWorks_Data_Factory4;
        public GalaxyWorks_Data_Service GetGalaxyWorks_Data_Service() => _galaxyWorks_Data_Service;
        public Portal_Events139_Key6 GetPortal_Events139_Key6() => _portal_Events139_Key6;
        public IPortal_Events139_Factory9 GetIPortal_Events139_Factory9() => _iPortal_Events139_Factory9;
