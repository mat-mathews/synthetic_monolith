...
{
    public abstract class Scheduling_Contracts425_Processor3
    {
        private readonly string _sql = "SELECT * FROM Roles WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Contracts425_Processor3 implementation
        }
...
public int Record70SortOrder { get; set; }
    ...
    public class Contracts425Context : DbContext
    {
        public DbSet<Scheduling_Contracts425_Processor3> Scheduling_Contracts425_Processor3s { get; set; }
    }
