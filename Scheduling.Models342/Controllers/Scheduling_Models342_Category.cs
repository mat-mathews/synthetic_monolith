...
{
    /// <summary>Defines the possible states for Scheduling_Models342_Category.</summary>
    public enum Scheduling_Models342_Category
    {
        None = 0,
        Active = 1,
        Inactive = 2,
    ...
    public class Models342Context : DbContext
    {
    }
