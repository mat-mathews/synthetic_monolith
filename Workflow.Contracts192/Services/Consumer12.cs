...
namespace Workflow.Contracts192
{
    ...
    public class Consumer12
    {
        ...
        private readonly Export_Data_Dto4 _export_Data_Dto4;
        private readonly Export_Data_Helper _export_Data_Helper;
        private readonly ISecurity_Events_Handler1 _iSecurity_Events_Handler1;
        private readonly Documents_Client58_Controller11 _documents_Client58_Controller11;
        private readonly IDocuments_Client58_Provider4 _iDocuments_Client58_Provider4;

        public Consumer12(IAuth_Events78_Service3 iAuth_Events78_Service3, IAuth_Client271_Handler7 iAuth_Client271_Handler7, Auth_Api143_Factory8 auth_Api143_Factory8, Export_Data_Dto4 export_Data_Dto4, Export_Data_Helper export_Data_Helper, ISecurity_Events_Handler1 iSecurity_Events_Handler1, Documents_Client58_Controller11 documents_Client58_Controller11, IDocuments_Client58_Provider4 iDocuments_Client58_Provider4)
        {
            ...
            _export_Data_Dto4 = export_Data_Dto4 ?? throw new ArgumentNullException(nameof(export_Data_Dto4));
            _export_Data_Helper = export_Data_Helper ?? throw new ArgumentNullException(nameof(export_Data_Helper));
            _iSecurity_Events_Handler1 = iSecurity_Events_Handler1 ?? throw new ArgumentNullException(nameof(iSecurity_Events_Handler1));
            _documents_Client58_Controller11 = documents_Client58_Controller11 ?? throw new ArgumentNullException(nameof(documents_Client58_Controller11));
            _iDocuments_Client58_Provider4 = iDocuments_Client58_Provider4 ?? throw new ArgumentNullException(nameof(iDocuments_Client58_Provider4));
        }
        ...
        public Export_Data_Dto4 GetExport_Data_Dto4() => _export_Data_Dto4;
        public Export_Data_Helper GetExport_Data_Helper() => _export_Data_Helper;
        public ISecurity_Events_Handler1 GetISecurity_Events_Handler1() => _iSecurity_Events_Handler1;
        public Documents_Client58_Controller11 GetDocuments_Client58_Controller11() => _documents_Client58_Controller11;
        public IDocuments_Client58_Provider4 GetIDocuments_Client58_Provider4() => _iDocuments_Client58_Provider4;
