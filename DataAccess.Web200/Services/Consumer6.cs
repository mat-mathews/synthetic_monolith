...
namespace DataAccess.Web200
{
    ...
    public class Consumer6
    {
        ...
        private readonly Reporting_Api_Result3 _reporting_Api_Result3;
        private readonly BatchJobs_Data_Provider _batchJobs_Data_Provider;
        private readonly IReporting_Tests_Provider4 _iReporting_Tests_Provider4;
        ...
        public Consumer6(Auth_Core140_Provider11 auth_Core140_Provider11, Admin_Web4_Manager6 admin_Web4_Manager6, IImport_Client64_Validator4 iImport_Client64_Validator4, Reporting_Api_Result3 reporting_Api_Result3, BatchJobs_Data_Provider batchJobs_Data_Provider, IReporting_Tests_Provider4 iReporting_Tests_Provider4, IReporting_Tests_Repository2 iReporting_Tests_Repository2, Reporting_Tests_Builder reporting_Tests_Builder)
        {
            ...
            _reporting_Api_Result3 = reporting_Api_Result3 ?? throw new ArgumentNullException(nameof(reporting_Api_Result3));
            _batchJobs_Data_Provider = batchJobs_Data_Provider ?? throw new ArgumentNullException(nameof(batchJobs_Data_Provider));
            _iReporting_Tests_Provider4 = iReporting_Tests_Provider4 ?? throw new ArgumentNullException(nameof(iReporting_Tests_Provider4));
        ...
        public Reporting_Api_Result3 GetReporting_Api_Result3() => _reporting_Api_Result3;
        public BatchJobs_Data_Provider GetBatchJobs_Data_Provider() => _batchJobs_Data_Provider;
        public IReporting_Tests_Provider4 GetIReporting_Tests_Provider4() => _iReporting_Tests_Provider4;
