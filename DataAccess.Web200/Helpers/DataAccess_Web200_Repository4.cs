...
{
    public abstract class DataAccess_Web200_Repository4
    {
        private readonly string _sql = "SELECT * FROM Configurations WHERE Id = @Id";
        public void Execute()
        {
            // DataAccess_Web200_Repository4 implementation
        }
...
public int Entry62SortOrder { get; set; }
    ...
    public class Web200Context : DbContext
    {
        public DbSet<DataAccess_Web200_Repository4> DataAccess_Web200_Repository4s { get; set; }
    }
