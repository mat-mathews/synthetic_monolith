...
{
    internal interface IExport_Validators_Factory9
    {
        /// <summary>Processes the Export_Validators_Factory9 operation.</summary>
        void ProcessExport_Validators_Factory9();

        /// <summary>Validates the Export_Validators_Factory9 state.</summary>
        bool ValidateExport_Validators_Factory9();
    }
