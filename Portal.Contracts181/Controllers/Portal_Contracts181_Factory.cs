...
{
    internal class Portal_Contracts181_Factory : IDisposable
    {
        private const string SprocName = "dbo.usp_ValidateConfiguration";
        // Execute stored procedure dbo.usp_ValidateConfiguration
        private const string SprocName = "dbo.sp_SearchOrder";
        // Execute stored procedure dbo.sp_SearchOrder
        private const string SprocName = "dbo.sp_GetInvoice";
        // Execute stored procedure dbo.sp_GetInvoice
        private const string SprocName = "dbo.sp_ValidateRole";
        // Execute stored procedure dbo.sp_ValidateRole
        public void Execute()
        {
            // Portal_Contracts181_Factory implementation
        }
