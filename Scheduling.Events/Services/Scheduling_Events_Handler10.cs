...
{
    internal class Scheduling_Events_Handler10
    {
        private readonly string _sql = "SELECT * FROM Configurations WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Events_Handler10 implementation
        }
...
public int Entry52SortOrder { get; set; }
    ...
    {
        public DbSet<Scheduling_Events_Handler10> Scheduling_Events_Handler10s { get; set; }
    }
