...
{
    public interface IScheduling_Events_Factory6
    {
        /// <summary>Processes the Scheduling_Events_Factory6 operation.</summary>
        void ProcessScheduling_Events_Factory6();

        /// <summary>Validates the Scheduling_Events_Factory6 state.</summary>
        bool ValidateScheduling_Events_Factory6();
    }
