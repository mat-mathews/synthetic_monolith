...
{
    public interface IDocuments_Core_Factory5
    {
        /// <summary>Processes the Documents_Core_Factory5 operation.</summary>
        void ProcessDocuments_Core_Factory5();

        /// <summary>Validates the Documents_Core_Factory5 state.</summary>
        bool ValidateDocuments_Core_Factory5();
    }
