...
{
    internal interface IDocuments_Core_Factory9
    {
        /// <summary>Processes the Documents_Core_Factory9 operation.</summary>
        void ProcessDocuments_Core_Factory9();

        /// <summary>Validates the Documents_Core_Factory9 state.</summary>
        bool ValidateDocuments_Core_Factory9();
    }
