...
{
    /// <summary>Immutable data transfer record for Workflow_Contracts_Dto8.</summary>
    internal record Workflow_Contracts_Dto8(string Value, int Count, DateTime Timestamp);
