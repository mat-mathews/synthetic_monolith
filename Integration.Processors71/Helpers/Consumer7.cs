...
namespace Integration.Processors71
{
    ...
    public class Consumer7
    {
        ...
        private readonly Common_Mappers343_Processor3 _common_Mappers343_Processor3;
        private readonly ICommon_Mappers343_Validator4 _iCommon_Mappers343_Validator4;
        private readonly Common_Mappers343_Controller _common_Mappers343_Controller;
        private readonly Workflow_Client_Provider _workflow_Client_Provider;
        private readonly Import_Events493_Service6 _import_Events493_Service6;
        private readonly Portal_Service_Controller6 _portal_Service_Controller6;

        public Consumer7(Admin_Models199_Dto admin_Models199_Dto, Admin_Service456_Controller1 admin_Service456_Controller1, Common_Mappers343_Processor3 common_Mappers343_Processor3, ICommon_Mappers343_Validator4 iCommon_Mappers343_Validator4, Common_Mappers343_Controller common_Mappers343_Controller, Workflow_Client_Provider workflow_Client_Provider, Import_Events493_Service6 import_Events493_Service6, Portal_Service_Controller6 portal_Service_Controller6)
        {
            ...
            _common_Mappers343_Processor3 = common_Mappers343_Processor3 ?? throw new ArgumentNullException(nameof(common_Mappers343_Processor3));
            _iCommon_Mappers343_Validator4 = iCommon_Mappers343_Validator4 ?? throw new ArgumentNullException(nameof(iCommon_Mappers343_Validator4));
            _common_Mappers343_Controller = common_Mappers343_Controller ?? throw new ArgumentNullException(nameof(common_Mappers343_Controller));
            _workflow_Client_Provider = workflow_Client_Provider ?? throw new ArgumentNullException(nameof(workflow_Client_Provider));
            _import_Events493_Service6 = import_Events493_Service6 ?? throw new ArgumentNullException(nameof(import_Events493_Service6));
        ...
        public Common_Mappers343_Processor3 GetCommon_Mappers343_Processor3() => _common_Mappers343_Processor3;
        public ICommon_Mappers343_Validator4 GetICommon_Mappers343_Validator4() => _iCommon_Mappers343_Validator4;
        public Common_Mappers343_Controller GetCommon_Mappers343_Controller() => _common_Mappers343_Controller;
        public Workflow_Client_Provider GetWorkflow_Client_Provider() => _workflow_Client_Provider;
        public Import_Events493_Service6 GetImport_Events493_Service6() => _import_Events493_Service6;
