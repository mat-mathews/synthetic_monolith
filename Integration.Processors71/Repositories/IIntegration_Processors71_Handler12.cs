...
{
    internal interface IIntegration_Processors71_Handler12
    {
        /// <summary>Processes the Integration_Processors71_Handler12 operation.</summary>
        void ProcessIntegration_Processors71_Handler12();

        /// <summary>Validates the Integration_Processors71_Handler12 state.</summary>
        bool ValidateIntegration_Processors71_Handler12();
    }
