...
namespace Security.Client353
{
    ...
    public class Consumer0
    {
        ...
        private readonly Workflow_Tests_ViewModel9 _workflow_Tests_ViewModel9;
        private readonly Workflow_Tests_Service2 _workflow_Tests_Service2;
        private readonly DataAccess_Api307_Helper _dataAccess_Api307_Helper;
        private readonly DataAccess_Api307_Handler7 _dataAccess_Api307_Handler7;
        private readonly Documents_Processors300_Builder7 _documents_Processors300_Builder7;
        private readonly Logging_Tests292_Helper3 _logging_Tests292_Helper3;
        private readonly Logging_Tests292_Repository9 _logging_Tests292_Repository9;

        public Consumer0(Admin_Events306_Event4 admin_Events306_Event4, Workflow_Tests_ViewModel9 workflow_Tests_ViewModel9, Workflow_Tests_Service2 workflow_Tests_Service2, DataAccess_Api307_Helper dataAccess_Api307_Helper, DataAccess_Api307_Handler7 dataAccess_Api307_Handler7, Documents_Processors300_Builder7 documents_Processors300_Builder7, Logging_Tests292_Helper3 logging_Tests292_Helper3, Logging_Tests292_Repository9 logging_Tests292_Repository9)
        {
            _admin_Events306_Event4 = admin_Events306_Event4 ?? throw new ArgumentNullException(nameof(admin_Events306_Event4));
            _workflow_Tests_ViewModel9 = workflow_Tests_ViewModel9 ?? throw new ArgumentNullException(nameof(workflow_Tests_ViewModel9));
            _workflow_Tests_Service2 = workflow_Tests_Service2 ?? throw new ArgumentNullException(nameof(workflow_Tests_Service2));
            _dataAccess_Api307_Helper = dataAccess_Api307_Helper ?? throw new ArgumentNullException(nameof(dataAccess_Api307_Helper));
            _dataAccess_Api307_Handler7 = dataAccess_Api307_Handler7 ?? throw new ArgumentNullException(nameof(dataAccess_Api307_Handler7));
            _documents_Processors300_Builder7 = documents_Processors300_Builder7 ?? throw new ArgumentNullException(nameof(documents_Processors300_Builder7));
            _logging_Tests292_Helper3 = logging_Tests292_Helper3 ?? throw new ArgumentNullException(nameof(logging_Tests292_Helper3));
        ...
        public Workflow_Tests_ViewModel9 GetWorkflow_Tests_ViewModel9() => _workflow_Tests_ViewModel9;
        public Workflow_Tests_Service2 GetWorkflow_Tests_Service2() => _workflow_Tests_Service2;
        public DataAccess_Api307_Helper GetDataAccess_Api307_Helper() => _dataAccess_Api307_Helper;
        public DataAccess_Api307_Handler7 GetDataAccess_Api307_Handler7() => _dataAccess_Api307_Handler7;
        public Documents_Processors300_Builder7 GetDocuments_Processors300_Builder7() => _documents_Processors300_Builder7;
        public Logging_Tests292_Helper3 GetLogging_Tests292_Helper3() => _logging_Tests292_Helper3;
