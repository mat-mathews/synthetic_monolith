...
{
    internal interface ISecurity_Client353_Provider11
    {
        /// <summary>Processes the Security_Client353_Provider11 operation.</summary>
        void ProcessSecurity_Client353_Provider11();

        /// <summary>Validates the Security_Client353_Provider11 state.</summary>
        bool ValidateSecurity_Client353_Provider11();
    }
