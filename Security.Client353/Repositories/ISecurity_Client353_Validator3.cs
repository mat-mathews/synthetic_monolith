...
{
    public interface ISecurity_Client353_Validator3
    {
        /// <summary>Processes the Security_Client353_Validator3 operation.</summary>
        void ProcessSecurity_Client353_Validator3();

        /// <summary>Validates the Security_Client353_Validator3 state.</summary>
        bool ValidateSecurity_Client353_Validator3();
    }
