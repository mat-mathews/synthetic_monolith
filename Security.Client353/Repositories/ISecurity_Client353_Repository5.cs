...
{
    internal interface ISecurity_Client353_Repository5
    {
        /// <summary>Processes the Security_Client353_Repository5 operation.</summary>
        void ProcessSecurity_Client353_Repository5();

        /// <summary>Validates the Security_Client353_Repository5 state.</summary>
        bool ValidateSecurity_Client353_Repository5();
    }
