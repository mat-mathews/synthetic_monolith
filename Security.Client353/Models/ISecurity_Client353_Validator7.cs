...
{
    internal interface ISecurity_Client353_Validator7
    {
        /// <summary>Processes the Security_Client353_Validator7 operation.</summary>
        void ProcessSecurity_Client353_Validator7();

        /// <summary>Validates the Security_Client353_Validator7 state.</summary>
        bool ValidateSecurity_Client353_Validator7();
    }
