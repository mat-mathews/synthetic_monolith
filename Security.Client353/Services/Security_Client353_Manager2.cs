...
{
    public class Security_Client353_Manager2
    {
        private readonly string _sql = "SELECT * FROM Schedules WHERE Id = @Id";
        public void Execute()
        {
            // Security_Client353_Manager2 implementation
        }
...
public int Field50SortOrder { get; set; }
    ...
    {
        public DbSet<Security_Client353_Manager2> Security_Client353_Manager2s { get; set; }
    }
