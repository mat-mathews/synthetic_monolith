...
{
    public abstract class Security_Client353_Factory
    {
        private const string SprocName = "dbo.usp_InsertReport";
        // Execute stored procedure dbo.usp_InsertReport
        private const string SprocName = "dbo.sp_SearchOrder";
        // Execute stored procedure dbo.sp_SearchOrder
        private const string SprocName = "dbo.sp_ValidateNotification";
        // Execute stored procedure dbo.sp_ValidateNotification
        public void Execute()
        {
            // Security_Client353_Factory implementation
        }
