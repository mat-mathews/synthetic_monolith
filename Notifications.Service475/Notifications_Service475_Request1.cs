...
{
    /// <summary>Immutable data transfer record for Notifications_Service475_Request1.</summary>
    public record Notifications_Service475_Request1(string Value, int Count, DateTime Timestamp);
