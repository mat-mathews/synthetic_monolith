...
{
    public interface ISecurity_Models136_Service10
    {
        /// <summary>Processes the Security_Models136_Service10 operation.</summary>
        void ProcessSecurity_Models136_Service10();

        /// <summary>Validates the Security_Models136_Service10 state.</summary>
        bool ValidateSecurity_Models136_Service10();
    }
