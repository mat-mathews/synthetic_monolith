...
{
    internal interface ISecurity_Models136_Handler7
    {
        /// <summary>Processes the Security_Models136_Handler7 operation.</summary>
        void ProcessSecurity_Models136_Handler7();

        /// <summary>Validates the Security_Models136_Handler7 state.</summary>
        bool ValidateSecurity_Models136_Handler7();
    }
