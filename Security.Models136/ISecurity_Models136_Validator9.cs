...
{
    internal interface ISecurity_Models136_Validator9
    {
        /// <summary>Processes the Security_Models136_Validator9 operation.</summary>
        void ProcessSecurity_Models136_Validator9();

        /// <summary>Validates the Security_Models136_Validator9 state.</summary>
        bool ValidateSecurity_Models136_Validator9();
    }
