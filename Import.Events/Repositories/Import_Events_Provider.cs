...
{
    public class Import_Events_Provider
    {
        private const string SprocName = "dbo.sp_InsertPayment";
        // Execute stored procedure dbo.sp_InsertPayment
        private const string SprocName = "dbo.sp_DeletePreference";
        // Execute stored procedure dbo.sp_DeletePreference
        private const string SprocName = "dbo.sp_UpdateConfiguration";
        // Execute stored procedure dbo.sp_UpdateConfiguration
        private const string SprocName = "dbo.sp_SearchTransaction";
        // Execute stored procedure dbo.sp_SearchTransaction
        public void Execute()
        {
            // Import_Events_Provider implementation
        }
