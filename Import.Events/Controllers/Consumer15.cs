...
namespace Import.Events
{
    ...
    public class Consumer15
    {
        ...
        private readonly Scheduling_Mappers442_Repository6 _scheduling_Mappers442_Repository6;
        private readonly Scheduling_Mappers442_Key2 _scheduling_Mappers442_Key2;
        private readonly Scheduling_Mappers442_Options5 _scheduling_Mappers442_Options5;
        private readonly ICommon_Validators_Service6 _iCommon_Validators_Service6;
        private readonly Common_Validators_Helper2 _common_Validators_Helper2;
        private readonly Common_Validators_Handler7 _common_Validators_Handler7;
        private readonly Import_Events374_Builder7 _import_Events374_Builder7;

        public Consumer15(Admin_Web4_Repository admin_Web4_Repository, Scheduling_Mappers442_Repository6 scheduling_Mappers442_Repository6, Scheduling_Mappers442_Key2 scheduling_Mappers442_Key2, Scheduling_Mappers442_Options5 scheduling_Mappers442_Options5, ICommon_Validators_Service6 iCommon_Validators_Service6, Common_Validators_Helper2 common_Validators_Helper2, Common_Validators_Handler7 common_Validators_Handler7, Import_Events374_Builder7 import_Events374_Builder7)
        {
            _admin_Web4_Repository = admin_Web4_Repository ?? throw new ArgumentNullException(nameof(admin_Web4_Repository));
            _scheduling_Mappers442_Repository6 = scheduling_Mappers442_Repository6 ?? throw new ArgumentNullException(nameof(scheduling_Mappers442_Repository6));
            _scheduling_Mappers442_Key2 = scheduling_Mappers442_Key2 ?? throw new ArgumentNullException(nameof(scheduling_Mappers442_Key2));
            _scheduling_Mappers442_Options5 = scheduling_Mappers442_Options5 ?? throw new ArgumentNullException(nameof(scheduling_Mappers442_Options5));
            _iCommon_Validators_Service6 = iCommon_Validators_Service6 ?? throw new ArgumentNullException(nameof(iCommon_Validators_Service6));
            _common_Validators_Helper2 = common_Validators_Helper2 ?? throw new ArgumentNullException(nameof(common_Validators_Helper2));
            _common_Validators_Handler7 = common_Validators_Handler7 ?? throw new ArgumentNullException(nameof(common_Validators_Handler7));
        ...
        public Scheduling_Mappers442_Repository6 GetScheduling_Mappers442_Repository6() => _scheduling_Mappers442_Repository6;
        public Scheduling_Mappers442_Key2 GetScheduling_Mappers442_Key2() => _scheduling_Mappers442_Key2;
        public Scheduling_Mappers442_Options5 GetScheduling_Mappers442_Options5() => _scheduling_Mappers442_Options5;
        public ICommon_Validators_Service6 GetICommon_Validators_Service6() => _iCommon_Validators_Service6;
        public Common_Validators_Helper2 GetCommon_Validators_Helper2() => _common_Validators_Helper2;
        public Common_Validators_Handler7 GetCommon_Validators_Handler7() => _common_Validators_Handler7;
