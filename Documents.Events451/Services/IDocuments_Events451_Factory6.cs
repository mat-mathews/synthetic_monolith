...
{
    public interface IDocuments_Events451_Factory6
    {
        /// <summary>Processes the Documents_Events451_Factory6 operation.</summary>
        void ProcessDocuments_Events451_Factory6();

        /// <summary>Validates the Documents_Events451_Factory6 state.</summary>
        bool ValidateDocuments_Events451_Factory6();
    }
