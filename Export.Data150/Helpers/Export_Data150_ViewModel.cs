...
{
    /// <summary>Immutable data transfer record for Export_Data150_ViewModel.</summary>
    internal record Export_Data150_ViewModel(string Value, int Count, DateTime Timestamp);
