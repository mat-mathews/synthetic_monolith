...
{
    public partial class Scheduling_Client187_Builder2
    {
        private readonly string _sql = "SELECT * FROM Payments WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Client187_Builder2 implementation
        }

/// <summary>
/// Validates the Builder2 before processing.
/// Checks required fields, business rules, and data integrity.
/// </summary>
/// <param name="input">The input to validate.</param>
/// <returns>True if valid, false otherwise.</returns>
public bool ValidateBuilder2(Builder2Request input)
{
    if (input == null)
    ...
    {
        _logger.LogWarning("Validation failed: Name is required for {Type}", nameof(Builder2));
        return false;
    }
...
/// <summary>
/// Processes the Builder2 operation asynchronously.
/// </summary>
public async Task<Builder2Result> ProcessBuilder2Async(
    Builder2Request request,
    CancellationToken cancellationToken = default)
{
    _logger.LogInformation("Processing {Operation} for {Id}",
        nameof(Builder2), request.Id);
    ...
    try
    {
        ...
        if (entity == null)
        {
            ...
            return new Builder2Result { Success = false, ErrorCode = "NOT_FOUND" };
        }
        ...
        _logger.LogInformation("Successfully processed {Operation}", nameof(Builder2));
        return new Builder2Result { Success = true, Data = entity };
    }
    catch (DbUpdateConcurrencyException ex)
    {
        _logger.LogError(ex, "Concurrency conflict processing {Operation}", nameof(Builder2));
        return new Builder2Result { Success = false, ErrorCode = "CONCURRENCY_CONFLICT" };
    }
}

/// <summary>
/// Retrieves a filtered and paginated list of Builder2 entities.
/// </summary>
/// <param name="filter">Filter criteria.</param>
/// <param name="page">Page number (1-based).</param>
/// <param name="pageSize">Items per page.</param>
public async Task<PagedResult<Builder2Dto>> GetBuilder2ListAsync(
    Builder2Filter filter, int page = 1, int pageSize = 25)
{
    // Ensure valid pagination parameters
    page = Math.Max(1, page);
    pageSize = Math.Clamp(pageSize, 1, 100);

    var query = _dbContext.Set<Builder2Entity>().AsQueryable();
    ...
    return new PagedResult<Builder2Dto>
    {
        Items = items,
...
private readonly ILogger<Builder2Service> _logger;
 ...
 */
public Builder2Service(
    ILogger<Builder2Service> logger,
    ...
    IMemoryCache cache)
{
    ...
    _cacheDuration = TimeSpan.FromMinutes(
        _configuration.GetValue<int>("Builder2:CacheDurationMinutes", 30));
}

/// <summary>
/// Gets or creates a cached Builder2 instance.
/// Uses IMemoryCache with sliding expiration.
/// </summary>
public async Task<Builder2Data> GetCachedBuilder2Async(string key)
{
    var cacheKey = $"Builder2_{key}";

    if (_cache.TryGetValue(cacheKey, out Builder2Data cached))
    {
    ...
    var data = await LoadFromBuilder2SourceAsync(key);
...
public int Attr53SortOrder { get; set; }
    ...
    public class Client187Context : DbContext
    {
        public DbSet<Scheduling_Client187_Builder2> Scheduling_Client187_Builder2s { get; set; }
    }
