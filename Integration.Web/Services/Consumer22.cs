...
namespace Integration.Web
{
    ...
    {
        private readonly IAdmin_Core_Provider9 _iAdmin_Core_Provider9;
        private readonly Admin_Core_Builder5 _admin_Core_Builder5;
        private readonly IAdmin_Core_Handler6 _iAdmin_Core_Handler6;
        private readonly BatchJobs_Web_Controller1 _batchJobs_Web_Controller1;
        private readonly BatchJobs_Web_Controller5 _batchJobs_Web_Controller5;
        private readonly Billing_Processors259_Repository _billing_Processors259_Repository;
        private readonly Documents_Contracts_Provider8 _documents_Contracts_Provider8;
        private readonly Documents_Contracts_Helper2 _documents_Contracts_Helper2;

        public Consumer22(IAdmin_Core_Provider9 iAdmin_Core_Provider9, Admin_Core_Builder5 admin_Core_Builder5, IAdmin_Core_Handler6 iAdmin_Core_Handler6, BatchJobs_Web_Controller1 batchJobs_Web_Controller1, BatchJobs_Web_Controller5 batchJobs_Web_Controller5, Billing_Processors259_Repository billing_Processors259_Repository, Documents_Contracts_Provider8 documents_Contracts_Provider8, Documents_Contracts_Helper2 documents_Contracts_Helper2)
        {
            _iAdmin_Core_Provider9 = iAdmin_Core_Provider9 ?? throw new ArgumentNullException(nameof(iAdmin_Core_Provider9));
            _admin_Core_Builder5 = admin_Core_Builder5 ?? throw new ArgumentNullException(nameof(admin_Core_Builder5));
            _iAdmin_Core_Handler6 = iAdmin_Core_Handler6 ?? throw new ArgumentNullException(nameof(iAdmin_Core_Handler6));
            _batchJobs_Web_Controller1 = batchJobs_Web_Controller1 ?? throw new ArgumentNullException(nameof(batchJobs_Web_Controller1));
            _batchJobs_Web_Controller5 = batchJobs_Web_Controller5 ?? throw new ArgumentNullException(nameof(batchJobs_Web_Controller5));
            _billing_Processors259_Repository = billing_Processors259_Repository ?? throw new ArgumentNullException(nameof(billing_Processors259_Repository));
            _documents_Contracts_Provider8 = documents_Contracts_Provider8 ?? throw new ArgumentNullException(nameof(documents_Contracts_Provider8));
            _documents_Contracts_Helper2 = documents_Contracts_Helper2 ?? throw new ArgumentNullException(nameof(documents_Contracts_Helper2));
        }

        public IAdmin_Core_Provider9 GetIAdmin_Core_Provider9() => _iAdmin_Core_Provider9;
        public Admin_Core_Builder5 GetAdmin_Core_Builder5() => _admin_Core_Builder5;
        public IAdmin_Core_Handler6 GetIAdmin_Core_Handler6() => _iAdmin_Core_Handler6;
        public BatchJobs_Web_Controller1 GetBatchJobs_Web_Controller1() => _batchJobs_Web_Controller1;
        public BatchJobs_Web_Controller5 GetBatchJobs_Web_Controller5() => _batchJobs_Web_Controller5;
        public Billing_Processors259_Repository GetBilling_Processors259_Repository() => _billing_Processors259_Repository;
        public Documents_Contracts_Provider8 GetDocuments_Contracts_Provider8() => _documents_Contracts_Provider8;
        public Documents_Contracts_Helper2 GetDocuments_Contracts_Helper2() => _documents_Contracts_Helper2;
