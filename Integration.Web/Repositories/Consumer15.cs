...
namespace Integration.Web
{
    ...
    {
        private readonly Admin_Core_Manager4 _admin_Core_Manager4;
        private readonly Admin_Core_Handler3 _admin_Core_Handler3;
        private readonly Admin_Core_Handler2 _admin_Core_Handler2;
        private readonly BatchJobs_Web_Repository2 _batchJobs_Web_Repository2;
        private readonly BatchJobs_Web_Controller5 _batchJobs_Web_Controller5;
        private readonly IBilling_Processors259_Validator2 _iBilling_Processors259_Validator2;
        private readonly Documents_Contracts_Service _documents_Contracts_Service;
        private readonly IDocuments_Contracts_Factory11 _iDocuments_Contracts_Factory11;

        public Consumer15(Admin_Core_Manager4 admin_Core_Manager4, Admin_Core_Handler3 admin_Core_Handler3, Admin_Core_Handler2 admin_Core_Handler2, BatchJobs_Web_Repository2 batchJobs_Web_Repository2, BatchJobs_Web_Controller5 batchJobs_Web_Controller5, IBilling_Processors259_Validator2 iBilling_Processors259_Validator2, Documents_Contracts_Service documents_Contracts_Service, IDocuments_Contracts_Factory11 iDocuments_Contracts_Factory11)
        {
            _admin_Core_Manager4 = admin_Core_Manager4 ?? throw new ArgumentNullException(nameof(admin_Core_Manager4));
            _admin_Core_Handler3 = admin_Core_Handler3 ?? throw new ArgumentNullException(nameof(admin_Core_Handler3));
            _admin_Core_Handler2 = admin_Core_Handler2 ?? throw new ArgumentNullException(nameof(admin_Core_Handler2));
            _batchJobs_Web_Repository2 = batchJobs_Web_Repository2 ?? throw new ArgumentNullException(nameof(batchJobs_Web_Repository2));
            _batchJobs_Web_Controller5 = batchJobs_Web_Controller5 ?? throw new ArgumentNullException(nameof(batchJobs_Web_Controller5));
            _iBilling_Processors259_Validator2 = iBilling_Processors259_Validator2 ?? throw new ArgumentNullException(nameof(iBilling_Processors259_Validator2));
            _documents_Contracts_Service = documents_Contracts_Service ?? throw new ArgumentNullException(nameof(documents_Contracts_Service));
            _iDocuments_Contracts_Factory11 = iDocuments_Contracts_Factory11 ?? throw new ArgumentNullException(nameof(iDocuments_Contracts_Factory11));
        }

        public Admin_Core_Manager4 GetAdmin_Core_Manager4() => _admin_Core_Manager4;
        public Admin_Core_Handler3 GetAdmin_Core_Handler3() => _admin_Core_Handler3;
        public Admin_Core_Handler2 GetAdmin_Core_Handler2() => _admin_Core_Handler2;
        public BatchJobs_Web_Repository2 GetBatchJobs_Web_Repository2() => _batchJobs_Web_Repository2;
        public BatchJobs_Web_Controller5 GetBatchJobs_Web_Controller5() => _batchJobs_Web_Controller5;
        public IBilling_Processors259_Validator2 GetIBilling_Processors259_Validator2() => _iBilling_Processors259_Validator2;
        public Documents_Contracts_Service GetDocuments_Contracts_Service() => _documents_Contracts_Service;
        public IDocuments_Contracts_Factory11 GetIDocuments_Contracts_Factory11() => _iDocuments_Contracts_Factory11;
