...
{
    /// <summary>Immutable data transfer record for Imaging_Shared115_ViewModel2.</summary>
    public record Imaging_Shared115_ViewModel2(string Value, int Count, DateTime Timestamp);
