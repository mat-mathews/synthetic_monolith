...
{
    /// <summary>Immutable data transfer record for Imaging_Shared115_Command.</summary>
    internal record Imaging_Shared115_Command(string Value, int Count, DateTime Timestamp);
