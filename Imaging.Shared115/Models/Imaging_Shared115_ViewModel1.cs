...
{
    /// <summary>Immutable data transfer record for Imaging_Shared115_ViewModel1.</summary>
    internal record Imaging_Shared115_ViewModel1(string Value, int Count, DateTime Timestamp);
