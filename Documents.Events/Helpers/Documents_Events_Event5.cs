...
{
    /// <summary>Immutable data transfer record for Documents_Events_Event5.</summary>
    internal record Documents_Events_Event5(string Value, int Count, DateTime Timestamp);
