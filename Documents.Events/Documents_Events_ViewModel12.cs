...
{
    /// <summary>Immutable data transfer record for Documents_Events_ViewModel12.</summary>
    internal record Documents_Events_ViewModel12(string Value, int Count, DateTime Timestamp);
