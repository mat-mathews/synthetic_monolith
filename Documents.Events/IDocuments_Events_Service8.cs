...
{
    internal interface IDocuments_Events_Service8
    {
        /// <summary>Processes the Documents_Events_Service8 operation.</summary>
        void ProcessDocuments_Events_Service8();

        /// <summary>Validates the Documents_Events_Service8 state.</summary>
        bool ValidateDocuments_Events_Service8();
    }
