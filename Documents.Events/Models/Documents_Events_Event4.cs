...
{
    /// <summary>Immutable data transfer record for Documents_Events_Event4.</summary>
    internal record Documents_Events_Event4(string Value, int Count, DateTime Timestamp);
