...
{
    internal interface IDocuments_Mappers_Handler5
    {
        /// <summary>Processes the Documents_Mappers_Handler5 operation.</summary>
        void ProcessDocuments_Mappers_Handler5();

        /// <summary>Validates the Documents_Mappers_Handler5 state.</summary>
        bool ValidateDocuments_Mappers_Handler5();
    }
