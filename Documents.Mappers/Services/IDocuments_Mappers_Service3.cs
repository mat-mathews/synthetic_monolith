...
{
    internal interface IDocuments_Mappers_Service3
    {
        /// <summary>Processes the Documents_Mappers_Service3 operation.</summary>
        void ProcessDocuments_Mappers_Service3();

        /// <summary>Validates the Documents_Mappers_Service3 state.</summary>
        bool ValidateDocuments_Mappers_Service3();
    }
