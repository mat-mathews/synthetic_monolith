...
{
    public interface IDocuments_Mappers_Repository6
    {
        /// <summary>Processes the Documents_Mappers_Repository6 operation.</summary>
        void ProcessDocuments_Mappers_Repository6();

        /// <summary>Validates the Documents_Mappers_Repository6 state.</summary>
        bool ValidateDocuments_Mappers_Repository6();
    }
