...
{
    public static class Import_Events374_Builder
    {
        private const string SprocName = "dbo.usp_InsertUser";
        // Execute stored procedure dbo.usp_InsertUser
        private const string SprocName = "dbo.usp_SearchOrder";
        // Execute stored procedure dbo.usp_SearchOrder
        private const string SprocName = "dbo.sp_DeletePreference";
        // Execute stored procedure dbo.sp_DeletePreference
        public void Execute()
        {
            // Import_Events374_Builder implementation
        }
