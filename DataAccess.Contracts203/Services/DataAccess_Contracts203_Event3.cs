...
{
    /// <summary>Immutable data transfer record for DataAccess_Contracts203_Event3.</summary>
    public record DataAccess_Contracts203_Event3(string Value, int Count, DateTime Timestamp);
