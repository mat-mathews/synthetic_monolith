...
{
    /// <summary>Defines the possible states for DataAccess_Contracts203_Status6.</summary>
    public enum DataAccess_Contracts203_Status6
    {
        None = 0,
        Active = 1,
        Inactive = 2,
    ...
    public class Contracts203Context : DbContext
    {
    }
