...
{
    public interface IImaging_Web172_Provider2
    {
        /// <summary>Processes the Imaging_Web172_Provider2 operation.</summary>
        void ProcessImaging_Web172_Provider2();

        /// <summary>Validates the Imaging_Web172_Provider2 state.</summary>
        bool ValidateImaging_Web172_Provider2();
    }
