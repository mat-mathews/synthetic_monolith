...
{
    /// <summary>Immutable data transfer record for Reporting_Service207_Response8.</summary>
    internal record Reporting_Service207_Response8(string Value, int Count, DateTime Timestamp);
