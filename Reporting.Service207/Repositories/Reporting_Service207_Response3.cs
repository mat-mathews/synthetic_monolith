...
{
    /// <summary>Immutable data transfer record for Reporting_Service207_Response3.</summary>
    public record Reporting_Service207_Response3(string Value, int Count, DateTime Timestamp);
