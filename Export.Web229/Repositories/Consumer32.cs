...
namespace Export.Web229
{
    ...
    public class Consumer32
    {
        ...
        private readonly Portal_Service_Command2 _portal_Service_Command2;
        private readonly Workflow_Validators_Service1 _workflow_Validators_Service1;
        private readonly Workflow_Validators_Manager5 _workflow_Validators_Manager5;
        private readonly Security_Tests_Handler7 _security_Tests_Handler7;
        private readonly Security_Tests_Helper1 _security_Tests_Helper1;
        private readonly Security_Tests_Handler _security_Tests_Handler;

        public Consumer32(IAuth_Events_Factory4 iAuth_Events_Factory4, Auth_Handlers_Range7 auth_Handlers_Range7, Portal_Service_Command2 portal_Service_Command2, Workflow_Validators_Service1 workflow_Validators_Service1, Workflow_Validators_Manager5 workflow_Validators_Manager5, Security_Tests_Handler7 security_Tests_Handler7, Security_Tests_Helper1 security_Tests_Helper1, Security_Tests_Handler security_Tests_Handler)
        {
            ...
            _portal_Service_Command2 = portal_Service_Command2 ?? throw new ArgumentNullException(nameof(portal_Service_Command2));
            _workflow_Validators_Service1 = workflow_Validators_Service1 ?? throw new ArgumentNullException(nameof(workflow_Validators_Service1));
            _workflow_Validators_Manager5 = workflow_Validators_Manager5 ?? throw new ArgumentNullException(nameof(workflow_Validators_Manager5));
            _security_Tests_Handler7 = security_Tests_Handler7 ?? throw new ArgumentNullException(nameof(security_Tests_Handler7));
            _security_Tests_Helper1 = security_Tests_Helper1 ?? throw new ArgumentNullException(nameof(security_Tests_Helper1));
            _security_Tests_Handler = security_Tests_Handler ?? throw new ArgumentNullException(nameof(security_Tests_Handler));
        }
        ...
        public Portal_Service_Command2 GetPortal_Service_Command2() => _portal_Service_Command2;
        public Workflow_Validators_Service1 GetWorkflow_Validators_Service1() => _workflow_Validators_Service1;
        public Workflow_Validators_Manager5 GetWorkflow_Validators_Manager5() => _workflow_Validators_Manager5;
        public Security_Tests_Handler7 GetSecurity_Tests_Handler7() => _security_Tests_Handler7;
        public Security_Tests_Helper1 GetSecurity_Tests_Helper1() => _security_Tests_Helper1;
        public Security_Tests_Handler GetSecurity_Tests_Handler() => _security_Tests_Handler;
