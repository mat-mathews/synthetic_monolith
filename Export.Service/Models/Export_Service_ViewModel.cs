...
{
    /// <summary>Immutable data transfer record for Export_Service_ViewModel.</summary>
    public record Export_Service_ViewModel(string Value, int Count, DateTime Timestamp);
