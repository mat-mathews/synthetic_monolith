...
namespace Export.Service
{
    ...
    public class Consumer15
    {
        ...
        private readonly Common_Web438_Processor8 _common_Web438_Processor8;
        private readonly Common_Web438_Command1 _common_Web438_Command1;
        private readonly IDataAccess_Api98_Factory3 _iDataAccess_Api98_Factory3;
        private readonly DataAccess_Api98_Point7 _dataAccess_Api98_Point7;
        private readonly Export_Events163_Point _export_Events163_Point;
        private readonly Export_Mappers237_Handler9 _export_Mappers237_Handler9;

        public Consumer15(IAdmin_Api_Handler6 iAdmin_Api_Handler6, Security_Processors246_Result4 security_Processors246_Result4, Common_Web438_Processor8 common_Web438_Processor8, Common_Web438_Command1 common_Web438_Command1, IDataAccess_Api98_Factory3 iDataAccess_Api98_Factory3, DataAccess_Api98_Point7 dataAccess_Api98_Point7, Export_Events163_Point export_Events163_Point, Export_Mappers237_Handler9 export_Mappers237_Handler9)
        {
            ...
            _common_Web438_Processor8 = common_Web438_Processor8 ?? throw new ArgumentNullException(nameof(common_Web438_Processor8));
            _common_Web438_Command1 = common_Web438_Command1 ?? throw new ArgumentNullException(nameof(common_Web438_Command1));
            _iDataAccess_Api98_Factory3 = iDataAccess_Api98_Factory3 ?? throw new ArgumentNullException(nameof(iDataAccess_Api98_Factory3));
            _dataAccess_Api98_Point7 = dataAccess_Api98_Point7 ?? throw new ArgumentNullException(nameof(dataAccess_Api98_Point7));
            _export_Events163_Point = export_Events163_Point ?? throw new ArgumentNullException(nameof(export_Events163_Point));
            _export_Mappers237_Handler9 = export_Mappers237_Handler9 ?? throw new ArgumentNullException(nameof(export_Mappers237_Handler9));
        }
        ...
        public Common_Web438_Processor8 GetCommon_Web438_Processor8() => _common_Web438_Processor8;
        public Common_Web438_Command1 GetCommon_Web438_Command1() => _common_Web438_Command1;
        public IDataAccess_Api98_Factory3 GetIDataAccess_Api98_Factory3() => _iDataAccess_Api98_Factory3;
        public DataAccess_Api98_Point7 GetDataAccess_Api98_Point7() => _dataAccess_Api98_Point7;
        public Export_Events163_Point GetExport_Events163_Point() => _export_Events163_Point;
        public Export_Mappers237_Handler9 GetExport_Mappers237_Handler9() => _export_Mappers237_Handler9;
