...
{
    public partial class Auth_Mappers_Helper3 : IDisposable
    {
        private readonly string _sql = "SELECT * FROM Invoices WHERE Id = @Id";
        public void Execute()
        {
            // Auth_Mappers_Helper3 implementation
        }
...
public int Param14SortOrder { get; set; }
    ...
    {
        public DbSet<Auth_Mappers_Helper3> Auth_Mappers_Helper3s { get; set; }
    }
