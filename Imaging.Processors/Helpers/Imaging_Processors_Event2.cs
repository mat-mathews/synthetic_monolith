...
{
    /// <summary>Immutable data transfer record for Imaging_Processors_Event2.</summary>
    internal record Imaging_Processors_Event2(string Value, int Count, DateTime Timestamp);
