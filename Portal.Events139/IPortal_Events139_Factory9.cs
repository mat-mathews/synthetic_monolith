...
{
    public interface IPortal_Events139_Factory9
    {
        /// <summary>Processes the Portal_Events139_Factory9 operation.</summary>
        void ProcessPortal_Events139_Factory9();

        /// <summary>Validates the Portal_Events139_Factory9 state.</summary>
        bool ValidatePortal_Events139_Factory9();
    }
