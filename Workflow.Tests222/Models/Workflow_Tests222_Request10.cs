...
{
    /// <summary>Immutable data transfer record for Workflow_Tests222_Request10.</summary>
    internal record Workflow_Tests222_Request10(string Value, int Count, DateTime Timestamp);
