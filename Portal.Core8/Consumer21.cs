...
namespace Portal.Core8
{
    ...
    public class Consumer21
    {
        ...
        private readonly ISecurity_Data278_Validator1 _iSecurity_Data278_Validator1;
        private readonly Security_Data278_Factory5 _security_Data278_Factory5;
        private readonly Security_Data278_Repository _security_Data278_Repository;
        private readonly Workflow_Tests75_Provider3 _workflow_Tests75_Provider3;
        private readonly Billing_Mappers124_Helper7 _billing_Mappers124_Helper7;
        private readonly Billing_Mappers124_Handler12 _billing_Mappers124_Handler12;
        private readonly Billing_Mappers124_Builder10 _billing_Mappers124_Builder10;

        public Consumer21(IAuth_Handlers467_Repository6 iAuth_Handlers467_Repository6, ISecurity_Data278_Validator1 iSecurity_Data278_Validator1, Security_Data278_Factory5 security_Data278_Factory5, Security_Data278_Repository security_Data278_Repository, Workflow_Tests75_Provider3 workflow_Tests75_Provider3, Billing_Mappers124_Helper7 billing_Mappers124_Helper7, Billing_Mappers124_Handler12 billing_Mappers124_Handler12, Billing_Mappers124_Builder10 billing_Mappers124_Builder10)
        {
            ...
            _iSecurity_Data278_Validator1 = iSecurity_Data278_Validator1 ?? throw new ArgumentNullException(nameof(iSecurity_Data278_Validator1));
            _security_Data278_Factory5 = security_Data278_Factory5 ?? throw new ArgumentNullException(nameof(security_Data278_Factory5));
            _security_Data278_Repository = security_Data278_Repository ?? throw new ArgumentNullException(nameof(security_Data278_Repository));
            _workflow_Tests75_Provider3 = workflow_Tests75_Provider3 ?? throw new ArgumentNullException(nameof(workflow_Tests75_Provider3));
            _billing_Mappers124_Helper7 = billing_Mappers124_Helper7 ?? throw new ArgumentNullException(nameof(billing_Mappers124_Helper7));
            _billing_Mappers124_Handler12 = billing_Mappers124_Handler12 ?? throw new ArgumentNullException(nameof(billing_Mappers124_Handler12));
            _billing_Mappers124_Builder10 = billing_Mappers124_Builder10 ?? throw new ArgumentNullException(nameof(billing_Mappers124_Builder10));
        }

        public IAuth_Handlers467_Repository6 GetIAuth_Handlers467_Repository6() => _iAuth_Handlers467_Repository6;
        public ISecurity_Data278_Validator1 GetISecurity_Data278_Validator1() => _iSecurity_Data278_Validator1;
        public Security_Data278_Factory5 GetSecurity_Data278_Factory5() => _security_Data278_Factory5;
        public Security_Data278_Repository GetSecurity_Data278_Repository() => _security_Data278_Repository;
        public Workflow_Tests75_Provider3 GetWorkflow_Tests75_Provider3() => _workflow_Tests75_Provider3;
        public Billing_Mappers124_Helper7 GetBilling_Mappers124_Helper7() => _billing_Mappers124_Helper7;
        public Billing_Mappers124_Handler12 GetBilling_Mappers124_Handler12() => _billing_Mappers124_Handler12;
        public Billing_Mappers124_Builder10 GetBilling_Mappers124_Builder10() => _billing_Mappers124_Builder10;
