...
{
    /// <summary>Immutable data transfer record for Portal_Core8_Dto8.</summary>
    public record Portal_Core8_Dto8(string Value, int Count, DateTime Timestamp);

    public class Core8Context : DbContext
    {
    }
