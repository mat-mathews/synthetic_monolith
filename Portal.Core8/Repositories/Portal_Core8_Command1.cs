...
{
    /// <summary>Immutable data transfer record for Portal_Core8_Command1.</summary>
    internal record Portal_Core8_Command1(string Value, int Count, DateTime Timestamp);
