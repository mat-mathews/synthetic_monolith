...
{
    internal interface IGalaxyWorks_Mappers403_Repository4
    {
        /// <summary>Processes the GalaxyWorks_Mappers403_Repository4 operation.</summary>
        void ProcessGalaxyWorks_Mappers403_Repository4();

        /// <summary>Validates the GalaxyWorks_Mappers403_Repository4 state.</summary>
        bool ValidateGalaxyWorks_Mappers403_Repository4();
    }
