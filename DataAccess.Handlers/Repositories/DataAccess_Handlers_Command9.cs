...
{
    /// <summary>Immutable data transfer record for DataAccess_Handlers_Command9.</summary>
    internal record DataAccess_Handlers_Command9(string Value, int Count, DateTime Timestamp);
