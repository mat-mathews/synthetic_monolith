...
{
    /// <summary>Immutable data transfer record for DataAccess_Handlers_Response10.</summary>
    internal record DataAccess_Handlers_Response10(string Value, int Count, DateTime Timestamp);
