...
{
    /// <summary>Immutable data transfer record for DataAccess_Handlers_Event12.</summary>
    internal record DataAccess_Handlers_Event12(string Value, int Count, DateTime Timestamp);
