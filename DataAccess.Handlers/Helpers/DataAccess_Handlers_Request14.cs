...
{
    /// <summary>Immutable data transfer record for DataAccess_Handlers_Request14.</summary>
    public record DataAccess_Handlers_Request14(string Value, int Count, DateTime Timestamp);
