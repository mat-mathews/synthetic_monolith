...
{
    public class Utilities_Handlers462_Handler4 : IDisposable
    {
        private readonly string _sql = "SELECT * FROM Users WHERE Id = @Id";
        public void Execute()
        {
            // Utilities_Handlers462_Handler4 implementation
        }
...
public int Param73SortOrder { get; set; }
    ...
    public class Handlers462Context : DbContext
    {
        public DbSet<Utilities_Handlers462_Handler4> Utilities_Handlers462_Handler4s { get; set; }
    }
