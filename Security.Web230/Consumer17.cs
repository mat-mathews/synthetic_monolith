...
namespace Security.Web230
{
    ...
    public class Consumer17
    {
        ...
        private readonly Auth_Client38_Handler2 _auth_Client38_Handler2;
        private readonly Auth_Client38_Handler4 _auth_Client38_Handler4;
        private readonly Auth_Contracts_Helper4 _auth_Contracts_Helper4;
        private readonly GalaxyWorks_Handlers_Factory6 _galaxyWorks_Handlers_Factory6;
        private readonly IAuth_Data135_Service2 _iAuth_Data135_Service2;
        private readonly GalaxyWorks_Mappers_Repository2 _galaxyWorks_Mappers_Repository2;
        private readonly GalaxyWorks_Mappers_Builder3 _galaxyWorks_Mappers_Builder3;

        public Consumer17(Auth_Client38_Service1 auth_Client38_Service1, Auth_Client38_Handler2 auth_Client38_Handler2, Auth_Client38_Handler4 auth_Client38_Handler4, Auth_Contracts_Helper4 auth_Contracts_Helper4, GalaxyWorks_Handlers_Factory6 galaxyWorks_Handlers_Factory6, IAuth_Data135_Service2 iAuth_Data135_Service2, GalaxyWorks_Mappers_Repository2 galaxyWorks_Mappers_Repository2, GalaxyWorks_Mappers_Builder3 galaxyWorks_Mappers_Builder3)
        {
            _auth_Client38_Service1 = auth_Client38_Service1 ?? throw new ArgumentNullException(nameof(auth_Client38_Service1));
            _auth_Client38_Handler2 = auth_Client38_Handler2 ?? throw new ArgumentNullException(nameof(auth_Client38_Handler2));
            _auth_Client38_Handler4 = auth_Client38_Handler4 ?? throw new ArgumentNullException(nameof(auth_Client38_Handler4));
            _auth_Contracts_Helper4 = auth_Contracts_Helper4 ?? throw new ArgumentNullException(nameof(auth_Contracts_Helper4));
            _galaxyWorks_Handlers_Factory6 = galaxyWorks_Handlers_Factory6 ?? throw new ArgumentNullException(nameof(galaxyWorks_Handlers_Factory6));
            _iAuth_Data135_Service2 = iAuth_Data135_Service2 ?? throw new ArgumentNullException(nameof(iAuth_Data135_Service2));
            _galaxyWorks_Mappers_Repository2 = galaxyWorks_Mappers_Repository2 ?? throw new ArgumentNullException(nameof(galaxyWorks_Mappers_Repository2));
            _galaxyWorks_Mappers_Builder3 = galaxyWorks_Mappers_Builder3 ?? throw new ArgumentNullException(nameof(galaxyWorks_Mappers_Builder3));
        }

        public Auth_Client38_Service1 GetAuth_Client38_Service1() => _auth_Client38_Service1;
        public Auth_Client38_Handler2 GetAuth_Client38_Handler2() => _auth_Client38_Handler2;
        public Auth_Client38_Handler4 GetAuth_Client38_Handler4() => _auth_Client38_Handler4;
        public Auth_Contracts_Helper4 GetAuth_Contracts_Helper4() => _auth_Contracts_Helper4;
        public GalaxyWorks_Handlers_Factory6 GetGalaxyWorks_Handlers_Factory6() => _galaxyWorks_Handlers_Factory6;
        public IAuth_Data135_Service2 GetIAuth_Data135_Service2() => _iAuth_Data135_Service2;
        public GalaxyWorks_Mappers_Repository2 GetGalaxyWorks_Mappers_Repository2() => _galaxyWorks_Mappers_Repository2;
        public GalaxyWorks_Mappers_Builder3 GetGalaxyWorks_Mappers_Builder3() => _galaxyWorks_Mappers_Builder3;
