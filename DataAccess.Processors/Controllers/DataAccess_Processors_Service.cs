...
{
    public class DataAccess_Processors_Service : IDisposable
    {
        private const string SprocName = "dbo.usp_ValidateConfiguration";
        // Execute stored procedure dbo.usp_ValidateConfiguration
        private const string SprocName = "dbo.sp_FindDocument";
        // Execute stored procedure dbo.sp_FindDocument
        private const string SprocName = "dbo.sp_ProcessInvoice";
        // Execute stored procedure dbo.sp_ProcessInvoice
        public void Execute()
        {
            // DataAccess_Processors_Service implementation
        }

/// <summary>
/// Validates the Service before processing.
/// Checks required fields, business rules, and data integrity.
/// </summary>
/// <param name="input">The input to validate.</param>
/// <returns>True if valid, false otherwise.</returns>
public bool ValidateService(ServiceRequest input)
{
    if (input == null)
    ...
    {
        _logger.LogWarning("Validation failed: Name is required for {Type}", nameof(Service));
        return false;
    }
...
/// <summary>
/// Processes the Service operation asynchronously.
/// </summary>
public async Task<ServiceResult> ProcessServiceAsync(
    ServiceRequest request,
    CancellationToken cancellationToken = default)
{
    _logger.LogInformation("Processing {Operation} for {Id}",
        nameof(Service), request.Id);
    ...
    try
    {
        ...
        if (entity == null)
        {
            ...
            return new ServiceResult { Success = false, ErrorCode = "NOT_FOUND" };
        }
        ...
        _logger.LogInformation("Successfully processed {Operation}", nameof(Service));
        return new ServiceResult { Success = true, Data = entity };
    }
    catch (DbUpdateConcurrencyException ex)
    {
        _logger.LogError(ex, "Concurrency conflict processing {Operation}", nameof(Service));
        return new ServiceResult { Success = false, ErrorCode = "CONCURRENCY_CONFLICT" };
    }
}

/// <summary>
/// Retrieves a filtered and paginated list of Service entities.
/// </summary>
/// <param name="filter">Filter criteria.</param>
/// <param name="page">Page number (1-based).</param>
/// <param name="pageSize">Items per page.</param>
public async Task<PagedResult<ServiceDto>> GetServiceListAsync(
    ServiceFilter filter, int page = 1, int pageSize = 25)
{
    ...
    IMemoryCache cache)
{
    ...
    _cacheDuration = TimeSpan.FromMinutes(
        _configuration.GetValue<int>("Service:CacheDurationMinutes", 30));
}
...
/// </summary>
public async Task<ServiceData> GetCachedServiceAsync(string key)
{
    var cacheKey = $"Service_{key}";

    if (_cache.TryGetValue(cacheKey, out ServiceData cached))
    {
    ...
    var data = await LoadFromServiceSourceAsync(key);
