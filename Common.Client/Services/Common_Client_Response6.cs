...
{
    /// <summary>Immutable data transfer record for Common_Client_Response6.</summary>
    internal record Common_Client_Response6(string Value, int Count, DateTime Timestamp);
