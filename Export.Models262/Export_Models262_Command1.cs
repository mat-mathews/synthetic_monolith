...
{
    /// <summary>Immutable data transfer record for Export_Models262_Command1.</summary>
    internal record Export_Models262_Command1(string Value, int Count, DateTime Timestamp);
