...
{
    public interface IExport_Models262_Repository3
    {
        /// <summary>Processes the Export_Models262_Repository3 operation.</summary>
        void ProcessExport_Models262_Repository3();

        /// <summary>Validates the Export_Models262_Repository3 state.</summary>
        bool ValidateExport_Models262_Repository3();
    }
