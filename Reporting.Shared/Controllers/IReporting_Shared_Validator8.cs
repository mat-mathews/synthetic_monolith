...
{
    public interface IReporting_Shared_Validator8
    {
        /// <summary>Processes the Reporting_Shared_Validator8 operation.</summary>
        void ProcessReporting_Shared_Validator8();

        /// <summary>Validates the Reporting_Shared_Validator8 state.</summary>
        bool ValidateReporting_Shared_Validator8();
    }
