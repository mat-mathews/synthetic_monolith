...
namespace Portal.Client
{
    ...
    {
        private readonly Admin_Handlers_Service1 _admin_Handlers_Service1;
        private readonly Admin_Processors_Service2 _admin_Processors_Service2;
        private readonly Admin_Processors_Builder4 _admin_Processors_Builder4;
        private readonly Auth_Core140_Processor12 _auth_Core140_Processor12;
        private readonly Auth_Core140_Processor5 _auth_Core140_Processor5;
        private readonly Common_Tests_Helper _common_Tests_Helper;
        private readonly Reporting_Processors326_Handler3 _reporting_Processors326_Handler3;
        private readonly Reporting_Processors326_Range7 _reporting_Processors326_Range7;

        public Consumer2(Admin_Handlers_Service1 admin_Handlers_Service1, Admin_Processors_Service2 admin_Processors_Service2, Admin_Processors_Builder4 admin_Processors_Builder4, Auth_Core140_Processor12 auth_Core140_Processor12, Auth_Core140_Processor5 auth_Core140_Processor5, Common_Tests_Helper common_Tests_Helper, Reporting_Processors326_Handler3 reporting_Processors326_Handler3, Reporting_Processors326_Range7 reporting_Processors326_Range7)
        {
            _admin_Handlers_Service1 = admin_Handlers_Service1 ?? throw new ArgumentNullException(nameof(admin_Handlers_Service1));
            _admin_Processors_Service2 = admin_Processors_Service2 ?? throw new ArgumentNullException(nameof(admin_Processors_Service2));
            _admin_Processors_Builder4 = admin_Processors_Builder4 ?? throw new ArgumentNullException(nameof(admin_Processors_Builder4));
            _auth_Core140_Processor12 = auth_Core140_Processor12 ?? throw new ArgumentNullException(nameof(auth_Core140_Processor12));
            _auth_Core140_Processor5 = auth_Core140_Processor5 ?? throw new ArgumentNullException(nameof(auth_Core140_Processor5));
            _common_Tests_Helper = common_Tests_Helper ?? throw new ArgumentNullException(nameof(common_Tests_Helper));
            _reporting_Processors326_Handler3 = reporting_Processors326_Handler3 ?? throw new ArgumentNullException(nameof(reporting_Processors326_Handler3));
            _reporting_Processors326_Range7 = reporting_Processors326_Range7 ?? throw new ArgumentNullException(nameof(reporting_Processors326_Range7));
        }

        public Admin_Handlers_Service1 GetAdmin_Handlers_Service1() => _admin_Handlers_Service1;
        public Admin_Processors_Service2 GetAdmin_Processors_Service2() => _admin_Processors_Service2;
        public Admin_Processors_Builder4 GetAdmin_Processors_Builder4() => _admin_Processors_Builder4;
        public Auth_Core140_Processor12 GetAuth_Core140_Processor12() => _auth_Core140_Processor12;
        public Auth_Core140_Processor5 GetAuth_Core140_Processor5() => _auth_Core140_Processor5;
        public Common_Tests_Helper GetCommon_Tests_Helper() => _common_Tests_Helper;
        public Reporting_Processors326_Handler3 GetReporting_Processors326_Handler3() => _reporting_Processors326_Handler3;
        public Reporting_Processors326_Range7 GetReporting_Processors326_Range7() => _reporting_Processors326_Range7;
