...
namespace Portal.Client
{
    ...
    public class Consumer23
    {
        ...
        private readonly ICommon_Tests_Repository1 _iCommon_Tests_Repository1;
        ...
        private readonly Integration_Validators_Manager1 _integration_Validators_Manager1;
        private readonly Integration_Validators_Manager8 _integration_Validators_Manager8;

        public Consumer23(Admin_Processors_Builder4 admin_Processors_Builder4, Auth_Core140_Helper2 auth_Core140_Helper2, Auth_Core140_Processor12 auth_Core140_Processor12, ICommon_Tests_Repository1 iCommon_Tests_Repository1, Reporting_Processors326_Processor4 reporting_Processors326_Processor4, Reporting_Processors326_Range5 reporting_Processors326_Range5, Integration_Validators_Manager1 integration_Validators_Manager1, Integration_Validators_Manager8 integration_Validators_Manager8)
        {
            ...
            _iCommon_Tests_Repository1 = iCommon_Tests_Repository1 ?? throw new ArgumentNullException(nameof(iCommon_Tests_Repository1));
            ...
            _integration_Validators_Manager1 = integration_Validators_Manager1 ?? throw new ArgumentNullException(nameof(integration_Validators_Manager1));
            _integration_Validators_Manager8 = integration_Validators_Manager8 ?? throw new ArgumentNullException(nameof(integration_Validators_Manager8));
        }
        ...
        public ICommon_Tests_Repository1 GetICommon_Tests_Repository1() => _iCommon_Tests_Repository1;
        ...
        public Integration_Validators_Manager1 GetIntegration_Validators_Manager1() => _integration_Validators_Manager1;
        public Integration_Validators_Manager8 GetIntegration_Validators_Manager8() => _integration_Validators_Manager8;
