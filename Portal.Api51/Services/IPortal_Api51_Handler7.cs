...
{
    public interface IPortal_Api51_Handler7
    {
        /// <summary>Processes the Portal_Api51_Handler7 operation.</summary>
        void ProcessPortal_Api51_Handler7();

        /// <summary>Validates the Portal_Api51_Handler7 state.</summary>
        bool ValidatePortal_Api51_Handler7();
    }
