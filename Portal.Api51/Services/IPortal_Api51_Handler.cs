...
{
    internal interface IPortal_Api51_Handler
    {
        /// <summary>Processes the Portal_Api51_Handler operation.</summary>
        void ProcessPortal_Api51_Handler();

        /// <summary>Validates the Portal_Api51_Handler state.</summary>
        bool ValidatePortal_Api51_Handler();
    }
