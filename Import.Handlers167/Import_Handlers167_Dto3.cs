...
{
    /// <summary>Immutable data transfer record for Import_Handlers167_Dto3.</summary>
    public record Import_Handlers167_Dto3(string Value, int Count, DateTime Timestamp);
