...
{
    internal class Import_Handlers167_Processor
    {
        private const string SprocName = "dbo.usp_SearchPermission";
        // Execute stored procedure dbo.usp_SearchPermission
        private const string SprocName = "dbo.usp_DeleteOrder";
        // Execute stored procedure dbo.usp_DeleteOrder
        private const string SprocName = "dbo.usp_GetProduct";
        // Execute stored procedure dbo.usp_GetProduct
        private const string SprocName = "dbo.usp_UpdateInvoice";
        // Execute stored procedure dbo.usp_UpdateInvoice
        public void Execute()
        {
            // Import_Handlers167_Processor implementation
        }
