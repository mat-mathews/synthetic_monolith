...
namespace Portal.Mappers233
{
    ...
    public class Consumer7
    {
        ...
        private readonly Admin_Service364_Range6 _admin_Service364_Range6;
        private readonly Import_Data100_Builder1 _import_Data100_Builder1;
        private readonly Import_Data100_ViewModel4 _import_Data100_ViewModel4;
        private readonly Import_Data100_Info2 _import_Data100_Info2;
        private readonly BatchJobs_Mappers31_Command11 _batchJobs_Mappers31_Command11;

        public Consumer7(Admin_Api255_Range7 admin_Api255_Range7, Admin_Api255_ViewModel1 admin_Api255_ViewModel1, Admin_Api255_Manager10 admin_Api255_Manager10, Admin_Service364_Range6 admin_Service364_Range6, Import_Data100_Builder1 import_Data100_Builder1, Import_Data100_ViewModel4 import_Data100_ViewModel4, Import_Data100_Info2 import_Data100_Info2, BatchJobs_Mappers31_Command11 batchJobs_Mappers31_Command11)
        {
            ...
            _admin_Service364_Range6 = admin_Service364_Range6 ?? throw new ArgumentNullException(nameof(admin_Service364_Range6));
            _import_Data100_Builder1 = import_Data100_Builder1 ?? throw new ArgumentNullException(nameof(import_Data100_Builder1));
            _import_Data100_ViewModel4 = import_Data100_ViewModel4 ?? throw new ArgumentNullException(nameof(import_Data100_ViewModel4));
            _import_Data100_Info2 = import_Data100_Info2 ?? throw new ArgumentNullException(nameof(import_Data100_Info2));
            _batchJobs_Mappers31_Command11 = batchJobs_Mappers31_Command11 ?? throw new ArgumentNullException(nameof(batchJobs_Mappers31_Command11));
        }
        ...
        public Admin_Service364_Range6 GetAdmin_Service364_Range6() => _admin_Service364_Range6;
        public Import_Data100_Builder1 GetImport_Data100_Builder1() => _import_Data100_Builder1;
        public Import_Data100_ViewModel4 GetImport_Data100_ViewModel4() => _import_Data100_ViewModel4;
        public Import_Data100_Info2 GetImport_Data100_Info2() => _import_Data100_Info2;
        public BatchJobs_Mappers31_Command11 GetBatchJobs_Mappers31_Command11() => _batchJobs_Mappers31_Command11;
