...
{
    public interface IPortal_Mappers233_Repository6
    {
        /// <summary>Processes the Portal_Mappers233_Repository6 operation.</summary>
        void ProcessPortal_Mappers233_Repository6();

        /// <summary>Validates the Portal_Mappers233_Repository6 state.</summary>
        bool ValidatePortal_Mappers233_Repository6();
    }
