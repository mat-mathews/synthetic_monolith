...
namespace Portal.Models
{
    ...
    public class Consumer14
    {
        ...
        private readonly Admin_Client_Command12 _admin_Client_Command12;
        private readonly Admin_Client_Response11 _admin_Client_Response11;
        private readonly Common_Web488_Response5 _common_Web488_Response5;
        private readonly GalaxyWorks_Shared_Service7 _galaxyWorks_Shared_Service7;
        private readonly GalaxyWorks_Shared_Service3 _galaxyWorks_Shared_Service3;
        private readonly GalaxyWorks_Shared_Handler6 _galaxyWorks_Shared_Handler6;
        private readonly Auth_Handlers209_Command3 _auth_Handlers209_Command3;

        public Consumer14(Auth_Client249_Service7 auth_Client249_Service7, Admin_Client_Command12 admin_Client_Command12, Admin_Client_Response11 admin_Client_Response11, Common_Web488_Response5 common_Web488_Response5, GalaxyWorks_Shared_Service7 galaxyWorks_Shared_Service7, GalaxyWorks_Shared_Service3 galaxyWorks_Shared_Service3, GalaxyWorks_Shared_Handler6 galaxyWorks_Shared_Handler6, Auth_Handlers209_Command3 auth_Handlers209_Command3)
        {
            _auth_Client249_Service7 = auth_Client249_Service7 ?? throw new ArgumentNullException(nameof(auth_Client249_Service7));
            _admin_Client_Command12 = admin_Client_Command12 ?? throw new ArgumentNullException(nameof(admin_Client_Command12));
            _admin_Client_Response11 = admin_Client_Response11 ?? throw new ArgumentNullException(nameof(admin_Client_Response11));
            _common_Web488_Response5 = common_Web488_Response5 ?? throw new ArgumentNullException(nameof(common_Web488_Response5));
            _galaxyWorks_Shared_Service7 = galaxyWorks_Shared_Service7 ?? throw new ArgumentNullException(nameof(galaxyWorks_Shared_Service7));
            _galaxyWorks_Shared_Service3 = galaxyWorks_Shared_Service3 ?? throw new ArgumentNullException(nameof(galaxyWorks_Shared_Service3));
            _galaxyWorks_Shared_Handler6 = galaxyWorks_Shared_Handler6 ?? throw new ArgumentNullException(nameof(galaxyWorks_Shared_Handler6));
            _auth_Handlers209_Command3 = auth_Handlers209_Command3 ?? throw new ArgumentNullException(nameof(auth_Handlers209_Command3));
        }

        public Auth_Client249_Service7 GetAuth_Client249_Service7() => _auth_Client249_Service7;
        public Admin_Client_Command12 GetAdmin_Client_Command12() => _admin_Client_Command12;
        public Admin_Client_Response11 GetAdmin_Client_Response11() => _admin_Client_Response11;
        public Common_Web488_Response5 GetCommon_Web488_Response5() => _common_Web488_Response5;
        public GalaxyWorks_Shared_Service7 GetGalaxyWorks_Shared_Service7() => _galaxyWorks_Shared_Service7;
        public GalaxyWorks_Shared_Service3 GetGalaxyWorks_Shared_Service3() => _galaxyWorks_Shared_Service3;
        public GalaxyWorks_Shared_Handler6 GetGalaxyWorks_Shared_Handler6() => _galaxyWorks_Shared_Handler6;
        public Auth_Handlers209_Command3 GetAuth_Handlers209_Command3() => _auth_Handlers209_Command3;
