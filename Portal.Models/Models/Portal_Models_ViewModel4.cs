...
{
    /// <summary>Immutable data transfer record for Portal_Models_ViewModel4.</summary>
    internal record Portal_Models_ViewModel4(string Value, int Count, DateTime Timestamp);
