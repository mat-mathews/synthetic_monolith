...
{
    public class Portal_Models_Repository1
    {
        private readonly string _sql = "SELECT * FROM Accounts WHERE Id = @Id";
        public void Execute()
        {
            // Portal_Models_Repository1 implementation
        }
...
public int Item23SortOrder { get; set; }
    ...
    {
        public DbSet<Portal_Models_Repository1> Portal_Models_Repository1s { get; set; }
    }
