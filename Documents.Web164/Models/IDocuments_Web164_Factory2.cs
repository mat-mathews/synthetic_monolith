...
namespace Documents.Web164
{
    public interface IDocuments_Web164_Factory2
    {
        /// <summary>Processes the Documents_Web164_Factory2 operation.</summary>
        void ProcessDocuments_Web164_Factory2();

        /// <summary>Validates the Documents_Web164_Factory2 state.</summary>
        bool ValidateDocuments_Web164_Factory2();
    }
