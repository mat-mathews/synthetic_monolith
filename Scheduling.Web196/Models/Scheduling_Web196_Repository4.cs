...
{
    public class Scheduling_Web196_Repository4 : IDisposable
    {
        private readonly string _sql = "SELECT * FROM Products WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Web196_Repository4 implementation
        }
...
public int Detail19SortOrder { get; set; }
    ...
    public class Web196Context : DbContext
    {
        public DbSet<Scheduling_Web196_Repository4> Scheduling_Web196_Repository4s { get; set; }
    }
