...
namespace Scheduling.Web196
{
    ...
    {
        private readonly IDocuments_Web164_Factory11 _iDocuments_Web164_Factory11;
        private readonly Documents_Web164_Controller6 _documents_Web164_Controller6;
        private readonly Documents_Web164_Point _documents_Web164_Point;
        private readonly Notifications_Tests195_Range9 _notifications_Tests195_Range9;
        private readonly Reporting_Tests226_Provider5 _reporting_Tests226_Provider5;
        private readonly Import_Processors412_Provider _import_Processors412_Provider;
        private readonly IImport_Processors412_Validator5 _iImport_Processors412_Validator5;
        private readonly Logging_Data29_Repository5 _logging_Data29_Repository5;

        public Consumer4(IDocuments_Web164_Factory11 iDocuments_Web164_Factory11, Documents_Web164_Controller6 documents_Web164_Controller6, Documents_Web164_Point documents_Web164_Point, Notifications_Tests195_Range9 notifications_Tests195_Range9, Reporting_Tests226_Provider5 reporting_Tests226_Provider5, Import_Processors412_Provider import_Processors412_Provider, IImport_Processors412_Validator5 iImport_Processors412_Validator5, Logging_Data29_Repository5 logging_Data29_Repository5)
        {
            _iDocuments_Web164_Factory11 = iDocuments_Web164_Factory11 ?? throw new ArgumentNullException(nameof(iDocuments_Web164_Factory11));
            ...
            _documents_Web164_Point = documents_Web164_Point ?? throw new ArgumentNullException(nameof(documents_Web164_Point));
            _notifications_Tests195_Range9 = notifications_Tests195_Range9 ?? throw new ArgumentNullException(nameof(notifications_Tests195_Range9));
            ...
            _import_Processors412_Provider = import_Processors412_Provider ?? throw new ArgumentNullException(nameof(import_Processors412_Provider));
            _iImport_Processors412_Validator5 = iImport_Processors412_Validator5 ?? throw new ArgumentNullException(nameof(iImport_Processors412_Validator5));
            _logging_Data29_Repository5 = logging_Data29_Repository5 ?? throw new ArgumentNullException(nameof(logging_Data29_Repository5));
        }

        public IDocuments_Web164_Factory11 GetIDocuments_Web164_Factory11() => _iDocuments_Web164_Factory11;
        public Documents_Web164_Controller6 GetDocuments_Web164_Controller6() => _documents_Web164_Controller6;
        public Documents_Web164_Point GetDocuments_Web164_Point() => _documents_Web164_Point;
        public Notifications_Tests195_Range9 GetNotifications_Tests195_Range9() => _notifications_Tests195_Range9;
        public Reporting_Tests226_Provider5 GetReporting_Tests226_Provider5() => _reporting_Tests226_Provider5;
        public Import_Processors412_Provider GetImport_Processors412_Provider() => _import_Processors412_Provider;
        public IImport_Processors412_Validator5 GetIImport_Processors412_Validator5() => _iImport_Processors412_Validator5;
        public Logging_Data29_Repository5 GetLogging_Data29_Repository5() => _logging_Data29_Repository5;
