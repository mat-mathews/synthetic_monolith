...
{
    public partial class Scheduling_Web196_Provider
    {
        private const string SprocName = "dbo.sp_SearchAudit";
        // Execute stored procedure dbo.sp_SearchAudit
        private const string SprocName = "dbo.sp_DeleteDocument";
        // Execute stored procedure dbo.sp_DeleteDocument
        private const string SprocName = "dbo.usp_UpdateAccount";
        // Execute stored procedure dbo.usp_UpdateAccount
        private const string SprocName = "dbo.usp_ProcessCustomer";
        // Execute stored procedure dbo.usp_ProcessCustomer
        private readonly string _sql = "SELECT * FROM Customers WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Web196_Provider implementation
        }
