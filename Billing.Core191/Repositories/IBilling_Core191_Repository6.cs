...
{
    public interface IBilling_Core191_Repository6
    {
        /// <summary>Processes the Billing_Core191_Repository6 operation.</summary>
        void ProcessBilling_Core191_Repository6();

        /// <summary>Validates the Billing_Core191_Repository6 state.</summary>
        bool ValidateBilling_Core191_Repository6();
    }
