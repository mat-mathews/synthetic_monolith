...
{
    public interface IBilling_Core191_Factory
    {
        /// <summary>Processes the Billing_Core191_Factory operation.</summary>
        void ProcessBilling_Core191_Factory();

        /// <summary>Validates the Billing_Core191_Factory state.</summary>
        bool ValidateBilling_Core191_Factory();
    }
