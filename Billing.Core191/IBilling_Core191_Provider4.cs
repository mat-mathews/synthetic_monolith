...
{
    internal interface IBilling_Core191_Provider4
    {
        /// <summary>Processes the Billing_Core191_Provider4 operation.</summary>
        void ProcessBilling_Core191_Provider4();

        /// <summary>Validates the Billing_Core191_Provider4 state.</summary>
        bool ValidateBilling_Core191_Provider4();
    }
