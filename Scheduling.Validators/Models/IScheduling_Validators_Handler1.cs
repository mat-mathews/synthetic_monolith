...
{
    public interface IScheduling_Validators_Handler1
    {
        /// <summary>Processes the Scheduling_Validators_Handler1 operation.</summary>
        void ProcessScheduling_Validators_Handler1();

        /// <summary>Validates the Scheduling_Validators_Handler1 state.</summary>
        bool ValidateScheduling_Validators_Handler1();
    }
