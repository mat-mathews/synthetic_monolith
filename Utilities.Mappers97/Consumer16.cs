...
namespace Utilities.Mappers97
{
    ...
    public class Consumer16
    {
        ...
        private readonly IExport_Events276_Handler7 _iExport_Events276_Handler7;
        ...
        private readonly BatchJobs_Processors410_Service4 _batchJobs_Processors410_Service4;
        private readonly IBatchJobs_Processors410_Repository3 _iBatchJobs_Processors410_Repository3;
        private readonly Logging_Client405_Processor1 _logging_Client405_Processor1;
        private readonly Logging_Client405_Repository6 _logging_Client405_Repository6;

        public Consumer16(Admin_Validators431_Helper admin_Validators431_Helper, IExport_Events276_Handler7 iExport_Events276_Handler7, Imaging_Validators108_Processor1 imaging_Validators108_Processor1, BatchJobs_Processors410_Controller5 batchJobs_Processors410_Controller5, BatchJobs_Processors410_Service4 batchJobs_Processors410_Service4, IBatchJobs_Processors410_Repository3 iBatchJobs_Processors410_Repository3, Logging_Client405_Processor1 logging_Client405_Processor1, Logging_Client405_Repository6 logging_Client405_Repository6)
        {
            _admin_Validators431_Helper = admin_Validators431_Helper ?? throw new ArgumentNullException(nameof(admin_Validators431_Helper));
            _iExport_Events276_Handler7 = iExport_Events276_Handler7 ?? throw new ArgumentNullException(nameof(iExport_Events276_Handler7));
            ...
            _batchJobs_Processors410_Service4 = batchJobs_Processors410_Service4 ?? throw new ArgumentNullException(nameof(batchJobs_Processors410_Service4));
            ...
            _logging_Client405_Processor1 = logging_Client405_Processor1 ?? throw new ArgumentNullException(nameof(logging_Client405_Processor1));
            _logging_Client405_Repository6 = logging_Client405_Repository6 ?? throw new ArgumentNullException(nameof(logging_Client405_Repository6));
        }

        public Admin_Validators431_Helper GetAdmin_Validators431_Helper() => _admin_Validators431_Helper;
        public IExport_Events276_Handler7 GetIExport_Events276_Handler7() => _iExport_Events276_Handler7;
        ...
        public BatchJobs_Processors410_Service4 GetBatchJobs_Processors410_Service4() => _batchJobs_Processors410_Service4;
        ...
        public Logging_Client405_Processor1 GetLogging_Client405_Processor1() => _logging_Client405_Processor1;
        public Logging_Client405_Repository6 GetLogging_Client405_Repository6() => _logging_Client405_Repository6;
