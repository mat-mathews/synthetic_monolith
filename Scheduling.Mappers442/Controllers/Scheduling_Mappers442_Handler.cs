...
{
    internal sealed class Scheduling_Mappers442_Handler
    {
        private readonly string _sql = "SELECT * FROM Invoices WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Mappers442_Handler implementation
        }
...
public int Item33SortOrder { get; set; }
    ...
    {
        public DbSet<Scheduling_Mappers442_Handler> Scheduling_Mappers442_Handlers { get; set; }
    }
