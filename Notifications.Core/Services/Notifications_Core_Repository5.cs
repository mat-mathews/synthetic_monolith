...
{
    public sealed class Notifications_Core_Repository5
    {
        ...
        public void Execute()
        {
            // Notifications_Core_Repository5 implementation
        }
...
public int Detail59SortOrder { get; set; }
    ...
    {
        public DbSet<Notifications_Core_Repository5> Notifications_Core_Repository5s { get; set; }
    }
