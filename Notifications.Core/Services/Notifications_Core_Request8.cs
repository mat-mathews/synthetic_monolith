...
{
    /// <summary>Immutable data transfer record for Notifications_Core_Request8.</summary>
    public record Notifications_Core_Request8(string Value, int Count, DateTime Timestamp);
