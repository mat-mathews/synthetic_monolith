...
{
    /// <summary>Immutable data transfer record for Billing_Client22_Request.</summary>
    internal record Billing_Client22_Request(string Value, int Count, DateTime Timestamp);
