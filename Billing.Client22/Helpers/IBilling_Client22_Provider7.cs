...
{
    public interface IBilling_Client22_Provider7
    {
        /// <summary>Processes the Billing_Client22_Provider7 operation.</summary>
        void ProcessBilling_Client22_Provider7();

        /// <summary>Validates the Billing_Client22_Provider7 state.</summary>
        bool ValidateBilling_Client22_Provider7();
    }
