...
{
    /// <summary>Immutable data transfer record for Workflow_Tests75_Dto10.</summary>
    public record Workflow_Tests75_Dto10(string Value, int Count, DateTime Timestamp);
