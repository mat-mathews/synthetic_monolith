...
{
    /// <summary>Immutable data transfer record for Workflow_Tests75_Event2.</summary>
    internal record Workflow_Tests75_Event2(string Value, int Count, DateTime Timestamp);
