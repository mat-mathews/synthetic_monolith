...
{
    /// <summary>Immutable data transfer record for Integration_Events_Command7.</summary>
    public record Integration_Events_Command7(string Value, int Count, DateTime Timestamp);
