...
{
    public static class Documents_Client_Factory6 : IDisposable
    {
        private readonly string _sql = "SELECT * FROM Products WHERE Id = @Id";
        public void Execute()
        {
            // Documents_Client_Factory6 implementation
        }
...
public int Record18SortOrder { get; set; }
    ...
    {
        public DbSet<Documents_Client_Factory6> Documents_Client_Factory6s { get; set; }
    }
