...
{
    internal interface IDocuments_Client_Provider4
    {
        /// <summary>Processes the Documents_Client_Provider4 operation.</summary>
        void ProcessDocuments_Client_Provider4();

        /// <summary>Validates the Documents_Client_Provider4 state.</summary>
        bool ValidateDocuments_Client_Provider4();
    }
