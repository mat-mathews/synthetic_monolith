...
namespace Documents.Client
{
    ...
    public class Consumer25
    {
        ...
        private readonly Reporting_Events188_Dto8 _reporting_Events188_Dto8;
        private readonly Reporting_Events188_Handler3 _reporting_Events188_Handler3;
        private readonly Reporting_Events188_Event9 _reporting_Events188_Event9;
        private readonly Security_Models18_Service7 _security_Models18_Service7;
        private readonly Security_Models18_Provider8 _security_Models18_Provider8;
        private readonly Scheduling_Api185_Service _scheduling_Api185_Service;
        private readonly Scheduling_Api185_Helper5 _scheduling_Api185_Helper5;

        public Consumer25(Admin_Contracts_Helper1 admin_Contracts_Helper1, Reporting_Events188_Dto8 reporting_Events188_Dto8, Reporting_Events188_Handler3 reporting_Events188_Handler3, Reporting_Events188_Event9 reporting_Events188_Event9, Security_Models18_Service7 security_Models18_Service7, Security_Models18_Provider8 security_Models18_Provider8, Scheduling_Api185_Service scheduling_Api185_Service, Scheduling_Api185_Helper5 scheduling_Api185_Helper5)
        {
            _admin_Contracts_Helper1 = admin_Contracts_Helper1 ?? throw new ArgumentNullException(nameof(admin_Contracts_Helper1));
            _reporting_Events188_Dto8 = reporting_Events188_Dto8 ?? throw new ArgumentNullException(nameof(reporting_Events188_Dto8));
            _reporting_Events188_Handler3 = reporting_Events188_Handler3 ?? throw new ArgumentNullException(nameof(reporting_Events188_Handler3));
            _reporting_Events188_Event9 = reporting_Events188_Event9 ?? throw new ArgumentNullException(nameof(reporting_Events188_Event9));
            _security_Models18_Service7 = security_Models18_Service7 ?? throw new ArgumentNullException(nameof(security_Models18_Service7));
            _security_Models18_Provider8 = security_Models18_Provider8 ?? throw new ArgumentNullException(nameof(security_Models18_Provider8));
            _scheduling_Api185_Service = scheduling_Api185_Service ?? throw new ArgumentNullException(nameof(scheduling_Api185_Service));
        ...
        public Reporting_Events188_Dto8 GetReporting_Events188_Dto8() => _reporting_Events188_Dto8;
        public Reporting_Events188_Handler3 GetReporting_Events188_Handler3() => _reporting_Events188_Handler3;
        public Reporting_Events188_Event9 GetReporting_Events188_Event9() => _reporting_Events188_Event9;
        public Security_Models18_Service7 GetSecurity_Models18_Service7() => _security_Models18_Service7;
        public Security_Models18_Provider8 GetSecurity_Models18_Provider8() => _security_Models18_Provider8;
        public Scheduling_Api185_Service GetScheduling_Api185_Service() => _scheduling_Api185_Service;
