...
{
    public partial class Reporting_Shared394_Handler : IDisposable
    {
        private const string SprocName = "dbo.sp_GetLog";
        // Execute stored procedure dbo.sp_GetLog
        private readonly string _sql = "SELECT * FROM Roles WHERE Id = @Id";
        public void Execute()
        {
            // Reporting_Shared394_Handler implementation
        }
...
public int Record89SortOrder { get; set; }
    ...
    public class Shared394Context : DbContext
    {
        public DbSet<Reporting_Shared394_Handler> Reporting_Shared394_Handlers { get; set; }
    }
