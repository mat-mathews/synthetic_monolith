...
{
    /// <summary>Immutable data transfer record for Imaging_Handlers_ViewModel8.</summary>
    internal record Imaging_Handlers_ViewModel8(string Value, int Count, DateTime Timestamp);
