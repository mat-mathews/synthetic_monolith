...
{
    internal interface IBatchJobs_Mappers362_Handler4
    {
        /// <summary>Processes the BatchJobs_Mappers362_Handler4 operation.</summary>
        void ProcessBatchJobs_Mappers362_Handler4();

        /// <summary>Validates the BatchJobs_Mappers362_Handler4 state.</summary>
        bool ValidateBatchJobs_Mappers362_Handler4();
    }
