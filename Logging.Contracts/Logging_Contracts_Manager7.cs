...
{
    public static class Logging_Contracts_Manager7
    {
        private readonly string _sql = "SELECT * FROM Payments WHERE Id = @Id";
        public void Execute()
        {
            // Logging_Contracts_Manager7 implementation
        }
...
public int Entry70SortOrder { get; set; }
    ...
    {
        public DbSet<Logging_Contracts_Manager7> Logging_Contracts_Manager7s { get; set; }
    }
