...
{
    public interface ILogging_Contracts_Validator8
    {
        /// <summary>Processes the Logging_Contracts_Validator8 operation.</summary>
        void ProcessLogging_Contracts_Validator8();

        /// <summary>Validates the Logging_Contracts_Validator8 state.</summary>
        bool ValidateLogging_Contracts_Validator8();
    }
