...
namespace Portal.Validators250
{
    ...
    public class Consumer11
    {
        ...
        private readonly IScheduling_Web264_Repository _iScheduling_Web264_Repository;
        private readonly GalaxyWorks_Tests445_Service _galaxyWorks_Tests445_Service;
        private readonly GalaxyWorks_Tests445_Provider2 _galaxyWorks_Tests445_Provider2;
        private readonly GalaxyWorks_Tests445_Builder5 _galaxyWorks_Tests445_Builder5;
        private readonly Scheduling_Handlers43_Builder10 _scheduling_Handlers43_Builder10;
        private readonly Scheduling_Handlers43_Handler _scheduling_Handlers43_Handler;
        private readonly Import_Contracts131_ViewModel1 _import_Contracts131_ViewModel1;

        public Consumer11(Auth_Handlers_Repository5 auth_Handlers_Repository5, IScheduling_Web264_Repository iScheduling_Web264_Repository, GalaxyWorks_Tests445_Service galaxyWorks_Tests445_Service, GalaxyWorks_Tests445_Provider2 galaxyWorks_Tests445_Provider2, GalaxyWorks_Tests445_Builder5 galaxyWorks_Tests445_Builder5, Scheduling_Handlers43_Builder10 scheduling_Handlers43_Builder10, Scheduling_Handlers43_Handler scheduling_Handlers43_Handler, Import_Contracts131_ViewModel1 import_Contracts131_ViewModel1)
        {
            _auth_Handlers_Repository5 = auth_Handlers_Repository5 ?? throw new ArgumentNullException(nameof(auth_Handlers_Repository5));
            _iScheduling_Web264_Repository = iScheduling_Web264_Repository ?? throw new ArgumentNullException(nameof(iScheduling_Web264_Repository));
            _galaxyWorks_Tests445_Service = galaxyWorks_Tests445_Service ?? throw new ArgumentNullException(nameof(galaxyWorks_Tests445_Service));
            _galaxyWorks_Tests445_Provider2 = galaxyWorks_Tests445_Provider2 ?? throw new ArgumentNullException(nameof(galaxyWorks_Tests445_Provider2));
            _galaxyWorks_Tests445_Builder5 = galaxyWorks_Tests445_Builder5 ?? throw new ArgumentNullException(nameof(galaxyWorks_Tests445_Builder5));
            _scheduling_Handlers43_Builder10 = scheduling_Handlers43_Builder10 ?? throw new ArgumentNullException(nameof(scheduling_Handlers43_Builder10));
            _scheduling_Handlers43_Handler = scheduling_Handlers43_Handler ?? throw new ArgumentNullException(nameof(scheduling_Handlers43_Handler));
            _import_Contracts131_ViewModel1 = import_Contracts131_ViewModel1 ?? throw new ArgumentNullException(nameof(import_Contracts131_ViewModel1));
        }

        public Auth_Handlers_Repository5 GetAuth_Handlers_Repository5() => _auth_Handlers_Repository5;
        public IScheduling_Web264_Repository GetIScheduling_Web264_Repository() => _iScheduling_Web264_Repository;
        public GalaxyWorks_Tests445_Service GetGalaxyWorks_Tests445_Service() => _galaxyWorks_Tests445_Service;
        public GalaxyWorks_Tests445_Provider2 GetGalaxyWorks_Tests445_Provider2() => _galaxyWorks_Tests445_Provider2;
        public GalaxyWorks_Tests445_Builder5 GetGalaxyWorks_Tests445_Builder5() => _galaxyWorks_Tests445_Builder5;
        public Scheduling_Handlers43_Builder10 GetScheduling_Handlers43_Builder10() => _scheduling_Handlers43_Builder10;
        public Scheduling_Handlers43_Handler GetScheduling_Handlers43_Handler() => _scheduling_Handlers43_Handler;
        public Import_Contracts131_ViewModel1 GetImport_Contracts131_ViewModel1() => _import_Contracts131_ViewModel1;
