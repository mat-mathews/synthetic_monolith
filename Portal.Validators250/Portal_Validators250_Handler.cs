...
{
    internal class Portal_Validators250_Handler
    {
        private const string SprocName = "dbo.sp_ValidateRole";
        // Execute stored procedure dbo.sp_ValidateRole
        private const string SprocName = "dbo.usp_ProcessAccount";
        // Execute stored procedure dbo.usp_ProcessAccount
        private const string SprocName = "dbo.sp_UpdateAudit";
        // Execute stored procedure dbo.sp_UpdateAudit
        private const string SprocName = "dbo.usp_SearchSchedule";
        // Execute stored procedure dbo.usp_SearchSchedule
        public void Execute()
        {
            // Portal_Validators250_Handler implementation
        }
