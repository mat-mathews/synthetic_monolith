...
namespace BatchJobs.Client267
{
    ...
    public class Consumer2
    {
        ...
        private readonly Utilities_Web398_Manager5 _utilities_Web398_Manager5;
        private readonly Security_Client353_Manager10 _security_Client353_Manager10;
        private readonly IExport_Core_Handler10 _iExport_Core_Handler10;
        private readonly Export_Core_Command2 _export_Core_Command2;
        private readonly Export_Core_Factory6 _export_Core_Factory6;
        private readonly Notifications_Web90_ViewModel8 _notifications_Web90_ViewModel8;
        private readonly Notifications_Web90_Helper3 _notifications_Web90_Helper3;

        public Consumer2(Auth_Handlers_Builder10 auth_Handlers_Builder10, Utilities_Web398_Manager5 utilities_Web398_Manager5, Security_Client353_Manager10 security_Client353_Manager10, IExport_Core_Handler10 iExport_Core_Handler10, Export_Core_Command2 export_Core_Command2, Export_Core_Factory6 export_Core_Factory6, Notifications_Web90_ViewModel8 notifications_Web90_ViewModel8, Notifications_Web90_Helper3 notifications_Web90_Helper3)
        {
            _auth_Handlers_Builder10 = auth_Handlers_Builder10 ?? throw new ArgumentNullException(nameof(auth_Handlers_Builder10));
            _utilities_Web398_Manager5 = utilities_Web398_Manager5 ?? throw new ArgumentNullException(nameof(utilities_Web398_Manager5));
            _security_Client353_Manager10 = security_Client353_Manager10 ?? throw new ArgumentNullException(nameof(security_Client353_Manager10));
            _iExport_Core_Handler10 = iExport_Core_Handler10 ?? throw new ArgumentNullException(nameof(iExport_Core_Handler10));
            _export_Core_Command2 = export_Core_Command2 ?? throw new ArgumentNullException(nameof(export_Core_Command2));
            _export_Core_Factory6 = export_Core_Factory6 ?? throw new ArgumentNullException(nameof(export_Core_Factory6));
            _notifications_Web90_ViewModel8 = notifications_Web90_ViewModel8 ?? throw new ArgumentNullException(nameof(notifications_Web90_ViewModel8));
            _notifications_Web90_Helper3 = notifications_Web90_Helper3 ?? throw new ArgumentNullException(nameof(notifications_Web90_Helper3));
        }

        public Auth_Handlers_Builder10 GetAuth_Handlers_Builder10() => _auth_Handlers_Builder10;
        public Utilities_Web398_Manager5 GetUtilities_Web398_Manager5() => _utilities_Web398_Manager5;
        public Security_Client353_Manager10 GetSecurity_Client353_Manager10() => _security_Client353_Manager10;
        public IExport_Core_Handler10 GetIExport_Core_Handler10() => _iExport_Core_Handler10;
        public Export_Core_Command2 GetExport_Core_Command2() => _export_Core_Command2;
        public Export_Core_Factory6 GetExport_Core_Factory6() => _export_Core_Factory6;
        public Notifications_Web90_ViewModel8 GetNotifications_Web90_ViewModel8() => _notifications_Web90_ViewModel8;
        public Notifications_Web90_Helper3 GetNotifications_Web90_Helper3() => _notifications_Web90_Helper3;
