...
{
    /// <summary>Immutable data transfer record for BatchJobs_Client267_Dto4.</summary>
    public record BatchJobs_Client267_Dto4(string Value, int Count, DateTime Timestamp);
