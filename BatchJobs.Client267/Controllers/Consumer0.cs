...
namespace BatchJobs.Client267
{
    ...
    public class Consumer0
    {
        ...
        private readonly Utilities_Web398_Helper3 _utilities_Web398_Helper3;
        private readonly Utilities_Web398_Provider2 _utilities_Web398_Provider2;
        private readonly ISecurity_Client353_Validator7 _iSecurity_Client353_Validator7;
        private readonly Export_Core_Repository _export_Core_Repository;
        private readonly INotifications_Web90_Factory2 _iNotifications_Web90_Factory2;
        private readonly Notifications_Web90_Processor10 _notifications_Web90_Processor10;

        public Consumer0(Auth_Handlers_Request8 auth_Handlers_Request8, Auth_Handlers_Manager3 auth_Handlers_Manager3, Utilities_Web398_Helper3 utilities_Web398_Helper3, Utilities_Web398_Provider2 utilities_Web398_Provider2, ISecurity_Client353_Validator7 iSecurity_Client353_Validator7, Export_Core_Repository export_Core_Repository, INotifications_Web90_Factory2 iNotifications_Web90_Factory2, Notifications_Web90_Processor10 notifications_Web90_Processor10)
        {
            ...
            _utilities_Web398_Helper3 = utilities_Web398_Helper3 ?? throw new ArgumentNullException(nameof(utilities_Web398_Helper3));
            _utilities_Web398_Provider2 = utilities_Web398_Provider2 ?? throw new ArgumentNullException(nameof(utilities_Web398_Provider2));
            ...
            _export_Core_Repository = export_Core_Repository ?? throw new ArgumentNullException(nameof(export_Core_Repository));
            _iNotifications_Web90_Factory2 = iNotifications_Web90_Factory2 ?? throw new ArgumentNullException(nameof(iNotifications_Web90_Factory2));
            _notifications_Web90_Processor10 = notifications_Web90_Processor10 ?? throw new ArgumentNullException(nameof(notifications_Web90_Processor10));
        }
        ...
        public Utilities_Web398_Helper3 GetUtilities_Web398_Helper3() => _utilities_Web398_Helper3;
        public Utilities_Web398_Provider2 GetUtilities_Web398_Provider2() => _utilities_Web398_Provider2;
        public ISecurity_Client353_Validator7 GetISecurity_Client353_Validator7() => _iSecurity_Client353_Validator7;
        public Export_Core_Repository GetExport_Core_Repository() => _export_Core_Repository;
        public INotifications_Web90_Factory2 GetINotifications_Web90_Factory2() => _iNotifications_Web90_Factory2;
        public Notifications_Web90_Processor10 GetNotifications_Web90_Processor10() => _notifications_Web90_Processor10;
