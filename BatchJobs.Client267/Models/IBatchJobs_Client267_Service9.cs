...
{
    internal interface IBatchJobs_Client267_Service9
    {
        /// <summary>Processes the BatchJobs_Client267_Service9 operation.</summary>
        void ProcessBatchJobs_Client267_Service9();

        /// <summary>Validates the BatchJobs_Client267_Service9 state.</summary>
        bool ValidateBatchJobs_Client267_Service9();
    }
