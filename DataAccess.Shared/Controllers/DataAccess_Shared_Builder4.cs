...
{
    public class DataAccess_Shared_Builder4
    {
        private readonly string _sql = "SELECT * FROM Invoices WHERE Id = @Id";
        public void Execute()
        {
            // DataAccess_Shared_Builder4 implementation
        }
...
public int Field5SortOrder { get; set; }
    ...
    {
        public DbSet<DataAccess_Shared_Builder4> DataAccess_Shared_Builder4s { get; set; }
    }
