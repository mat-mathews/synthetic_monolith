...
namespace DataAccess.Shared
{
    ...
    public class Consumer25
    {
        ...
        private readonly Documents_Client58_Handler7 _documents_Client58_Handler7;
        private readonly Import_Models_Event11 _import_Models_Event11;
        private readonly Import_Models_Controller1 _import_Models_Controller1;
        private readonly Security_Contracts_Helper5 _security_Contracts_Helper5;
        private readonly Security_Contracts_Handler12 _security_Contracts_Handler12;
        private readonly Security_Contracts_Provider8 _security_Contracts_Provider8;
        private readonly ICommon_Mappers190_Factory2 _iCommon_Mappers190_Factory2;

        public Consumer25(Admin_Service339_Provider10 admin_Service339_Provider10, Documents_Client58_Handler7 documents_Client58_Handler7, Import_Models_Event11 import_Models_Event11, Import_Models_Controller1 import_Models_Controller1, Security_Contracts_Helper5 security_Contracts_Helper5, Security_Contracts_Handler12 security_Contracts_Handler12, Security_Contracts_Provider8 security_Contracts_Provider8, ICommon_Mappers190_Factory2 iCommon_Mappers190_Factory2)
        {
            ...
            _documents_Client58_Handler7 = documents_Client58_Handler7 ?? throw new ArgumentNullException(nameof(documents_Client58_Handler7));
            _import_Models_Event11 = import_Models_Event11 ?? throw new ArgumentNullException(nameof(import_Models_Event11));
            _import_Models_Controller1 = import_Models_Controller1 ?? throw new ArgumentNullException(nameof(import_Models_Controller1));
            _security_Contracts_Helper5 = security_Contracts_Helper5 ?? throw new ArgumentNullException(nameof(security_Contracts_Helper5));
            _security_Contracts_Handler12 = security_Contracts_Handler12 ?? throw new ArgumentNullException(nameof(security_Contracts_Handler12));
            _security_Contracts_Provider8 = security_Contracts_Provider8 ?? throw new ArgumentNullException(nameof(security_Contracts_Provider8));
            _iCommon_Mappers190_Factory2 = iCommon_Mappers190_Factory2 ?? throw new ArgumentNullException(nameof(iCommon_Mappers190_Factory2));
        }

        public Admin_Service339_Provider10 GetAdmin_Service339_Provider10() => _admin_Service339_Provider10;
        public Documents_Client58_Handler7 GetDocuments_Client58_Handler7() => _documents_Client58_Handler7;
        public Import_Models_Event11 GetImport_Models_Event11() => _import_Models_Event11;
        public Import_Models_Controller1 GetImport_Models_Controller1() => _import_Models_Controller1;
        public Security_Contracts_Helper5 GetSecurity_Contracts_Helper5() => _security_Contracts_Helper5;
        public Security_Contracts_Handler12 GetSecurity_Contracts_Handler12() => _security_Contracts_Handler12;
        public Security_Contracts_Provider8 GetSecurity_Contracts_Provider8() => _security_Contracts_Provider8;
        public ICommon_Mappers190_Factory2 GetICommon_Mappers190_Factory2() => _iCommon_Mappers190_Factory2;
