...
{
    public interface IScheduling_Processors335_Handler9
    {
        /// <summary>Processes the Scheduling_Processors335_Handler9 operation.</summary>
        void ProcessScheduling_Processors335_Handler9();

        /// <summary>Validates the Scheduling_Processors335_Handler9 state.</summary>
        bool ValidateScheduling_Processors335_Handler9();
    }
