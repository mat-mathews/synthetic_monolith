...
{
    internal class Scheduling_Tests85_Service
    {
        private readonly string _sql = "SELECT * FROM Orders WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Tests85_Service implementation
        }
...
public int Attr41SortOrder { get; set; }
    ...
    public class Tests85Context : DbContext
    {
        public DbSet<Scheduling_Tests85_Service> Scheduling_Tests85_Services { get; set; }
    }
