...
{
    /// <summary>Immutable data transfer record for Scheduling_Data_Response6.</summary>
    internal record Scheduling_Data_Response6(string Value, int Count, DateTime Timestamp);
