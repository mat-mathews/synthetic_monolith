...
{
    public abstract class Scheduling_Web221_Manager10
    {
        private readonly string _sql = "SELECT * FROM Reports WHERE Id = @Id";
        public void Execute()
        {
            // Scheduling_Web221_Manager10 implementation
        }
...
public int Entry16SortOrder { get; set; }
    ...
    {
        public DbSet<Scheduling_Web221_Manager10> Scheduling_Web221_Manager10s { get; set; }
    }
