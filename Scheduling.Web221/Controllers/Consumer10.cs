...
namespace Scheduling.Web221
{
    ...
    public class Consumer10
    {
        ...
        private readonly Billing_Client182_Repository3 _billing_Client182_Repository3;
        private readonly Billing_Client182_Repository2 _billing_Client182_Repository2;
        private readonly Billing_Client182_Provider12 _billing_Client182_Provider12;
        private readonly Export_Data_Range1 _export_Data_Range1;
        private readonly Import_Client_Service7 _import_Client_Service7;
        private readonly ICommon_Web438_Repository2 _iCommon_Web438_Repository2;
        private readonly Reporting_Contracts_Result _reporting_Contracts_Result;

        public Consumer10(IAdmin_Handlers_Validator6 iAdmin_Handlers_Validator6, Billing_Client182_Repository3 billing_Client182_Repository3, Billing_Client182_Repository2 billing_Client182_Repository2, Billing_Client182_Provider12 billing_Client182_Provider12, Export_Data_Range1 export_Data_Range1, Import_Client_Service7 import_Client_Service7, ICommon_Web438_Repository2 iCommon_Web438_Repository2, Reporting_Contracts_Result reporting_Contracts_Result)
        {
            _iAdmin_Handlers_Validator6 = iAdmin_Handlers_Validator6 ?? throw new ArgumentNullException(nameof(iAdmin_Handlers_Validator6));
            _billing_Client182_Repository3 = billing_Client182_Repository3 ?? throw new ArgumentNullException(nameof(billing_Client182_Repository3));
            _billing_Client182_Repository2 = billing_Client182_Repository2 ?? throw new ArgumentNullException(nameof(billing_Client182_Repository2));
            _billing_Client182_Provider12 = billing_Client182_Provider12 ?? throw new ArgumentNullException(nameof(billing_Client182_Provider12));
            _export_Data_Range1 = export_Data_Range1 ?? throw new ArgumentNullException(nameof(export_Data_Range1));
            _import_Client_Service7 = import_Client_Service7 ?? throw new ArgumentNullException(nameof(import_Client_Service7));
            _iCommon_Web438_Repository2 = iCommon_Web438_Repository2 ?? throw new ArgumentNullException(nameof(iCommon_Web438_Repository2));
            _reporting_Contracts_Result = reporting_Contracts_Result ?? throw new ArgumentNullException(nameof(reporting_Contracts_Result));
        }

        public IAdmin_Handlers_Validator6 GetIAdmin_Handlers_Validator6() => _iAdmin_Handlers_Validator6;
        public Billing_Client182_Repository3 GetBilling_Client182_Repository3() => _billing_Client182_Repository3;
        public Billing_Client182_Repository2 GetBilling_Client182_Repository2() => _billing_Client182_Repository2;
        public Billing_Client182_Provider12 GetBilling_Client182_Provider12() => _billing_Client182_Provider12;
        public Export_Data_Range1 GetExport_Data_Range1() => _export_Data_Range1;
        public Import_Client_Service7 GetImport_Client_Service7() => _import_Client_Service7;
        public ICommon_Web438_Repository2 GetICommon_Web438_Repository2() => _iCommon_Web438_Repository2;
        public Reporting_Contracts_Result GetReporting_Contracts_Result() => _reporting_Contracts_Result;
