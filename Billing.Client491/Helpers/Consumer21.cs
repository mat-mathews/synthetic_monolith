...
namespace Billing.Client491
{
    ...
    public class Consumer21
    {
        ...
        private readonly Documents_Data490_Handler _documents_Data490_Handler;
        private readonly Documents_Handlers_Provider1 _documents_Handlers_Provider1;
        ...
        public Consumer21(IAuth_Contracts_Factory2 iAuth_Contracts_Factory2, Documents_Data490_Handler documents_Data490_Handler, Documents_Handlers_Provider1 documents_Handlers_Provider1, Documents_Handlers_Event3 documents_Handlers_Event3, Documents_Handlers_Repository5 documents_Handlers_Repository5, Logging_Data29_Command6 logging_Data29_Command6, Logging_Data29_Handler logging_Data29_Handler, Logging_Data29_Helper12 logging_Data29_Helper12)
        {
            _iAuth_Contracts_Factory2 = iAuth_Contracts_Factory2 ?? throw new ArgumentNullException(nameof(iAuth_Contracts_Factory2));
            _documents_Data490_Handler = documents_Data490_Handler ?? throw new ArgumentNullException(nameof(documents_Data490_Handler));
            _documents_Handlers_Provider1 = documents_Handlers_Provider1 ?? throw new ArgumentNullException(nameof(documents_Handlers_Provider1));
        ...
        public Documents_Data490_Handler GetDocuments_Data490_Handler() => _documents_Data490_Handler;
        public Documents_Handlers_Provider1 GetDocuments_Handlers_Provider1() => _documents_Handlers_Provider1;
