...
{
    /// <summary>Immutable data transfer record for Documents_Shared487_Response6.</summary>
    internal record Documents_Shared487_Response6(string Value, int Count, DateTime Timestamp);
