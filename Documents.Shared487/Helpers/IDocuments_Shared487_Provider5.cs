...
{
    public interface IDocuments_Shared487_Provider5
    {
        /// <summary>Processes the Documents_Shared487_Provider5 operation.</summary>
        void ProcessDocuments_Shared487_Provider5();

        /// <summary>Validates the Documents_Shared487_Provider5 state.</summary>
        bool ValidateDocuments_Shared487_Provider5();
    }
